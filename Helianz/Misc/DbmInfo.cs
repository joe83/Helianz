...
namespace Helianz.Misc {
		public class DbmInfo {
			...
			//has all of the info from https://www.helianz.com/manual/dbmlogresults.html
			public static List<DbmInfo> ListDbmInfos=>new List<DbmInfo>() {
				...
				new DbmInfo() {
						...
						WhyItHappens="A bug in an older version of Helianz caused this issue to occur sometimes when processing payments for ERAs."
					},
				new DbmInfo() {
