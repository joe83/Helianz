...
using Helianz.User_Controls.SetupWizard;
using System.Linq;
...
namespace Helianz {
	...
	public partial class SetupWizard {
			...
			public override string GetDescript {
				get {
					return "You have indicated that you will be using the Clinics feature. "
						+"Clinics can be used when you have multiple locations. Once clinics are set up, you can assign clinics throughout Helianz. "
		...
		public class ProvSetup:SetupWizClass {
			...
			public override string GetDescript {
				get {
					return "Providers will show up in almost every part of Helianz. "
		...
		//	public override ODSetupStatus GetStatus {
		//		get {
		//			Clearinghouse clearHouseCur = HelianzBusiness.Clearinghouses.GetDefaultDental();
