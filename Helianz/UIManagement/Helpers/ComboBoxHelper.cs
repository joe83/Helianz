...
namespace Helianz.UIManagement {
	...
	public class ComboBoxHelper{
		public static ComboBox CreateComboBox(Helianz.UI.ComboBox comboBox){
		...
		public static void Item_Add(ComboBox wComboBox,Helianz.UI.ComboBox oComboBox,string txt){
