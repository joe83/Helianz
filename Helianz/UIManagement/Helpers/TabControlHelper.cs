...
namespace Helianz.UIManagement {
	...
	public class TabControlHelper{
		public static TabControl CreateTabControl(Helianz.UI.TabControl tabControl){
		...
		public static TabItem CreateTabPage(Helianz.UI.TabPage tabPage,FrameworkElement frameworkElementTabControl){
