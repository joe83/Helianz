...
namespace Helianz {
	public partial class FormRpHiddenPaySplits {
		...
		private void InitializeComponent()
		{
			...
			this.odDateRangePicker = new Helianz.UI.ODDateRangePicker();
			this.checkAllProv = new Helianz.UI.CheckBox();
			this.listBoxProv = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.listBoxClinic = new Helianz.UI.ListBox();
			this.labelClinic = new System.Windows.Forms.Label();
			this.checkAllClinics = new Helianz.UI.CheckBox();
			this.checkAllUnearnedTypes = new Helianz.UI.CheckBox();
			this.listBoxUnearnedTypes = new Helianz.UI.ListBox();
			...
			this.listBoxProv.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxClinic.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxUnearnedTypes.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ODDateRangePicker odDateRangePicker;
		private Helianz.UI.CheckBox checkAllProv;
		private Helianz.UI.ListBox listBoxProv;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.ListBox listBoxClinic;
		private System.Windows.Forms.Label labelClinic;
		private Helianz.UI.CheckBox checkAllClinics;
		private Helianz.UI.CheckBox checkAllUnearnedTypes;
		private Helianz.UI.ListBox listBoxUnearnedTypes;
