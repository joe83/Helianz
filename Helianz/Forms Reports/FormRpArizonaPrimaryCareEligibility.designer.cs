namespace Helianz{
	partial class FormRpArizonaPrimaryCareEligibility {
		...
		private void InitializeComponent() {
			...
			this.folderEligibilityPath=new Helianz.FolderBrowserDialog();
			...
			this.butFinished=new Helianz.UI.Button();
