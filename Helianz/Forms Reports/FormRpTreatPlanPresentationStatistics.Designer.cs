namespace Helianz{
	partial class FormRpTreatPlanPresentationStatistics {
		...
		private void InitializeComponent() {
			...
			this.checkAllUsers = new Helianz.UI.CheckBox();
			...
			this.groupGrossNet = new Helianz.UI.GroupBox();
			...
			this.groupUser = new Helianz.UI.GroupBox();
			...
			this.listUser.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.GroupBox groupGrossNet;
		...
		private Helianz.UI.CheckBox checkAllUsers;
		...
		private Helianz.UI.GroupBox groupUser;
