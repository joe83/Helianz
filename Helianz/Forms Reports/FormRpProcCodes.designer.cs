...
namespace Helianz {
	public partial class FormRpProcCodes {
		...
		private void InitializeComponent()
		{
			...
			this.listBoxFeeSched = new Helianz.UI.ListBox();
			...
			this.listBoxProviders = new Helianz.UI.ListBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.checkShowBlankFees = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.ListBox listBoxFeeSched;
		private System.Windows.Forms.RadioButton radioCategories;
		private System.Windows.Forms.RadioButton radioCode;
		private Label label1;
		private Helianz.UI.ListBox listBoxClinics;
		private Helianz.UI.ListBox listBoxProviders;
		private Label label2;
		private Label label3;
		private Helianz.UI.CheckBox checkShowBlankFees;
