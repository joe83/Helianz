...
namespace Helianz {
	public partial class FormRpPatients {
		...
		private void InitializeComponent() {
			...
			this.tabPatients = new Helianz.UI.TabControl();
			this.tabData = new Helianz.UI.TabPage();
			this.listBoxRefType = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textBox1 = new System.Windows.Forms.TextBox();
			this.labelReferredTo = new System.Windows.Forms.Label();
			this.listReferredToSelect = new Helianz.UI.ListBox();
			this.labelPatient = new System.Windows.Forms.Label();
			this.listPatientSelect = new Helianz.UI.ListBox();
			this.tabFilters = new Helianz.UI.TabPage();
			this.label2 = new System.Windows.Forms.Label();
			this.labelHelp = new System.Windows.Forms.Label();
			this.listBoxColumns = new Helianz.UI.ListBox();
			this.TextDate = new Helianz.ValidDate();
			this.TextValidAge = new Helianz.ValidNum();
			this.butDeleteFilter = new Helianz.UI.Button();
			this.listPrerequisites = new Helianz.UI.ListBox();
			this.butAddFilter = new Helianz.UI.Button();
			this.listConditions = new Helianz.UI.ListBox();
			this.TextBox = new System.Windows.Forms.TextBox();
			this.DropListFilter = new Helianz.UI.ComboBox();
			...
			this.listBoxRefType.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listReferredToSelect.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listPatientSelect.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxColumns.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listPrerequisites.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.TabControl tabPatients;
		private Helianz.UI.TabPage tabFilters;
		private Helianz.UI.TabPage tabData;
		private Helianz.UI.ListBox listBoxColumns;
		private Helianz.UI.ListBox listPatientSelect;
		private Helianz.UI.ListBox listPrerequisites;
		private Helianz.UI.ListBox listReferredToSelect;
		private Helianz.UI.ListBox listConditions;
		private Helianz.UI.ComboBox DropListFilter;
		private Helianz.UI.Button butOK;
		private Helianz.UI.Button butAddFilter;
		private Helianz.UI.Button butDeleteFilter;
		private System.Windows.Forms.TextBox TextSQL;
		private System.Windows.Forms.TextBox TextBox;
		private Helianz.ValidNum TextValidAge;
