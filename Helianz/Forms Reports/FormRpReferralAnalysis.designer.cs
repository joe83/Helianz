...
namespace Helianz {
	public partial class FormRpReferralAnalysis {
		...
		private void InitializeComponent(){
			...
			this.checkAddress = new Helianz.UI.CheckBox();
			this.label5 = new System.Windows.Forms.Label();
			this.butOK = new Helianz.UI.Button();
			this.checkNewPat = new Helianz.UI.CheckBox();
			this.checkLandscape = new Helianz.UI.CheckBox();
    ...
    "t necessarily everyone.";
		...
		private Helianz.UI.CheckBox checkAddress;
		private Label label5;
		private Helianz.UI.CheckBox checkNewPat;
		private Helianz.UI.CheckBox checkLandscape;
	}
}
