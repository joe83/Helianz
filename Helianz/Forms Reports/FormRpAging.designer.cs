...
namespace Helianz {
	public partial class FormRpAging {
		...
		private void InitializeComponent(){
			...
			this.groupAgeOfAccount = new Helianz.UI.GroupBox();
			...
			this.checkIncludeNeg = new Helianz.UI.CheckBox();
			this.groupIncludePats = new Helianz.UI.GroupBox();
			this.checkIncludeInsNoBal = new Helianz.UI.CheckBox();
			this.checkOnlyNeg = new Helianz.UI.CheckBox();
			this.checkExcludeInactive = new Helianz.UI.CheckBox();
			this.listProv = new Helianz.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.checkProvAll = new Helianz.UI.CheckBox();
			this.checkBillTypesAll = new Helianz.UI.CheckBox();
			...
			this.checkHasDateLastPay = new Helianz.UI.CheckBox();
			...
			this.butQuery = new Helianz.UI.Button();
			this.groupOnlyShow = new Helianz.UI.GroupBox();
			this.checkOnlyInsNoBal = new Helianz.UI.CheckBox();
			this.groupExcludePats = new Helianz.UI.GroupBox();
			this.checkAgePatPayPlanPayments = new Helianz.UI.CheckBox();
			this.labelFutureTrans = new System.Windows.Forms.Label();
			this.checkBoxExcludeIncomeTransfers = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.GroupBox groupAgeOfAccount;
		...
		private Helianz.UI.CheckBox checkIncludeNeg;
		private Helianz.UI.GroupBox groupIncludePats;
		private Helianz.UI.CheckBox checkOnlyNeg;
		private Helianz.UI.CheckBox checkExcludeInactive;
		private Helianz.UI.ListBox listProv;
		private Label label3;
		private Helianz.UI.CheckBox checkProvAll;
		private Helianz.UI.CheckBox checkBillTypesAll;
		...
		private Helianz.UI.CheckBox checkHasDateLastPay;
		...
		private Helianz.UI.CheckBox checkIncludeInsNoBal;
		private Helianz.UI.GroupBox groupOnlyShow;
		private Helianz.UI.CheckBox checkOnlyInsNoBal;
		private Helianz.UI.GroupBox groupExcludePats;
		private Helianz.UI.CheckBox checkAgePatPayPlanPayments;
		private Label labelFutureTrans;
		private Helianz.UI.CheckBox checkBoxExcludeIncomeTransfers;
