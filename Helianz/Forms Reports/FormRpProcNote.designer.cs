...
namespace Helianz {
	public partial class FormRpProcNote {
		...
		private void InitializeComponent() {
			...
			this.checkNoNotes = new Helianz.UI.CheckBox();
			this.checkUnsignedNote = new Helianz.UI.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.groupFilter = new Helianz.UI.GroupBox();
			this.checkShowExcludedCodes = new Helianz.UI.CheckBox();
			...
			this.comboProvs = new Helianz.UI.ComboBox();
		...
		#endregion
		private Helianz.UI.CheckBox checkNoNotes;
		private Helianz.UI.CheckBox checkUnsignedNote;
		...
		private Helianz.UI.CheckBox checkShowExcludedCodes;
	}
}
