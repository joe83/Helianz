...
namespace Helianz {
	public partial class FormRpInsAging {
		...
		private void InitializeComponent(){
			...
			this.checkOnlyShowPatsOutstandingClaims = new Helianz.UI.CheckBox();
			this.groupFilter = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.CheckBox checkOnlyShowPatsOutstandingClaims;
		private Label labelFutureTrans;
		private Helianz.UI.GroupBox groupFilter;
