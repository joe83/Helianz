...
namespace Helianz {
	public partial class FormRpReferrals {
		...
		private void InitializeComponent()
		{
			...
			this.tabReferrals = new Helianz.UI.TabControl();
			this.tabData = new Helianz.UI.TabPage();
			this.listSelect = new Helianz.UI.ListBox();
			this.butCheckAll = new Helianz.UI.Button();
			...
			this.listOptions = new Helianz.UI.ListBox();
			...
			this.listSelect.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listOptions.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.Button butCheckAll;
		private Helianz.UI.Button butClear;
		private Helianz.UI.TabPage tabFilters;
		private Helianz.UI.ListBox listOptions;
		...
		private Helianz.UI.TabControl tabReferrals;
		private Helianz.UI.ListBox listSelect;
