...
namespace Helianz {
	public partial class FormRpProcOverpaid {
		...
		private void InitializeComponent()
		{
			...
			this.checkExcludeOverpaidWithIns = new Helianz.UI.CheckBox();
			...
			this.comboBoxMultiClinics = new Helianz.UI.ComboBoxClinicPicker();
		...
		private Helianz.UI.CheckBox checkExcludeOverpaidWithIns;
	}
}
