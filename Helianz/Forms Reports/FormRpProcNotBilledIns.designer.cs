namespace Helianz {
	partial class FormRpProcNotBilledIns {
		...
		private void InitializeComponent() {
			...
			this.checkShowProcsInProcess = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkShowProcsInProcess;
