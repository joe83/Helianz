...
namespace Helianz {
	public partial class FormRpRecall {
		...
		private void InitializeComponent(){
			...
			this.listPatientSelect2 = new Helianz.UI.ListBox();
			this.SuspendLayout();
			// 
			// labelPatient
			// 
			...
			this.listPatientSelect2.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listPatientSelect2;
