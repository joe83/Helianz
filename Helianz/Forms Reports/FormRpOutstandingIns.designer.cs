...
namespace Helianz {
	public partial class FormRpOutstandingIns {
		...
		private void InitializeComponent() {
			...
			this.checkIgnoreCustom = new Helianz.UI.CheckBox();
			...
			this.comboPreauthOptions = new Helianz.UI.ComboBox();
			this.tabControlDate = new Helianz.UI.TabControl();
			this.tabDaysOld = new Helianz.UI.TabPage();
			this.textDaysOldMax = new Helianz.ValidNum();
			this.labelDaysOldMax = new System.Windows.Forms.Label();
			this.textDaysOldMin = new Helianz.ValidNum();
			this.labelDateMinMaxAdvice = new System.Windows.Forms.Label();
			this.labelDaysOldMin = new System.Windows.Forms.Label();
			this.tabDateRange = new Helianz.UI.TabPage();
			this.dateRangePicker = new Helianz.UI.ODDateRangePicker();
			this.comboDateFilterBy = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.comboErrorDef = new Helianz.UI.ComboBox();
			this.butMine = new Helianz.UI.Button();
			this.comboUserAssigned = new Helianz.UI.ComboBox();
			this.butPickUser = new Helianz.UI.Button();
			this.labelForUser = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.comboLastClaimTrack = new Helianz.UI.ComboBox();
			this.label1 = new System.Windows.Forms.Label();
			this.buttonUpdateCustomTrack = new Helianz.UI.Button();
			this.labelClaimCount = new System.Windows.Forms.Label();
			this.groupBoxUpdateCustomTracking = new Helianz.UI.GroupBox();
			this.labelCustomTracking = new System.Windows.Forms.Label();
			this.butAssignUser = new Helianz.UI.Button();
			...
			this.textCarrierPhone = new Helianz.ValidPhone();
			...
			this.butZeroClaims = new Helianz.UI.Button();
		...
		private Helianz.UI.CheckBox checkIgnoreCustom;
		...
		private Helianz.UI.GroupBox groupBoxUpdateCustomTracking;
		...
		private Helianz.UI.TabControl tabControlDate;
		private Helianz.UI.TabPage tabDaysOld;
		...
		private Helianz.UI.TabPage tabDateRange;
