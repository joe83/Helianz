...
namespace Helianz {
	public partial class FormRpTreatmentFinder {
		...
		private void InitializeComponent(){
			...
			this.checkIncludeNoIns = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.label5 = new System.Windows.Forms.Label();
			this.checkUseTreatingProvider = new Helianz.UI.CheckBox();
			...
			this.comboBoxMultiBilling = new Helianz.UI.ComboBox();
			this.comboBoxMultiProv = new Helianz.UI.ComboBox();
			this.textOverAmount = new Helianz.ValidDouble();
			this.comboMonthStart = new System.Windows.Forms.ComboBox();
			this.label8 = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.checkIncludePatsWithApts = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.labelCodeRange = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.butRefresh = new Helianz.UI.Button();
			this.datePickerEnd = new Helianz.UI.ODDatePicker();
			this.datePickerStart = new Helianz.UI.ODDatePicker();
			...
			this.buttonExport = new Helianz.UI.Button();
			this.butLettersPreview = new Helianz.UI.Button();
			this.butLabelSingle = new Helianz.UI.Button();
			this.butLabelPreview = new Helianz.UI.Button();
			this.butGotoAccount = new Helianz.UI.Button();
			this.butGotoFamily = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.checkIncludeHiddenBillingTypes = new Helianz.UI.CheckBox();
			...
			this.butLettersPreview.Image = global::Helianz.Properties.Resources.butPreview;
			...
			this.butLabelSingle.Image = global::Helianz.Properties.Resources.butLabel;
			...
			this.butLabelPreview.Image = global::Helianz.Properties.Resources.butLabel;
		...
		private Helianz.UI.CheckBox checkIncludeNoIns;
		...
		private Helianz.UI.CheckBox checkIncludePatsWithApts;
		private Helianz.UI.CheckBox checkBenefitAssumeGeneral;
		private UI.ODCodeRangeFilter codeRangeFilter;
		private Helianz.UI.CheckBox checkUseTreatingProvider;
		...
		private Helianz.UI.CheckBox checkIncludeHiddenBillingTypes;
	}
}
