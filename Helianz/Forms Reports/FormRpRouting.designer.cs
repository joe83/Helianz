...
namespace Helianz {
	public partial class FormRpRouting {
		...
		private void InitializeComponent() {
			...
			this.butDisplayed = new Helianz.UI.Button();
			this.checkClinAll = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.Button butDisplayed;
		private Helianz.UI.Button butToday;
		private Helianz.UI.CheckBox checkClinAll;
