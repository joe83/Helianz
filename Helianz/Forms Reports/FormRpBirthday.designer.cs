...
namespace Helianz {
	public partial class FormRpBirthday {
		...
		private void InitializeComponent()
		{
			...
			this.validDateTo = new Helianz.ValidDate();
			this.validDateFrom = new Helianz.ValidDate();
		...
		private Helianz.UI.Button butMonth;
