...
///<summary></summary>
	public partial class FormRpTreatmentFinder:FormODBase {
		...
		private void gridMain_CellClick(object sender,ODGridClickEventArgs e) {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Chart,patNum:PIn.Long(gridMain.SelectedTag<DataRow>()["PatNum"].ToString()));
		}
		...
		private void menuItemFamily_Click(object sender,EventArgs e) {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Family, patNum:patNum);
		}
