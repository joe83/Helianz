...
namespace Helianz {
	public partial class FormRpLaserLabels {
		...
		private void InitializeComponent() {
			...
			this.tabCustomLabels = new Helianz.UI.TabPage();
			this.butCusRemove = new Helianz.UI.Button();
			this.butCusAdd = new Helianz.UI.Button();
			this.listCusNames = new Helianz.UI.ListBox();
			...
			this.tabInsCo = new Helianz.UI.TabPage();
			this.butInsCoEnd = new Helianz.UI.Button();
			this.butInsCoStart = new Helianz.UI.Button();
			...
			this.listProviders = new Helianz.UI.ListBox();
			this.checkAllProviders = new Helianz.UI.CheckBox();
			this.checkActiveOnly = new Helianz.UI.CheckBox();
			this.checkGroupByFamily = new Helianz.UI.CheckBox();
			this.butEndName = new Helianz.UI.Button();
			this.textEndName = new System.Windows.Forms.TextBox();
			this.textStartName = new System.Windows.Forms.TextBox();
			this.butStartName = new Helianz.UI.Button();
			...
			this.tabLabelSetup = new Helianz.UI.TabControl();
			this.tabBirthday = new Helianz.UI.TabPage();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butBirthdayMonth = new Helianz.UI.Button();
			this.butBirthdayRight = new Helianz.UI.Button();
			this.butBirthdayLeft = new Helianz.UI.Button();
			...
			this.checkBirthdayActive = new Helianz.UI.CheckBox();
			...
			this.listProviders.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			// butBirthdayRight
			// 
			this.butBirthdayRight.Image = global::Helianz.Properties.Resources.Right;
			...
			// butBirthdayLeft
			// 
			this.butBirthdayLeft.Image = global::Helianz.Properties.Resources.Left;
		...
		private Helianz.UI.TabPage tabCustomLabels;
		private Helianz.UI.TabPage tabInsCo;
		private Helianz.UI.TabPage tabPage1;
		private Helianz.UI.ListBox listProviders;
		private Helianz.UI.CheckBox checkAllProviders;
		private Helianz.UI.CheckBox checkActiveOnly;
		private Helianz.UI.CheckBox checkGroupByFamily;
		...
		private Helianz.UI.TabControl tabLabelSetup;
		...
		private Helianz.UI.Button butEndName;
		private Helianz.UI.Button butStartName;
		...
		private Helianz.UI.ListBox listCusNames;
		private Helianz.UI.Button butCusAdd;
		private Helianz.UI.ListBox listStatus;
		private Panel panLabels;
		private Helianz.UI.Button butCusRemove;
		private Label labInsCoStartAddr;
		private Label labInsCoEndAddr;
		private Helianz.UI.Button butInsCoEnd;
		private Helianz.UI.TabPage tabBirthday;
		private Label labBirthdayTo;
		private Label labBirthdayFrom;
		private Helianz.UI.CheckBox checkBirthdayActive;
		private TextBox textBirthdayFrom;
		private TextBox textBirthdayTo;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.Button butBirthdayLeft;
		private Helianz.UI.Button butBirthdayRight;
		private Helianz.UI.Button butBirthdayMonth;
		private Helianz.UI.Button butInsCoStart;
	}
}
