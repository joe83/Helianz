...
namespace Helianz {
	public partial class FormRpProviderPayroll {
		...
		private void InitializeComponent()
		{
			...
			this.checkClinicBreakdown = new Helianz.UI.CheckBox();
			this.butOK = new Helianz.UI.Button();
			this.checkClinicInfo = new Helianz.UI.CheckBox();
			this.groupPayrollReportType = new Helianz.UI.GroupBox();
    ...
    " transaction dates.  See manual for more details.";
		...
		private Helianz.UI.CheckBox checkClinicBreakdown;
    private Helianz.UI.CheckBox checkClinicInfo;
		...
		private Helianz.UI.GroupBox groupPayrollReportType;
