...
namespace Helianz {
	public partial class FormRpPrintPreview {
		...
		private void InitializeComponent(){
			...
			this._printPreviewControl2 = new Helianz.UI.ODPrintPreviewControl();
			this.butNext = new Helianz.UI.Button();
			this.butPrev = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
		...
		///<summary></summary>
		private Helianz.UI.ODPrintPreviewControl _printPreviewControl2;
		private Helianz.UI.Button butNext;
		private Helianz.UI.Button butPrev;
	}
}
