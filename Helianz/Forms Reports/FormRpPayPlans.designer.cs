...
namespace Helianz {
	public partial class FormRpPayPlans {
		...
		private void InitializeComponent()
		{
			...
			this.checkHideCompletePlans = new Helianz.UI.CheckBox();
			...
			this.checkShowFamilyBalance = new Helianz.UI.CheckBox();
			this.checkAllClin = new Helianz.UI.CheckBox();
			this.listClin = new Helianz.UI.ListBox();
			this.labelClin = new System.Windows.Forms.Label();
			this.checkHasDateRange = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkHideCompletePlans;
		...
		private Helianz.UI.CheckBox checkShowFamilyBalance;
		private Helianz.UI.CheckBox checkAllClin;
		private Helianz.UI.ListBox listClin;
		private Label labelClin;
		private Helianz.UI.CheckBox checkHasDateRange;
