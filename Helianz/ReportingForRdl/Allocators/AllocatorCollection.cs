...
namespace Helianz.Reporting.Allocators {
	/// <summary>
	/// <seealso cref="Helianz.Reporting.Allocators.IAllocator"/>
	/// Here is the model.
	...
	public class AllocatorCollection {
		...
		/// it was no longer possible to make a call into Helianz UI layer.
		...
		/// don't have to worry about helianz calling this.
		/// </summary>
		private static void CreateAllocators() {
			_AllocatorList = new List<Allocator>();
			_AllocatorList.Add(new Helianz.Reporting.Allocators.MyAllocator1_ProviderPayment());
		}
