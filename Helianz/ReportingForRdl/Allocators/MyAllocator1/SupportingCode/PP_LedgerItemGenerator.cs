/*=============================================================================================================
Helianz is a dental practice management program.
Copyright (C) 2003,2004,2005,2006,2007  Jordan Sparks, DMD.  http://www.helianz.com,  http://www.docsparks.com
...
{
	/// <summary>
	/// A place to consolidate the queries for pulling data from helianz.
	/// A collection of classes that provide different sements of the SQL querry that pulls the different 
	/// helianz tables for the data we need to reconstruct a Ledger for a specific guarantor.
	/// 
	...
	//           + "\n     && Procedurelog.ProcStatus = " + ((int)HelianzBusiness.ProcStat.C).ToString(); ;
	//        if (Guarantor != 0)
	//            rVal += "\n      && Patient.Guarantor = " + Guarantor;
	//        if (IsPulledFlag)
