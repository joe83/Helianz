...
namespace Helianz {
	...
	public class MedicationL {
		...
		///<summary>Throws Exception. Downloads default medications list from Helianz.com; returns filename of temp file.</summary>
		public static string DownloadDefaultMedicationsFile() {
			string tempFile=PrefC.GetRandomTempFile(".tmp");
			using(WebClient webClient=new WebClient()) {
				webClient.DownloadFile("http://www.helianz.com/medications/DefaultMedications.txt",tempFile);
			}
			return tempFile;
		}
