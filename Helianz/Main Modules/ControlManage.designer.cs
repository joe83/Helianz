...
namespace Helianz {
	partial class ControlManage {
		...
		private void InitializeComponent(){
            ...
            this.butSchedule = new Helianz.UI.Button();
            this.groupBox3 = new Helianz.UI.GroupBox();
            this.butEras = new Helianz.UI.Button();
            this.butImportInsPlans = new Helianz.UI.Button();
            this.butEmailInbox = new Helianz.UI.Button();
            this.butSupply = new Helianz.UI.Button();
            this.butClaimPay = new Helianz.UI.Button();
            this.butBilling = new Helianz.UI.Button();
            this.butAccounting = new Helianz.UI.Button();
            this.butBackup = new Helianz.UI.Button();
            this.butDeposit = new Helianz.UI.Button();
            this.butSendClaims = new Helianz.UI.Button();
            this.butTasks = new Helianz.UI.Button();
            this.groupBox2 = new Helianz.UI.GroupBox();
            this.listBoxMessages = new Helianz.UI.ListBox();
            this.butSend = new Helianz.UI.Button();
            this.butAck = new Helianz.UI.Button();
            this.labelSending = new System.Windows.Forms.Label();
            this.textDays = new System.Windows.Forms.TextBox();
            this.labelDays = new System.Windows.Forms.Label();
            this.label6 = new System.Windows.Forms.Label();
            this.comboBoxViewUser = new Helianz.UI.ComboBox();
            this.gridMessages = new Helianz.UI.GridOD();
            this.checkIncludeAck = new Helianz.UI.CheckBox();
            this.label7 = new System.Windows.Forms.Label();
            this.label5 = new System.Windows.Forms.Label();
            this.listBoxExtras = new Helianz.UI.ListBox();
            this.label4 = new System.Windows.Forms.Label();
            this.listBoxFrom = new Helianz.UI.ListBox();
            this.label3 = new System.Windows.Forms.Label();
            this.listBoxTo = new Helianz.UI.ListBox();
            ...
            this.butViewSched = new Helianz.UI.Button();
            this.butManage = new Helianz.UI.Button();
            this.butBreaks = new Helianz.UI.Button();
            this.gridEmp = new Helianz.UI.GridOD();
            this.labelCurrentTime = new System.Windows.Forms.Label();
            this.listBoxStatus = new Helianz.UI.ListBox();
            this.butClockOut = new Helianz.UI.Button();
            this.butTimeCard = new Helianz.UI.Button();
            this.labelTime = new System.Windows.Forms.Label();
            this.butClockIn = new Helianz.UI.Button();
            this.butDaycare = new Helianz.UI.Button();
            this.butDaycareCheckIn = new Helianz.UI.Button();
            ...
            // butEmailInbox
            // 
            this.butEmailInbox.Icon = Helianz.UI.EnumIcons.Email;
            ...
            this.gridMessages.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
            ...
            this.gridEmp.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
            ...
            this.gridEmp.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridEmp_CellDoubleClick);
            this.gridEmp.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridEmp_CellClick);
            // 
            // labelCurrentTime
            // 
		...
		private Helianz.UI.CheckBox checkIncludeAck;
		...
		private Helianz.UI.ListBox listBoxExtras;
		private Helianz.UI.ListBox listBoxFrom;
		private Helianz.UI.ListBox listBoxMessages;
		private Helianz.UI.ListBox listBoxStatus;
		private Helianz.UI.ListBox listBoxTo;
