namespace Helianz {
	partial class ControlAppt {
		...
		private void InitializeComponent() {
			...
			this.gridProv = new Helianz.UI.GridOD();
			this.tabReminders = new Helianz.UI.TabPage();
			...
			this.groupSearch = new Helianz.UI.GroupBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butProvHygenist = new Helianz.UI.Button();
			this.butProvDentist = new Helianz.UI.Button();
			this.butProvPick = new Helianz.UI.Button();
			this.butRefresh = new Helianz.UI.Button();
			this.listSearchResults = new Helianz.UI.ListBox();
			this._listBoxProviders = new Helianz.UI.ListBox();
			this.butSearchClose = new Helianz.UI.Button();
			...
			this.butSearchNext = new Helianz.UI.Button();
			this.toolBarMain = new Helianz.UI.ToolBarOD();
			this.toggleDayWeek = new Helianz.UI.ToggleDayWeek();
			this.butFwd4 = new Helianz.UI.Button();
			this.butFwd6 = new Helianz.UI.Button();
			this.butFwd3 = new Helianz.UI.Button();
			this.pinBoard = new Helianz.UI.PinBoard();
			this.listConfirmed = new Helianz.UI.ListBox();
			this.butAdvSearch = new Helianz.UI.Button();
			this.butFwdMonth = new Helianz.UI.Button();
			this.butBackMonth = new Helianz.UI.Button();
			this.butBackWeek = new Helianz.UI.Button();
			this.butFwdWeek = new Helianz.UI.Button();
			this.butToday = new Helianz.UI.Button();
			this.butFwd = new Helianz.UI.Button();
			this.butBack = new Helianz.UI.Button();
			this.butLab = new Helianz.UI.Button();
			this.butClearPin = new Helianz.UI.Button();
			this.butSearch = new Helianz.UI.Button();
			this.comboView = new Helianz.UI.ComboBox();
			this.butMonth = new Helianz.UI.Button();
			this.monthCalendarOD = new Helianz.UI.MonthCalendarOD();
			this.contrApptPanel = new Helianz.UI.ControlApptPanel();
			...
			this.gridReminders.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridReminders_CellDoubleClick);
			...
			this._listBoxProviders.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.pinBoard.ApptMovedFromPinboard += new System.EventHandler<Helianz.UI.ApptFromPinboardEventArgs>(this.pinBoard_ApptMovedFromPinboard);
			this.pinBoard.ModuleNeedsRefresh += new System.EventHandler(this.pinBoard_ModuleNeedsRefresh);
			this.pinBoard.PreparingToDragFromPinboard += new System.EventHandler<Helianz.UI.ApptDataRowEventArgs>(this.pinBoard_PreparingToDragFromPinboard);
			...
			this.contrApptPanel.ApptDoubleClicked += new System.EventHandler<Helianz.UI.ApptEventArgs>(this.contrApptPanel_ApptDoubleClicked);
			this.contrApptPanel.ApptMainAreaDoubleClicked += new System.EventHandler<Helianz.UI.ApptMainClickEventArgs>(this.contrApptPanel_ApptMainAreaDoubleClicked);
			this.contrApptPanel.ApptMainAreaRightClicked += new System.EventHandler<Helianz.UI.ApptMainClickEventArgs>(this.ContrApptPanel_ApptMainAreaRightClicked);
			this.contrApptPanel.ApptMoved += new System.EventHandler<Helianz.UI.ApptMovedEventArgs>(this.contrApptPanel_ApptMoved);
			this.contrApptPanel.ApptMovedToPinboard += new System.EventHandler<Helianz.UI.ApptDataRowEventArgs>(this.contrApptPanel_ApptMovedToPinboard);
			this.contrApptPanel.ApptNullFound += new System.EventHandler(this.contrApptPanel_ApptNullFound);
			this.contrApptPanel.ApptResized += new System.EventHandler<Helianz.UI.ApptEventArgs>(this.contrApptPanel_ApptResized);
			this.contrApptPanel.ApptRightClicked += new System.EventHandler<Helianz.UI.ApptRightClickEventArgs>(this.ContrApptPanel_ApptRightClicked);
			...
			this.contrApptPanel.SelectedApptChanged += new System.EventHandler<Helianz.UI.ApptSelectedChangedEventArgs>(this.contrApptPanel_SelectedApptChanged);
			// 
			// ControlAppt
			// 
		...
		private Helianz.UI.TabPage tabReminders;
		private UI.GridOD gridReminders;
		private Helianz.UI.ListBox listConfirmed;
		private Helianz.UI.GroupBox groupSearch;
		...
		private Helianz.UI.ListBox listSearchResults;
