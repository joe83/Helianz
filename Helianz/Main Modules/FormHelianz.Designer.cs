...
namespace Helianz{
	partial class FormHelianz{
		...
		private void InitializeComponent(){
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormHelianz));
			...
			this.butNewMap = new Helianz.UI.Button();
			this.labelMsg = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.butVoiceMails = new Helianz.UI.Button();
			this.labelFieldType = new System.Windows.Forms.Label();
			this.comboTriageCoordinator = new Helianz.UI.ComboBox();
			this.butTriage = new Helianz.UI.Button();
			this.butPhoneList = new Helianz.UI.Button();
			...
			this.lightSignalGrid1.ButtonClick += new Helianz.UI.ODLightSignalGridClickEventHandler(this.lightSignalGrid1_ButtonClick);
			// 
			// menuMain
			// 
			...
			this.Name = "FormHelianz";
			this.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.Text = "Helianz";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Deactivate += new System.EventHandler(this.FormHelianz_Deactivate);
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FormHelianz_FormClosing);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormHelianz_FormClosed);
			this.Load += new System.EventHandler(this.FormHelianz_Load);
			this.Shown += new System.EventHandler(this.FormHelianz_Shown);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FormHelianz_KeyDown);
