namespace Helianz {
	partial class ControlAccount {
		...
		private void InitializeComponent() {
			...
			this.tabControlShow = new Helianz.UI.TabControl();
			this.tabMain = new Helianz.UI.TabPage();
			this.gridAcctPat = new Helianz.UI.GridOD();
			this.butCreditCard = new Helianz.UI.Button();
			this.textUrgFinNote = new Helianz.ODtextBox();
			this.butServiceDateView = new Helianz.UI.Button();
			this.textFinNote = new Helianz.ODtextBox();
			this.checkUseSuperFam = new Helianz.UI.CheckBox();
			this.tabShow = new Helianz.UI.TabPage();
			this.checkShowCommAuto = new Helianz.UI.CheckBox();
			this.checkShowCompletePayPlans = new Helianz.UI.CheckBox();
			this.checkShowFamilyComm = new Helianz.UI.CheckBox();
			this.checkShowDetail = new Helianz.UI.CheckBox();
			this.labelEndDate = new System.Windows.Forms.Label();
			this.labelStartDate = new System.Windows.Forms.Label();
			this.butToday = new Helianz.UI.Button();
			this.butDatesAll = new Helianz.UI.Button();
			this.but90days = new Helianz.UI.Button();
			this.but45days = new Helianz.UI.Button();
			this.butRefresh = new Helianz.UI.Button();
			this.textDateEnd = new Helianz.ValidDate();
			this.textDateStart = new Helianz.ValidDate();
			...
			this.groupBoxIndDis = new Helianz.DashIndividualDiscount();
			this.groupBoxFamilyIns = new Helianz.UI.GroupBox();
			...
			this.groupBoxIndIns = new Helianz.UI.GroupBox();
			...
			this.gridRepeat = new Helianz.UI.GridOD();
			this.gridPayPlan = new Helianz.UI.GridOD();
			this.tabControlAccount = new Helianz.UI.TabControl();
			this.tabPagePatAccount = new Helianz.UI.TabPage();
			this.gridAccount = new Helianz.UI.GridOD();
			this.tabPageAutoOrtho = new Helianz.UI.TabPage();
			this.splitContainerAutoOrtho = new Helianz.UI.SplitContainer();
			this.splitterPanel1 = new Helianz.UI.SplitterPanel();
			this.gridAutoOrtho = new Helianz.UI.GridOD();
			this.splitterPanel2 = new Helianz.UI.SplitterPanel();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.butAutoOrthoDefaultPlacement = new Helianz.UI.Button();
			this.textDateAutoOrthoPlacement = new Helianz.ValidDate();
			this.butEditAutoOrthoPlacement = new Helianz.UI.Button();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.textAutoOrthoMonthsTreat = new Helianz.ValidNum();
			this.butAutoOrthoDefaultMonthsTreat = new Helianz.UI.Button();
			this.butAutoOrthoEditMonthsTreat = new Helianz.UI.Button();
			this.tabPageOrthoCases = new Helianz.UI.TabPage();
			this.splitContainerOrthoCases = new Helianz.UI.SplitContainer();
			this.splitterPanel3 = new Helianz.UI.SplitterPanel();
			this.gridOrthoCases = new Helianz.UI.GridOD();
			this.splitterPanel4 = new Helianz.UI.SplitterPanel();
			this.butMakeOrthoCaseActive = new Helianz.UI.Button();
			this.butAddOrthoCase = new Helianz.UI.Button();
			this.checkHideInactiveOrthoCases = new Helianz.UI.CheckBox();
			this.tabPageHiddenSplits = new Helianz.UI.TabPage();
			this.gridTpSplits = new Helianz.UI.GridOD();
			this.gridComm = new Helianz.UI.GridOD();
			this.gridPatInfo = new Helianz.UI.GridOD();
			this.ToolBarMain = new Helianz.UI.ToolBarOD();
			this.splitContainerAccountCommLog = new Helianz.UI.SplitContainer();
			this.splitterPanel5 = new Helianz.UI.SplitterPanel();
			this.splitterPanel6 = new Helianz.UI.SplitterPanel();
			this.splitContainerRepChargesPP = new Helianz.UI.SplitContainer();
			this.splitterPanel7 = new Helianz.UI.SplitterPanel();
			this.splitterPanel8 = new Helianz.UI.SplitterPanel();
			this.splitContainerParent = new Helianz.UI.SplitContainer();
			this.splitterPanel9 = new Helianz.UI.SplitterPanel();
			this.splitterPanel10 = new Helianz.UI.SplitterPanel();
			...
			this.gridAcctPat.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAcctPat_CellClick);
			// 
			// butCreditCard
			// 
			...
			this.textUrgFinNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.FinancialNotes;
			...
			this.textFinNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.FinancialNotes;
			...
			this.gridRepeat.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridRepeat_CellDoubleClick);
			// 
			// gridPayPlan
			// 
			...
			this.gridPayPlan.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPayPlan_CellDoubleClick);
			this.gridPayPlan.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPayPlan_CellClick);
			// 
			// tabControlAccount
			// 
			...
			this.gridAccount.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAccount.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAccount_CellDoubleClick);
			this.gridAccount.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAccount_CellClick);
			// 
			// tabPageAutoOrtho
			// 
			...
			this.gridAutoOrtho.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridAutoOrtho.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAutoOrtho_CellDoubleClick);
			// 
			// splitterPanel2
			// 
			...
			// 
			this.butEditAutoOrthoPlacement.Image = global::Helianz.Properties.Resources.Left;
			...
			// 
			this.butAutoOrthoEditMonthsTreat.Image = global::Helianz.Properties.Resources.Left;
			...
			this.gridOrthoCases.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.GridOrthoCases_CellDoubleClick);
			// 
			// splitterPanel4
			// 
			...
			this.gridTpSplits.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.GridTpSplits_CellDoubleClick);
			// 
			// gridComm
			// 
			...
			this.gridComm.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridComm_CellDoubleClick);
			// 
			// gridPatInfo
			// 
			this.gridPatInfo.Location = new System.Drawing.Point(938, 47);
			this.gridPatInfo.Name = "gridPatInfo";
			this.gridPatInfo.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridPatInfo.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPatInfo_CellDoubleClick);
			// 
			// ToolBarMain
			// 
		...
		#region Designer 
		private Helianz.UI.CheckBox checkHideInactiveOrthoCases;
		private Helianz.UI.CheckBox checkShowCompletePayPlans;
		private Helianz.UI.CheckBox checkShowDetail;
		private Helianz.UI.CheckBox checkShowFamilyComm;
		...
		private Helianz.UI.GroupBox groupBoxFamilyIns;
		private Helianz.UI.GroupBox groupBoxIndIns;
		...
		private Helianz.UI.TabControl tabControlAccount;
		private Helianz.UI.TabControl tabControlShow;
		private Helianz.UI.TabPage tabMain;
		private Helianz.UI.TabPage tabPageAutoOrtho;
		private Helianz.UI.TabPage tabPageHiddenSplits;
		private Helianz.UI.TabPage tabPageOrthoCases;
		private Helianz.UI.TabPage tabPagePatAccount;
		...
		private Helianz.UI.CheckBox checkUseSuperFam;
	}
}
