namespace Helianz {
	partial class ControlChart {
		...
		private void InitializeComponent(){
			...
			this.checkDone = new Helianz.UI.CheckBox();
			...
			this.checkToday = new Helianz.UI.CheckBox();
			this.label6 = new System.Windows.Forms.Label();
			this.textProcCode = new System.Windows.Forms.TextBox();
			this.label14 = new System.Windows.Forms.Label();
			this.label13 = new System.Windows.Forms.Label();
			this.checkAudit = new Helianz.UI.CheckBox();
			this.checkShowTeeth = new Helianz.UI.CheckBox();
			this.checkNotes = new Helianz.UI.CheckBox();
			...
			this.tabControlImages = new Helianz.UI.TabControl();
			this.tabPage1 = new Helianz.UI.TabPage();
			this.tabPage2 = new Helianz.UI.TabPage();
			this.tabPage4 = new Helianz.UI.TabPage();
			this.panelImages = new System.Windows.Forms.Panel();
			this.listViewImages = new System.Windows.Forms.ListView();
			this.imageListThumbnails = new System.Windows.Forms.ImageList(this.components);
			this.tabControlProc = new Helianz.UI.TabControl();
			this.tabEnterTx = new Helianz.UI.TabPage();
			this.checkTreatPlans = new Helianz.UI.CheckBox();
			this.panelQuickButtons = new Helianz.UI.ODButtonPanel();
			this.comboPrognosis = new Helianz.UI.ComboBox();
			this.labelPrognosis = new System.Windows.Forms.Label();
			this.listDx = new Helianz.UI.ListBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			...
			this.listButtonCats = new Helianz.UI.ListBox();
			this.butD = new Helianz.UI.Button();
			this.comboPriority = new Helianz.UI.ComboBox();
			this.textDate = new Helianz.ValidDate();
			this.butBF = new Helianz.UI.Button();
			this.butL = new Helianz.UI.Button();
			this.butM = new Helianz.UI.Button();
			this.butOK = new Helianz.UI.Button();
			this.butAddProc = new Helianz.UI.Button();
			this.butV = new Helianz.UI.Button();
			this.butOI = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.tabMissing = new Helianz.UI.TabPage();
			this.butMixed = new Helianz.UI.Button();
			this.butAllPerm = new Helianz.UI.Button();
			this.butAllPrimary = new Helianz.UI.Button();
			this.groupBox5 = new Helianz.UI.GroupBox();
			this.butPerm = new Helianz.UI.Button();
			this.butPrimary = new Helianz.UI.Button();
			this.label5 = new System.Windows.Forms.Label();
			this.butUnhide = new Helianz.UI.Button();
			this.listHidden = new Helianz.UI.ListBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.label7 = new System.Windows.Forms.Label();
			this.butNotMissing = new Helianz.UI.Button();
			this.butMissing = new Helianz.UI.Button();
			this.butHidden = new Helianz.UI.Button();
			this.butEdentulous = new Helianz.UI.Button();
			this.tabMovements = new Helianz.UI.TabPage();
			this.groupBox9 = new Helianz.UI.GroupBox();
			this.butClearSelectedMovements = new Helianz.UI.Button();
			this.butClearAllMovements = new Helianz.UI.Button();
			this.label16 = new System.Windows.Forms.Label();
			this.groupBox4 = new Helianz.UI.GroupBox();
			this.butTipBplus = new Helianz.UI.Button();
			this.butTipBminus = new Helianz.UI.Button();
			this.butTipMplus = new Helianz.UI.Button();
			this.butTipMminus = new Helianz.UI.Button();
			this.butRotatePlus = new Helianz.UI.Button();
			this.butRotateMinus = new Helianz.UI.Button();
			this.textTipB = new Helianz.ValidDouble();
			this.label11 = new System.Windows.Forms.Label();
			this.textTipM = new Helianz.ValidDouble();
			this.label12 = new System.Windows.Forms.Label();
			this.textRotate = new Helianz.ValidDouble();
			this.label15 = new System.Windows.Forms.Label();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.butShiftBplus = new Helianz.UI.Button();
			this.butShiftBminus = new Helianz.UI.Button();
			this.butShiftOplus = new Helianz.UI.Button();
			this.butShiftOminus = new Helianz.UI.Button();
			this.butShiftMplus = new Helianz.UI.Button();
			this.butShiftMminus = new Helianz.UI.Button();
			this.textShiftB = new Helianz.ValidDouble();
			this.label10 = new System.Windows.Forms.Label();
			this.textShiftO = new Helianz.ValidDouble();
			this.label9 = new System.Windows.Forms.Label();
			this.textShiftM = new Helianz.ValidDouble();
			this.label8 = new System.Windows.Forms.Label();
			this.butApplyMovements = new Helianz.UI.Button();
			this.tabPlanned = new Helianz.UI.TabPage();
			this.checkShowCompleted = new Helianz.UI.CheckBox();
			this.butPin = new Helianz.UI.Button();
			this.butClear = new Helianz.UI.Button();
			this.butNew = new Helianz.UI.Button();
			this.butDown = new Helianz.UI.Button();
			this.butUp = new Helianz.UI.Button();
			this.gridPlanned = new Helianz.UI.GridOD();
			this.tabShow = new Helianz.UI.TabPage();
			this.checkShowCommAuto = new Helianz.UI.CheckBox();
			this.labelSearchClear = new System.Windows.Forms.Label();
			this.label23 = new System.Windows.Forms.Label();
			this.checkTPChart = new Helianz.UI.CheckBox();
			this.textShowDateRange = new System.Windows.Forms.TextBox();
			this.labelCustView = new System.Windows.Forms.Label();
			this.groupBox7 = new Helianz.UI.GroupBox();
			this.checkCommSuperFamily = new Helianz.UI.CheckBox();
			this.checkSheets = new Helianz.UI.CheckBox();
			this.checkTasks = new Helianz.UI.CheckBox();
			this.checkEmail = new Helianz.UI.CheckBox();
			this.checkCommFamily = new Helianz.UI.CheckBox();
			this.checkAppt = new Helianz.UI.CheckBox();
			this.checkLabCase = new Helianz.UI.CheckBox();
			this.checkRx = new Helianz.UI.CheckBox();
			this.checkComm = new Helianz.UI.CheckBox();
			this.groupBox6 = new Helianz.UI.GroupBox();
			this.checkShowCn = new Helianz.UI.CheckBox();
			this.checkShowE = new Helianz.UI.CheckBox();
			this.checkShowR = new Helianz.UI.CheckBox();
			this.checkShowC = new Helianz.UI.CheckBox();
			this.checkShowTP = new Helianz.UI.CheckBox();
			this.butShowDateRange = new Helianz.UI.Button();
			this.butChartViewDown = new Helianz.UI.Button();
			this.butChartViewUp = new Helianz.UI.Button();
			this.butChartViewAdd = new Helianz.UI.Button();
			this.butShowAll = new Helianz.UI.Button();
			this.butShowNone = new Helianz.UI.Button();
			this.gridChartViews = new Helianz.UI.GridOD();
			this.textSearch = new Helianz.ODtextBox();
			this.tabDraw = new Helianz.UI.TabPage();
			...
			this.butAddText = new Helianz.UI.Button();
			this.butDeleteText = new Helianz.UI.Button();
			this.listBoxText = new Helianz.UI.ListBox();
			this.groupBox8 = new Helianz.UI.GroupBox();
			this.panelBlack = new System.Windows.Forms.Panel();
			this.label22 = new System.Windows.Forms.Label();
			this.butColorOther = new Helianz.UI.Button();
			...
			this.tabCustomer = new Helianz.UI.TabPage();
			...
			this.listCommonProcs = new Helianz.UI.ListBox();
			this.gridCustomerViews = new Helianz.UI.GridOD();
			this.tabOrtho = new Helianz.UI.TabPage();
			this.checkShowHidden = new Helianz.UI.CheckBox();
			this.checkOrthoGraphics = new Helianz.UI.CheckBox();
			this.label25 = new System.Windows.Forms.Label();
			this.checkOrthoMode = new Helianz.UI.CheckBox();
			this.checkShowOrtho = new Helianz.UI.CheckBox();
			this.groupBoxOD1 = new Helianz.UI.GroupBox();
			this.butUnhideOrtho = new Helianz.UI.Button();
			this.butHideOrtho = new Helianz.UI.Button();
			this.butOrthoRx = new Helianz.UI.Button();
			this.label27 = new System.Windows.Forms.Label();
			this.label26 = new System.Windows.Forms.Label();
			this.butOrthoAdd = new Helianz.UI.Button();
			this.butOrthoCopy = new Helianz.UI.Button();
			this.butOrthoDelete = new Helianz.UI.Button();
			this.comboOrthoDate = new Helianz.UI.ComboBox();
			...
			this.listPriorities = new Helianz.UI.ListBox();
			this.panelGridProg = new System.Windows.Forms.Panel();
			this.gridProg = new Helianz.UI.GridOld();
			this.gridProgPageNav = new Helianz.UI.ODGridPageNav();
			this.tabControlOrthoCategories = new Helianz.UI.TabControl();
			this.tabPage3 = new Helianz.UI.TabPage();
			this.tabPage5 = new Helianz.UI.TabPage();
			this.gridOrtho = new Helianz.UI.GridOD();
			this.gridTpProcs = new Helianz.UI.GridOD();
			this.butNewTP = new Helianz.UI.Button();
			this.gridTreatPlans = new Helianz.UI.GridOD();
			this.butErxAccess = new Helianz.UI.Button();
			this.butPhoneNums = new Helianz.UI.Button();
			this.butForeignKey = new Helianz.UI.Button();
			this.butAddKey = new Helianz.UI.Button();
			this.ToolBarMain = new Helianz.UI.ToolBarOD();
			this.button1 = new Helianz.UI.Button();
			this.gridPtInfo = new Helianz.UI.GridOD();
			this.textTreatmentNotes = new Helianz.ODtextBox();
			this.odInternalCustomerGrids = new Helianz.UI.ODInternalCustomerGrids();
			...
			this.tabControlImages.TabAlignment = Helianz.UI.EnumTabAlignment.Bottom;
			...
			this.panelQuickButtons.ItemClickBut += new Helianz.UI.ODButtonPanelEventHandler(this.panelQuickButtons_ItemClickBut);
			// 
			// comboPrognosis
			// 
			...
			// butClear
			// 
			this.butClear.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// butNew
			// 
			this.butNew.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridPlanned.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridPlanned.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPlanned_CellDoubleClick);
			// 
			// tabShow
			// 
			...
			// butChartViewDown
			// 
			this.butChartViewDown.Image = global::Helianz.Properties.Resources.down;
			...
			// butChartViewUp
			// 
			this.butChartViewUp.Image = global::Helianz.Properties.Resources.up;
			...
			// butChartViewAdd
			// 
			this.butChartViewAdd.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridChartViews.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridChartViews_DoubleClick);
			this.gridChartViews.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridChartViews_CellClick);
			// 
			// textSearch
			// 
			...
			this.textSearch.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TreatPlan;
    ...
    "ally for procedures with a PaintType of Text)";
			...
			// butAddText
			// 
			this.butAddText.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butDeleteText
			// 
			this.butDeleteText.Icon = Helianz.UI.EnumIcons.DeleteX;
        ...
        "Query Programming"};
			...
			this.gridCustomerViews.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomerViews_CellDoubleClick);
			this.gridCustomerViews.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomerViews_CellClick);
			// 
			// tabOrtho
			// 
			...
			this.listPriorities.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.gridProg.PagingMode = Helianz.UI.GridOld.GridPagingMode.EnabledBottomUp;
			this.gridProg.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProg.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProg_CellDoubleClick);
			this.gridProg.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridProg_CellClick);
			...
			this.gridOrtho.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridOrtho.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridOrtho_CellDoubleClick);
			...
			this.gridTpProcs.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridTpProcs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTpProcs_CellDoubleClick);
			this.gridTpProcs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridTpProcs_CellClick);
			// 
			// butNewTP
			// 
			this.butNewTP.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridTreatPlans.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridTreatPlans.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTreatPlans_CellDoubleClick);
			this.gridTreatPlans.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridTreatPlans_CellClick);
			// 
			// butErxAccess
			// 
			...
			this.ToolBarMain.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.ToolBarMain_ButtonClick);
			// 
			// button1
			// 
			...
			this.gridPtInfo.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridPtInfo.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPtInfo_CellDoubleClick);
			...
			this.textTreatmentNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.ChartTreatment;
		...
		private Helianz.UI.Button butAddProc;
		private Helianz.UI.Button butM;
		private Helianz.UI.Button butOI;
		private Helianz.UI.Button butD;
		private Helianz.UI.Button butBF;
		private Helianz.UI.Button butL;
		private Helianz.UI.Button butV;
		private System.Windows.Forms.TextBox textSurf;
		private Helianz.UI.GroupBox groupBox2;
		...
		private Helianz.UI.ListBox listDx;
		private Helianz.UI.CheckBox checkDone;
		private System.Windows.Forms.RadioButton radioEntryR;
		private System.Windows.Forms.Label label13;
		private Helianz.UI.CheckBox checkNotes;
		private Helianz.UI.CheckBox checkShowR;
		private Helianz.UI.Button butShowNone;
		private Helianz.UI.Button butShowAll;
		private Helianz.UI.CheckBox checkShowE;
		private Helianz.UI.CheckBox checkShowC;
		private Helianz.UI.CheckBox checkShowTP;
		private Helianz.UI.CheckBox checkRx;
		...
		private Helianz.UI.Button butClear;
		private Helianz.UI.ToolBarOD ToolBarMain;
		...
		private Helianz.UI.TabPage tabPage4;
		private Helianz.UI.TabControl tabControlImages;
		private System.Windows.Forms.Panel panelImages;
		private System.Windows.Forms.ImageList imageListThumbnails;
		private System.Windows.Forms.ListView listViewImages;
		private Helianz.ValidDate textDate;
		private System.Windows.Forms.Label label6;
		private Helianz.UI.CheckBox checkToday;
		private Helianz.UI.CheckBox checkShowTeeth;//used in printing progress notes
		...
		private Helianz.UI.Button butPin;
		private Helianz.UI.ListBox listButtonCats;
		...
		private Helianz.UI.TabControl tabControlProc;
		private Helianz.UI.TabPage tabEnterTx;
		private Helianz.UI.TabPage tabMissing;
		private Helianz.UI.TabPage tabMovements;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.Button butUnhide;
		private System.Windows.Forms.Label label5;
		private Helianz.UI.ListBox listHidden;
		private Helianz.UI.Button butEdentulous;
		private System.Windows.Forms.Label label7;
		private Helianz.UI.Button butNotMissing;
		private Helianz.UI.Button butMissing;
		private Helianz.UI.Button butHidden;
		private Helianz.UI.GroupBox groupBox3;
		private System.Windows.Forms.Label label8;
		private Helianz.UI.GroupBox groupBox4;
		...
		private Helianz.UI.Button butRotatePlus;
		private Helianz.UI.Button butTipBplus;
		private Helianz.UI.Button butTipMplus;
		private Helianz.UI.Button butShiftBplus;
		private Helianz.UI.Button butShiftOplus;
		private Helianz.UI.Button butShiftMplus;
		private System.Windows.Forms.Label label16;
		private Helianz.UI.Button butApplyMovements;
		private Helianz.UI.Button butTipBminus;
		private Helianz.UI.Button butTipMminus;
		private Helianz.UI.Button butRotateMinus;
		private Helianz.UI.Button butShiftBminus;
		private Helianz.UI.Button butShiftOminus;
		private Helianz.UI.Button butShiftMminus;
		private Helianz.UI.GridOD gridPtInfo;
		private Helianz.UI.CheckBox checkComm;
		private System.Windows.Forms.MenuItem menuItemPrintDay;
		private Helianz.UI.CheckBox checkAudit;
		...
		private Helianz.UI.TabPage tabPlanned;
		private Helianz.UI.TabPage tabShow;
		private Helianz.UI.GroupBox groupBox7;
		private Helianz.UI.GroupBox groupBox6;
		private Helianz.UI.CheckBox checkAppt;
		private Helianz.UI.CheckBox checkLabCase;
		private Helianz.UI.Button butAddKey;
		private Helianz.UI.CheckBox checkCommFamily;
		private Helianz.UI.Button butForeignKey;
		private Helianz.UI.CheckBox checkTasks;
		private Helianz.UI.CheckBox checkEmail;
		private Helianz.UI.CheckBox checkSheets;
		private Helianz.UI.TabPage tabDraw;
		...
		private Helianz.UI.Button butChartViewDown;
		private Helianz.UI.Button butChartViewUp;
		private Helianz.UI.Button butChartViewAdd;
		private System.Windows.Forms.Label labelCustView;
		private Helianz.UI.GridOD gridChartViews;
		...
		private Helianz.UI.TabPage tabCustomer;
		private Helianz.UI.GridOD gridCustomerViews;
		...
		private Helianz.UI.ListBox listCommonProcs;
		...
		private Helianz.UI.ODButtonPanel panelQuickButtons;
		private UI.Button butClearAllMovements;
		private Helianz.UI.CheckBox checkShowCompleted;
		...
		private Helianz.UI.CheckBox checkTreatPlans;
		private Helianz.UI.GridOD gridTreatPlans;
		private Helianz.UI.GridOD gridTpProcs;
		private System.Windows.Forms.Label label4;
		private Helianz.UI.ListBox listPriorities;
		private UI.Button butNewTP;
		private Helianz.UI.CheckBox checkTPChart;
		...
		private Helianz.UI.ODInternalCustomerGrids odInternalCustomerGrids;
		...
		private Helianz.UI.GridOld gridProg;
		...
		private Helianz.UI.GroupBox groupBox9;
		private UI.Button butClearSelectedMovements;
		private Helianz.UI.CheckBox checkShowCommAuto;
		private Helianz.UI.CheckBox checkCommSuperFamily;
		...
		private Helianz.UI.GroupBox groupBox5;
		...
		private Helianz.UI.TabPage tabOrtho;
		private Helianz.UI.CheckBox checkShowOrtho;
		private UI.GridOD gridOrtho;
		private Helianz.UI.TabControl tabControlOrthoCategories;
		private Helianz.UI.TabPage tabPage3;
		private Helianz.UI.TabPage tabPage5;
		private UI.Button butOrthoAdd;
		private Helianz.UI.CheckBox checkOrthoMode;
		...
		private Helianz.UI.CheckBox checkOrthoGraphics;
