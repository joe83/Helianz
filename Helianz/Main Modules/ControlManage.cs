...
namespace Helianz{
	...
	public partial class ControlManage : UserControl{
		...
		private void butBackup_Click(object sender,EventArgs e) {
			...
			GlobalFormHelianz.PatientSelected(new Patient(),false);//unload patient after restore.
		...
		private void formClaimsSend_GoToChanged(ODEventArgs e) {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Account, claimNum:claimSendQueueItem.ClaimNum);
		}
