...
namespace Helianz {
	partial class ControlFamily {
		...
		private void InitializeComponent(){
			...
			this.gridSuperFam = new Helianz.UI.GridOD();
			this.gridRecall = new Helianz.UI.GridOD();
			this.gridFamily = new Helianz.UI.GridOD();
			this.gridPat = new Helianz.UI.GridOD();
			this.gridIns = new Helianz.UI.GridOD();
			this.gridPatientClones = new Helianz.UI.GridOD();
			this.pictureBoxPat = new Helianz.UI.ODPictureBox();
			this.toolBarMain = new Helianz.UI.ToolBarOD();
			this.splitContainerSuperClones = new Helianz.UI.SplitContainer();
			...
			this.gridSuperFam.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSuperFam_CellDoubleClick);
			this.gridSuperFam.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSuperFam_CellClick);
			// 
			// gridRecall
			// 
			...
			this.gridRecall.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridRecall_CellDoubleClick);
			...
			this.gridFamily.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridFamily_CellDoubleClick);
			this.gridFamily.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridFamily_CellClick);
			// 
			// gridPat
			// 
			...
			this.gridPat.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridPat.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPat_CellDoubleClick);
			this.gridPat.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPat_CellClick);
			...
			this.gridIns.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridPatientClones.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPatientClone_CellClick);
			// 
			// pictureBoxPat
			// 
