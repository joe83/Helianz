namespace Helianz
{
	partial class ControlImages
	{
		...
		private void InitializeComponent()
		{
			...
			this.butImportStart = new Helianz.UI.Button();
			this.butImportClose = new Helianz.UI.Button();
			this.butBrowse = new Helianz.UI.Button();
			this.textImportAuto = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.panelDraw = new System.Windows.Forms.Panel();
			this.toolBarDraw = new Helianz.UI.ToolBarOD();
			...
			this.panelSplitter = new Helianz.UI.PanelOD();
			this.toolBarPaint = new Helianz.UI.ToolBarOD();
			this.controlImageDock = new Helianz.ControlImageDock();
			...
			this.groupPearl = new Helianz.UI.GroupBox();
			this.labelAIProcessing = new System.Windows.Forms.Label();
			this.checkPearlShow = new Helianz.UI.CheckBox();
			this.butPearlLayers = new Helianz.UI.Button();
			this.checkPearlToothParts = new Helianz.UI.CheckBox();
    ...
    "les will be ignored.  Imported files will be deleted.";
			...
			this.toolBarDraw.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.toolBarDraw_ButtonClick);
			// 
			...
			this.toolBarPaint.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.toolBarPaint_ButtonClick);
			// 
			// controlImageDock
			// 
		...
		private Helianz.ControlImageDock controlImageDock;
