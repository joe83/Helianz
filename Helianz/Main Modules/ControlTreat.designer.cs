...
namespace Helianz {
	partial class ControlTreat {
		...
		private void InitializeComponent(){
			...
			this.listSetPr = new Helianz.UI.ListBox();
			this.pd2 = new System.Drawing.Printing.PrintDocument();
			this.imageListMain = new System.Windows.Forms.ImageList(this.components);
			this.gridMain = new Helianz.UI.GridOD();
			this.gridPrint = new Helianz.UI.GridOD();
			this.gridPreAuth = new Helianz.UI.GridOD();
			this.gridPlans = new Helianz.UI.GridOD();
			this.dateTimeTP = new System.Windows.Forms.DateTimePicker();
			this.tabControlShowSort = new Helianz.UI.TabControl();
			this.tabPageShow = new Helianz.UI.TabPage();
			this.checkShowDiscount = new Helianz.UI.CheckBox();
			this.checkShowTotals = new Helianz.UI.CheckBox();
			this.checkShowMaxDed = new Helianz.UI.CheckBox();
			this.checkShowSubtotals = new Helianz.UI.CheckBox();
			this.checkShowFees = new Helianz.UI.CheckBox();
			this.checkShowIns = new Helianz.UI.CheckBox();
			this.checkShowCompleted = new Helianz.UI.CheckBox();
			this.tabPageSort = new Helianz.UI.TabPage();
			...
			this.tabPagePrint = new Helianz.UI.TabPage();
			this.checkPrintClassic = new Helianz.UI.CheckBox();
			...
			this.userControlIndIns = new Helianz.DashIndividualInsurance();
			this.userControlFamIns = new Helianz.DashFamilyInsurance();
			this.butPlannedAppt = new Helianz.UI.Button();
			this.butRefresh = new Helianz.UI.Button();
			this.butSaveTP = new Helianz.UI.Button();
			this.butNewTP = new Helianz.UI.Button();
			this.butInsRem = new Helianz.UI.Button();
			...
			this.userControlIndDis = new Helianz.DashIndividualDiscount();
			...
			this.gridPreAuth.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPreAuth_CellDoubleClick);
			this.gridPreAuth.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPreAuth_CellClick);
			// 
			...
			this.gridPlans.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPlans_CellDoubleClick);
			this.gridPlans.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPlans_CellClick);
			// 
			// dateTimeTP
			// 
			...
			// butPlannedAppt
			// 
			this.butPlannedAppt.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butSaveTP
			// 
			this.butSaveTP.Image = global::Helianz.Properties.Resources.Copy;
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TreatPlan;
		...
		private Helianz.UI.ListBox listSetPr;
		private UI.Button butRefresh;
		private Helianz.UI.TabControl tabControlShowSort;
		private Helianz.UI.TabPage tabPageShow;
		private Helianz.UI.CheckBox checkShowDiscount;
		private Helianz.UI.CheckBox checkShowTotals;
		private Helianz.UI.CheckBox checkShowMaxDed;
		private Helianz.UI.CheckBox checkShowSubtotals;
		private Helianz.UI.CheckBox checkShowFees;
		private Helianz.UI.CheckBox checkShowIns;
		private Helianz.UI.CheckBox checkShowCompleted;
		private Helianz.UI.TabPage tabPageSort;
		...
		private Helianz.UI.TabPage tabPagePrint;
		private Helianz.UI.CheckBox checkPrintClassic;
		...
		private Helianz.UI.GridOD gridPrint;
		private Helianz.UI.GridOD gridPreAuth;
		private System.Windows.Forms.ContextMenu menuConsent;
		private System.Windows.Forms.ImageList imageListMain;
		private Helianz.UI.ToolBarOD ToolBarMain;
		private Helianz.UI.GridOD gridPlans;
