namespace Helianz.UI {
	partial class ODDateRangePicker {
		...
		private void InitializeComponent() {
			...
			this.panelWeek = new Helianz.UI.PanelOD();
			this.butWeekPrevious = new Helianz.UI.Button();
			this.butWeekNext = new Helianz.UI.Button();
			this.datePickerFrom = new Helianz.UI.ODDatePicker();
			this.datePickerTo = new Helianz.UI.ODDatePicker();
