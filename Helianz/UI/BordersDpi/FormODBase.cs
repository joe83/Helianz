...
namespace Helianz {
	...
	public class FormODBase : Form {
		...
		///<summary>True when form has been shown by the system. Used for filter controls and for closing open forms. Number of references is incorrect because called by reflection in FormHelianz.</summary>
		[Browsable(false)]
...
//todo: close when this form closes.
		...
		private void PanelBorders_Paint(object sender, PaintEventArgs e){
			...
			if(this.GetType()==typeof(FormImageFloat)){ //"Helianz.FormImageFloat"){
