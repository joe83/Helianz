...
namespace Helianz.UI {
	class ODInternalCustomerGrids : UserControl {
		private Helianz.UI.TabControl tabHqBugControl;
		private Helianz.UI.TabPage tabBugsFixed;
		private GridOD gridBugsFixed;
		private Helianz.UI.TabPage tabBugSubs;
		...
		private Helianz.UI.TabPage tabBugsInProgress;
		...
		private void InitializeComponent() {
			this.tabHqBugControl = new Helianz.UI.TabControl();
			this.tabBugsInProgress = new Helianz.UI.TabPage();
			this.gridBugsInProgress = new Helianz.UI.GridOD();
			this.tabBugsFixed = new Helianz.UI.TabPage();
			this.gridBugsFixed = new Helianz.UI.GridOD();
			this.tabBugSubs = new Helianz.UI.TabPage();
			this.gridBugSubmissions = new Helianz.UI.GridOD();
			this.label1 = new System.Windows.Forms.Label();
			this.butRefresh = new Helianz.UI.Button();
			this.datePickerHqBugSub = new Helianz.UI.ODDateRangePicker();
			...
			this.gridBugsInProgress.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBugs_CellDoubleClick);
			// 
			// tabBugsFixed
			// 
			...
			this.gridBugsFixed.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBugs_CellDoubleClick);
			// 
			// tabBugSubs
			// 
			...
			this.gridBugSubmissions.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBugSubmissions_CellDoubleClick);
			// 
			// label1
			// 
