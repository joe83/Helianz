...
namespace Helianz.UI {
	///<summary>This is meant to replace all existing MS Splitters and SplitContainers. The best way to use it is to copy an existing blank SplitContainer from Helianz/Forms/BasicTemplate.cs because it already has both splitter panels.</summary>
	...
	public class SplitContainer:UserControl {
		...
		protected override void OnPaint(PaintEventArgs e) {
			...
			string str="You must set Panel1 and/or Panel2 properties.\r\n"
				+"The best way to do this is to copy an existing blank SplitContainer from Helianz/Forms/BasicTemplate.cs because it already has both splitter panels.";
