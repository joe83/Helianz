...
namespace Helianz.UI {
	///<summary>This is meant to replace all existing MS tab controls. The best way to use it is to copy an existing blank UI.TabControl from Helianz/Forms/BasicTemplate.cs because it already has two tabPages.</summary>
