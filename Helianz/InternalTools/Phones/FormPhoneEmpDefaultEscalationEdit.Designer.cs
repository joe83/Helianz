namespace Helianz {
	partial class FormPhoneEmpDefaultEscalationEdit {
		...
		private void InitializeComponent() {
			...
			this.gridEscalation = new Helianz.UI.GridOD();
			this.gridEmployees = new Helianz.UI.GridOD();
			...
			this.comboEscalationViewEdit = new Helianz.UI.ComboBox();
			...
			this.gridEscalation.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridEmployees.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
