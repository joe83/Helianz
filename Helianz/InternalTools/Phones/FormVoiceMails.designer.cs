namespace Helianz{
	partial class FormVoiceMails {
		...
		private void InitializeComponent() {
			...
			this.gridVoiceMails = new Helianz.UI.GridOD();
			this.butCreateTask = new Helianz.UI.Button();
			...
			this.gridVoiceMails.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridVoiceMails.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridVoiceMails_CellClick);
			this.gridVoiceMails.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridVoiceMails_CellLeave);
			// 
			// butCreateTask
			// 
