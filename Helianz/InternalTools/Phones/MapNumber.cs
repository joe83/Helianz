...
namespace Helianz.InternalTools.Phones {
	public partial class MapNumber:Control {
		...
		public void SetTriageColors(long siteNum=0) {
			...
			ColorOutline=SiteLinks.GetSiteOuterColorBySiteNum(siteNum,HelianzBusiness.Phones.PhoneColorScheme.COLOR_DUAL_OuterTriage);
			BackColor=SiteLinks.GetSiteInnerColorBySiteNum(siteNum,HelianzBusiness.Phones.PhoneColorScheme.COLOR_DUAL_InnerTriageHere);
		}
