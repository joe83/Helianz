namespace Helianz{
	partial class FormPhoneConfs {
		...
		private void InitializeComponent() {
			...
			this.gridConfRoom = new Helianz.UI.GridOD();
			this.butRefresh = new Helianz.UI.Button();
			this.butAdd = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butKick = new Helianz.UI.Button();
			this.checkHideEmpty = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// gridConfRoom
			// 
			...
			this.gridConfRoom.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridConfRoom.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridConfRoom_CellDoubleClick);
			// 
			// butRefresh
			// 
		...
		private Helianz.UI.CheckBox checkHideEmpty;
	}
}