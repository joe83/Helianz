namespace Helianz {
	partial class FormPhoneGraphEdit {
		...
		private void InitializeComponent() {
			...
			this.checkAbsent = new Helianz.UI.CheckBox();
			this.label10 = new System.Windows.Forms.Label();
			this.textNote = new System.Windows.Forms.TextBox();
			this.butCopy = new Helianz.UI.Button();
			this.butClear = new Helianz.UI.Button();
			this.checkGraphDefault = new Helianz.UI.CheckBox();
			this.checkPrescheduledOff = new Helianz.UI.CheckBox();
			this.label12 = new System.Windows.Forms.Label();
			this.groupProv = new Helianz.UI.GroupBox();
			...
			this.butCopyEmp = new Helianz.UI.Button();
			this.butCopyOverride = new Helianz.UI.Button();
			this.butSign = new Helianz.UI.Button();
			...
			// butCopy
			// 
			this.butCopy.Image = global::Helianz.Properties.Resources.Right;
			...
			// butCopyEmp
			// 
			this.butCopyEmp.Image = global::Helianz.Properties.Resources.Right;
			...
			// butCopyOverride
			// 
			this.butCopyOverride.Image = global::Helianz.Properties.Resources.Right;
		...
		private Helianz.UI.CheckBox checkGraphDefault;
		private Helianz.UI.CheckBox checkAbsent;
		private Helianz.UI.CheckBox checkPrescheduledOff;
		...
		private Helianz.UI.GroupBox groupProv;
