namespace Helianz{
	partial class FormMapAreaContainerEdit {
		...
		private void InitializeComponent() {
			...
			this.checkSnap = new Helianz.UI.CheckBox();
			this.butAddLabel = new Helianz.UI.Button();
			this.butAddCubicle = new Helianz.UI.Button();
			...
			this.butAddLabel.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddCubicle.Icon = Helianz.UI.EnumIcons.Add;
