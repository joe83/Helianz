namespace Helianz.InternalTools.Phones{
	partial class FormMap {
		...
		private void InitializeComponent() {
			...
			this.comboRoom = new Helianz.UI.ComboBox();
			this.groupPhoneMetrics = new Helianz.UI.GroupBox();
			this.mapNumberTriageTime = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberTriageRedTime = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberChatTime = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberTriageCalls = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberVoicemailTime = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberChatCount = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberVoicemailCalls = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberTriageRedCalls = new Helianz.InternalTools.Phones.MapNumber();
			...
			this.escalationView = new Helianz.InternalTools.Phones.EscalationView();
			this.escalationViewOfficesDown = new Helianz.InternalTools.Phones.EscalationView();
			this.labelTirageOpLocal = new System.Windows.Forms.Label();
			this.label14 = new System.Windows.Forms.Label();
			this.labelTirageOpTotal = new System.Windows.Forms.Label();
			this.mapNumberTriageOpsLocal = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberTriageOpsTotal = new Helianz.InternalTools.Phones.MapNumber();
			this.userControlMapDetails1 = new Helianz.InternalTools.Phones.UserControlMapDetails();
			this.label3 = new System.Windows.Forms.Label();
			this.label5 = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.mapNumberCustDownCount = new Helianz.InternalTools.Phones.MapNumber();
			this.mapNumberCustDownTime = new Helianz.InternalTools.Phones.MapNumber();
			this.mapPanel = new Helianz.InternalTools.Phones.MapPanel();
			this.label8 = new System.Windows.Forms.Label();
			this.butZoomFit = new Helianz.UI.Button();
			this.comboEscalationView = new Helianz.UI.ComboBox();
		...
		private Helianz.InternalTools.Phones.UserControlMapDetails userControlMapDetails1;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.Label label7;
		private MapNumber mapNumberCustDownCount;
		private MapNumber mapNumberCustDownTime;
		private Helianz.InternalTools.Phones.MapPanel mapPanel;
