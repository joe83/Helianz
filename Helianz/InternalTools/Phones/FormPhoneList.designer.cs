namespace Helianz {
	partial class FormPhoneList {
		...
		private void InitializeComponent() {
			...
			this.butConfRooms = new Helianz.UI.Button();
			this.checkHideClockedOut = new Helianz.UI.CheckBox();
			this.timerFlash = new System.Windows.Forms.Timer(this.components);
			this.checkHideOnBreak = new Helianz.UI.CheckBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.textNameOrExt = new System.Windows.Forms.TextBox();
			this.labelSearch = new System.Windows.Forms.Label();
			this.checkNeedsHelpTop = new Helianz.UI.CheckBox();
			...
			this.butGotoPatient = new Helianz.UI.Button();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.label4 = new System.Windows.Forms.Label();
			this.butPhoneManage = new Helianz.UI.Button();
			this.butPhoneAttach = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.listBoxClockOut = new Helianz.UI.ListBox();
			this.label2 = new System.Windows.Forms.Label();
			this.listBoxQueues = new Helianz.UI.ListBox();
			this.label7 = new System.Windows.Forms.Label();
			this.listBoxQueueFilter = new Helianz.UI.ListBox();
			this.checkHideFloaters = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkHideClockedOut;
		private System.Windows.Forms.Timer timerFlash;
		private Helianz.UI.CheckBox checkHideOnBreak;
