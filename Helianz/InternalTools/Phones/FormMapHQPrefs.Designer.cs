namespace Helianz{
	partial class FormMapHQPrefs {
		...
		private void InitializeComponent() {
			...
			this.groupRedTriage = new Helianz.UI.GroupBox();
			this.textRedTime = new Helianz.ValidNum();
			this.textRedCalls = new Helianz.ValidNum();
			this.groupVoicemail = new Helianz.UI.GroupBox();
			this.textVMTime = new Helianz.ValidNum();
			this.textVMCalls = new Helianz.ValidNum();
			this.labelVMTime = new System.Windows.Forms.Label();
			this.labelVMCalls = new System.Windows.Forms.Label();
			this.groupTriage = new Helianz.UI.GroupBox();
			this.textTime = new Helianz.ValidNum();
			this.textTimeWarning = new Helianz.ValidNum();
			this.textCalls = new Helianz.ValidNum();
			this.textCallsWarning = new Helianz.ValidNum();
		...
		private Helianz.UI.GroupBox groupRedTriage;
		private Helianz.UI.GroupBox groupVoicemail;
		private System.Windows.Forms.Label labelVMTime;
		private System.Windows.Forms.Label labelVMCalls;
		private Helianz.UI.GroupBox groupTriage;
