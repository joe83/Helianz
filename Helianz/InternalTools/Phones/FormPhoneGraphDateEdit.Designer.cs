namespace Helianz{
	partial class FormPhoneGraphDateEdit {
		...
		private void InitializeComponent() {
			...
			this.butEditSchedule = new Helianz.UI.Button();
			...
			this.listSupers = new Helianz.UI.ListBox();
			...
			this.listSupers.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
    ...
    "cheduled Off box";
		...
		private Helianz.UI.ListBox listSupers;
