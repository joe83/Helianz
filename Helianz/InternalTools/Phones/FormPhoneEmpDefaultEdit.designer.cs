...
namespace Helianz {
	public partial class FormPhoneEmpDefaultEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listRingGroup = new Helianz.UI.ListBox();
			this.checkIsGraphed = new Helianz.UI.CheckBox();
			this.label5 = new System.Windows.Forms.Label();
			this.checkHasColor = new Helianz.UI.CheckBox();
			this.textEmpName = new System.Windows.Forms.TextBox();
			this.label6 = new System.Windows.Forms.Label();
			this.textNotes = new Helianz.ODtextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.checkIsPrivateScreen = new Helianz.UI.CheckBox();
			...
			this.listStatusOverride = new Helianz.UI.ListBox();
			this.label17 = new System.Windows.Forms.Label();
			this.checkIsTriageOperator = new Helianz.UI.CheckBox();
			this.textPhoneExt = new Helianz.ValidNum();
			this.textEmployeeNum = new Helianz.ValidNum();
			...
			this.checkIsWorkingHome = new Helianz.UI.CheckBox();
			this.checkIsFurloughed = new Helianz.UI.CheckBox();
			...
			this.textNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.PhoneEmpDefaultStatus;
    ...
    "e.  Used in MapHQ and reserving conference rooms.";
		...
		private Helianz.UI.ListBox listRingGroup;
		private Helianz.UI.CheckBox checkIsGraphed;
		private Label label5;
		private Helianz.UI.CheckBox checkHasColor;
		private TextBox textEmpName;
		private Label label6;
		private Helianz.ODtextBox textNotes;
		private Label label3;
		private Helianz.UI.CheckBox checkIsPrivateScreen;
		...
		private Helianz.UI.ListBox listStatusOverride;
		private Label label17;
		private Helianz.UI.CheckBox checkIsTriageOperator;
		private Helianz.UI.ComboBox comboSite;
		private Label label18;
		private Label label19;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.CheckBox checkIsWorkingHome;
		private Helianz.UI.CheckBox checkIsFurloughed;
