namespace Helianz {
	partial class FormMobileBugEdit {
		...
		private void InitializeComponent() {
			...
			this.groupBoxODMobile = new Helianz.UI.GroupBox();
			...
			this.checkiOS = new Helianz.UI.CheckBox();
			this.checkAndroid = new Helianz.UI.CheckBox();
			this.checkUWP = new Helianz.UI.CheckBox();
			this.checkODMobile = new Helianz.UI.CheckBox();
			this.checkEClipboard = new Helianz.UI.CheckBox();
			this.butDelete = new Helianz.UI.Button();
			this.butCancel = new Helianz.UI.Button();
			this.butOK = new Helianz.UI.Button();
			this.butLast3found = new Helianz.UI.Button();
			this.butLast2found = new Helianz.UI.Button();
			this.butLast1found = new Helianz.UI.Button();
			this.butLast3 = new Helianz.UI.Button();
			this.butLast2 = new Helianz.UI.Button();
			this.butLast1 = new Helianz.UI.Button();
			this.butODVersionCopyDown = new Helianz.UI.Button();
			this.butODMobileNextVersion = new Helianz.UI.Button();
			this.butODMobileLastVersion = new Helianz.UI.Button();
			this.butEClipboardNextVersion = new Helianz.UI.Button();
			this.butEClipboardLastVersion = new Helianz.UI.Button();
		...
		private Helianz.UI.GroupBox groupBoxODMobile;
		...
		private Helianz.UI.CheckBox checkiOS;
		private Helianz.UI.CheckBox checkAndroid;
		private Helianz.UI.CheckBox checkUWP;
		private Helianz.UI.CheckBox checkODMobile;
		private Helianz.UI.CheckBox checkEClipboard;
