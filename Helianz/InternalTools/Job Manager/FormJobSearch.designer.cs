namespace Helianz{
	partial class FormJobSearch {
		...
		private void InitializeComponent() {
			...
			this.listBoxUsers = new Helianz.UI.ListBox();
			this.listBoxPhases = new Helianz.UI.ListBox();
			this.listBoxCategory = new Helianz.UI.ListBox();
			...
			this.listBoxPriorities = new Helianz.UI.ListBox();
			this.SuspendLayout();
			// 
			// label2
			// 
			...
			this.listBoxUsers.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxPhases.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxCategory.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listBoxUsers;
		private Helianz.UI.ListBox listBoxPhases;
		private Helianz.UI.ListBox listBoxCategory;
