namespace Helianz {
	partial class ODjobTextEditor {
		...
		private void InitializeComponent() {
			...
			this.textConcept = new Helianz.ODtextBox();
			this.panelWriteup = new System.Windows.Forms.Panel();
			this.textWriteup = new Helianz.ODtextBox();
			this.panelRequirements = new System.Windows.Forms.Panel();
			this.gridRequirements = new Helianz.UI.GridOD();
			...
			this.textConcept.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.textWriteup.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.gridRequirements.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridRequirements.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridRequirements_CellClick);
			this.gridRequirements.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridRequirements_CellLeave);
			this.gridRequirements.CellKeyDown += new Helianz.UI.ODGridKeyEventHandler(this.gridRequirements_CellKeyDown);
