...
namespace Helianz {
	partial class FormBackport {
		...
		private void InitializeComponent() {
			...
			this.butCommit = new Helianz.UI.Button();
			this.butClose = new Helianz.UI.Button();
			this.butRefresh = new Helianz.UI.Button();
			this.butCompileAll = new Helianz.UI.Button();
			this.butBackport = new Helianz.UI.Button();
			this.listBoxVersions = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.validJobNum = new Helianz.ValidNum();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.butBackportAndCommit = new Helianz.UI.Button();
			this.butFindPath = new Helianz.UI.Button();
			...
			this.listBoxVersions.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
