namespace Helianz {
	partial class FormJobTeams {
		...
		private void InitializeComponent() {
			...
			this.gridTeams = new Helianz.UI.GridOD();
			...
			this.listBoxTeamMembers = new Helianz.UI.ListBox();
			this.butAddTeamMember = new Helianz.UI.Button();
			this.butDeleteTeamMember = new Helianz.UI.Button();
			this.butChangeTeamLead = new Helianz.UI.Button();
			...
			this.gridTeams.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTeams_CellDoubleClick);
