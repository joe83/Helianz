namespace Helianz.InternalTools.Job_Manager {
	partial class UserControlQueryEdit {
		...
		private void InitializeComponent() {
			...
			this.checkApproved = new Helianz.UI.CheckBox();
			this.DatePickerApproved = new Helianz.UI.ODDatePicker();
			this.DatePickerDeadline = new Helianz.UI.ODDatePicker();
			this.DatePickerSched = new Helianz.UI.ODDatePicker();
			...
			this.butActions.Image = global::Helianz.Properties.Resources.arrowDownTriangle;
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
			...
			this.textJobEditor.OnTextEdited += new Helianz.ODjobTextEditor.textChangedEventHandler(this.textEditorMain_OnTextEdited);
			// 
			// tabControlMain
			// 
			...
			this.gridAppointments.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAppointments_CellClick);
			...
			this.gridTasks.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridTasks_CellClick);
			...
			this.gridQuotes.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridQuotes_CellDoubleClick);
		...
		private Helianz.UI.CheckBox checkApproved;
