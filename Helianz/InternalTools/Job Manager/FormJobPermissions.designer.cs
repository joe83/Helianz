namespace Helianz{
	partial class FormJobPermissions {
		...
		private void InitializeComponent() {
			...
			this.butExpert = new Helianz.UI.Button();
			this.butPreExpert = new Helianz.UI.Button();
			this.butEngineer = new Helianz.UI.Button();
			this.butCustomerManager = new Helianz.UI.Button();
			this.butTechWriter = new Helianz.UI.Button();
			this.butQueryManager = new Helianz.UI.Button();
			this.butJobManager = new Helianz.UI.Button();
			this.butFeatureManager = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.butQuoteManager = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butOK
			// 
