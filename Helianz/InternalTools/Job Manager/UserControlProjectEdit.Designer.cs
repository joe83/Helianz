namespace Helianz.InternalTools.Job_Manager {
	partial class UserControlProjectEdit {
		...
		private void InitializeComponent() {
			...
			this.gridConcept = new Helianz.UI.GridOD();
			this.gridComplete = new Helianz.UI.GridOD();
			this.gridDefinition = new Helianz.UI.GridOD();
			this.gridDevelopment = new Helianz.UI.GridOD();
			this.gridDocumentation = new Helianz.UI.GridOD();
			this.gridPendingReview = new Helianz.UI.GridOD();
			...
			this.gridDiscussion = new Helianz.UI.GridOD();
			this.gridProjects = new Helianz.UI.GridOD();
			this.labelProjectDescription = new System.Windows.Forms.Label();
			this.labelVersion = new System.Windows.Forms.Label();
			this.textVersion = new System.Windows.Forms.TextBox();
			this.tableLayoutPanel2 = new System.Windows.Forms.TableLayoutPanel();
			this.textEditorProjectDescription = new Helianz.OdtextEditor();
			...
			this.butAddExistingJob = new Helianz.UI.Button();
			this.textHoursActualDescendants = new Helianz.ValidDouble();
			this.butChangeEst = new Helianz.UI.Button();
			this.textHoursLeftDescendants = new Helianz.ValidDouble();
			this.butCalculateSums = new Helianz.UI.Button();
			this.textEstHours = new Helianz.ValidDouble();
			this.textHoursEstDescendants = new Helianz.ValidDouble();
			...
			this.groupGridFilters = new Helianz.UI.GroupBox();
			this.checkShowAllChildJobs = new Helianz.UI.CheckBox();
			this.checkIncludeCancelled = new Helianz.UI.CheckBox();
			this.checkIncludeComplete = new Helianz.UI.CheckBox();
			this.butActions = new Helianz.UI.Button();
			this.checkIsActive = new Helianz.UI.CheckBox();
			this.comboPhase = new Helianz.UI.ComboBox();
			this.comboJobTeam = new Helianz.UI.ComboBox();
			this.checkIncludeCompletedJobsInHoursCalc = new Helianz.UI.CheckBox();
			...
			this.gridConcept.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJob_CellDoubleClick);
			// 
			// gridComplete
			// 
			...
			this.gridComplete.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJob_CellDoubleClick);
			// 
			// gridDefinition
			// 
			...
			this.gridDefinition.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJob_CellDoubleClick);
			// 
			// gridDevelopment
			// 
			...
			this.gridDevelopment.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJob_CellDoubleClick);
			// 
			// gridDocumentation
			// 
			...
			this.gridDocumentation.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJob_CellDoubleClick);
			// 
			// gridPendingReview
			// 
			...
			this.gridPendingReview.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJob_CellDoubleClick);
			// 
			// labelJobTeam
			// 
			...
			this.gridDiscussion.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridDiscussion_CellDoubleClick);
			...
			this.gridProjects.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProjects_CellDoubleClick);
			this.gridProjects.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridProjects_CellClick);
			// 
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
			...
			this.textEditorProjectDescription.SaveClick += new Helianz.ODtextEditorSaveEventHandler(this.textEditor_SaveClick);
			this.textEditorProjectDescription.OnTextEdited += new Helianz.OdtextEditor.textChangedEventHandler(this.textEditor_OnTextEdited);
			// 
			// tableLayoutPanel3
			// 
