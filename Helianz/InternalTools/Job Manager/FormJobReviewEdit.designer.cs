namespace Helianz{
	partial class FormJobReviewEdit {
		...
		private void InitializeComponent() {
			...
			this.butLogin = new Helianz.UI.Button();
			this.labelReviewTime = new System.Windows.Forms.Label();
			this.textReviewTime = new Helianz.ValidNum();
			this.butAutoNote = new Helianz.UI.Button();
			this.checkAsyncReview = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.textDescription.QuickPasteType = HelianzBusiness.EnumQuickPasteType.CommLog;
