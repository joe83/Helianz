...
namespace Helianz {
	public partial class FormJobManagerOverview:FormODBase {
		...
		private void butHomePage_Click(object sender,EventArgs e) {
			try{
				Process.Start("https://www.helianz.com");
			}
			catch{
		...
		private void butForum_Click(object sender,EventArgs e) {
			try{
				Process.Start("http://helianzsoft.com/forum/");
			}
			catch{
		...
		private void butBugManager_Click(object sender,EventArgs e) {
			try{
				Process.Start("http://helianzsoft.com:1942/ODBugTracker/BugList.aspx");
			}
			catch{
		...
		private void butSchema_Click(object sender,EventArgs e) {
			try{
				Process.Start("https://www.helianz.com/HelianzDocumentation18-2.xml");
			}
			catch{
		...
		private void butBugsList_Click(object sender,EventArgs e) {
			try{
				Process.Start("http://helianzsoft.com:1942/ODBugTracker/PreviousVersions.aspx");
			}
			catch{
		...
		private void butUserGroup_Click(object sender,EventArgs e) {
			try{
				Process.Start("https://www.facebook.com/groups/HelianzUsers/");
			}
			catch{
