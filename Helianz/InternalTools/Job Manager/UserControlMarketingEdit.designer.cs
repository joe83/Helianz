namespace Helianz.InternalTools.Job_Manager {
	partial class UserControlMarketingEdit {
		...
		private void InitializeComponent() {
			...
			this.textEditorMain = new Helianz.OdtextEditor();
    ...
    "";
			...
			this.textEditorMain.SaveClick += new Helianz.ODtextEditorSaveEventHandler(this.textEditor_SaveClick);
			this.textEditorMain.OnTextEdited += new Helianz.OdtextEditor.textChangedEventHandler(this.textEditorMain_OnTextEdited);
			// 
			// tabControlMain
			// 
