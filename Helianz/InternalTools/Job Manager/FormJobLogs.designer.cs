namespace Helianz{
	partial class FormJobLogs {
		...
		private void InitializeComponent() {
			...
			this.gridLog = new Helianz.UI.GridOD();
			this.checkShowHistoryText = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// butClose
			// 
			...
			this.gridLog.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridLog_CellDoubleClick);
			// 
		...
		private Helianz.UI.CheckBox checkShowHistoryText;
	}
}