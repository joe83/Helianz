...
using System.Text;
using HelianzBusiness.InternalTools.Job_Manager.HelperClasses;
...
namespace Helianz {
	public partial class FormTeamSummary:FormODBase {
		...
		private void butDraftEmail_Click(object sender,EventArgs e) {
			...
			if(fromAddress==null) {
				MsgBox.Show(this,"You don't have an email address setup in Helianz");
				return;
			}
			...
			EmailMessage emailMessage=new EmailMessage() { 
				...
				ToAddress="EngineeringManagement@helianz.com",
