namespace Helianz {
	partial class UserControlSprintManager {
		...
		private void InitializeComponent() {
			...
			this.gridSprintJobs = new Helianz.UI.GridOD();
			this.panel2 = new System.Windows.Forms.Panel();
			this.textCompletionPercentage = new System.Windows.Forms.Label();
			this.progressBarCompletionPercent = new Helianz.UI.OdProgressBar();
			this.groupBoxSprintDetails = new Helianz.UI.GroupBox();
			this.butDashboard = new Helianz.UI.Button();
			this.checkProgressMode = new Helianz.UI.CheckBox();
			this.butSave = new Helianz.UI.Button();
			this.textBreakHours = new Helianz.ValidDouble();
			this.textAvgDevelopmentHours = new Helianz.ValidDouble();
			this.textEngJobPercent = new Helianz.ValidDouble();
			...
			this.progressBarAllocatedHours = new Helianz.UI.OdProgressBar();
			...
			this.gridSprintJobs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSprintJobs_CellDoubleClick);
		...
		#endregion
		private Helianz.UI.OdProgressBar progressBarAllocatedHours;
		private System.Windows.Forms.Label labelCompletionPercentDescription;
		private Helianz.UI.OdProgressBar progressBarCompletionPercent;
		private System.Windows.Forms.TableLayoutPanel tableLayoutPanel1;
		private Helianz.UI.GroupBox groupBoxSprintDetails;
		...
		private Helianz.UI.CheckBox checkProgressMode;
