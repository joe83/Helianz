namespace Helianz{
	partial class FormBugSearch {
		...
		private void InitializeComponent() {
			...
			this.checkToken = new Helianz.UI.CheckBox();
			...
			this.butViewSubs = new Helianz.UI.Button();
			this.checkMobile = new Helianz.UI.CheckBox();
			this.butAddMobile = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.butAddMobile.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.CheckBox checkToken;
		private UI.Button butRefresh;
		private Helianz.UI.CheckBox checkShow;
		private UI.Button butAdd;
		private UI.Button butViewSubs;
		private Helianz.UI.CheckBox checkMobile;
