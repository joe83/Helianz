namespace Helianz{
	partial class FormTeamSummary {
		...
		private void InitializeComponent() {
			...
			this.butDraftEmail = new Helianz.UI.Button();
			this.tabControlSummary = new Helianz.UI.TabControl();
			this.buttonCopy = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butDraftEmail
			// 
		...
		private Helianz.UI.Button butDraftEmail;
