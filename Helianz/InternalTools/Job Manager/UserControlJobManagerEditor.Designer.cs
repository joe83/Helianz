using Helianz.InternalTools.Job_Manager;
...
namespace Helianz {
	partial class UserControlJobManagerEditor {
		...
		private void InitializeComponent() {
			this.userControlJobEdit = new Helianz.InternalTools.Job_Manager.UserControlJobEdit();
			this.userControlMarketingEdit = new Helianz.InternalTools.Job_Manager.UserControlMarketingEdit();
			this.userControlQueryEdit = new Helianz.InternalTools.Job_Manager.UserControlQueryEdit();
			this.userControlProjectEdit = new Helianz.InternalTools.Job_Manager.UserControlProjectEdit();
			this.SuspendLayout();
			// 
			// userControlJobEdit
			// 
			...
			this.userControlJobEdit.RequestJob += new Helianz.InternalTools.Job_Manager.UserControlJobEdit.RequestJobEvent(this.userControlJobEdit_RequestJob);
			// 
			...
			this.userControlQueryEdit.RequestJob += new Helianz.InternalTools.Job_Manager.UserControlQueryEdit.RequestJobEvent(this.userControlJobEdit_RequestJob);
			// 
			...
			this.userControlProjectEdit.RequestJob += new Helianz.InternalTools.Job_Manager.UserControlProjectEdit.RequestJobEvent(this.userControlProjectEdit_RequestJob);
			// 
