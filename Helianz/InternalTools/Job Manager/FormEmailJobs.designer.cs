...
namespace Helianz {
	public partial class FormEmailJobs {
		...
		private void InitializeComponent()
		{
			...
			this.gridRecipients = new Helianz.UI.GridOD();
			this.textVersions = new Helianz.ODtextBox();
			this.textDescriptions = new Helianz.ODtextBox();
			this.textPledgeTemplate = new Helianz.ODtextBox();
			this.textSubject = new Helianz.ODtextBox();
			this.textFromAddress = new Helianz.ODtextBox();
			this.textBodyTextTemplate = new Helianz.ODtextBox();
			...
			this.gridRecipients.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridRecipients_CellClick);
			// 
			// textVersions
			// 
			...
			this.textVersions.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textDescriptions.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textPledgeTemplate.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textBodyTextTemplate.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
