namespace Helianz.InternalTools.Job_Manager {
	partial class UserControlJobEdit {
		...
		private void InitializeComponent() {
			...
			this.gridCustomers = new Helianz.UI.GridOD();
			this.gridFiles = new Helianz.UI.GridOD();
			this.gridSubscribers = new Helianz.UI.GridOD();
			this.gridBugs = new Helianz.UI.GridOD();
			this.gridQuotes = new Helianz.UI.GridOD();
			this.gridFeatureReq = new Helianz.UI.GridOD();
			this.gridTasks = new Helianz.UI.GridOD();
			this.gridAppointments = new Helianz.UI.GridOD();
			this.butGitActions = new Helianz.UI.Button();
			this.comboJobTeam = new Helianz.UI.ComboBox();
			this.treeRelatedJobs = new Helianz.UI.BufferedTreeView();
			this.butParentPick = new Helianz.UI.Button();
			this.checkIsActive = new Helianz.UI.CheckBox();
			this.butParentRemove = new Helianz.UI.Button();
			this.gridRoles = new Helianz.UI.GridOD();
			this.butActions = new Helianz.UI.Button();
			this.butPopout = new Helianz.UI.Button();
			this.butChangeEst = new Helianz.UI.Button();
			this.textHoursLeft = new Helianz.ValidDouble();
			this.butAddTime = new Helianz.UI.Button();
			this.butVersionPrompt = new Helianz.UI.Button();
			this.textEstHours = new Helianz.ValidDouble();
			this.textActualHours = new Helianz.ValidDouble();
			this.butTimeLog = new Helianz.UI.Button();
			this.checkIncludeCompleteCanceled = new Helianz.UI.CheckBox();
			this.textJobEditor = new Helianz.ODjobTextEditor();
			this.gridNotes = new Helianz.UI.GridOD();
			this.gridReview = new Helianz.UI.GridOD();
			this.textEditorDocumentation = new Helianz.OdtextEditor();
			this.textTestingHours = new Helianz.ValidDouble();
			this.gridTestingNotes = new Helianz.UI.GridOD();
			this.checkNotTested = new Helianz.UI.CheckBox();
			this.butTested = new Helianz.UI.Button();
			this.textTitle = new Helianz.ODtextBox();
			...
			this.gridCustomers.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomers_CellDoubleClick);
			...
			this.gridFiles.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridFiles_CellDoubleClick);
			...
			this.gridBugs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBugs_CellDoubleClick);
			...
			this.gridQuotes.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomerQuotes_CellDoubleClick);
			...
			this.gridFeatureReq.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridFeatureReq_CellDoubleClick);
			...
			this.gridTasks.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTasks_CellDoubleClick);
			...
			this.gridAppointments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAppointments_CellDoubleClick);
			...
			this.butGitActions.Image = global::Helianz.Properties.Resources.downArrowWinForm;
			...
			this.butParentRemove.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// gridRoles
			// 
			this.gridRoles.Location = new System.Drawing.Point(0, 351);
			this.gridRoles.Name = "gridRoles";
			this.gridRoles.SelectionMode = Helianz.UI.GridSelectionMode.None;
			this.gridRoles.Size = new System.Drawing.Size(276, 259);
			...
			this.butActions.Image = global::Helianz.Properties.Resources.downArrowWinForm;
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
			...
			this.textJobEditor.SaveClick += new Helianz.ODtextEditorSaveEventHandler(this.textEditor_SaveClick);
			this.textJobEditor.OnTextEdited += new Helianz.ODjobTextEditor.textChangedEventHandler(this.textEditor_OnTextEdited);
			// 
			// gridNotes
			// 
			...
			this.gridNotes.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridNotes_CellDoubleClick);
			...
			this.gridReview.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridReview_CellDoubleClick);
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
			...
			this.textEditorDocumentation.SaveClick += new Helianz.ODtextEditorSaveEventHandler(this.textEditor_SaveClick);
			this.textEditorDocumentation.OnTextEdited += new Helianz.OdtextEditor.textChangedEventHandler(this.textEditor_OnTextEdited);
			// 
			// textTestingHours
			// 
			...
			this.gridTestingNotes.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTestingNotes_CellDoubleClick);
			...
			this.textTitle.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
		...
		private Helianz.UI.CheckBox checkNotTested;
		private Helianz.UI.CheckBox checkIsActive;
		private UI.BufferedTreeView treeRelatedJobs;
		private Helianz.UI.CheckBox checkIncludeCompleteCanceled;
