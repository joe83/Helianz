namespace Helianz{
	partial class FormJobLinks {
		...
		private void InitializeComponent() {
			...
			this.butLinkTask = new Helianz.UI.Button();
			this.butLinkFeatReq = new Helianz.UI.Button();
			this.butLinkBug = new Helianz.UI.Button();
			this.groupAddLink = new Helianz.UI.GroupBox();
			this.butLinkQuote = new Helianz.UI.Button();
		...
		private Helianz.UI.GroupBox groupAddLink;
