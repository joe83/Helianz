namespace Helianz{
	partial class FormJobAdd {
		...
		private void InitializeComponent() {
			...
			this.textConcept = new Helianz.OdtextEditor();
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
			...
			this.gridCustomers.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomers_CellClick);
			...
			this.gridSubscribers.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubscribers_CellClick);
			...
			this.gridFeatureReq.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridFeatureReq_CellClick);
			...
			this.gridBugs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridBugs_CellClick);
			...
			this.gridQuotes.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridQuotes_CellClick);
