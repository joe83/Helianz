namespace Helianz{
	partial class FormJobManagerOverview {
		...
		private void InitializeComponent() {
			...
			this.gridEngineerHours = new Helianz.UI.GridOD();
			this.groupPrintOptions = new Helianz.UI.GroupBox();
			this.butFixTopParents = new Helianz.UI.Button();
			this.butExport = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.butRefresh = new Helianz.UI.Button();
			this.groupFilters = new Helianz.UI.GroupBox();
			this.textWithinLastXDays = new System.Windows.Forms.TextBox();
			this.labelWithinLastXDays = new System.Windows.Forms.Label();
			this.comboTeams = new Helianz.UI.ComboBox();
			this.labelTeams = new System.Windows.Forms.Label();
			this.groupCompletedDateRange = new Helianz.UI.GroupBox();
			this.dateRangeJobCompleted = new Helianz.UI.ODDateRangePicker();
			this.checkRemoveApprovalJobs = new Helianz.UI.CheckBox();
			this.checkRemoveNoQuote = new Helianz.UI.CheckBox();
			this.butPatSelect = new Helianz.UI.Button();
			this.textPatNum = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.comboEngineers = new Helianz.UI.ComboBox();
			this.label6 = new System.Windows.Forms.Label();
			this.listPriorities = new Helianz.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.listPhases = new Helianz.UI.ListBox();
			this.label5 = new System.Windows.Forms.Label();
			this.listCategories = new Helianz.UI.ListBox();
			this.label4 = new System.Windows.Forms.Label();
			this.groupPresetFilters = new Helianz.UI.GroupBox();
			...
			this.gridJobs = new Helianz.UI.GridOD();
			...
			this.userControlJobTeamReport = new Helianz.InternalTools.Job_Manager.UserControlTeamReport();
			...
			this.gridSprints.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSprints_CellClick);
			...
			this.gridEngineerHours.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridEngineerHours_CellClick);
			// 
			// groupPrintOptions
			// 
			...
			this.butExport.Image = global::Helianz.Properties.Resources.butExport;
			...
			this.listPriorities.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listPhases.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridJobs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJobs_CellDoubleClick);
			// 
			// toolMainLeft
			// 
		...
		private Helianz.UI.GroupBox groupFilters;
		private Helianz.UI.GroupBox groupPresetFilters;
		...
		private Helianz.UI.CheckBox checkRemoveNoQuote;
		private UI.Button butPatSelect;
		private System.Windows.Forms.TextBox textPatNum;
		private System.Windows.Forms.Label label2;
		private Helianz.UI.CheckBox checkRemoveApprovalJobs;
		private Helianz.UI.GroupBox groupCompletedDateRange;
