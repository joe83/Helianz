namespace Helianz{
	partial class FormReleaseCalculator {
		...
		private void InitializeComponent() {
			...
			this.gridCalculatedJobs = new Helianz.UI.GridOD();
			this.panel2 = new System.Windows.Forms.Panel();
			this.label7 = new System.Windows.Forms.Label();
			this.listEngineers = new Helianz.UI.ListBox();
			...
			this.listEngNoJobs = new Helianz.UI.ListBox();
			...
			this.gridCalculatedJobs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCalculatedJobs_CellDoubleClick);
			// 
			// panel2
			// 
