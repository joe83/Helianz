...
namespace Helianz.InternalTools.Job_Manager {
	...
	public partial class UserControlJobEdit:UserControl {
		...
		private void menuItemCustomersGoToChart_Click(object sender,EventArgs e) {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Chart,patNum:gridCustomers.SelectedTag<Patient>().PatNum);
		}
		...
		private void gridTasks_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			...
			//GoTo patietn will not work from this form. It would require a delegate to be passed in all the way from FormHelianz.
		...
		private void gridCustomers_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			...
			if(frmPatientSelect.IsDialogOK) {
				...
				GlobalFormHelianz.PatientSelected(patientSelected,true);
			}
		}
