namespace Helianz {
	partial class FormJobManager {
		...
		private void InitializeComponent() {
			...
			this.gridPatternReview = new Helianz.UI.GridOD();
			this.tabAction = new System.Windows.Forms.TabPage();
			this.butExport = new Helianz.UI.Button();
			this.label15 = new System.Windows.Forms.Label();
			this.comboProposedVersionNeedsAction = new Helianz.UI.ComboBox();
			this.checkShowUnassigned = new Helianz.UI.CheckBox();
			this.gridAction = new Helianz.UI.GridOD();
			this.tabSpecialProjects = new System.Windows.Forms.TabPage();
			this.checkShowUnassignedSpecial = new Helianz.UI.CheckBox();
			this.gridSpecial = new Helianz.UI.GridOD();
			...
			this.gridDocumentation = new Helianz.UI.GridOD();
			this.tabTesting = new System.Windows.Forms.TabPage();
			this.checkHideNotTested = new Helianz.UI.CheckBox();
			this.butTestingRefresh = new Helianz.UI.Button();
			this.checkShowAllUsers = new Helianz.UI.CheckBox();
			this.checkHideTested = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.textVersionText = new System.Windows.Forms.TextBox();
			this.gridTesting = new Helianz.UI.GridOD();
			this.tabQuery = new System.Windows.Forms.TabPage();
			this.gridQueries = new Helianz.UI.GridOD();
			...
			this.comboQueryPhaseFilter = new Helianz.UI.ComboBox();
			this.comboQueryPriorityFilter = new Helianz.UI.ComboBox();
			this.butQueriesRefresh = new Helianz.UI.Button();
			this.checkShowQueryComplete = new Helianz.UI.CheckBox();
			this.checkShowQueryCancelled = new Helianz.UI.CheckBox();
			this.tabNotify = new System.Windows.Forms.TabPage();
			this.gridNotify = new Helianz.UI.GridOD();
			this.checkNotifyShowHqOnly = new Helianz.UI.CheckBox();
			this.tabSubscribed = new System.Windows.Forms.TabPage();
			this.checkSubscribedIncludeOnHold = new Helianz.UI.CheckBox();
			this.gridSubscribedJobs = new Helianz.UI.GridOD();
			this.tabNeedsEngineer = new System.Windows.Forms.TabPage();
			this.labelNeedsEngineerTeam = new System.Windows.Forms.Label();
			this.comboTeamFilterNeedsEngineer = new Helianz.UI.ComboBox();
			this.label7 = new System.Windows.Forms.Label();
			this.comboProposedVersionNeedsEngineer = new Helianz.UI.ComboBox();
			this.gridAvailableJobs = new Helianz.UI.GridOD();
			this.tabNeedsExpert = new System.Windows.Forms.TabPage();
			this.label2 = new System.Windows.Forms.Label();
			this.comboTeamFilterNeedsExpert = new Helianz.UI.ComboBox();
			this.label8 = new System.Windows.Forms.Label();
			this.comboProposedVersionNeedsExpert = new Helianz.UI.ComboBox();
			this.gridAvailableJobsExpert = new Helianz.UI.GridOD();
			this.tabOnHold = new System.Windows.Forms.TabPage();
			this.gridJobsOnHold = new Helianz.UI.GridOD();
			this.tabSearch = new System.Windows.Forms.TabPage();
			this.gridSearch = new Helianz.UI.GridOD();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.labelTeamSearch = new System.Windows.Forms.Label();
			this.comboTeamSearch = new Helianz.UI.ComboBox();
			this.checkResults = new Helianz.UI.CheckBox();
			this.labeluserSearch = new System.Windows.Forms.Label();
			this.comboProposedVersionSearch = new Helianz.UI.ComboBox();
			this.textUserSearch = new System.Windows.Forms.TextBox();
			this.labelProposedVersionSearch = new System.Windows.Forms.Label();
			this.comboPrioritySearch = new Helianz.UI.ComboBox();
			this.labelPrioritySearch = new System.Windows.Forms.Label();
			this.checkContactSearch = new Helianz.UI.CheckBox();
			this.comboCatSearch = new Helianz.UI.ComboBox();
			...
			this.butMarketingRefresh = new Helianz.UI.Button();
			this.checkShowDesignComplete = new Helianz.UI.CheckBox();
			this.checkShowDesignCancelled = new Helianz.UI.CheckBox();
			this.gridMarketing = new Helianz.UI.GridOD();
			this.tabUnresolvedIssues = new System.Windows.Forms.TabPage();
			this.gridUnresolvedIssues = new Helianz.UI.GridOD();
			this.butRefreshUnresolved = new Helianz.UI.Button();
			this.checkIncludeCancelledUnresolved = new Helianz.UI.CheckBox();
			this.tabSubmittedJobs = new System.Windows.Forms.TabPage();
			this.checkShowOnHoldSubmitted = new Helianz.UI.CheckBox();
			this.gridSubmittedJobs = new Helianz.UI.GridOD();
			this.userControlJobManagerEditor = new Helianz.UserControlJobManagerEditor();
			this.tabProjectManagement = new System.Windows.Forms.TabPage();
			this.checkOnlyShowTopLevel = new Helianz.UI.CheckBox();
			this.gridProjectManagement = new Helianz.UI.GridOD();
			this.labelProjectManagementTeam = new System.Windows.Forms.Label();
			this.comboTeamFilterProjectManagement = new Helianz.UI.ComboBox();
			this.label5 = new System.Windows.Forms.Label();
			this.butAdvSearch = new Helianz.UI.Button();
			this.butMe = new Helianz.UI.Button();
			...
			this.butForward = new Helianz.UI.Button();
			...
			this.gridPatternReview.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPatternReview_CellClick);
			// 
			// tabAction
			// 
			...
			this.gridAction.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAction_CellDoubleClick);
			this.gridAction.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAction_CellClick);
			...
			this.gridSpecial.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSpecial_CellDoubleClick);
			this.gridSpecial.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSpecial_CellClick);
			// 
			// tabDocumentation
			// 
			...
			this.gridDocumentation.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridDocumentation_CellDoubleClick);
			this.gridDocumentation.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridDocumentation_CellClick);
			// 
			// tabTesting
			// 
			...
			this.gridTesting.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTesting_CellDoubleClick);
			this.gridTesting.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridTesting_CellClick);
			// 
			// tabQuery
			// 
			...
			this.gridQueries.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridQueries_CellDoubleClick);
			this.gridQueries.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridQueries_CellClick);
			// 
			// groupBox1
			// 
			...
			this.gridNotify.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridNotify_CellDoubleClick);
			this.gridNotify.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridNotify_CellClick);
			// 
			...
			this.gridSubscribedJobs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubscribedJobs_CellDoubleClick);
			this.gridSubscribedJobs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubscribedJobs_CellClick);
			// 
			// tabNeedsEngineer
			// 
			...
			this.gridAvailableJobs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAvailableJobs_CellDoubleClick);
			this.gridAvailableJobs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAvailableJobs_CellClick);
			// 
			// tabNeedsExpert
			// 
			...
			this.gridAvailableJobsExpert.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAvailableJobsExpert_CellDoubleClick);
			this.gridAvailableJobsExpert.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAvailableJobsExpert_CellClick);
			// 
			// tabOnHold
			// 
			...
			this.gridJobsOnHold.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridJobsOnHold_CellDoubleClick);
			this.gridJobsOnHold.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridJobsOnHold_CellClick);
			// 
			// tabSearch
			// 
			...
			this.gridSearch.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSearch_CellDoubleClick);
			this.gridSearch.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSearch_CellClick);
			// 
			// groupBox2
			// 
			...
			this.gridMarketing.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridMarketing_CellClick);
			// 
			// tabUnresolvedIssues
			// 
			...
			this.gridUnresolvedIssues.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridUnresolvedIssues_CellClick);
			// 
			...
			this.gridSubmittedJobs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubmittedJobs_CellDoubleClick);
			this.gridSubmittedJobs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubmittedJobs_CellClick);
			// 
			...
			this.gridProjectManagement.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProjectManagement_CellDoubleClick);
			this.gridProjectManagement.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridProjectManagement_CellClick);
			// 
			...
			this.butBack.Image = global::Helianz.Properties.Resources.Left;
			...
			this.butForward.Image = global::Helianz.Properties.Resources.Right;
		...
		private Helianz.UI.CheckBox checkShowUnassigned;
		...
		private Helianz.UI.CheckBox checkShowQueryCancelled;
		private Helianz.UI.CheckBox checkShowQueryComplete;
		...
		private Helianz.UI.CheckBox checkSubscribedIncludeOnHold;
		...
		private Helianz.UI.CheckBox checkShowAllUsers;
		private Helianz.UI.CheckBox checkHideTested;
		...
		private Helianz.UI.CheckBox checkContactSearch;
		private System.Windows.Forms.TabPage tabSpecialProjects;
		private Helianz.UI.CheckBox checkShowUnassignedSpecial;
		...
		private Helianz.UI.CheckBox checkHideNotTested;
		...
		private Helianz.UI.CheckBox checkShowDesignComplete;
		private Helianz.UI.CheckBox checkShowDesignCancelled;
		...
		private Helianz.UI.CheckBox checkResults;
		...
		private Helianz.UI.CheckBox checkIncludeCancelledUnresolved;
		private UI.Button butExport;
		private System.Windows.Forms.TabPage tabSubmittedJobs;
		private Helianz.UI.CheckBox checkShowOnHoldSubmitted;
		private UI.GridOD gridSubmittedJobs;
		private Helianz.UI.CheckBox checkNotifyShowHqOnly;
