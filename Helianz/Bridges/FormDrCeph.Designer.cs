...
namespace Helianz {
	partial class FormDrCeph {
		...
		private void InitializeComponent() {
			...
			this.butCephBrowse = new Helianz.UI.Button();
			this.butPhotoBrowse = new Helianz.UI.Button();
			this.textCephLocation = new System.Windows.Forms.TextBox();
			this.textPhotoLocation = new System.Windows.Forms.TextBox();
			this.listBoxRace = new Helianz.UI.ListBox();
			this.listBoxTxPhase = new Helianz.UI.ListBox();
			this.SuspendLayout();
			// 
			// labelRace
			// 
