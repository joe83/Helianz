namespace Helianz{
	partial class FormPrintTrojan {
		...
		private void InitializeComponent() {
			...
			this.butPreviousPage = new Helianz.UI.Button();
			this.butNextPage = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// printPanel
			// 
			...
			// butPreviousPage
			// 
			this.butPreviousPage.Image = global::Helianz.Properties.Resources.up;
			...
			// butNextPage
			// 
			this.butNextPage.Image = global::Helianz.Properties.Resources.down;
		...
		private Helianz.UI.Button butNextPage;
		private Helianz.UI.Button butPreviousPage;
