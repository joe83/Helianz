namespace Helianz {
	partial class SheetEditMobileCtrl {
		...
		private void InitializeComponent() {
			...
			this.checkUseMobileLayout = new Helianz.UI.CheckBox();
			this.butAddHeader = new System.Windows.Forms.Button();
			this.butOrderFields = new System.Windows.Forms.Button();
			this.panelPreview = new Helianz.SheetEditMobilePreviewPanel();
			this.SuspendLayout();
			// 
			// labelDragToOrder
			// 
		...
		private Helianz.UI.CheckBox checkUseMobileLayout;
