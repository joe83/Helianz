	...
	class SheetPrintingJob {
		...
		public void PrintBatch(List<Sheet> sheetBatch){
			...
			if(ODBuild.IsDebug()) {
				...
				foreach(Sheet s in _listSheets) {
					s.SheetFields.Sort(HelianzBusiness.SheetFields.SortDrawingOrderLayers);
				}
		...
		public void DrawSheetFirstPage(Graphics g,Sheet sheet) {
			...
			HelianzBusiness.SheetDrawingJob.DrawFooter(sheet,g,null,_pagesPrinted,_yPosPrint,_medLab);
		}
			...
			foreach(SheetField field in sheet.SheetFields) {
				...
				switch(field.FieldType) {
					...
					case SheetFieldType.Special:
						HelianzBusiness.SheetPrinting.DrawFieldSpecial(sheet,field,g,gx,_yPosPrint);
						break;
		...
		private void pd_PrintPage(object sender,System.Drawing.Printing.PrintPageEventArgs e) {
			...
			HelianzBusiness.SheetDrawingJob.DrawHeader(sheet,g,null,_pagesPrinted,_yPosPrint);
			HelianzBusiness.SheetDrawingJob.DrawFooter(sheet,g,null,_pagesPrinted,_yPosPrint,_medLab);
			#if DEBUG
				if(_printCalibration) {
					HelianzBusiness.SheetDrawingJob.DrawCalibration(sheet,g,e,null,null);
				}
			#endif
			g.Dispose();
			g=null;
