	...
	public class SheetPrinting {
			...
			,bool isInPatientDashboard=false,Patient patCur=null,List<Appointment> listAppts=null) 
		{
			...
			if(listProceduresFilteredOverride!=null) {
				...
				listProceduresFiltered=HelianzBusiness.SheetPrinting.FilterProceduresForToothChart(listProceduresAll,treatPlan,showCompleted);
			}
			listProceduresFiltered.Sort(HelianzBusiness.SheetPrinting.CompareProcListFiltered);
			//Draw tooth chart
