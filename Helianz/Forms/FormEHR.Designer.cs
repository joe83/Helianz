namespace Helianz {
	partial class FormEHR {
		...
		private void InitializeComponent() {
			...
			this.gridMu = new Helianz.UI.GridOD();
			...
			this.gridMu.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridMu.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridMu_CellClick);
			// 
			// butClinicalSummary
			// 
		...
		private Helianz.UI.GridOD gridMu;
