namespace Helianz{
	partial class FormEServicesMobileSettings {
		...
		private void InitializeComponent() {
			...
			this.butVerifyAndSave = new Helianz.UI.Button();
			this.comboBoxClinicPicker1 = new Helianz.UI.ComboBoxClinicPicker();
			this.label1 = new System.Windows.Forms.Label();
			this.textUserName = new System.Windows.Forms.TextBox();
			this.groupAccountRecovery = new Helianz.UI.GroupBox();
			this.textValidPhone = new Helianz.ValidPhone();
	...
	"ly registering.";
		...
		private Helianz.UI.Button butVerifyAndSave;
		private UI.ComboBoxClinicPicker comboBoxClinicPicker1;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.TextBox textUserName;
		private Helianz.UI.GroupBox groupAccountRecovery;
