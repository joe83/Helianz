...
namespace Helianz {
	public partial class FormRxEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkControlled = new Helianz.UI.CheckBox();
			this.butView = new Helianz.UI.Button();
			this.labelView = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.comboSendStatus = new Helianz.UI.ComboBox();
			...
			this.textPharmInfo = new Helianz.ODtextBox();
			this.checkProcRequired = new Helianz.UI.CheckBox();
			this.comboProcCode = new Helianz.UI.ComboBox();
			this.labelProcedure = new System.Windows.Forms.Label();
			this.labelDaysOfSupply = new System.Windows.Forms.Label();
			this.textDaysOfSupply = new Helianz.ValidDouble();
			this.textPatInstructions = new Helianz.ODtextBox();
			this.label11 = new System.Windows.Forms.Label();
			this.butPrintPatInstructions = new Helianz.UI.Button();
			...
			this.butView.Image = global::Helianz.Properties.Resources.printPreview20;
			...
			this.textNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Rx;
			...
			this.textPharmInfo.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Rx;
			...
			this.textPatInstructions.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Rx;
			...
			this.butPrintPatInstructions.Image = global::Helianz.Properties.Resources.butPrint;
		...
		private Helianz.UI.CheckBox checkControlled;
		private Helianz.UI.Button butView;
		private Label labelView;
		private Label label9;
		private Helianz.UI.ComboBox comboSendStatus;
		...
		private Helianz.UI.CheckBox checkProcRequired;
		private Helianz.UI.ComboBox comboProcCode;
