...
namespace Helianz {
	public partial class FormEmailMessageEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butEditTemplate = new Helianz.UI.Button();
			this.butInsertTemplate = new Helianz.UI.Button();
			this.butDeleteTemplate = new Helianz.UI.Button();
			this.butAddTemplate = new Helianz.UI.Button();
			this.labelDecrypt = new System.Windows.Forms.Label();
			this.panelAutographs = new System.Windows.Forms.Panel();
			this.butEditAutograph = new Helianz.UI.Button();
			this.butInsertAutograph = new Helianz.UI.Button();
			this.butDeleteAutograph = new Helianz.UI.Button();
			this.butAddAutograph = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.listAutographs = new Helianz.UI.ListBox();
			this.butRefresh = new Helianz.UI.Button();
			this.butRawMessage = new Helianz.UI.Button();
			this.butDecrypt = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.emailPreview = new Helianz.EmailPreviewControl();
			this.toolTipMessage = new System.Windows.Forms.ToolTip(this.components);
			this.butEditHtml = new Helianz.UI.Button();
			this.butEditText = new Helianz.UI.Button();
			this.toolBarSend = new Helianz.UI.ToolBarOD();
			...
			// butEditTemplate
			// 
			this.butEditTemplate.Image = global::Helianz.Properties.Resources.editPencil;
			...
			this.butInsertTemplate.Image = global::Helianz.Properties.Resources.Right;
			...
			// butDeleteTemplate
			// 
			this.butDeleteTemplate.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// butAddTemplate
			// 
			this.butAddTemplate.Icon = Helianz.UI.EnumIcons.Add;
    ...
    "e Decrypt button to try again.";
			...
			// butEditAutograph
			// 
			this.butEditAutograph.Image = global::Helianz.Properties.Resources.editPencil;
			...
			this.butInsertAutograph.Image = global::Helianz.Properties.Resources.Right;
			...
			// butDeleteAutograph
			// 
			this.butDeleteAutograph.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// butAddAutograph
			// 
			this.butAddAutograph.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.toolBarSend.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.toolBarSend_ButtonClick);
			// 
		...
		#endregion
		private Helianz.UI.Button butDeleteTemplate;
		private Helianz.UI.Button butAddTemplate;
		private System.Windows.Forms.Label labelTemplate;
		private System.Windows.Forms.ListBox listTemplates;
		private Helianz.UI.Button butInsertTemplate;
