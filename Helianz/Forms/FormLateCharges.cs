...
namespace Helianz {
	...
	public partial class FormLateCharges:FormODBase {
		...
		///<summary>The following logic was moved into a Shown method, rather than a Load method, because the progress bar causes the window to pop behind FormHelianz when in Load.</summary>
		...
		///HelianzService.ProcessStatements.RunAgingEnterprise().</summary>
