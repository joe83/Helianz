...
namespace Helianz {
	public partial class FormReqAppt {
		...
		private void InitializeComponent()
		{
			...
			this.comboCourse = new Helianz.UI.ComboBox();
			this.label1 = new System.Windows.Forms.Label();
			this.comboClass = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.comboInstructor = new Helianz.UI.ComboBox();
			this.butSave = new Helianz.UI.Button();
			this.gridReqs = new Helianz.UI.GridOD();
			...
			this.gridReqs.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			// butAdd
			// 
			this.butAdd.Image = global::Helianz.Properties.Resources.down;
			...
			// butRemove
			// 
			this.butRemove.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.gridStudents.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridStudents_CellClick);
			// 
			// FormReqAppt
			// 
		...
		#endregion
		private Helianz.UI.GridOD gridStudents;
		private Label label2;
		private Helianz.UI.ComboBox comboCourse;
