namespace Helianz {
	partial class FormProgramLinkHideClinics {
		...
		private void InitializeComponent() {
			...
			this.listboxHiddenClinics = new Helianz.UI.ListBox();
			this.listboxVisibleClinics = new Helianz.UI.ListBox();
			...
			this.listboxHiddenClinics.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listboxVisibleClinics.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
