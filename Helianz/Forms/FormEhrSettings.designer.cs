namespace Helianz{
	partial class FormEhrSettings {
		...
		private void InitializeComponent() {
			...
			this.groupEncounter = new Helianz.UI.GroupBox();
			this.label7 = new System.Windows.Forms.Label();
			this.butEncounterTool = new Helianz.UI.Button();
			this.textEncCodeDescript = new System.Windows.Forms.TextBox();
			this.butEncCpt = new Helianz.UI.Button();
			...
			this.butEncHcpcs = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.butEncSnomed = new Helianz.UI.Button();
			this.butEncCdt = new Helianz.UI.Button();
			this.groupPregnancy = new Helianz.UI.GroupBox();
			...
			this.butPregIcd9 = new Helianz.UI.Button();
			this.butPregSnomed = new Helianz.UI.Button();
			this.butPregIcd10 = new Helianz.UI.Button();
			this.label11 = new System.Windows.Forms.Label();
			this.label12 = new System.Windows.Forms.Label();
			this.label13 = new System.Windows.Forms.Label();
			this.groupGlobalSettings = new Helianz.UI.GroupBox();
			this.checkAutoWebmails = new Helianz.UI.CheckBox();
			this.checkAlertHighSeverity = new Helianz.UI.CheckBox();
    ...
    "lude the patient from certain measures.";
		...
		private Helianz.UI.GroupBox groupEncounter;
		...
		private Helianz.UI.GroupBox groupPregnancy;
		...
		private Helianz.UI.GroupBox groupGlobalSettings;
		...
		private Helianz.UI.CheckBox checkAlertHighSeverity;
		...
		private Helianz.UI.CheckBox checkAutoWebmails;
	}
}