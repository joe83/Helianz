...
namespace Helianz {
	public partial class FormImagingSetup {
		...
		private void InitializeComponent()
		{
			...
			this.slider = new Helianz.UI.WindowingSlider();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.label37 = new System.Windows.Forms.Label();
			this.groupBoxSuni = new Helianz.UI.GroupBox();
			this.checkBinned = new Helianz.UI.CheckBox();
    ...
    " Window\" instead";
		...
		private Helianz.UI.GroupBox groupBoxSuni;
		...
		private Helianz.UI.CheckBox checkBinned;
	}
}
