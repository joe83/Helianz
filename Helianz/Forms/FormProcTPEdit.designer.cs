...
namespace Helianz {
	public partial class FormProcTPEdit {
		...
		private void InitializeComponent()
		{
			...
			this.textPatAmt = new Helianz.ValidDouble();
			this.textSecInsAmt = new Helianz.ValidDouble();
			this.textPriInsAmt = new Helianz.ValidDouble();
			this.textFeeAmt = new Helianz.ValidDouble();
			...
			this.textFeeAllowed = new Helianz.ValidDouble();
		...
		private Helianz.ValidDouble textFeeAmt;
		private Helianz.ValidDouble textPriInsAmt;
		private Helianz.ValidDouble textSecInsAmt;
		private ValidDouble textDiscount;
		private Label label2;
		private Helianz.ValidDouble textPatAmt;
