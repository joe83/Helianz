...
namespace Helianz {
	public partial class FormEtrans835ClaimPay {
		...
		private void InitializeComponent()
		{
			...
			this.gridClaimAdjustments = new Helianz.UI.GridOD();
			this.gridProcedureBreakdown = new Helianz.UI.GridOD();
			this.gridPayments = new Helianz.UI.GridOD();
			...
			this.butViewEobDetails = new Helianz.UI.Button();
			this.butWriteOff = new Helianz.UI.Button();
			this.butDeductible = new Helianz.UI.Button();
			this.textWriteOff = new Helianz.ValidDouble();
			this.butSave = new Helianz.UI.Button();
			this.checkIncludeWOPercCoPay = new Helianz.UI.CheckBox();
			this.butSplitProcs = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// textInsPayAllowed
			// 
    ...
    "the insurance EOB.";
			...
			this.gridClaimAdjustments.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridClaimAdjustments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridClaimAdjustments_CellDoubleClick);
			// 
			...
			this.gridProcedureBreakdown.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProcedureBreakdown.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProcedureBreakdown_CellDoubleClick);
			// 
			// gridPayments
			// 
			...
			this.gridPayments.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridPayments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridMain_CellDoubleClick);
			this.gridPayments.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPayments_CellClick);
		...
		private Helianz.UI.Button butDeductible;
		private Helianz.UI.Button butWriteOff;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label4;
		private Helianz.UI.GridOD gridPayments;
		private Helianz.UI.GridOD gridClaimAdjustments;
		private Helianz.UI.GridOD gridProcedureBreakdown;
		...
		private Helianz.UI.CheckBox checkIncludeWOPercCoPay;
