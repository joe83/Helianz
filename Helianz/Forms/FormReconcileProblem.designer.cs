namespace Helianz{
	partial class FormReconcileProblem {
		...
		private void InitializeComponent() {
			...
			this.gridProbExisting = new Helianz.UI.GridOD();
			this.gridProbImport = new Helianz.UI.GridOD();
			...
			this.gridProbReconcile = new Helianz.UI.GridOD();
			...
			this.gridProbExisting.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProbImport.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProbReconcile.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
