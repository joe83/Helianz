...
namespace Helianz {
	public partial class FormPayPeriodManager {
		...
		private void InitializeComponent()
		{
			...
			this.checkExcludeWeekends = new Helianz.UI.CheckBox();
			this.comboDay = new Helianz.UI.ComboBox();
			this.textDaysAfterPayPeriod = new Helianz.ValidNum();
			this.label4 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.groupBoxSemiMonthly = new Helianz.UI.GroupBox();
			this.checkLast = new Helianz.UI.CheckBox();
			this.labelPeriod2Day = new System.Windows.Forms.Label();
			this.textDay2 = new Helianz.ValidNum();
			this.labelPeriod1Day = new System.Windows.Forms.Label();
			this.textDay1 = new Helianz.ValidNum();
			...
			this.textPayPeriods = new Helianz.ValidNum();
		...
		private Helianz.UI.ComboBox comboDay;
		private RadioButton radioPayBefore;
		private RadioButton radioPayAfter;
		private Helianz.UI.CheckBox checkExcludeWeekends;
		private Label label3;
		private RadioButton radioSemiMonthly;
		private Label label7;
		private Label label6;
		private Helianz.UI.GroupBox groupBoxSemiMonthly;
		...
		private Helianz.UI.CheckBox checkLast;
	}
}
