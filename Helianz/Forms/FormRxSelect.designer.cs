...
namespace Helianz {
	public partial class FormRxSelect {
		...
		private void InitializeComponent()
		{
			...
			this.butBlank = new Helianz.UI.Button();
			...
			this.checkControlledOnly = new Helianz.UI.CheckBox();
    ...
    "rescription.";
		...
		private Helianz.UI.Button butBlank;
		private Helianz.UI.GridOD gridMain;
		private Helianz.UI.GroupBox groupBox1;
		private Label label2;
		private Label label1;
		private Helianz.UI.CheckBox checkControlledOnly;
