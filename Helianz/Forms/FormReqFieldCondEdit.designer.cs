namespace Helianz{
	partial class FormReqFieldCondEdit {
		...
		private void InitializeComponent() {
			...
			this.listConditionType = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textConditionValue1 = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.listConditionValues = new Helianz.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.comboOperator2 = new Helianz.UI.ComboBox();
			this.textConditionValue2 = new System.Windows.Forms.TextBox();
			this.comboOperator1 = new Helianz.UI.ComboBox();
			...
			this.listConditionValues.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listConditionType;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.TextBox textConditionValue1;
		private System.Windows.Forms.Label label2;
		private UI.Button butDelete;
		private UI.Button butPickProv;
		private Helianz.UI.ListBox listConditionValues;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.ComboBox comboOperator2;
		private System.Windows.Forms.TextBox textConditionValue2;
		private Helianz.UI.ComboBox comboOperator1;
