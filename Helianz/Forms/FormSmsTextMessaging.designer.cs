namespace Helianz{
	partial class FormSmsTextMessaging {
		...
		private void InitializeComponent() {
			...
			this.checkRead = new Helianz.UI.CheckBox();
			this.checkSent = new Helianz.UI.CheckBox();
			...
			this.textReply = new Helianz.ODtextBox();
			this.smsThreadView = new Helianz.SmsThreadView();
			this.butPatCurrent = new Helianz.UI.Button();
			this.butPatAll = new Helianz.UI.Button();
			this.butPatFind = new Helianz.UI.Button();
			this.butRefresh = new Helianz.UI.Button();
			this.comboClinics = new Helianz.UI.ComboBoxClinicPicker();
			this.textMsgCount = new Helianz.ODtextBox();
			this.textCharCount = new Helianz.ODtextBox();
			...
			this.textReply.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
			...
			this.textMsgCount.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
			...
			this.textCharCount.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
		...
		private Helianz.UI.CheckBox checkSent;
		private Helianz.UI.CheckBox checkRead;
