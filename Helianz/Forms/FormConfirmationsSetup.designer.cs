namespace Helianz{
	partial class FormConfirmationSetup {
		...
		private void InitializeComponent() {
			...
			this.comboStatusTextMessagedConfirm = new Helianz.UI.ComboBox();
			this.label6 = new System.Windows.Forms.Label();
			this.comboStatusEmailedConfirm = new Helianz.UI.ComboBox();
    ...
    "ions and reminders.";
		...
		private Helianz.UI.ComboBox comboStatusTextMessagedConfirm;
		private System.Windows.Forms.Label label6;
		private Helianz.UI.ComboBox comboStatusEmailedConfirm;
