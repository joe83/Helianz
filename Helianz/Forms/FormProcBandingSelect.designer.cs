namespace Helianz{
	partial class FormProcBandingSelect {
		...
		private void InitializeComponent() {
			...
			this.gridTpBandingProcs = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.gridTpBandingProcs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.GridTpBandingProcs_CellDoubleClick);
			// 
