namespace Helianz {
	partial class FormAdjMulti {
		...
		private void InitializeComponent() {
            ...
            this.groupCreditLogic = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.GroupBox groupCreditLogic;
