namespace Helianz{
	partial class FormEClipboardImageCaptureDefEdit {
		...
		private void InitializeComponent() {
			...
			this.listOCRCaptureType = new Helianz.UI.ListBox();
			...
			this.checkSelfPortrait = new Helianz.UI.CheckBox();
			...
			this.listDefinition = new Helianz.UI.ListBox();
			this.butDefinitions = new Helianz.UI.Button();
