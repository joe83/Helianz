namespace Helianz{
	partial class FormSheetFieldStatic {
		...
		private void InitializeComponent() {
			...
			this.checkPmtOpt = new Helianz.UI.CheckBox();
			this.labelTextW = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.listFields = new Helianz.UI.ListBox();
			this.textFieldValue = new System.Windows.Forms.TextBox();
			this.comboGrowthBehavior = new Helianz.UI.ComboBox();
			...
			this.comboTextAlign = new Helianz.UI.ComboBox();
			this.label2 = new System.Windows.Forms.Label();
			this.checkFontIsBold = new Helianz.UI.CheckBox();
			this.label4 = new System.Windows.Forms.Label();
			this.comboFontName = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.checkIsLocked = new Helianz.UI.CheckBox();
			this.butExamSheet = new Helianz.UI.Button();
			...
			this.checkIncludeInMobile = new Helianz.UI.CheckBox();
			this.butCalcWidth = new Helianz.UI.Button();
			this.butCalcHeight = new Helianz.UI.Button();
		...
		private Helianz.UI.ComboBox comboFontName;
		private Helianz.UI.CheckBox checkFontIsBold;
		...
		private Helianz.UI.ListBox listFields;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label labelTextW;
		private UI.Button butExamSheet;
		private Helianz.UI.ComboBox comboTextAlign;
		private System.Windows.Forms.Label label2;
		private Helianz.UI.CheckBox checkPmtOpt;
		private System.Windows.Forms.Label label10;
		private System.Windows.Forms.Button butColor;
		private Helianz.UI.CheckBox checkIsLocked;
		private System.Windows.Forms.Label labelTextH;
		private Helianz.UI.CheckBox checkIncludeInMobile;
