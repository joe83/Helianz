namespace Helianz {
	partial class FormBugSubmissionHashVitals {
		...
		private void InitializeComponent() {
			...
			this.gridHashes = new Helianz.UI.GridOD();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.comboGrouping = new Helianz.UI.ComboBox();
			this.label13 = new System.Windows.Forms.Label();
			this.textBugIds = new Helianz.ODtextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.butRefreshSearch = new Helianz.UI.Button();
			this.datePicker = new Helianz.UI.ODDateRangePicker();
			this.textFullHash = new Helianz.ODtextBox();
			this.textPartHash = new Helianz.ODtextBox();
			this.textHashNum = new Helianz.ODtextBox();
			...
			this.butCheckHash = new Helianz.UI.Button();
			this.chartVitals = new System.Windows.Forms.DataVisualization.Charting.Chart();
			this.gridHashData = new Helianz.UI.GridOD();
			...
			this.gridHashes.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridHashes_CellClick);
			// 
			// groupBox1
			// 
			...
			this.textBugIds.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
			...
			this.textFullHash.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
			...
			this.textPartHash.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
			...
			this.textHashNum.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
			...
			this.gridHashData.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridHashData_CellClick);
			// 
