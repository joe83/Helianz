...
namespace Helianz {
	public partial class FormEmailTemplateEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butBodyFields = new Helianz.UI.Button();
			this.textSubject = new Helianz.ODtextBox();
			this.textDescription = new Helianz.ODtextBox();
			this.butSubjectFields = new Helianz.UI.Button();
			...
			this.textDescription.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
		...
		private Helianz.ODtextBox textBodyText;
