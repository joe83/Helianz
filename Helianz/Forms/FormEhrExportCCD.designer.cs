namespace Helianz{
	partial class FormEhrExportCCD {
		...
		private void InitializeComponent() {
			...
			this.checkEncounter = new Helianz.UI.CheckBox();
			this.checkFunctionalStatus = new Helianz.UI.CheckBox();
			this.checkImmunization = new Helianz.UI.CheckBox();
			this.checkMedication = new Helianz.UI.CheckBox();
			this.checkAllergy = new Helianz.UI.CheckBox();
			this.checkPlanOfCare = new Helianz.UI.CheckBox();
			this.checkProblem = new Helianz.UI.CheckBox();
			this.checkProcedure = new Helianz.UI.CheckBox();
			this.checkResult = new Helianz.UI.CheckBox();
			this.checkSocialHistory = new Helianz.UI.CheckBox();
			this.checkVitalSign = new Helianz.UI.CheckBox();
			this.labelSections = new System.Windows.Forms.Label();
			this.textInstructions = new System.Windows.Forms.TextBox();
			this.labelInstructions = new System.Windows.Forms.Label();
			this.checkReferral = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butCheckNone = new Helianz.UI.Button();
		...
		private Helianz.UI.CheckBox checkEncounter;
		private Helianz.UI.CheckBox checkFunctionalStatus;
		private Helianz.UI.CheckBox checkImmunization;
		private Helianz.UI.CheckBox checkMedication;
		private Helianz.UI.CheckBox checkAllergy;
		private Helianz.UI.CheckBox checkPlanOfCare;
		private Helianz.UI.CheckBox checkProblem;
		private Helianz.UI.CheckBox checkProcedure;
		private Helianz.UI.CheckBox checkResult;
		private Helianz.UI.CheckBox checkSocialHistory;
		private Helianz.UI.CheckBox checkVitalSign;
		...
		private Helianz.UI.CheckBox checkReferral;
