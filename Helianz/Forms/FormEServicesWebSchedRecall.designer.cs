namespace Helianz{
	partial class FormEServicesWebSchedRecall {
		...
		private void InitializeComponent() {
			...
			this.groupWebSchedProvRule = new Helianz.UI.GroupBox();
			this.butProvRulePickClinic = new Helianz.UI.Button();
			this.checkUseDefaultProvRule = new Helianz.UI.CheckBox();
			this.comboClinicProvRule = new Helianz.UI.ComboBoxClinicPicker();
			this.listBoxWebSchedProviderPref = new Helianz.UI.ListBox();
			this.label21 = new System.Windows.Forms.Label();
			this.checkWSRDoubleBooking = new Helianz.UI.CheckBox();
			this.checkRecallAllowProvSelection = new Helianz.UI.CheckBox();
			this.comboWSRConfirmStatus = new Helianz.UI.ComboBox();
			this.labelRecallConfirmStatus = new System.Windows.Forms.Label();
			this.labelDaysFuture = new System.Windows.Forms.Label();
			this.textWebSchedRecallApptSearchDays = new Helianz.ValidNum();
			this.groupWebSchedText = new Helianz.UI.GroupBox();
			this.labelWebSchedPerBatch = new System.Windows.Forms.Label();
			this.textWebSchedPerBatch = new Helianz.ValidNum();
			...
			this.butWebSchedRecallRestrictedToBlockoutEdit = new Helianz.UI.Button();
			this.listboxWebSchedRecallIgnoreBlockoutTypes = new Helianz.UI.ListBox();
			this.labelRestrictedToBlockouts = new System.Windows.Forms.Label();
			this.butWebSchedRecallBlockouts = new Helianz.UI.Button();
			this.listboxRestrictedToBlockouts = new Helianz.UI.ListBox();
			this.groupBoxWebSchedAutomation = new Helianz.UI.GroupBox();
			...
			this.groupWebSchedPreview = new Helianz.UI.GroupBox();
			this.butRefresh = new Helianz.UI.Button();
			this.butWebSchedPickClinic = new Helianz.UI.Button();
			this.butWebSchedPickProv = new Helianz.UI.Button();
			this.label22 = new System.Windows.Forms.Label();
			this.comboWebSchedProviders = new Helianz.UI.ComboBox();
			this.butWebSchedToday = new Helianz.UI.Button();
			this.gridWebSchedTimeSlots = new Helianz.UI.GridOD();
			this.textWebSchedDateStart = new Helianz.ValidDate();
			this.labelWebSchedClinic = new System.Windows.Forms.Label();
			this.labelWebSchedRecallTypes = new System.Windows.Forms.Label();
			this.comboWebSchedClinic = new Helianz.UI.ComboBox();
			this.comboWebSchedRecallTypes = new Helianz.UI.ComboBox();
			this.gridWebSchedOperatories = new Helianz.UI.GridOD();
			this.butRecallSchedSetup = new Helianz.UI.Button();
			this.gridWebSchedRecallTypes = new Helianz.UI.GridOD();
			this.labelRecallSetup = new System.Windows.Forms.Label();
			this.butWebSchedRecallNotify = new Helianz.UI.Button();
			this.butEditOperatories = new Helianz.UI.Button();
			this.butEditRecallTypes = new Helianz.UI.Button();
			this.groupCustomizedMessages = new Helianz.UI.GroupBox();
			this.labelNotificationSettings = new System.Windows.Forms.Label();
			this.groupOtherSettings = new Helianz.UI.GroupBox();
			this.textNumMonthsCheck = new Helianz.ValidNum();
        ...
        "Last Seen Hygienist"};
			...
			this.listboxWebSchedRecallIgnoreBlockoutTypes.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listboxRestrictedToBlockouts.SelectionMode = Helianz.UI.SelectionMode.None;
    ...
    "d.";
			...
			this.gridWebSchedTimeSlots.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridWebSchedOperatories.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridWebSchedRecallTypes.SelectionMode = Helianz.UI.GridSelectionMode.None;
		...
		private Helianz.UI.GroupBox groupWebSchedProvRule;
		private UI.Button butProvRulePickClinic;
		private Helianz.UI.CheckBox checkUseDefaultProvRule;
		private UI.ComboBoxClinicPicker comboClinicProvRule;
		private Helianz.UI.ListBox listBoxWebSchedProviderPref;
		private System.Windows.Forms.Label label21;
		private Helianz.UI.CheckBox checkWSRDoubleBooking;
		...
		private Helianz.UI.CheckBox checkRecallAllowProvSelection;
		private Helianz.UI.GroupBox groupWebSchedText;
		...
		private Helianz.UI.ListBox listboxWebSchedRecallIgnoreBlockoutTypes;
		private UI.Button butWebSchedRecallBlockouts;
		private Helianz.UI.GroupBox groupBoxWebSchedAutomation;
		...
		private Helianz.UI.GroupBox groupWebSchedPreview;
		private UI.Button butWebSchedPickClinic;
		private UI.Button butWebSchedPickProv;
		private System.Windows.Forms.Label label22;
		private Helianz.UI.ComboBox comboWebSchedProviders;
		...
		private Helianz.UI.ComboBox comboWebSchedClinic;
		private Helianz.UI.ComboBox comboWebSchedRecallTypes;
