namespace Helianz{
	partial class FormScheduledProcessesEdit {
		...
		private void InitializeComponent() {
			...
			this.butDeleteSchedProc = new Helianz.UI.Button();
			this.textTimeToRun = new Helianz.ValidTime();
			...
			this.comboScheduledAction = new Helianz.UI.ComboBox();
			...
			this.butDeleteSchedProc.Icon = Helianz.UI.EnumIcons.DeleteX;
