namespace Helianz{
	partial class FormGraphEmployeeTime {
		...
		private void InitializeComponent() {
			...
			this.buttonLeft = new Helianz.UI.Button();
			this.buttonRight = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.butPrefs = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.toolTip = new System.Windows.Forms.ToolTip(this.components);
			this.label7 = new System.Windows.Forms.Label();
			this.textFilterName = new System.Windows.Forms.TextBox();
			this.butEditDefaults = new Helianz.UI.Button();
			this.checkGraphed = new Helianz.UI.CheckBox();
			this.checkScheduled = new Helianz.UI.CheckBox();
			this.label4 = new System.Windows.Forms.Label();
			this.textTime = new System.Windows.Forms.TextBox();
			this.radioAM = new System.Windows.Forms.RadioButton();
			this.radioPM = new System.Windows.Forms.RadioButton();
			this.listOrder = new Helianz.UI.ListBox();
			this.label5 = new System.Windows.Forms.Label();
			this.butRefresh = new Helianz.UI.Button();
			this.checkOffAtTop = new Helianz.UI.CheckBox();
			...
			this.butEditDaily = new Helianz.UI.Button();
			this.textNote = new System.Windows.Forms.TextBox();
			this.butToday = new Helianz.UI.Button();
			this.label11 = new System.Windows.Forms.Label();
			this.comboSupervisor = new Helianz.UI.ComboBox();
			this.butShifts = new Helianz.UI.Button();
			this.monthCalendarOD = new Helianz.UI.MonthCalendarOD();
			this.butPrintList = new Helianz.UI.Button();
			...
			// buttonLeft
			// 
			this.buttonLeft.Image = global::Helianz.Properties.Resources.Left;
			...
			// buttonRight
			// 
			this.buttonRight.Image = global::Helianz.Properties.Resources.Right;
    ...
    "ermissions can increase the limit.";
			...
			this.butPrintList.Image = global::Helianz.Properties.Resources.butPrint;
		...
		private Helianz.UI.Button buttonRight;
		private Helianz.UI.Button buttonLeft;
		...
		private Helianz.UI.CheckBox checkGraphed;
		private Helianz.UI.CheckBox checkScheduled;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.TextBox textTime;
		private System.Windows.Forms.RadioButton radioAM;
		private System.Windows.Forms.RadioButton radioPM;
		private Helianz.UI.ListBox listOrder;
		private System.Windows.Forms.Label label5;
		private UI.Button butRefresh;
		private Helianz.UI.CheckBox checkOffAtTop;
