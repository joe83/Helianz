namespace Helianz{
	partial class FormAllergyDefEdit {
		...
		private void InitializeComponent() {
			...
			this.comboSnomedAllergyType = new Helianz.UI.ComboBox();
			...
			this.butNoneUnii = new Helianz.UI.Button();
			this.butNone = new Helianz.UI.Button();
			this.butUniiSelect = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.butMedicationSelect = new Helianz.UI.Button();
		...
		private Helianz.UI.ComboBox comboSnomedAllergyType;
