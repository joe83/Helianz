...
namespace Helianz {
	public partial class FormPrntScrn {
		...
		private void InitializeComponent(){
			...
			this.butZoomIn = new Helianz.UI.Button();
			this.butZoomOut = new Helianz.UI.Button();
			...
			this.butZoomIn.Image = global::Helianz.Properties.Resources.butZoomIn;
			...
			this.butZoomOut.Image = global::Helianz.Properties.Resources.butZoomOut;
		...
		private Helianz.UI.Button butZoomIn;
		private Helianz.UI.Button butZoomOut;
