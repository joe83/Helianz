namespace Helianz{
	partial class FormProcBroken {
		...
		private void InitializeComponent() {
			...
			this.butAutoNoteChart = new Helianz.UI.Button();
			this.butAutoNoteAccount = new Helianz.UI.Button();
			this.textChartNotes = new Helianz.ODtextBox();
			this.textDateEntry = new Helianz.ValidDate();
			this.textProcDate = new Helianz.ValidDate();
			this.textAccountNotes = new Helianz.ODtextBox();
			...
			this.textChartNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
			...
			this.textAccountNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Adjustment;
