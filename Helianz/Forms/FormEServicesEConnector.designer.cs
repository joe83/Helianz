namespace Helianz{
	partial class FormEServicesEConnector {
		...
		private void InitializeComponent() {
			...
			this.checkEnableEServicesListener = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.textLogCleanupInterval = new Helianz.ValidNum();
			this.labelIntervalDays = new System.Windows.Forms.Label();
			this.checkEmailsWithDiffProcess = new Helianz.UI.CheckBox();
			this.labelInstallWarning = new System.Windows.Forms.Label();
			this.butInstallEConnector = new Helianz.UI.Button();
			this.labelListenerServiceAck = new System.Windows.Forms.Label();
			this.butListenerServiceAck = new Helianz.UI.Button();
			this.label27 = new System.Windows.Forms.Label();
			this.butListenerServiceHistoryRefresh = new Helianz.UI.Button();
			this.label26 = new System.Windows.Forms.Label();
			this.gridListenerServiceStatusHistory = new Helianz.UI.GridOD();
			this.butStartListenerService = new Helianz.UI.Button();
			this.label24 = new System.Windows.Forms.Label();
			this.labelListenerStatus = new System.Windows.Forms.Label();
			this.butListenerAlertsOff = new Helianz.UI.Button();
    ...
    "h.";
			...
			this.label27.Text = "Helianz monitors the status of the eConnector Service and alerts all workstat" +
    ...
    "ill automatically resume when an active eConnector Service has been detected.";
		...
		private Helianz.UI.CheckBox checkEmailsWithDiffProcess;
