namespace Helianz{
	partial class FormHL7DefSegmentEdit {
		...
		private void InitializeComponent() {
			...
			this.checkCanRepeat = new Helianz.UI.CheckBox();
			this.checkIsOptional = new Helianz.UI.CheckBox();
			this.comboSegmentName = new Helianz.UI.ComboBox();
			...
			this.textItemOrder = new Helianz.ValidNum();
			this.SuspendLayout();
			// 
			// butSave
			// 
    ...
    " list.";
		...
		private Helianz.UI.CheckBox checkCanRepeat;
		private Helianz.UI.CheckBox checkIsOptional;
		private Helianz.UI.ComboBox comboSegmentName;
