namespace Helianz{
	partial class FormEServicesPaymentPortal {
		...
		private void InitializeComponent() {
			...
			this.groupBoxPaymentPortal = new Helianz.UI.GroupBox();
			...
			this.comboClinicPicker = new Helianz.UI.ComboBoxClinicPicker();
			this.butSave = new Helianz.UI.Button();
			this.groupBoxMessageToPay = new Helianz.UI.GroupBox();
			this.groupBoxUserControlFill = new Helianz.UI.GroupBox();
