...
namespace Helianz {
	partial class FormReactivationSetup {
		...
		private void InitializeComponent() {
			...
			this.comboStatusMailedReactivation = new Helianz.UI.ComboBox();
			this.label26 = new System.Windows.Forms.Label();
			this.textMaxReminders = new Helianz.ValidNum();
			this.label4 = new System.Windows.Forms.Label();
			this.comboStatusEmailedReactivation = new Helianz.UI.ComboBox();
			this.butSave = new Helianz.UI.Button();
			this.labelContactInterval = new System.Windows.Forms.Label();
			this.textDaysContactInterval = new Helianz.ValidNum();
