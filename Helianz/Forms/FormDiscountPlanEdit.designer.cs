namespace Helianz{
	partial class FormDiscountPlanEdit {
		...
		private void InitializeComponent() {
			...
			this.butFeeSched = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.comboBoxAdjType = new Helianz.UI.ComboBox();
			this.checkHidden = new Helianz.UI.CheckBox();
			this.butListPatients = new Helianz.UI.Button();
			this.textNumPatients = new System.Windows.Forms.TextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.comboPatient = new Helianz.UI.ComboBox();
			...
			this.textDiscountPAFreq = new Helianz.ValidNum();
			this.textDiscountXrayFreq = new Helianz.ValidNum();
			this.textDiscountLimitedFreq = new Helianz.ValidNum();
			this.textDiscountPerioFreq = new Helianz.ValidNum();
			this.textDiscountFluorideFreq = new Helianz.ValidNum();
			this.textDiscountProphyFreq = new Helianz.ValidNum();
			this.textDiscountExamFreq = new Helianz.ValidNum();
		...
		private Helianz.UI.ComboBox comboBoxAdjType;
		...
		private Helianz.UI.ComboBox comboPatient;
		private Helianz.ODtextBox textPlanNote;
