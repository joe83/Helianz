...
namespace Helianz {
	public partial class FormDepositEdit {
		...
		private void InitializeComponent()
		{
			...
			this.groupSelect = new Helianz.UI.GroupBox();
			this.comboClassRefs = new Helianz.UI.ComboBox();
			this.labelClassRef = new System.Windows.Forms.Label();
			this.listInsPayType = new Helianz.UI.ListBox();
			...
			this.butSendQB = new Helianz.UI.Button();
			...
			this.butEmailPDF = new Helianz.UI.Button();
			this.labelDepositAccountNum = new System.Windows.Forms.Label();
			this.comboDepositAccountNum = new Helianz.UI.ComboBox();
			...
			this.listInsPayType.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listPayType.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridIns.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridIns.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridIns_CellClick);
			...
			this.gridPat.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.GroupBox groupSelect;
		private Helianz.UI.Button butPrint;
		private Helianz.UI.GridOD gridPat;
		private Helianz.UI.GridOD gridIns;
		private Helianz.ValidDate textDateStart;
		...
		private Helianz.UI.ListBox listInsPayType;
		...
		private Helianz.UI.ComboBox comboClassRefs;
