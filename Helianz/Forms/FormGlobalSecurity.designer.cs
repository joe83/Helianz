namespace Helianz{
	partial class FormGlobalSecurity {
		...
		private void InitializeComponent() {
			...
			this.checkDomainLoginEnabled = new Helianz.UI.CheckBox();
			this.checkPasswordForceWeakToStrong = new Helianz.UI.CheckBox();
			this.checkPasswordsStrongIncludeSpecial = new Helianz.UI.CheckBox();
			this.checkDisableBackupReminder = new Helianz.UI.CheckBox();
			...
			this.checkLogOffWindows = new Helianz.UI.CheckBox();
			...
			this.checkCannotEditOwn = new Helianz.UI.CheckBox();
			this.checkTimecardSecurityEnabled = new Helianz.UI.CheckBox();
			...
			this.checkAllowLogoffOverride = new Helianz.UI.CheckBox();
			this.checkCannotEditPastPayPeriods = new Helianz.UI.CheckBox();
			this.checkMaintainPatient = new Helianz.UI.CheckBox();
			this.checkBadgeLogIn = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkDomainLoginEnabled;
		private Helianz.UI.CheckBox checkPasswordForceWeakToStrong;
		private Helianz.UI.CheckBox checkPasswordsStrongIncludeSpecial;
		private Helianz.UI.CheckBox checkDisableBackupReminder;
		private System.Windows.Forms.Label labelGlobalDateLockDisabled;
		private Helianz.UI.CheckBox checkUserNameManualEntry;
		private System.Windows.Forms.TextBox textLogOffAfterMinutes;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.CheckBox checkLogOffWindows;
		private System.Windows.Forms.TextBox textDaysLock;
		private System.Windows.Forms.Label label2;
		private Helianz.UI.CheckBox checkPasswordsMustBeStrong;
		private UI.Button butChange;
		private System.Windows.Forms.TextBox textDateLock;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.CheckBox checkCannotEditOwn;
		private Helianz.UI.CheckBox checkTimecardSecurityEnabled;
		...
		private Helianz.UI.CheckBox checkAllowLogoffOverride;
		private Helianz.UI.CheckBox checkCannotEditPastPayPeriods;
		private Helianz.UI.CheckBox checkMaintainPatient;
