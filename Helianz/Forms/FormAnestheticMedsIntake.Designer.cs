namespace Helianz
{
	partial class FormAnestheticMedsIntake
	{
		...
		private void InitializeComponent()
		{
			...
			this.butAddSupplier = new Helianz.UI.Button();
			...
			this.butAddSupplier.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butAddSupplier.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butAddSupplier.CornerRadius = 4F;
			this.butAddSupplier.Image = global::Helianz.Properties.Resources.Add;
        ...
        private Helianz.UI.Button butAddSupplier;
	}
}