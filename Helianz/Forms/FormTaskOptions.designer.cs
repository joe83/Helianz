namespace Helianz{
	partial class FormTaskOptions {
		...
		private void InitializeComponent() {
			...
			this.checkShowFinished = new Helianz.UI.CheckBox();
			this.textStartDate = new Helianz.ValidDate();
			this.labelStartDate = new System.Windows.Forms.Label();
			this.checkTaskSortApptDateTime = new Helianz.UI.CheckBox();
			this.checkCollapsed = new Helianz.UI.CheckBox();
			this.checkShowArchivedTaskLists = new Helianz.UI.CheckBox();
			this.checkBlockedTaskPlaySound = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// butSave
			// 
		...
		private Helianz.UI.CheckBox checkShowFinished;
		private ValidDate textStartDate;
		private System.Windows.Forms.Label labelStartDate;
		private Helianz.UI.CheckBox checkTaskSortApptDateTime;
		private Helianz.UI.CheckBox checkCollapsed;
		private Helianz.UI.CheckBox checkShowArchivedTaskLists;
		private Helianz.UI.CheckBox checkBlockedTaskPlaySound;
	}
}