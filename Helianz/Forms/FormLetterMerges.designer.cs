...
namespace Helianz {
	public partial class FormLetterMerges {
		...
		private void InitializeComponent()
		{
			...
			this.butMerge = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.listLetters = new Helianz.UI.ListBox();
			this.butEditCats = new Helianz.UI.Button();
			this.butCreateData = new Helianz.UI.Button();
			this.butEditTemplate = new Helianz.UI.Button();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.comboImageCategory = new Helianz.UI.ComboBox();
			this.labelImageCategory = new System.Windows.Forms.Label();
			this.butViewData = new Helianz.UI.Button();
		...
		private Helianz.UI.ListBox listCategories;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.ListBox listLetters;
		private Helianz.UI.Button butEditCats;
		private Helianz.UI.Button butMerge;
		private Helianz.UI.Button butCreateData;
		private Helianz.UI.Button butEditTemplate;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.Button butViewData;
