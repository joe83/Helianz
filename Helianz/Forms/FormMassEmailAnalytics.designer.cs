namespace Helianz{
	partial class FormMassEmailAnalytics {
		...
		private void InitializeComponent() {
			...
			this.comboClinicAnalytics = new Helianz.UI.ComboBoxClinicPicker();
			this.butRefreshAnalytics = new Helianz.UI.Button();
			this.gridAnalytics = new Helianz.UI.GridOD();
			this.dateRangeAnalytics = new Helianz.UI.ODDateRangePicker();
