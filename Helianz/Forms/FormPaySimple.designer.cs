namespace Helianz{
	partial class FormPaySimple {
		...
		private void InitializeComponent() {
			...
			this.tabCredit = new Helianz.UI.TabPage();
			this.checkPrintReceipt = new Helianz.UI.CheckBox();
			this.tabACH = new Helianz.UI.TabPage();
			this.checkPrintReceiptACH = new Helianz.UI.CheckBox();
			this.labelAmountACH = new System.Windows.Forms.Label();
			this.textAmountACH = new System.Windows.Forms.TextBox();
			this.checkOneTimePaymentACH = new Helianz.UI.CheckBox();
			this.groupBankAccountType = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.TabPage tabCredit;
		private Helianz.UI.TabPage tabACH;
		private Helianz.UI.CheckBox checkOneTimePaymentACH;
		private Helianz.UI.GroupBox groupBankAccountType;
		...
		private Helianz.UI.CheckBox checkPrintReceiptACH;
	}
}