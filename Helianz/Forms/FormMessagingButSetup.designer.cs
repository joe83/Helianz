...
namespace Helianz {
	public partial class FormMessagingButSetup {
		...
		private void InitializeComponent()
		{
			...
			this.listButtons = new Helianz.UI.ListBox();
			this.listComputers = new Helianz.UI.ListBox();
			this.label2 = new System.Windows.Forms.Label();
			this.butDown = new Helianz.UI.Button();
			this.butUp = new Helianz.UI.Button();
			this.butSynchAll = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
		...
		private Helianz.UI.ListBox listButtons;
		private Helianz.UI.ListBox listComputers;
