...
namespace Helianz {
	public partial class FormSigButDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.textSynchIcon = new Helianz.ValidNum();
			...
			this.comboTo = new Helianz.UI.ComboBox();
			this.label4 = new System.Windows.Forms.Label();
			this.label10 = new System.Windows.Forms.Label();
			this.comboExtras = new Helianz.UI.ComboBox();
			this.label11 = new System.Windows.Forms.Label();
			this.comboMessage = new Helianz.UI.ComboBox();
			this.SuspendLayout();
			// 
			// label2
			// 
    ...
    " button lights up.  0 for none.";
		...
		private Helianz.UI.ComboBox comboTo;
		private Label label4;
		private Label label10;
		private Helianz.UI.ComboBox comboExtras;
		private Label label11;
		private Helianz.UI.ComboBox comboMessage;
	}
}
