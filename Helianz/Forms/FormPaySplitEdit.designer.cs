namespace Helianz {
	partial class FormPaySplitEdit {
		...
		private void InitializeComponent(){
			...
			this.listPatient = new Helianz.UI.ListBox();
			this.labelAmount = new System.Windows.Forms.Label();
			this.checkPayPlan = new Helianz.UI.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textPatient = new System.Windows.Forms.TextBox();
			this.checkPatOtherFam = new Helianz.UI.CheckBox();
			this.groupPatient = new Helianz.UI.GroupBox();
			this.label15 = new System.Windows.Forms.Label();
			this.label17 = new System.Windows.Forms.Label();
			this.textDateEntry = new Helianz.ValidDate();
			this.textDatePay = new Helianz.ValidDate();
			this.butDelete = new Helianz.UI.Button();
			this.textAmount = new Helianz.ValidDouble();
			this.butRemainder = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.comboUnearnedTypes = new Helianz.UI.ComboBox();
			...
			this.tabProcedure = new Helianz.UI.TabPage();
			...
			this.tabAdjustment = new Helianz.UI.TabPage();
			...
			this.butDetachAdjust = new Helianz.UI.Button();
			this.butAttachAdjust = new Helianz.UI.Button();
    ...
    ".";
		...
		private Helianz.UI.Button butRemainder;
		...
		private Helianz.UI.CheckBox checkPatOtherFam;
		private UI.ComboBox comboUnearnedTypes;
		private UI.ComboBox comboProvider;
		private UI.ComboBoxClinicPicker comboClinic;
		private Helianz.UI.GroupBox groupPatient;
		...
		private Helianz.UI.ListBox listPatient;
		private System.Windows.Forms.TextBox textPatient;
		private Helianz.ValidDate textDatePay;
		private Helianz.ValidDate textDateEntry;
		private Helianz.ValidDouble textAmount;
		private Helianz.UI.TabControl tabControl;
		private Helianz.UI.TabPage tabProcedure;
		private Helianz.UI.TabPage tabAdjustment;
