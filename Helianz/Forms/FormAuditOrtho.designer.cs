namespace Helianz{
	partial class FormAuditOrtho {
		...
		private void InitializeComponent() {
			...
			this.gridHist = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// gridMain
			// 
			...
			this.gridHist.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridHist.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridHist_CellClick);
			// 
			// FormAuditOrtho
			// 
