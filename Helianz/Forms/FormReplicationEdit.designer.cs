namespace Helianz{
	partial class FormReplicationEdit {
		...
		private void InitializeComponent() {
			...
			this.checkUpdateBlocked = new Helianz.UI.CheckBox();
			this.label7 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.butDelete = new Helianz.UI.Button();
			this.textServerId = new Helianz.ValidNum();
			this.butSave = new Helianz.UI.Button();
			this.label11 = new System.Windows.Forms.Label();
			this.checkTempTablesAllowedServer = new Helianz.UI.CheckBox();
			this.butThisComputerDesc = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
    ...
    "rogram in certain situations.";
		...
		private Helianz.UI.CheckBox checkUpdateBlocked;
		private System.Windows.Forms.Label label7;
		private System.Windows.Forms.Label label8;
		private System.Windows.Forms.Label label11;
		private Helianz.UI.CheckBox checkTempTablesAllowedServer;
