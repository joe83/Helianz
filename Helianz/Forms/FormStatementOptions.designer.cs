...
namespace Helianz {
	public partial class FormStatementOptions {
		...
		private void InitializeComponent()
		{
			...
			this.checkHidePayment = new Helianz.UI.CheckBox();
			...
			this.textNoteBold = new Helianz.ODtextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.listMode = new Helianz.UI.ListBox();
			...
			this.checkIsSent = new Helianz.UI.CheckBox();
			...
			this.checkIsReceipt = new Helianz.UI.CheckBox();
			this.groupInvoice = new Helianz.UI.GroupBox();
			this.textInvoiceNum = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.checkIsInvoiceCopy = new Helianz.UI.CheckBox();
			this.checkIsInvoice = new Helianz.UI.CheckBox();
			this.checkSuperStatement = new Helianz.UI.CheckBox();
			this.checkLimited = new Helianz.UI.CheckBox();
			this.butPatPortal = new Helianz.UI.Button();
			this.checkShowLName = new Helianz.UI.CheckBox();
			this.checkSendSms = new Helianz.UI.CheckBox();
			this.checkExcludeTxfr = new Helianz.UI.CheckBox();
			this.checkExportCSV = new Helianz.UI.CheckBox();
			...
			this.textNoteBold.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Statement;
			...
			// butPrint
			// 
			this.butPrint.Image = global::Helianz.Properties.Resources.butPrint;
			...
			// butPreview
			// 
			this.butPreview.Image = global::Helianz.Properties.Resources.printPreview20;
		...
		private Helianz.UI.CheckBox checkHidePayment;
		...
		private Helianz.UI.ListBox listMode;
		...
		private Helianz.UI.CheckBox checkIsSent;
		...
		private Helianz.UI.CheckBox checkIsReceipt;
		private Helianz.UI.GroupBox groupInvoice;
		private Helianz.UI.CheckBox checkIsInvoiceCopy;
		private Helianz.UI.CheckBox checkIsInvoice;
		private TextBox textInvoiceNum;
		private Label label5;
		private Helianz.UI.CheckBox checkSuperStatement;
		private Helianz.UI.CheckBox checkLimited;
		private UI.Button butPatPortal;
		private Helianz.UI.CheckBox checkBoxBillShowTransSinceZero;
		private Helianz.UI.CheckBox checkShowLName;
		private Helianz.UI.CheckBox checkSendSms;
		private Helianz.UI.CheckBox checkExcludeTxfr;
		private Helianz.UI.CheckBox checkExportCSV;
	}
}
