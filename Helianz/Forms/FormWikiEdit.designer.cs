namespace Helianz{
	partial class FormWikiEdit {
		...
		private void InitializeComponent() {
			...
			this.toolBar2.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.toolBar2_ButtonClick);
			// 
			// webBrowserWiki
			// 
		...
		private Helianz.ODcodeBox textContent;
	}
}