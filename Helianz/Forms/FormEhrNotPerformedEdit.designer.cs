namespace Helianz{
	partial class FormEhrNotPerformedEdit {
		...
		private void InitializeComponent() {
			...
			this.groupItem = new Helianz.UI.GroupBox();
			...
			this.groupReason = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.GroupBox groupItem;
		...
		private Helianz.UI.GroupBox groupReason;
