namespace Helianz{
	partial class FormSheetDefEdit {
			...
			if(disposing) {
				...
				if(SheetDef_!=null){
					for(int i=0;i<SheetDef_.SheetFieldDefs.Count;i++){
						if(SheetDef_.SheetFieldDefs[i].FieldType==HelianzBusiness.SheetFieldType.Image){
		...
		private void InitializeComponent() {
			...
			this.panelMain = new Helianz.UI.PanelOD();
			this.butAlignTop = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.groupBoxSubViews = new Helianz.UI.GroupBox();
			this.checkSynchMatchedFields = new Helianz.UI.CheckBox();
			this.comboLanguages = new Helianz.UI.ComboBox();
			this.butAutoSnap = new Helianz.UI.Button();
			this.butMobile = new Helianz.UI.Button();
			this.groupAlignH = new Helianz.UI.GroupBox();
			this.butAlignRight = new Helianz.UI.Button();
			this.butAlignCenterH = new Helianz.UI.Button();
			this.butAlignLeft = new Helianz.UI.Button();
			this.textDescription = new System.Windows.Forms.TextBox();
			this.groupPage = new Helianz.UI.GroupBox();
			this.butPageAdd = new Helianz.UI.Button();
			this.butPageRemove = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butTabOrder = new Helianz.UI.Button();
			this.labelInternal = new System.Windows.Forms.Label();
			this.linkLabelTips = new System.Windows.Forms.LinkLabel();
			this.listBoxFields = new Helianz.UI.ListBox();
			this.butPaste = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.butCopy = new Helianz.UI.Button();
			this.butEdit = new Helianz.UI.Button();
			this.panelLeft = new System.Windows.Forms.Panel();
			this.panelRight = new System.Windows.Forms.Panel();
			this.groupShowField = new Helianz.UI.GroupBox();
			this.checkShowMobileHeader = new Helianz.UI.CheckBox();
			this.checkShowScreenChart = new Helianz.UI.CheckBox();
			this.checkShowGrid = new Helianz.UI.CheckBox();
			this.checkShowSpecial = new Helianz.UI.CheckBox();
			this.checkShowSigBoxPractice = new Helianz.UI.CheckBox();
			this.checkShowSigBox = new Helianz.UI.CheckBox();
			this.checkShowRectangle = new Helianz.UI.CheckBox();
			this.checkShowLine = new Helianz.UI.CheckBox();
			this.checkShowPatImage = new Helianz.UI.CheckBox();
			this.checkShowImage = new Helianz.UI.CheckBox();
			this.checkShowComboBox = new Helianz.UI.CheckBox();
			this.butShowNone = new Helianz.UI.Button();
			this.butShowAll = new Helianz.UI.Button();
			this.checkShowCheckBox = new Helianz.UI.CheckBox();
			this.checkShowStaticText = new Helianz.UI.CheckBox();
			this.checkShowInputField = new Helianz.UI.CheckBox();
			this.checkShowOutputText = new Helianz.UI.CheckBox();
			this.checkBlue = new Helianz.UI.CheckBox();
			this.groupAddField = new Helianz.UI.GroupBox();
			this.labelMobileHeader = new System.Windows.Forms.Label();
			this.butScreenChart = new Helianz.UI.Button();
			this.butSpecial = new Helianz.UI.Button();
			this.butGrid = new Helianz.UI.Button();
			this.butSigBox = new Helianz.UI.Button();
			this.butSigBoxPractice = new Helianz.UI.Button();
			this.butLine = new Helianz.UI.Button();
			this.butRectangle = new Helianz.UI.Button();
			this.butPatImage = new Helianz.UI.Button();
			this.butImage = new Helianz.UI.Button();
			this.butComboBox = new Helianz.UI.Button();
			this.butCheckBox = new Helianz.UI.Button();
			this.butStaticText = new Helianz.UI.Button();
			this.butInputField = new Helianz.UI.Button();
			this.butOutputText = new Helianz.UI.Button();
			this.butRedo = new Helianz.UI.Button();
			...
			this.listBoxFields.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listBoxFields;
		...
		private Helianz.UI.GroupBox groupPage;
		private Helianz.UI.GroupBox groupAlignH;
		...
		private Helianz.UI.GroupBox groupBoxSubViews;
		private Helianz.UI.ComboBox comboLanguages;
		private Helianz.UI.CheckBox checkSynchMatchedFields;
		...
		private Helianz.UI.CheckBox checkBlue;
		private UI.GroupBox groupShowField;
		private Helianz.UI.CheckBox checkShowScreenChart;
		private Helianz.UI.CheckBox checkShowGrid;
		private Helianz.UI.CheckBox checkShowSpecial;
		private Helianz.UI.CheckBox checkShowSigBoxPractice;
		private Helianz.UI.CheckBox checkShowSigBox;
		private Helianz.UI.CheckBox checkShowRectangle;
		private Helianz.UI.CheckBox checkShowLine;
		private Helianz.UI.CheckBox checkShowPatImage;
		private Helianz.UI.CheckBox checkShowImage;
		private Helianz.UI.CheckBox checkShowComboBox;
		private UI.Button butShowNone;
		private UI.Button butShowAll;
		private Helianz.UI.CheckBox checkShowCheckBox;
		private Helianz.UI.CheckBox checkShowStaticText;
		private Helianz.UI.CheckBox checkShowInputField;
		private Helianz.UI.CheckBox checkShowOutputText;
		private Helianz.UI.CheckBox checkShowMobileHeader;
