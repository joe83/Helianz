...
namespace Helianz {
	public partial class FormClaimPayEdit {
		...
		private void InitializeComponent(){
			...
			this.butCarrierSelect = new Helianz.UI.Button();
			this.label8 = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.label10 = new System.Windows.Forms.Label();
			this.comboPayType = new Helianz.UI.ComboBox();
			this.label11 = new System.Windows.Forms.Label();
			this.butPickPaymentGroup = new Helianz.UI.Button();
			this.comboPayGroup = new Helianz.UI.ComboBox();
			this.labelClaimPaymentGroup = new System.Windows.Forms.Label();
			this.panelXcharge = new System.Windows.Forms.Panel();
			this.groupPrepaid = new Helianz.UI.GroupBox();
			this.butPaySimple = new System.Windows.Forms.Panel();
			this.groupBoxDeposit = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.ComboBox comboPayType;
		private Label label11;
		private Label label1;
		private UI.Button butPickPaymentGroup;
		private Helianz.UI.ComboBox comboPayGroup;
		private Label labelClaimPaymentGroup;
		private Panel panelXcharge;
		private Helianz.UI.GroupBox groupPrepaid;
		private Helianz.UI.GroupBox groupBoxDeposit;
