...
namespace Helianz {
	public partial class FormUpdateSetup {
		...
		private void InitializeComponent()
		{
			...
			this.checkShowMsi = new Helianz.UI.CheckBox();
			this.label10 = new System.Windows.Forms.Label();
			this.labelRecopy = new System.Windows.Forms.Label();
			this.butRecopy = new Helianz.UI.Button();
			this.butChangeRegKey = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.butChangeTime = new Helianz.UI.Button();
    ...
    " folder and puts a zipped copy into the database.\r\n";
		...
		private Helianz.UI.Button butChangeRegKey;
		private Helianz.UI.CheckBox checkShowMsi;
		private Label label10;
		private Label labelRecopy;
		private Helianz.UI.Button butRecopy;
