...
namespace Helianz {
	public partial class FormPayPlan {
		...
		private void InitializeComponent() {
			...
			this.butAddTxCredits = new Helianz.UI.Button();
			this.textDue = new System.Windows.Forms.TextBox();
			this.textBalance = new Helianz.ValidDouble();
			this.textInterest = new System.Windows.Forms.TextBox();
			this.textPayment = new Helianz.ValidDouble();
			this.textPrincipal = new Helianz.ValidDouble();
			this.labelTotals = new System.Windows.Forms.Label();
			this.groupProvClin = new Helianz.UI.GroupBox();
			...
			this.butChangePlan = new Helianz.UI.Button();
			...
			this.butRecalculate = new Helianz.UI.Button();
			this.labelInterestDelay1 = new System.Windows.Forms.Label();
			this.butMoreOptions = new Helianz.UI.Button();
			...
			this.butAdj = new Helianz.UI.Button();
			this.textAdjustment = new Helianz.ValidDouble();
			...
			this.butAdj.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.GroupBox groupProvClin;
