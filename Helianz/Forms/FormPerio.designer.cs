...
namespace Helianz {
	public partial class FormPerio {
		...
		private void InitializeComponent()
		{
			...
			this.checkThree = new Helianz.UI.CheckBox();
			this.checkGingMarg = new Helianz.UI.CheckBox();
			this.butCalcIndex = new Helianz.UI.Button();
			this.butCalculus = new Helianz.UI.Button();
			this.butPlaque = new Helianz.UI.Button();
			this.butSkip = new Helianz.UI.Button();
			this.butCount = new Helianz.UI.Button();
			this.butPus = new Helianz.UI.Button();
			this.butBleed = new Helianz.UI.Button();
			this.but10 = new Helianz.UI.Button();
			this.checkShowCurrent = new Helianz.UI.CheckBox();
			...
			this.listPlaqueHistory = new Helianz.UI.ListBox();
			this.textInputBox = new System.Windows.Forms.TextBox();
			this.butCopyPrevious = new Helianz.UI.Button();
			this.contrPerio = new Helianz.ContrPerio();
			this.butSaveImage = new Helianz.UI.Button();
			this.butGraphical = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.butAdd = new Helianz.UI.Button();
			this.but0 = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.but8 = new Helianz.UI.Button();
			this.but4 = new Helianz.UI.Button();
			this.but5 = new Helianz.UI.Button();
			this.but9 = new Helianz.UI.Button();
			this.but6 = new Helianz.UI.Button();
			this.but1 = new Helianz.UI.Button();
			this.but2 = new Helianz.UI.Button();
			this.but3 = new Helianz.UI.Button();
			this.but7 = new Helianz.UI.Button();
			this.butListen = new Helianz.UI.Button();
			this.labelListening = new System.Windows.Forms.Label();
			this.labelNotes = new System.Windows.Forms.Label();
			this.butCopyNote = new Helianz.UI.Button();
			this.labelIsMobileActive = new System.Windows.Forms.Label();
			this.butUnlockEClip = new Helianz.UI.Button();
			this.timerEClipCheck = new System.Windows.Forms.Timer(this.components);
			this.butDefault = new Helianz.UI.Button();
			...
			this.textExamNotes = new Helianz.ODtextBox();
			this.gridODExam = new Helianz.UI.GridOD();
        ...
        "  Used to input positive gingival margins (hyperplasia).");
			...
			this.listPlaqueHistory.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			// butCopyPrevious
			// 
			this.butCopyPrevious.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butListen
			// 
			this.butListen.Image = global::Helianz.Properties.Resources.Microphone_22px;
			...
			// butCopyNote
			// 
			this.butCopyNote.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.labelIsMobileActive.Image = global::Helianz.Properties.Resources.record;
			...
			// butDefault
			// 
			this.butDefault.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.textExamNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
			...
			this.gridODExam.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridODExam_CellDoubleClick);
			this.gridODExam.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridODExam_CellClick);
			// 
			// butBolaLaunch
			// 
			this.butBolaLaunch.BackgroundImage = global::Helianz.Properties.Resources.bola_launch;
			...
			// butBolaGet
			// 
			this.butBolaGet.BackgroundImage = global::Helianz.Properties.Resources.bola_get;
		...
		#region Controls
		private Helianz.UI.Button but7;
		...
		private Helianz.UI.Button but3;
		private Helianz.UI.Button but2;
		private Helianz.UI.Button but1;
		private Helianz.UI.Button but6;
		private Helianz.UI.Button but9;
		private Helianz.UI.Button but5;
		private Helianz.UI.Button but4;
		private Helianz.UI.Button but8;
		...
		private Helianz.UI.Button but0;
		private Helianz.UI.Button but10;
		private Helianz.UI.Button butBleed;
		private Helianz.UI.Button butPus;
		private Helianz.UI.CheckBox checkThree;
		private Helianz.UI.Button butSkip;
		...
		private Helianz.UI.Button butCalculus;
		private Helianz.UI.Button butPlaque;
		...
		private Helianz.UI.Button butCalcIndex;
		...
		private Helianz.UI.Button butCount;
		...
		private Helianz.UI.Button butGraphical;
		private Helianz.UI.Button butSaveImage;
		private Label labelPlaqueHistory;
		private Helianz.UI.ListBox listPlaqueHistory;
		private Helianz.UI.CheckBox checkGingMarg;
		private TextBox textInputBox;
		private UI.Button butCopyPrevious;
		private UI.Button butListen;
		private Label labelListening;
		private Helianz.UI.CheckBox checkShowCurrent;
		private UI.GridOD gridODExam;
		private Label labelNotes;
		private ODtextBox textExamNotes;
		private UI.Button butCopyNote;
		private Helianz.ContrPerio contrPerio;
		...
		//private Helianz.ContrPerio gridP;
		//private Helianz.ContrPerio contrPerio1;
		#endregion Controls
