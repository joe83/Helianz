namespace Helianz{
	partial class FormEServicesEClipboard{
		...
		private void InitializeComponent() {
			...
			this.checkEClipboardUseDefaults = new Helianz.UI.CheckBox();
			this.groupEClipboardRules = new Helianz.UI.GroupBox();
			this.checkEClipboardAllowPaymentCheckIn = new Helianz.UI.CheckBox();
			this.checkDisplayIndividually = new Helianz.UI.CheckBox();
			this.checkRequire2FA = new Helianz.UI.CheckBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.butConfStatuses = new Helianz.UI.Button();
			this.textByodSmsTemplate = new System.Windows.Forms.TextBox();
			this.checkAppendByodToArrivalResponseSms = new Helianz.UI.CheckBox();
			this.checkEnableByodSms = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.checkEClipboardCreateMissingForms = new Helianz.UI.CheckBox();
			this.labelEClipboardMessage = new System.Windows.Forms.Label();
			this.textEClipboardMessage = new System.Windows.Forms.TextBox();
			this.checkEClipboardAllowSheets = new Helianz.UI.CheckBox();
			this.checkEClipboardAllowCheckIn = new Helianz.UI.CheckBox();
			this.checkEClipboardPopupKiosk = new Helianz.UI.CheckBox();
			this.butImageAdd = new Helianz.UI.Button();
			this.clinicPickerEClipboard = new Helianz.UI.ComboBoxClinicPicker();
			this.labelEClipboardNotSignedUp = new System.Windows.Forms.Label();
			this.butBrandingProfile = new Helianz.UI.Button();
			this.butEFormAdd = new Helianz.UI.Button();
			this.butSheetAdd = new Helianz.UI.Button();
			this.butEClipboardUp = new Helianz.UI.Button();
			this.butEClipboardDown = new Helianz.UI.Button();
			this.gridForms = new Helianz.UI.GridOD();
			this.gridImages = new Helianz.UI.GridOD();
			...
			this.butImageAdd.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butEFormAdd.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butSheetAdd.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butEClipboardUp.Image = global::Helianz.Properties.Resources.up;
			...
			this.butEClipboardDown.Image = global::Helianz.Properties.Resources.down;
			...
			this.gridForms.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridForms_CellDoubleClick);
			// 
			// gridImages
			// 
			...
			this.gridImages.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridImages_CellDoubleClick);
			// 
		...
		private Helianz.UI.CheckBox checkEClipboardUseDefaults;
		private Helianz.UI.GroupBox groupEClipboardRules;
		private Helianz.UI.CheckBox checkEClipboardCreateMissingForms;
		private System.Windows.Forms.Label labelEClipboardMessage;
		private System.Windows.Forms.TextBox textEClipboardMessage;
		private Helianz.UI.CheckBox checkEClipboardAllowSheets;
		private Helianz.UI.CheckBox checkEClipboardAllowCheckIn;
		private Helianz.UI.CheckBox checkEClipboardPopupKiosk;
		private UI.ComboBoxClinicPicker clinicPickerEClipboard;
		private System.Windows.Forms.Label labelEClipboardNotSignedUp;
		private Helianz.UI.CheckBox checkEnableByodSms;
		private Helianz.UI.CheckBox checkAppendByodToArrivalResponseSms;
		...
		private Helianz.UI.CheckBox checkRequire2FA;
		private Helianz.UI.CheckBox checkDisplayIndividually;
		private Helianz.UI.CheckBox checkEClipboardAllowPaymentCheckIn;
