namespace Helianz {
	partial class FormEhrPatientSmoking {
		...
		private void InitializeComponent() {
			...
			this.groupTobaccoUse = new Helianz.UI.GroupBox();
			this.groupIntervention = new Helianz.UI.GroupBox();
			...
			this.groupAssessment = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.GridOD gridAssessments;
		...
		private Helianz.UI.GroupBox groupTobaccoUse;
		...
		private Helianz.UI.GroupBox groupIntervention;
		private Helianz.UI.GroupBox groupAssessment;
