...
namespace Helianz {
	public partial class FormFeeEdit {
		...
		private void InitializeComponent()
		{
			...
			this.textFee = new Helianz.ValidDouble();
			this.checkDefFee = new Helianz.UI.CheckBox();
			this.checkDefCov = new Helianz.UI.CheckBox();
		...
		private Helianz.ValidDouble textFee;
		private Helianz.UI.CheckBox checkDefFee;
		private Helianz.UI.CheckBox checkDefCov;
