namespace Helianz {
	partial class FormPrepaymentTool {
		...
		private void InitializeComponent() {
			...
			this.GridPrepayment = new Helianz.UI.GridOD();
			this.butAddMonths = new Helianz.UI.Button();
			...
			this.butAdd12 = new Helianz.UI.Button();
			this.GridCodes = new Helianz.UI.GridOD();
			this.label3 = new System.Windows.Forms.Label();
			this.groupAddProcedures = new Helianz.UI.GroupBox();
			this.label4 = new System.Windows.Forms.Label();
			this.butDelete = new Helianz.UI.Button();
			this.textTotal = new Helianz.ValidDouble();
			this.textOrigSub = new Helianz.ValidDouble();
			this.textTaxSub = new Helianz.ValidDouble();
			this.labelUnsentTotals = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.textDiscount = new Helianz.ValidDouble();
			this.label5 = new System.Windows.Forms.Label();
			this.GridCompletedProcs = new Helianz.UI.GridOD();
			this.butPreviousProc = new Helianz.UI.Button();
			...
			this.GridPrepayment.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.GridPrepayment.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.GridPrepayment_CellDoubleClick);
			// 
			// butAddMonths
			// 
			this.butAddMonths.Icon = Helianz.UI.EnumIcons.Add;
			...
			// button4
			// 
			this.button4.Icon = Helianz.UI.EnumIcons.Add;
			...
			// button5
			// 
			this.button5.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butAdd12
			// 
			this.butAdd12.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.GridCodes.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.GroupBox groupAddProcedures;
