...
namespace Helianz {
	public partial class FormBlockoutCutCopyPaste {
		...
		private void InitializeComponent()
		{
			...
			this.checkWeekend = new Helianz.UI.CheckBox();
			this.butClearDay = new Helianz.UI.Button();
    ...
    " It also does not copy to a different operatory.";
		...
		private Helianz.UI.Button butCopyWeek;
		private Helianz.UI.Button butCopyDay;
		private Helianz.UI.GroupBox groupBox2;
		private Helianz.UI.Button butRepeat;
		private Label label4;
		private Helianz.UI.CheckBox checkReplace;
		private TextBox textRepeat;
		private Helianz.UI.Button butPaste;
		private Helianz.UI.CheckBox checkWeekend;
		private TextBox textClipboard;
		private Label label3;
		private Label label1;
		private Helianz.UI.Button butClearDay;
	}
}
