...
namespace Helianz {
	partial class FormEClipboardSheetRules {
		...
		private void InitializeComponent() {
			...
			this.comboBehavior = new Helianz.UI.ComboBox();
			this.checkMinAge = new Helianz.UI.CheckBox();
			this.checkMaxAge = new Helianz.UI.CheckBox();
    ...
    "dicates only submit once.)";
		...
		private Helianz.UI.CheckBox checkMinAge;
		private Helianz.UI.CheckBox checkMaxAge;
