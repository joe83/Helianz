namespace Helianz {
	partial class FormSupplyInventory {
		...
		private void InitializeComponent() {
			...
			this.butAddNeeded = new Helianz.UI.Button();
			this.butEquipment = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.butOrders = new Helianz.UI.Button();
			this.butSupplies = new Helianz.UI.Button();
			...
			this.gridMain.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridNeeded_CellDoubleClick);
			// 
			// butAddNeeded
			// 
			...
			this.butAddNeeded.Icon = Helianz.UI.EnumIcons.Add;
    ...
    "ow.  But most supply shortages are instead noticed by taking regular inventory.";
		...
		#endregion
		private Helianz.UI.Button butAddNeeded;
