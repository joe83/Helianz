namespace Helianz{
	partial class FormDunningSetup {
		...
		private void InitializeComponent() {
			...
			this.textAdv = new Helianz.ValidNum();
			...
			this.listBill = new Helianz.UI.ListBox();
			...
			this.gridDunning.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridDunning_CellDoubleClick);
			// 
			// groupBox1
			// 
			...
			this.listBill.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listBill;
