...
namespace Helianz {
	public partial class FormDatabaseMaintenance {
		...
		private void InitializeComponent() {
			...
			this.butCheck = new Helianz.UI.Button();
			this.checkShow = new Helianz.UI.CheckBox();
			...
			this.butNoneChecks = new Helianz.UI.Button();
			this.textNoneChecks = new System.Windows.Forms.TextBox();
			this.tabControlDBM = new Helianz.UI.TabControl();
			this.tabChecks = new Helianz.UI.TabPage();
			this.butExplainChecks = new Helianz.UI.Button();
			this.butStopDBM = new Helianz.UI.Button();
			this.tabHidden = new Helianz.UI.TabPage();
			this.butExplainHidden = new Helianz.UI.Button();
			this.butSelectAll = new Helianz.UI.Button();
			this.textHidden = new System.Windows.Forms.TextBox();
			this.gridHidden = new Helianz.UI.GridOD();
			this.tabOld = new Helianz.UI.TabPage();
			this.butExplainOld = new Helianz.UI.Button();
			this.checkShowHidden = new Helianz.UI.CheckBox();
			this.butStopDBMOld = new Helianz.UI.Button();
			this.textNoneOld = new System.Windows.Forms.TextBox();
			this.butNoneOld = new Helianz.UI.Button();
			this.butFixOld = new Helianz.UI.Button();
			this.butCheckOld = new Helianz.UI.Button();
			this.textOld = new System.Windows.Forms.TextBox();
			this.gridOld = new Helianz.UI.GridOD();
			this.tabTools = new Helianz.UI.TabPage();
			this.butFixTools = new Helianz.UI.Button();
			this.gridTools = new Helianz.UI.GridOD();
			this.groupBoxUpdateInProg = new Helianz.UI.GroupBox();
			this.labelUpdateInProgress = new System.Windows.Forms.Label();
			this.textBoxUpdateInProg = new System.Windows.Forms.TextBox();
			this.butClearUpdateInProgress = new Helianz.UI.Button();
    ...
    " method by selecting a method, right clicking, and select Unhide.\r\n\r\n";
			...
			this.gridHidden.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
    ...
    "essary. Should not be ran unless directly told to do so.\r\n\r\n";
			...
			this.gridOld.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridOld.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridOld_CellDoubleClick);
    ...
    "s and you are sure an update is not currently in progress.";
		...
		private Helianz.UI.Button butCheck;
		private Helianz.UI.CheckBox checkShow;
		...
		private Helianz.UI.TabControl tabControlDBM;
		private Helianz.UI.TabPage tabChecks;
		private Helianz.UI.TabPage tabTools;
		private TextBox textTools;
		private Label labelSkipCheckTable;
		private Helianz.UI.GroupBox groupBoxUpdateInProg;
		private Label labelUpdateInProgress;
		private TextBox textBoxUpdateInProg;
		private UI.Button butClearUpdateInProgress;
		private Helianz.UI.TabPage tabHidden;
		private TextBox textHidden;
		private Helianz.UI.GridOD gridHidden;
		private Helianz.UI.TabPage tabOld;
		private TextBox textOld;
		private Helianz.UI.GridOD gridOld;
		...
		private Helianz.UI.GridOD gridTools;
