namespace Helianz {
	partial class FormEhrClinicalSummary {
		...
		private void InitializeComponent() {
			...
			this.gridEHRMeasureEvents = new Helianz.UI.GridOD();
			...
			this.gridEHRMeasureEvents.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
        ...
        private Helianz.UI.GridOD gridEHRMeasureEvents;
