...
namespace Helianz {
	public partial class FormBenefitEdit {
		...
		private void InitializeComponent(){
			...
			this.checkPat = new Helianz.UI.CheckBox();
			this.textProcCode = new System.Windows.Forms.TextBox();
			this.listBenefitType = new Helianz.UI.ListBox();
			this.labelType = new System.Windows.Forms.Label();
			this.labelPercent = new System.Windows.Forms.Label();
			this.listTimePeriod = new Helianz.UI.ListBox();
			this.label4 = new System.Windows.Forms.Label();
			this.listQuantityQualifier = new Helianz.UI.ListBox();
			this.label8 = new System.Windows.Forms.Label();
			this.groupQuantity = new Helianz.UI.GroupBox();
			this.textQuantity = new Helianz.ValidNum();
			this.listCoverageLevel = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textAmount = new Helianz.ValidDouble();
			this.butDelete = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.textPercent = new Helianz.ValidNum();
			...
			this.comboCodeGroup = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.ListBox listBenefitType;
		private Label labelType;
		private Label labelPercent;
		private Helianz.UI.ListBox listTimePeriod;
		private Label label4;
		private ValidNum textQuantity;
		private Helianz.UI.ListBox listQuantityQualifier;
		private Label label8;
		private Helianz.UI.GroupBox groupQuantity;
		private Helianz.UI.CheckBox checkPat;
		private Helianz.UI.ListBox listCoverageLevel;
