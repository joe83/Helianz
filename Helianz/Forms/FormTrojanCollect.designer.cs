...
namespace Helianz {
	public partial class FormTrojanCollect {
		...
		private void InitializeComponent()
		{
			...
			this.butHelp = new Helianz.UI.Button();
			this.butOK = new Helianz.UI.Button();
			this.textDate = new Helianz.ValidDate();
			this.groupTransactionType = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.Button butHelp;
		...
		private Helianz.UI.GroupBox groupTransactionType;
