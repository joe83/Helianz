namespace Helianz{
	partial class FormEdgeExpressTrans {
		...
		private void InitializeComponent() {
			...
			this.textCashBackAmt = new Helianz.ValidDouble();
			this.listBoxTransType = new Helianz.UI.ListBox();
			this.checkSaveToken = new Helianz.UI.CheckBox();
			this.checkSignature = new Helianz.UI.CheckBox();
			...
			this.groupCardEntry = new Helianz.UI.GroupBox();
		...
		private Helianz.ValidDouble textCashBackAmt;
		private Helianz.UI.ListBox listBoxTransType;
		private Helianz.UI.CheckBox checkSaveToken;
		private Helianz.UI.CheckBox checkSignature;
		...
		private Helianz.UI.GroupBox groupCardEntry;
