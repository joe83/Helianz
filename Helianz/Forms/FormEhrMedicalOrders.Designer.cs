namespace Helianz {
	partial class FormEhrMedicalOrders {
		...
		private void InitializeComponent() {
			...
			this.checkBoxShowDiscontinued = new Helianz.UI.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.gridMedOrders = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
    ...
    "bs and radiology orders are now entered via the EHR window.";
			...
			this.gridMedOrders.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridMedOrders.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridMedOrders_CellDoubleClick);
			// 
		...
		private Helianz.UI.GridOD gridMedOrders;
		private Helianz.UI.CheckBox checkBoxShowDiscontinued;
