...
namespace Helianz {
	public partial class FormProviderSetup {
		...
		private void InitializeComponent(){
			...
			this.groupDentalSchools = new Helianz.UI.GroupBox();
			...
			this.comboClass = new Helianz.UI.ComboBox();
			this.label1 = new System.Windows.Forms.Label();
			this.butCreateUsers = new Helianz.UI.Button();
			this.groupCreateUsers = new Helianz.UI.GroupBox();
			this.comboUserGroup = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.groupMovePats = new Helianz.UI.GroupBox();
			this.butMoveSec = new Helianz.UI.Button();
			this.butProvPick = new Helianz.UI.Button();
			this.textMoveTo = new System.Windows.Forms.TextBox();
			this.butReassign = new Helianz.UI.Button();
			this.labelReassign = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.butMovePri = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.butStudBulkEdit = new Helianz.UI.Button();
			this.checkShowDeleted = new Helianz.UI.CheckBox();
			...
			this.checkShowPatientCount = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.GroupBox groupDentalSchools;
		private Helianz.UI.ComboBox comboClass;
		private Label label1;
		private Helianz.UI.Button butCreateUsers;
		private Helianz.UI.GroupBox groupCreateUsers;
		private Label label3;
		private Helianz.UI.GroupBox groupMovePats;
		...
		private Helianz.UI.CheckBox checkShowDeleted;
		...
		private Helianz.UI.CheckBox checkShowPatientCount;
