namespace Helianz {
	partial class FormBackup : FormODBase {
		...
		private void InitializeComponent()
		{
			...
			this.tabPageBackup = new Helianz.UI.TabPage();
			this.groupManagedBackups = new Helianz.UI.GroupBox();
			this.pictureCDS = new Helianz.UI.ODPictureBox();
			this.label1 = new System.Windows.Forms.Label();
			this.checkExcludeImages = new Helianz.UI.CheckBox();
			this.butSave = new Helianz.UI.Button();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.textBox5 = new System.Windows.Forms.TextBox();
			this.butBrowseRestoreAtoZTo = new Helianz.UI.Button();
			this.textBackupRestoreAtoZToPath = new System.Windows.Forms.TextBox();
			this.textBox3 = new System.Windows.Forms.TextBox();
			this.butBrowseRestoreTo = new Helianz.UI.Button();
			this.textBackupRestoreToPath = new System.Windows.Forms.TextBox();
			this.textBox4 = new System.Windows.Forms.TextBox();
			this.butBrowseRestoreFrom = new Helianz.UI.Button();
			this.textBackupRestoreFromPath = new System.Windows.Forms.TextBox();
			this.butRestore = new Helianz.UI.Button();
			this.textBox2 = new System.Windows.Forms.TextBox();
			this.butBrowseFrom = new Helianz.UI.Button();
			this.butBackup = new Helianz.UI.Button();
			this.textBackupFromPath = new System.Windows.Forms.TextBox();
			this.textBackupToPath = new System.Windows.Forms.TextBox();
			this.textBox1 = new System.Windows.Forms.TextBox();
			this.butBrowseTo = new Helianz.UI.Button();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.tabPageArchive = new Helianz.UI.TabPage();
			this.checkOptimize = new Helianz.UI.CheckBox();
			this.checkTaskHist = new Helianz.UI.CheckBox();
			this.checkWikiPageHist = new Helianz.UI.CheckBox();
			this.checkWikiListHist = new Helianz.UI.CheckBox();
			this.labelSelectTables = new System.Windows.Forms.Label();
			this.checkEmailMessage = new Helianz.UI.CheckBox();
			this.checkSecurityLog = new Helianz.UI.CheckBox();
			this.checkArchiveDoBackupFirst = new Helianz.UI.CheckBox();
			this.labelWarning = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.butSaveArchiveData = new Helianz.UI.Button();
			this.groupBoxBackupConnection = new Helianz.UI.GroupBox();
			...
			this.butArchive = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.dateTimeArchive = new System.Windows.Forms.DateTimePicker();
			this.tabPageSupplementalBackups = new Helianz.UI.TabPage();
			this.butSupplementalSaveDefaults = new Helianz.UI.Button();
			this.butSupplementalBrowse = new Helianz.UI.Button();
			...
			this.checkSupplementalBackupEnabled = new Helianz.UI.CheckBox();
			...
			this.pictureCDS.Image = global::Helianz.Properties.Resources.Unison_BDR_Logo;
    ...
    "cated.\r\nIf running on a single computer only, Server Name may be localhost.";
		...
		private Helianz.UI.CheckBox checkArchiveDoBackupFirst;
		private Helianz.UI.TabPage tabPageSupplementalBackups;
		...
		private Helianz.UI.CheckBox checkSupplementalBackupEnabled;
		private System.Windows.Forms.Label labelExplanation;
		private UI.Button butSupplementalSaveDefaults;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.Button butRestore;
		private Helianz.UI.GroupBox groupBox1;
		private System.Windows.Forms.TextBox textBox1;
		private System.Windows.Forms.TextBox textBox2;
		private System.Windows.Forms.TextBox textBox4;
		private Helianz.UI.Button butBackup;
		private Helianz.UI.Button butBrowseTo;
		private Helianz.UI.Button butBrowseFrom;
		private Helianz.UI.Button butBrowseRestoreFrom;
		private System.Windows.Forms.TextBox textBox3;
		private Helianz.UI.Button butBrowseRestoreTo;
		...
		private Helianz.UI.Button butBrowseRestoreAtoZTo;
		private Helianz.UI.Button butSave;
		//Required designer variable.
		private System.ComponentModel.Container components = null;
		private Helianz.UI.GroupBox groupBox2;
		private Helianz.UI.CheckBox checkExcludeImages;
		private UI.ODPictureBox pictureCDS;
		private Helianz.UI.GroupBox groupManagedBackups;
		private Helianz.UI.TabControl tabControl1;
		private Helianz.UI.TabPage tabPageArchive;
		private Helianz.UI.TabPage tabPageBackup;
		...
		private Helianz.UI.GroupBox groupBoxBackupConnection;
		...
		private Helianz.UI.CheckBox checkSecurityLog;
		private Helianz.UI.CheckBox checkEmailMessage;
