...
namespace Helianz {
	public partial class FormApptViews {
		...
		private void InitializeComponent()
		{
			...
			this.listViews = new Helianz.UI.ListBox();
			...
			this.checkTwoRows = new Helianz.UI.CheckBox();
			this.butProcColors = new Helianz.UI.Button();
		...
		private Helianz.UI.ListBox listViews;
		...
		private Helianz.UI.CheckBox checkTwoRows;
		private RadioButton radioFive;
		private Helianz.UI.Button butProcColors;
