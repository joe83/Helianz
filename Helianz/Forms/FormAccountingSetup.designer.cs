...
namespace Helianz {
	public partial class FormAccountingSetup {
		...
		private void InitializeComponent()
		{
			...
			this.listAccountsDep = new Helianz.UI.ListBox();
			...
			this.groupAutomaticPayment = new Helianz.UI.GroupBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.butChangeCash = new Helianz.UI.Button();
			this.label4 = new System.Windows.Forms.Label();
			this.textAccountCashInc = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.butAddPay = new Helianz.UI.Button();
    ...
    "ally created.";
		...
		private Helianz.UI.GroupBox groupAutomaticPayment;
		private Helianz.UI.Button butChangeCash;
		private Label label4;
		private TextBox textAccountCashInc;
		private Label label5;
		private Helianz.UI.Button butAddPay;
