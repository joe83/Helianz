namespace Helianz{
	partial class FormEServicesWebSchedNotify {
		...
		private void InitializeComponent() {
			...
			this.butRestoreWebSchedVerify = new Helianz.UI.Button();
			this.label28 = new System.Windows.Forms.Label();
			this.checkUseDefaultsVerify = new Helianz.UI.CheckBox();
			this.groupBox = new Helianz.UI.GroupBox();
			this.groupBoxTextTemplate = new Helianz.UI.GroupBox();
			this.textMessageTemplate = new System.Windows.Forms.TextBox();
			this.groupBoxRecallEmail = new Helianz.UI.GroupBox();
			...
			this.groupBoxRadio = new Helianz.UI.GroupBox();
			...
			this.comboClinicVerify = new Helianz.UI.ComboBoxClinicPicker();
			...
			this.radioTextAndEmail.Tag = HelianzBusiness.WebSchedVerifyType.TextAndEmail;
			...
			this.radioEmail.Tag = HelianzBusiness.WebSchedVerifyType.Email;
			...
			this.radioText.Tag = HelianzBusiness.WebSchedVerifyType.Text;
			...
			this.radioNone.Tag = HelianzBusiness.WebSchedVerifyType.None;
		...
		private Helianz.UI.CheckBox checkUseDefaultsVerify;
		private Helianz.UI.GroupBox groupBox;
		private Helianz.UI.GroupBox groupBoxTextTemplate;
		private System.Windows.Forms.TextBox textMessageTemplate;
		private Helianz.UI.GroupBox groupBoxRecallEmail;
		...
		private Helianz.UI.GroupBox groupBoxRadio;
