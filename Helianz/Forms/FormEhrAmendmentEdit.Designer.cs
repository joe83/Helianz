namespace Helianz {
	partial class FormEhrAmendmentEdit {
		...
		private void InitializeComponent() {
			...
			this.listAmdStatus = new Helianz.UI.ListBox();
			this.label8 = new System.Windows.Forms.Label();
			this.butNowReq = new Helianz.UI.Button();
			this.butNowAcc = new Helianz.UI.Button();
			this.butNowApp = new Helianz.UI.Button();
		...
		private Helianz.UI.ListBox listAmdStatus;
