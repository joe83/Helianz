namespace Helianz{
	partial class FormMobileBrandingProfileEdit {
		...
		private void InitializeComponent() {
			...
			this.butSelectImage = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.textDescription = new Helianz.ODtextBox();
			this.odPictureBoxPreview = new Helianz.UI.ODPictureBox();
			this.textFilePathImage = new Helianz.ODtextBox();
			...
			this.textDescription.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Letter;
			...
			this.textFilePathImage.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Letter;
