...
-Look in the code for any references to other Forms. If those forms  |FormHelianz.S_TxtMsg_Click()
...
///<summary></summary>
	public partial class FormPatientEdit : FormODBase {
		...
		private HelianzBusiness.Address _addressOld;
		...
		private Helianz.UI.ListBox listBoxCounties;
		private Helianz.UI.ListBox listBoxEmps;
		private Helianz.UI.ListBox listBoxMedicaidStates;
		private Helianz.UI.ListBox listBoxSites;
		private Helianz.UI.ListBox listBoxStates;
		...
		public FormPatientEdit(){
			...
			listBoxEmps=new Helianz.UI.ListBox();
			...
			listBoxCounties=new Helianz.UI.ListBox();
			...
			listBoxSites=new Helianz.UI.ListBox();
			...
			listBoxMedicaidStates=new Helianz.UI.ListBox();
			...
			listBoxStates=new Helianz.UI.ListBox();
		...
		private void FormPatientEdit_Load(object sender, System.EventArgs e) {
			...
			if(!IsNew) {
				_addressOld=new HelianzBusiness.Address();
...
;						break;
		...
		private void PromptForSmsIfNecessary(Patient patientNew,Patient patientOld) {
				...
				&& MsgBox.Show(this,MsgBoxButtons.YesNo,"Texting settings have changed.  Would you like to send a message now?","Send a message?")) 
			{
				...
				GlobalFormHelianz.SendTextMessage(patientNew.PatNum,msg);
				return;
			}
