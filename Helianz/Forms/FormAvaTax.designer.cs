namespace Helianz{
	partial class FormAvaTax {
		...
		private void InitializeComponent() {
			...
			this.groupProcCodes = new Helianz.UI.GroupBox();
			...
			this.listBoxTaxedStates = new Helianz.UI.ListBox();
			...
			this.listBoxNonTaxedStates = new Helianz.UI.ListBox();
			this.groupOffice = new Helianz.UI.GroupBox();
			this.validTaxLockDate = new Helianz.ValidDate();
			this.labelSalesTaxLockDate = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.textReturnAdjType = new System.Windows.Forms.TextBox();
			this.butChooseRetAdjType = new Helianz.UI.Button();
			this.labelTaxExempt = new System.Windows.Forms.Label();
			this.textTaxExempt = new System.Windows.Forms.TextBox();
			this.butChooseTaxExempt = new Helianz.UI.Button();
			...
			this.butChooseTaxAdjType = new Helianz.UI.Button();
			this.groupApiSettings = new Helianz.UI.GroupBox();
			this.listBoxLogLevel = new Helianz.UI.ListBox();
			this.labelLogLevel = new System.Windows.Forms.Label();
			this.labelPass = new System.Windows.Forms.Label();
			this.butPing = new Helianz.UI.Button();
			...
			this.groupOverrides = new Helianz.UI.GroupBox();
    ...
    "arated list.";
		...
		private Helianz.UI.GroupBox groupOffice;
		...
		private Helianz.UI.GroupBox groupApiSettings;
		...
		private Helianz.UI.ListBox listBoxLogLevel;
		...
		private Helianz.UI.GroupBox groupProcCodes;
		...
		private Helianz.UI.GroupBox groupOverrides;
