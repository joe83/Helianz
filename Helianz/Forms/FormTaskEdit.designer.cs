...
namespace Helianz {
	public partial class FormTaskEdit {
		...
		private void InitializeComponent() {
			...
			this.panelReminderDays = new Helianz.UI.PanelOD();
			this.labelReminderRepeatDayKey = new System.Windows.Forms.Label();
			this.labelReminderRepeatDays = new System.Windows.Forms.Label();
			this.checkReminderRepeatMonday = new Helianz.UI.CheckBox();
			this.checkReminderRepeatSunday = new Helianz.UI.CheckBox();
			this.checkReminderRepeatTuesday = new Helianz.UI.CheckBox();
			this.checkReminderRepeatSaturday = new Helianz.UI.CheckBox();
			this.checkReminderRepeatWednesday = new Helianz.UI.CheckBox();
			this.checkReminderRepeatFriday = new Helianz.UI.CheckBox();
			this.checkReminderRepeatThursday = new Helianz.UI.CheckBox();
			...
			this.checkNew = new Helianz.UI.CheckBox();
			...
			this.butReply = new Helianz.UI.Button();
			this.butNowFinished = new Helianz.UI.Button();
			...
			this.butGoto = new Helianz.UI.Button();
			this.butChange = new Helianz.UI.Button();
			this.listObjectType = new Helianz.UI.ListBox();
			...
			this.butBlue = new Helianz.UI.Button();
			this.butRed = new Helianz.UI.Button();
			this.textDescript = new Helianz.ODtextBox();
			...
			this.butSubscribers = new Helianz.UI.Button();
			...
			this.butCopy.Image = global::Helianz.Properties.Resources.Copy;
			...
			this.textDescript.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Task;
		...
		private Helianz.ODtextBox textDescript;
		private Helianz.ValidDate textDateTask;
		private Helianz.UI.Button butChange;
		private Helianz.UI.Button butGoto;
		private Helianz.UI.CheckBox checkFromNum;
		private System.Windows.Forms.Label labelObjectDesc;
		private System.Windows.Forms.TextBox textObjectDesc;
		private Helianz.UI.ListBox listObjectType;
		...
		private Helianz.UI.CheckBox checkNew;
		...
		private Helianz.UI.GroupBox groupReminder;
		private Label labelRemindFrequency;
		private Label labelReminderRepeatDays;
		private Helianz.UI.CheckBox checkReminderRepeatSunday;
		private Helianz.UI.CheckBox checkReminderRepeatSaturday;
		private Helianz.UI.CheckBox checkReminderRepeatFriday;
		private Helianz.UI.CheckBox checkReminderRepeatThursday;
		private Helianz.UI.CheckBox checkReminderRepeatWednesday;
		private Helianz.UI.CheckBox checkReminderRepeatTuesday;
		private Helianz.UI.CheckBox checkReminderRepeatMonday;
		...
		private Helianz.UI.CheckBox checkIsReadOnly;
