namespace Helianz {
	partial class FormNewCropBilling {
		...
		private void InitializeComponent() {
			...
			this.gridBillingList = new Helianz.UI.GridOD();
			this.textBillingFilePath = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.openFileDialog1 = new System.Windows.Forms.OpenFileDialog();
			this.butLoad = new Helianz.UI.Button();
			this.butBrowse = new Helianz.UI.Button();
			this.butProcess = new Helianz.UI.Button();
    ...
    "removed from NewCrop manually.";
		...
		private Helianz.UI.GridOD gridBillingList;
