namespace Helianz{
	partial class FormMassEmailSend {
		...
		private void InitializeComponent() {
			...
			this.butSendEmails = new Helianz.UI.Button();
			this.userControlEmailTemplate1 = new Helianz.UserControlEmailTemplate();
			this.textSubject = new Helianz.ODtextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.checkDisplay = new Helianz.UI.CheckBox();
			this.textPatient = new Helianz.ODtextBox();
			this.butPatientSelect = new Helianz.UI.Button();
			this.textboxAlias = new Helianz.ODtextBox();
			this.labelEmailAlias = new System.Windows.Forms.Label();
			this.textSenderAddress = new Helianz.ODtextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.butSelectSender = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.textEmailGroup = new Helianz.ODtextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.label5 = new System.Windows.Forms.Label();
			this.groupSender = new Helianz.UI.GroupBox();
			this.butVerifications = new Helianz.UI.Button();
			...
			this.butSelectPatients = new Helianz.UI.Button();
			...
			this.comboEmailHostingTemplate = new Helianz.UI.ComboBox();
			this.groupClinics = new Helianz.UI.GroupBox();
			...
			this.textPatient.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textboxAlias.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textSenderAddress.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textEmailGroup.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
		...
		private Helianz.UI.GroupBox groupSender;
