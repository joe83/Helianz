...
namespace Helianz{
	...
	public partial class FormDepositEdit:FormODBase {
		...
		private void gridPat_CellClick(object sender, Helianz.UI.ODGridClickEventArgs e) {
			ComputeAmt();
		}
		...
		private void gridIns_CellClick(object sender, Helianz.UI.ODGridClickEventArgs e) {
			ComputeAmt();
		}
