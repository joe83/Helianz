namespace Helianz{
	partial class FormBugSubmissions {
		...
		private void InitializeComponent() {
			...
			this.butAddJob = new Helianz.UI.Button();
			this.gridSubs = new Helianz.UI.GridOD();
			this.label1 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.textMsgText = new Helianz.ODtextBox();
			this.textStackFilter = new Helianz.ODtextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.groupFilters = new Helianz.UI.GroupBox();
			this.butRefreshMobile = new Helianz.UI.Button();
			this.listVersionsFilter = new Helianz.UI.ListBox();
			this.textCategoryFilters = new Helianz.ODtextBox();
			this.listShowHideOptions = new Helianz.UI.ListBox();
			this.textDevNoteFilter = new Helianz.ODtextBox();
			this.label15 = new System.Windows.Forms.Label();
			this.textPatNums = new Helianz.ODtextBox();
			this.comboRegKeys = new Helianz.UI.ComboBox();
			this.butRefresh = new Helianz.UI.Button();
			this.label7 = new System.Windows.Forms.Label();
			this.dateRangePicker = new Helianz.UI.ODDateRangePicker();
			this.comboSortBy = new Helianz.UI.ComboBox();
			this.label14 = new System.Windows.Forms.Label();
			this.comboGrouping = new Helianz.UI.ComboBox();
			this.label13 = new System.Windows.Forms.Label();
			this.bugSubmissionControl = new Helianz.UI.BugSubmissionControl();
			...
			this.gridSubs.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridSubs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubs_CellDoubleClick);
			this.gridSubs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSubs_CellClick);
			// 
			// label1
			// 
			...
			this.textMsgText.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.textStackFilter.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.listVersionsFilter.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.textCategoryFilters.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
        ...
        "Min Count"};
			...
			this.listShowHideOptions.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.textDevNoteFilter.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.textPatNums.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
		...
		private Helianz.UI.Button butAddJob;
		...
		private Helianz.UI.ComboBox comboSortBy;
		private System.Windows.Forms.Label label14;
		private Helianz.UI.ComboBox comboGrouping;
		...
		private Helianz.UI.ListBox listShowHideOptions;
		private ODtextBox textCategoryFilters;
		private Helianz.UI.ListBox listVersionsFilter;
