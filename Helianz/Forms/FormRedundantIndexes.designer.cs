namespace Helianz{
	partial class FormRedundantIndexes {
		...
		private Helianz.UI.Button butDropIndexes;
		private UI.GridOD gridMain;
		private UI.Button butAll;
		private UI.Button butNone;
		private Helianz.UI.CheckBox checkLogAddStatements;
