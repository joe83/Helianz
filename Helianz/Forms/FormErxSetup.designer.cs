namespace Helianz{
	partial class FormErxSetup {
		...
		private void InitializeComponent() {
			...
			this.groupErxOptions = new Helianz.UI.GroupBox();
			...
			this.checkShowHiddenClinics = new Helianz.UI.CheckBox();
			this.gridProperties = new Helianz.UI.GridOD();
			this.butClearAccountId = new Helianz.UI.Button();
			...
			this.gridProperties.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProperties.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProperties_CellDoubleClick);
			// 
			// butClearAccountId
			// 
		...
		private Helianz.UI.GroupBox groupErxOptions;
		...
		private Helianz.UI.CheckBox checkShowHiddenClinics;
