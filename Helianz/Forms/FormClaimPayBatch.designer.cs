...
namespace Helianz {
	public partial class FormClaimPayBatch {
		...
		private void InitializeComponent(){
			...
			this.butCarrierPick = new Helianz.UI.Button();
			...
			this.textTotal = new Helianz.ValidDouble();
			this.butAttach = new Helianz.UI.Button();
			...
			this.butDetach = new Helianz.UI.Button();
			this.gridOut = new Helianz.UI.GridOD();
			...
			this.textDateIssued = new Helianz.ValidDate();
			this.label2 = new System.Windows.Forms.Label();
			this.labelDateIssued = new System.Windows.Forms.Label();
			this.butClaimPayEdit = new Helianz.UI.Button();
			...
			this.gridAttached = new Helianz.UI.GridOD();
			...
			// butAttach
			// 
			this.butAttach.Image = global::Helianz.Properties.Resources.up;
			...
			// butDetach
			// 
			this.butDetach.Image = global::Helianz.Properties.Resources.down;
			...
			this.gridOut.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridOut.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridOut_CellDoubleClick);
			// 
			// groupBox1
			// 
			...
			this.gridAttached.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAttached.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAttached_CellDoubleClick);
			// 
			// butDelete
			// 
		...
		private Helianz.UI.GridOD gridAttached;
		...
		private Helianz.UI.GridOD gridOut;
