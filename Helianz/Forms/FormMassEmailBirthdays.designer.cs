namespace Helianz{
	partial class FormMassEmailBirthdays {
		...
		private void InitializeComponent() {
			...
			this.checkBoxSendGuarantorBirthdayForMinor = new Helianz.UI.CheckBox();
			...
			this.checkUseDefaultsBirthday = new Helianz.UI.CheckBox();
			this.checkIsEnabled = new Helianz.UI.CheckBox();
			this.butEditTemplate = new Helianz.UI.Button();
			this.tabControlLanguages = new Helianz.UI.TabControl();
			this.tabPageDefault = new Helianz.UI.TabPage();
			this.userControlEmailTemplateDefault = new Helianz.UserControlEmailTemplate();
			this.butLangaugeAdd = new Helianz.UI.Button();
			this.butLanguageRemove = new Helianz.UI.Button();
			this.comboClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.comboMinorAge = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.CheckBox checkBoxSendGuarantorBirthdayForMinor;
		...
		private Helianz.UI.CheckBox checkUseDefaultsBirthday;
		private Helianz.UI.CheckBox checkIsEnabled;
		private UI.Button butEditTemplate;
		private Helianz.UI.TabControl tabControlLanguages;
		...
		private Helianz.UI.ComboBox comboMinorAge;
