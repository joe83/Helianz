...
namespace Helianz {
	public partial class FormScreenGroupEdit {
		...
		private void InitializeComponent()
		{
			...
			this.comboCounty = new Helianz.UI.ComboBox();
			this.comboGradeSchool = new Helianz.UI.ComboBox();
			this.textProvName = new System.Windows.Forms.TextBox();
			this.labelScreener = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.gridScreenPats = new Helianz.UI.GridOD();
			this.gridMain = new Helianz.UI.GridOD();
			this.butStartScreens = new Helianz.UI.Button();
			this.butRemovePat = new Helianz.UI.Button();
			...
			this.comboSheetDefs = new Helianz.UI.ComboBox();
			...
			this.gridScreenPats.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridScreenPats_CellDoubleClick);
			// 
			// gridMain
			// 
			...
			// butRemovePat
			// 
			this.butRemovePat.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// button1
			// 
			this.button1.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.ComboBox comboCounty;
		...
		private Helianz.UI.ComboBox comboGradeSchool;
		...
		private Helianz.UI.ComboBox comboSheetDefs;
