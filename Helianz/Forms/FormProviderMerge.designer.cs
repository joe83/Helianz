namespace Helianz{
	partial class FormProviderMerge {
		...
		private void InitializeComponent() {
			...
			this.groupBoxInto = new Helianz.UI.GroupBox();
    ...
    "vider will be deleted.";
		...
		private Helianz.UI.GroupBox groupBoxInto;
		...
		private Helianz.UI.GroupBox groupBoxFrom;
		...
		private Helianz.UI.CheckBox checkDeletedProvs;
	}
}