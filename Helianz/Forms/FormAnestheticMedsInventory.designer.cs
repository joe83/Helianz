namespace Helianz{
	partial class FormAnestheticMedsInventory {
		...
		private void InitializeComponent() {
			...
			this.butAnesthMedIntake = new Helianz.UI.Button();
			this.butClose = new Helianz.UI.Button();
			this.butCancel = new Helianz.UI.Button();
			this.butAddAnesthMeds = new Helianz.UI.Button();
			this.gridAnesthMedsInventory = new Helianz.UI.ODGrid();
			...
			this.butAnesthMedIntake.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butAnesthMedIntake.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butAnesthMedIntake.CornerRadius = 4F;
			this.butAnesthMedIntake.Image = global::Helianz.Properties.Resources.Add;
			...
			this.butAddAnesthMeds.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butAddAnesthMeds.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butAddAnesthMeds.CornerRadius = 4F;
			this.butAddAnesthMeds.Image = global::Helianz.Properties.Resources.Add;
			...
			this.gridAnesthMedsInventory.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAnesthMedsInventory_CellDoubleClick);
			// 
			// label1
			// 
		...
		private Helianz.UI.ODGrid gridAnesthMedsInventory;
		private System.Windows.Forms.GroupBox groupAnestheticMeds;
		private Helianz.UI.Button butAddAnesthMeds;
		private System.Windows.Forms.Label labelIntakeNewMeds;
		private Helianz.UI.Button butAnesthMedIntake;
