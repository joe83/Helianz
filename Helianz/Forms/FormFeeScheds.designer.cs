...
namespace Helianz {
	public partial class FormFeeScheds {
		...
		private void InitializeComponent()
		{
			...
			this.butCleanUp = new Helianz.UI.Button();
			this.labelSort = new System.Windows.Forms.Label();
			this.butSort = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.groupBox7 = new Helianz.UI.GroupBox();
			this.butIns = new Helianz.UI.Button();
    ...
    "et.";
			...
			this.listType.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.Button butIns;
		private Label label6;
		private Label label1;
		private Helianz.UI.Button butSort;
		...
		private Helianz.UI.CheckBox checkBoxShowHidden;
	}
}
