...
namespace Helianz {
	public partial class FormInsPlan {
		...
		private void InitializeComponent(){
			...
			this.checkAssign = new Helianz.UI.CheckBox();
			this.checkRelease = new Helianz.UI.CheckBox();
			this.textSubscriber = new System.Windows.Forms.TextBox();
			this.groupSubscriber = new Helianz.UI.GroupBox();
			...
			this.textDateEffect = new Helianz.ValidDate();
			this.textDateTerm = new Helianz.ValidDate();
			this.textSubscNote = new Helianz.ODtextBox();
			this.toolTip1 = new System.Windows.Forms.ToolTip(this.components);
			this.butImportTrojan = new Helianz.UI.Button();
			this.butIapFind = new Helianz.UI.Button();
			this.butBenefitNotes = new Helianz.UI.Button();
			this.butHistoryElect = new Helianz.UI.Button();
			this.butGetElectronic = new Helianz.UI.Button();
			this.butSubstCodes = new Helianz.UI.Button();
			this.labelDrop = new System.Windows.Forms.Label();
			this.groupRequestBen = new Helianz.UI.GroupBox();
			...
			this.comboRelationship = new Helianz.UI.ComboBox();
			this.label31 = new System.Windows.Forms.Label();
			this.checkIsPending = new Helianz.UI.CheckBox();
			this.label32 = new System.Windows.Forms.Label();
			this.label33 = new System.Windows.Forms.Label();
			this.listAdj = new Helianz.UI.ListBox();
			...
			this.butAuditPat = new Helianz.UI.Button();
			this.butHistory = new Helianz.UI.Button();
			this.butPatOrtho = new Helianz.UI.Button();
			this.label30 = new System.Windows.Forms.Label();
			this.textDateLastVerifiedPatPlan = new Helianz.ValidDate();
			this.butVerifyPatPlan = new Helianz.UI.Button();
			this.textPatPlanNum = new System.Windows.Forms.TextBox();
			this.label27 = new System.Windows.Forms.Label();
			this.textOrdinal = new Helianz.ValidNum();
			this.butAdjAdd = new Helianz.UI.Button();
			this.butDrop = new Helianz.UI.Button();
			this.label18 = new System.Windows.Forms.Label();
			this.radioChangeAll = new System.Windows.Forms.RadioButton();
			this.groupChanges = new Helianz.UI.GroupBox();
			this.radioCreateNew = new System.Windows.Forms.RadioButton();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.label34 = new System.Windows.Forms.Label();
			this.checkDontVerify = new Helianz.UI.CheckBox();
			this.butVerifyBenefits = new Helianz.UI.Button();
			this.textDateLastVerifiedBenefits = new Helianz.ValidDate();
			this.butAudit = new Helianz.UI.Button();
			this.butPick = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.butLabel = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.tabControlInsPlan = new Helianz.UI.TabControl();
			this.tabPageInsPlanInfo = new Helianz.UI.TabPage();
			this.panelPlan = new System.Windows.Forms.Panel();
			this.checkUseBlueBook = new Helianz.UI.CheckBox();
			this.groupCarrierAllowedAmounts = new Helianz.UI.GroupBox();
			this.labelManualBlueBook = new System.Windows.Forms.Label();
			this.comboManualBlueBook = new Helianz.UI.ComboBox();
			this.labelOutOfNetwork = new System.Windows.Forms.Label();
			this.comboOutOfNetwork = new Helianz.UI.ComboBox();
			this.comboFeeSched = new Helianz.UI.ComboBox();
			this.groupCoPay = new Helianz.UI.GroupBox();
			this.labelCopayFeeSched = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.comboCopay = new Helianz.UI.ComboBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textInsPlanNum = new System.Windows.Forms.TextBox();
			this.label29 = new System.Windows.Forms.Label();
			this.groupPlan = new Helianz.UI.GroupBox();
			this.butOtherSubscribers = new Helianz.UI.Button();
			...
			this.groupCarrier = new Helianz.UI.GroupBox();
			this.labelSendElectronically = new System.Windows.Forms.Label();
			this.comboSendElectronically = new Helianz.UI.ComboBox();
			this.butPickCarrier = new Helianz.UI.Button();
			this.textPhone = new Helianz.ValidPhone();
			this.textAddress = new System.Windows.Forms.TextBox();
			this.comboElectIDdescript = new Helianz.UI.ComboBox();
			...
			this.comboLinked = new Helianz.UI.ComboBox();
			...
			this.checkIsMedical = new Helianz.UI.CheckBox();
			this.comboPlanType = new Helianz.UI.ComboBox();
			this.label14 = new System.Windows.Forms.Label();
			this.tabPageOtherInsInfo = new Helianz.UI.TabPage();
			this.panelOrthInfo = new System.Windows.Forms.Panel();
			this.label41 = new System.Windows.Forms.Label();
			this.label40 = new System.Windows.Forms.Label();
			this.label12 = new System.Windows.Forms.Label();
			this.groupBoxPerVisitAmounts = new Helianz.UI.GroupBox();
			this.labelPerVisit = new System.Windows.Forms.Label();
			this.textPerVisitInsAmount = new Helianz.ValidDouble();
			this.textPerVisitPatAmount = new Helianz.ValidDouble();
			...
			this.comboZeroWriteOffsOnLimitationOrAging = new Helianz.UI.ComboBox();
			this.comboBoxZeroWriteOffsOnAnnualMaxLimitation = new Helianz.UI.ComboBox();
			this.label39 = new System.Windows.Forms.Label();
			this.comboExclusionFeeRule = new Helianz.UI.ComboBox();
			this.label11 = new System.Windows.Forms.Label();
			this.checkPpoSubWo = new Helianz.UI.CheckBox();
			this.comboBillType = new Helianz.UI.ComboBox();
			this.label38 = new System.Windows.Forms.Label();
			this.comboCobRule = new Helianz.UI.ComboBox();
			this.label20 = new System.Windows.Forms.Label();
			this.comboFilingCodeSubtype = new Helianz.UI.ComboBox();
			this.label15 = new System.Windows.Forms.Label();
			this.checkIsHidden = new Helianz.UI.CheckBox();
			this.checkCodeSubst = new Helianz.UI.CheckBox();
			this.checkShowBaseUnits = new Helianz.UI.CheckBox();
			this.comboFilingCode = new Helianz.UI.ComboBox();
			this.label13 = new System.Windows.Forms.Label();
			this.comboClaimForm = new Helianz.UI.ComboBox();
			this.label23 = new System.Windows.Forms.Label();
			this.checkAlternateCode = new Helianz.UI.CheckBox();
			this.checkClaimsUseUCR = new Helianz.UI.CheckBox();
			this.tabPageCanadian = new Helianz.UI.TabPage();
			this.panelCanadian = new System.Windows.Forms.Panel();
			this.groupCanadian = new Helianz.UI.GroupBox();
			...
			this.checkIsPMP = new Helianz.UI.CheckBox();
			this.label24 = new System.Windows.Forms.Label();
			this.label22 = new System.Windows.Forms.Label();
			this.textPlanFlag = new System.Windows.Forms.TextBox();
			this.tabPageOrtho = new Helianz.UI.TabPage();
			this.panelOrtho = new System.Windows.Forms.Panel();
			this.textOrthoAutoFee = new Helianz.ValidDouble();
			this.labelOrthoAutoFee = new System.Windows.Forms.Label();
			this.butDefaultAutoOrthoProc = new Helianz.UI.Button();
			this.butPickOrthoProc = new Helianz.UI.Button();
			this.textOrthoAutoProc = new System.Windows.Forms.TextBox();
			this.label37 = new System.Windows.Forms.Label();
			this.comboOrthoClaimType = new Helianz.UI.ComboBox();
			this.comboOrthoAutoProcPeriod = new Helianz.UI.ComboBox();
			this.labelAutoOrthoProcPeriod = new System.Windows.Forms.Label();
			this.label36 = new System.Windows.Forms.Label();
			this.checkOrthoWaitDays = new Helianz.UI.CheckBox();
			this.gridBenefits = new Helianz.UI.GridOD();
			this.textPlanNote = new Helianz.ODtextBox();
			...
			this.textSubscNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.InsPlan;
    ...
    ", Family Ins.";
			...
			this.gridBenefits.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.textPlanNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.InsPlan;
    ...
    "t.\n5 lines in 72 vert\n6 in 85";
		...
		private Helianz.ValidDate textDateEffect;
		private Helianz.ValidDate textDateTerm;
		private Helianz.UI.CheckBox checkRelease;
		private System.Windows.Forms.TextBox textSubscriber;
		private Helianz.UI.GroupBox groupSubscriber;
		private Helianz.UI.Button butDelete;
		private System.Windows.Forms.TextBox textSubscriberID;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.ToolTip toolTip1;
		private Helianz.UI.CheckBox checkAssign;
		private System.Windows.Forms.Label labelDrop;
		private Helianz.UI.Button butDrop;
		private Helianz.ODtextBox textSubscNote;
		private Helianz.UI.Button butLabel;
		private Helianz.UI.GroupBox groupRequestBen;
		private System.Windows.Forms.Label labelTrojanID;
		private System.Windows.Forms.TextBox textTrojanID;
		private Helianz.UI.Button butImportTrojan;
		private Helianz.UI.Button butIapFind;
		private Helianz.UI.Button butBenefitNotes;
		...
		private Helianz.UI.ComboBox comboRelationship;
		private Helianz.UI.CheckBox checkIsPending;
		private System.Windows.Forms.TextBox textPatID;
		private Helianz.UI.Button butAdjAdd;
		private Helianz.UI.ListBox listAdj;
		private System.Windows.Forms.Panel panelPat;
		private Helianz.ValidNum textOrdinal;
		private Helianz.UI.GridOD gridBenefits;
		private Helianz.UI.Button butPick;
		private ODtextBox textPlanNote;
		private Label label18;
		private Helianz.UI.Button butGetElectronic;
		private TextBox textElectBenLastDate;
		private Label labelHistElect;
		private Helianz.UI.Button butHistoryElect;
		...
		private Helianz.UI.CheckBox checkDontVerify;
		private Helianz.UI.TabControl tabControlInsPlan;
		private Helianz.UI.TabPage tabPageInsPlanInfo;
		...
		private Helianz.UI.ComboBox comboElectIDdescript;
		...
		private Helianz.UI.CheckBox checkIsMedical;
		private TextBox textGroupNum;
		private Label labelGroupNum;
		private Label label8;
		private Helianz.UI.ComboBox comboLinked;
		private TextBox textLinkedNum;
		private Label label16;
		private Label label4;
		private Label labelDivisionDash;
		private Helianz.UI.ComboBox comboPlanType;
		private Label label14;
		private Helianz.UI.TabPage tabPageOtherInsInfo;
		private Panel panelOrthInfo;
		private Helianz.UI.ComboBox comboCobRule;
		private Label label20;
		private UI.ComboBox comboFilingCodeSubtype;
		private Label label15;
		private Helianz.UI.CheckBox checkIsHidden;
		private Helianz.UI.CheckBox checkCodeSubst;
		private Helianz.UI.CheckBox checkShowBaseUnits;
		private UI.ComboBox comboFilingCode;
		private Label label13;
		private UI.ComboBox comboClaimForm;
		private Label label23;
		private Helianz.UI.CheckBox checkAlternateCode;
		private Helianz.UI.CheckBox checkClaimsUseUCR;
		private Helianz.UI.TabPage tabPageCanadian;
		private Panel panelCanadian;
		private Label label19;
		private TextBox textCanadianInstCode;
		private Label label9;
		private TextBox textCanadianDiagCode;
		private Helianz.UI.CheckBox checkIsPMP;
		private Label label24;
		private Label label22;
		private TextBox textPlanFlag;
		private Helianz.UI.TabPage tabPageOrtho;
		private Panel panelOrtho;
		private Label labelAutoOrthoProcPeriod;
		private Label label36;
		private Helianz.UI.CheckBox checkOrthoWaitDays;
		private Helianz.UI.ComboBox comboOrthoClaimType;
		private Helianz.UI.ComboBox comboOrthoAutoProcPeriod;
		...
		private Helianz.UI.CheckBox checkPpoSubWo;
		private UI.Button butHistory;
		private Helianz.UI.ComboBox comboExclusionFeeRule;
		...
		private Helianz.UI.GroupBox groupChanges;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.GroupBox groupPlan;
		private Helianz.UI.GroupBox groupCarrier;
		private Helianz.UI.GroupBox groupCanadian;
		private Helianz.UI.GroupBox groupCarrierAllowedAmounts;
		private Helianz.UI.GroupBox groupCoPay;
		private Helianz.UI.CheckBox checkUseBlueBook;
		...
		private Helianz.UI.GroupBox groupBoxPerVisitAmounts;
