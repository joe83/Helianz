namespace Helianz{
	partial class FormOrthoChart {
		...
		private void InitializeComponent() {
			...
			this.butUseAutoNote = new Helianz.UI.Button();
			...
			this.buttonTakeControl = new Helianz.UI.Button();
			...
			this.gridMain.CellSelectionCommitted += new Helianz.UI.ODGridClickEventHandler(this.gridMain_CellSelectionCommitted);
