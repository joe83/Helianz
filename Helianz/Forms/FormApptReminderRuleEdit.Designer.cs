namespace Helianz {
	partial class FormApptReminderRuleEdit {
		...
		private void InitializeComponent() {
			...
			this.gridPriorities = new Helianz.UI.GridOD();
			this.butUp = new Helianz.UI.Button();
			this.butDown = new Helianz.UI.Button();
			this.checkSendAll = new Helianz.UI.CheckBox();
			this.labelTags = new System.Windows.Forms.Label();
			this.butDelete = new Helianz.UI.Button();
			this.groupSendTime = new Helianz.UI.GroupBox();
			this.textDaysWithin = new Helianz.ValidNum();
			...
			this.textHoursWithin = new Helianz.ValidNum();
			this.label1 = new System.Windows.Forms.Label();
			this.textHours = new Helianz.ValidNum();
			this.labelHoursWithin = new System.Windows.Forms.Label();
			this.groupSendOrder = new Helianz.UI.GroupBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.checkEnabled = new Helianz.UI.CheckBox();
			this.butAdvanced = new Helianz.UI.Button();
			this.butLanguage = new Helianz.UI.Button();
			this.tabPageDefault = new Helianz.UI.TabPage();
			this.checkSendSecureEmail = new Helianz.UI.CheckBox();
			this.tabControl = new Helianz.UI.TabControl();
			this.checkEConfirmationAutoReplies = new Helianz.UI.CheckBox();
			this.butRemove = new Helianz.UI.Button();
			this.groupPatientPortalInvites = new Helianz.UI.GroupBox();
			this.radioSendPatientPortalInviteNoVisit = new System.Windows.Forms.RadioButton();
			this.textPatientPortalLastVisit = new Helianz.ValidNum();
			...
			this.butSetWebForm = new Helianz.UI.Button();
		...
		private Helianz.UI.CheckBox checkSendAll;
		private System.Windows.Forms.Label labelTags;
		private UI.Button butDelete;
		private Helianz.UI.GroupBox groupSendTime;
		private Helianz.UI.GroupBox groupSendOrder;
		...
		private Helianz.UI.TabPage tabPageDefault;
		private Helianz.UI.TabControl tabControl;
		private Helianz.UI.CheckBox checkEConfirmationAutoReplies;
		...
		public Helianz.UI.CheckBox checkSendSecureEmail;
	}
}