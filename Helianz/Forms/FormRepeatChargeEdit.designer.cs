...
using Button = Helianz.UI.Button;
...
namespace Helianz {
	public partial class FormRepeatChargeEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkCopyNoteToProc = new Helianz.UI.CheckBox();
			this.label8 = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.checkCreatesClaim = new Helianz.UI.CheckBox();
			...
			this.butCalculate = new Helianz.UI.Button();
			this.butManual = new Helianz.UI.Button();
			...
			this.textBillingDay = new Helianz.ValidNum();
    ...
    "count.";
		...
		private Helianz.UI.CheckBox checkCopyNoteToProc;
		private Label label8;
		private Label label9;
		private Button butManual;
		private Helianz.UI.CheckBox checkCreatesClaim;
		...
		private Helianz.UI.CheckBox checkUseUnearned;
