namespace Helianz {
	public partial class FormPayment {
		...
		private Helianz.ValidDouble textAmount;
		private Helianz.UI.ListBox listPayType;
		private Helianz.UI.Button butDeletePayment;
		private Helianz.ODtextBox textNote;//(not including discounts)
		...
		private Helianz.UI.ComboBox comboDepositAccount;
		...
		private Helianz.UI.CheckBox checkPayTypeNone;
		...
		private Helianz.UI.CheckBox checkRecurring;
		private UI.Button butPrintReceipt;
		private Helianz.UI.GroupBox groupXWeb;
		private UI.Button butReturn;
		private UI.Button butVoid;
		private UI.Button butPrePay;
		private Helianz.UI.CheckBox checkProcessed;
		private UI.Button butEmailReceipt;
		private System.Windows.Forms.Label labelPayPlan;
		private Helianz.UI.TabControl tabControlSplits;
		private Helianz.UI.TabPage tabPageSplits;
		...
		private Helianz.UI.CheckBox checkShowAll;
		private UI.Button butPay;
		private UI.Button butClear;
		private UI.Button butDelete;
		private Helianz.UI.ComboBox comboGroupBy;
		...
		private Helianz.UI.GroupBox groupBoxFilteringOutstanding;
		...
		private Helianz.UI.CheckBox checkShowSuperfamily;
		private System.Windows.Forms.Label label9;
		private UI.Button butShowHide;
		private Helianz.UI.CheckBox checkIncludeExplicitCreditsOnly;
		private Helianz.UI.TabControl tabControlCharges;
		private Helianz.UI.TabPage tabPageOutstanding;
		private Helianz.UI.TabPage tabPageTreatPlan;
		...
		private void InitializeComponent() {
			...
			this.butDeletePayment = new Helianz.UI.Button();
			this.butPrintReceipt = new Helianz.UI.Button();
			this.butEmailReceipt = new Helianz.UI.Button();
			this.butCareCredit = new System.Windows.Forms.Panel();
			this.butPaySimple = new System.Windows.Forms.Panel();
			this.butShowHide = new Helianz.UI.Button();
			...
			this.comboCreditCards = new Helianz.UI.ComboBox();
			...
			this.comboDepositAccount = new Helianz.UI.ComboBox();
			this.checkRecurring = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.textDateEntry = new Helianz.ValidDate();
			this.butPrePay = new Helianz.UI.Button();
			this.label4 = new System.Windows.Forms.Label();
			this.label12 = new System.Windows.Forms.Label();
			this.checkProcessed = new Helianz.UI.CheckBox();
			this.label5 = new System.Windows.Forms.Label();
			this.groupXWeb = new Helianz.UI.GroupBox();
			this.butReturn = new Helianz.UI.Button();
			this.butVoid = new Helianz.UI.Button();
			this.label6 = new System.Windows.Forms.Label();
			this.textPaidBy = new System.Windows.Forms.TextBox();
			this.label11 = new System.Windows.Forms.Label();
			this.listPayType = new Helianz.UI.ListBox();
			this.textNote = new Helianz.ODtextBox();
			this.textAmount = new Helianz.ValidDouble();
			...
			this.checkPayTypeNone = new Helianz.UI.CheckBox();
			this.tabControlCharges = new Helianz.UI.TabControl();
			this.tabPageOutstanding = new Helianz.UI.TabPage();
			this.checkShowSuperfamily = new Helianz.UI.CheckBox();
			this.gridCharges = new Helianz.UI.GridOD();
			this.checkIncludeExplicitCreditsOnly = new Helianz.UI.CheckBox();
			this.checkShowAll = new Helianz.UI.CheckBox();
			this.tabPageTreatPlan = new Helianz.UI.TabPage();
			this.labelTPProcWarning = new System.Windows.Forms.Label();
			this.gridTreatPlan = new Helianz.UI.GridOD();
			this.butPay = new Helianz.UI.Button();
			this.labelPayPlan = new System.Windows.Forms.Label();
			this.tabControlSplits = new Helianz.UI.TabControl();
			this.tabPageSplits = new Helianz.UI.TabPage();
			this.gridSplits = new Helianz.UI.GridOD();
			this.textChargeTotal = new System.Windows.Forms.TextBox();
			this.butCreatePartial = new Helianz.UI.Button();
			this.label8 = new System.Windows.Forms.Label();
			this.butDelete = new Helianz.UI.Button();
			this.comboGroupBy = new Helianz.UI.ComboBox();
			this.labelGroupBy = new System.Windows.Forms.Label();
			this.groupBoxFilteringOutstanding = new Helianz.UI.GroupBox();
			this.comboProviderOutstandingFilter = new Helianz.UI.ComboBox();
			...
			this.butRefreshOutstanding = new Helianz.UI.Button();
			this.comboPatientOutstandingFilter = new Helianz.UI.ComboBox();
			this.labelProcCodes = new System.Windows.Forms.Label();
			this.comboTypeOutstandingFilter = new Helianz.UI.ComboBox();
			this.comboClinicOutstandingFilter = new Helianz.UI.ComboBox();
			...
			this.butAddManual = new Helianz.UI.Button();
			...
			this.groupBoxFilteringPaySplits = new Helianz.UI.GroupBox();
			this.labelIncludesNegativeEntries = new System.Windows.Forms.Label();
			this.comboProviderPaySplitsFilter = new Helianz.UI.ComboBox();
			...
			this.butRefreshPaySplits = new Helianz.UI.Button();
			this.comboPatientPaySplitsFilter = new Helianz.UI.ComboBox();
			this.comboClinicsPaySplitsFilter = new Helianz.UI.ComboBox();
			...
			this.butDeletePayment.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.butPrintReceipt.Image = global::Helianz.Properties.Resources.butPrintSmall;
			...
			this.butEmailReceipt.Icon = Helianz.UI.EnumIcons.Email;
			...
			// butCareCredit
			// 
			this.butCareCredit.BackgroundImage = global::Helianz.Properties.Resources.CareCredit_Button_NoTag_26x90;
			...
			// butPaySimple
			// 
			this.butPaySimple.BackgroundImage = global::Helianz.Properties.Resources.PaySimple_Button_2019_26x75;
			...
			// butShowHide
			// 
			this.butShowHide.Image = global::Helianz.Properties.Resources.arrowDownTriangle;
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Payment;
			...
			this.gridCharges.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridCharges.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCharges_CellClick);
			// 
    ...
    "";
			...
			this.gridTreatPlan.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridTreatPlan.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridTreatPlan_CellClick);
			// 
			// butPay
			// 
			...
			this.butPay.Image = global::Helianz.Properties.Resources.Left;
			...
			this.gridSplits.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridSplits.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSplits_CellDoubleClick);
			this.gridSplits.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridSplits_CellClick);
			// 
			// textChargeTotal
			// 
			...
			this.butCreatePartial.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddManual.Icon = Helianz.UI.EnumIcons.Add;
