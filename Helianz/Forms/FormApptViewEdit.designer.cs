...
namespace Helianz {
	public partial class FormApptViewEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listOps = new Helianz.UI.ListBox();
			...
			this.checkOnlyScheduledProvs = new Helianz.UI.CheckBox();
			this.textBeforeTime = new System.Windows.Forms.TextBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.checkOnlyScheduledProvDays = new Helianz.UI.CheckBox();
			...
			this.listStackLR = new Helianz.UI.ListBox();
			this.label4 = new System.Windows.Forms.Label();
			this.listStackUR = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.gridLR = new Helianz.UI.GridOD();
			this.gridUR = new Helianz.UI.GridOD();
			...
			this.checkDynamicScroll = new Helianz.UI.CheckBox();
			this.checkApptBubblesDisabled = new Helianz.UI.CheckBox();
			this.textWidthOpMinimum = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.listWaitingRmNameFormat = new Helianz.UI.ListBox();
			this.label7 = new System.Windows.Forms.Label();
			this.butMobileView = new Helianz.UI.Button();
			this.gridPatFieldDefs = new Helianz.UI.GridOD();
			this.gridApptFieldDefs = new Helianz.UI.GridOD();
			this.gridAvailable = new Helianz.UI.GridOD();
			...
			this.listOps.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridLR.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridLR_CellDoubleClick);
			this.gridLR.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridLR_CellClick);
			// 
			// gridUR
			// 
			...
			this.gridUR.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridUR_CellDoubleClick);
			this.gridUR.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridUR_CellClick);
			// 
			// gridMain
			// 
			...
			this.gridPatFieldDefs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPatFieldDefs_CellClick);
			// 
			// gridApptFieldDefs
			// 
			...
			this.gridApptFieldDefs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridApptFieldDefs_CellClick);
			// 
			// gridAvailable
			// 
			...
			this.gridAvailable.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAvailable_CellClick);
			// 
			// FormApptViewEdit
			// 
		...
		private Helianz.UI.ListBox listOps;
		...
		private Helianz.UI.CheckBox checkOnlyScheduledProvs;
		...
		private Helianz.UI.GridOD gridLR;
		private Helianz.UI.GridOD gridUR;
		private Helianz.UI.GridOD gridMain;
		private Helianz.UI.GridOD gridAvailable;
		private Helianz.UI.ListBox listStackLR;
		private Label label4;
		private Helianz.UI.ListBox listStackUR;
		private Label label1;
		private Helianz.UI.GridOD gridApptFieldDefs;
		private Helianz.UI.GridOD gridPatFieldDefs;
		private Helianz.UI.ComboBoxClinicPicker comboClinic;
		private TextBox textScrollTime;
		private Label labelStartTime;
		private Helianz.UI.CheckBox checkDynamicScroll;
		private Helianz.UI.CheckBox checkApptBubblesDisabled;
