namespace Helianz {
	partial class FormMessageReplacementTextEdit {
		...
		private void InitializeComponent() {
			...
			this.textBoxEditor = new Helianz.ODtextBox();
			this.butReplacementText = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butSave
			// 
			...
			this.textBoxEditor.QuickPasteType = HelianzBusiness.EnumQuickPasteType.PayPlan;
