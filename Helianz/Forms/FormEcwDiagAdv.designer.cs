namespace Helianz{
	partial class FormEcwDiagAdv {
		...
		private void InitializeComponent() {
			...
			this.gridTables = new Helianz.UI.GridOD();
			this.butRunQ = new Helianz.UI.Button();
			this.listQuery = new Helianz.UI.ListBox();
			this.SuspendLayout();
			// 
			// textQuery
			// 
			...
			this.gridTables.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTables_CellDoubleClick);
			...
			this.butRunQ.Image = global::Helianz.Properties.Resources.butGoto;
		...
		private Helianz.UI.ListBox listQuery;
	}
}