...
///<summary></summary>
	public partial class FormInsPlan : FormODBase {
		...
		public FormInsPlan(InsPlan insPlan,PatPlan patPlan,InsSub insSub) {
			...
			//tbPercentPlan.CellClicked += new Helianz.ContrTable.CellEventHandler(tbPercentPlan_CellClicked);
			//tbPercentPat.CellClicked += new Helianz.ContrTable.CellEventHandler(tbPercentPat_CellClicked);
			Lan.F(this);
		...
		private void butImportTrojan_Click(object sender,System.EventArgs e) {
			if(ODEnvironment.IsCloudServer) {
				MsgBox.Show(this,"Bridge is not available while using Helianz Cloud.");
		...
		private void EligibilityCheckDentalXchange() {
			Cursor = Cursors.WaitCursor;
			HelianzBusiness.com.dentalxchange.webservices.WebServiceService DCIService 
				= new HelianzBusiness.com.dentalxchange.webservices.WebServiceService();
			HelianzBusiness.com.dentalxchange.webservices.Credentials DCICredential 
				= new HelianzBusiness.com.dentalxchange.webservices.Credentials();
			HelianzBusiness.com.dentalxchange.webservices.Request DCIRequest = new HelianzBusiness.com.dentalxchange.webservices.Request();
			HelianzBusiness.com.dentalxchange.webservices.Response DCIResponse = new HelianzBusiness.com.dentalxchange.webservices.Response();
			string loginID;
			string passWord;
			// Get Login / Password
