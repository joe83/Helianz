namespace Helianz{
	partial class FormEServicesSetup {
		...
		private void InitializeComponent() {
			...
			this.butTextingServices = new Helianz.UI.Button();
			this.butPatPortal = new Helianz.UI.Button();
			this.butMobileWeb = new Helianz.UI.Button();
			this.butMisc = new Helianz.UI.Button();
			this.butEConnector = new Helianz.UI.Button();
			this.butEClipboard = new Helianz.UI.Button();
			this.butECR = new Helianz.UI.Button();
			this.butSignup = new Helianz.UI.Button();
			this.label23 = new System.Windows.Forms.Label();
			this.labelECR = new System.Windows.Forms.Label();
			this.labelSignup = new System.Windows.Forms.Label();
			this.groupboxWebSched = new Helianz.UI.GroupBox();
			this.butExistingPatient = new Helianz.UI.Button();
			this.butAdvanced = new Helianz.UI.Button();
			this.butNewPatient = new Helianz.UI.Button();
			this.butRecall = new Helianz.UI.Button();
			this.butMobileSettings = new Helianz.UI.Button();
			this.butSecureEmail = new Helianz.UI.Button();
			this.butPayPortal = new Helianz.UI.Button();
			this.butODTouch = new Helianz.UI.Button();
			this.butMobileAppDevice = new Helianz.UI.Button();
			...
			this.label23.Text = "eServices are Helianz features that can be delivered electronically via the i" +
    "nternet.  \r\nAll eServices hosted by Helianz use the eConnector Service.";
		...
		private Helianz.UI.GroupBox groupboxWebSched;
