...
namespace Helianz {
    ...
    " click anywhere on panel above to add or edit an item.";
			...
			this.panelQuickButtons.RowDoubleClick += new Helianz.UI.ODButtonPanelEventHandler(this.panelQuickButtons_RowDoubleClick);
			// 
			// butEdit
			// 
			this.butEdit.Icon = Helianz.UI.EnumIcons.Add;
