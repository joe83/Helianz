...
namespace Helianz {
	public partial class FormApptConflicts:FormODBase {
		...
		private void SendPinboard_Click() {
			...
			FillGrid();
			GlobalFormHelianz.GoToModule(EnumModuleType.Appointments, listPinApptNums:listSelectedAptNums,dateSelected:DateTime.Today);//Pins all appointments to the pinboard that were in listAptSelected.
		}
