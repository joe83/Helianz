namespace Helianz{
	partial class FormAllocationsSetup {
		...
		private void InitializeComponent() {
			...
			this.checkClaimPayByTotalSplitsAuto = new Helianz.UI.CheckBox();
			this.checkShowIncomeTransferManager = new Helianz.UI.CheckBox();
			this.label40 = new System.Windows.Forms.Label();
			this.butLineItem = new Helianz.UI.Button();
			this.butSimple = new Helianz.UI.Button();
			this.checkHidePaysplits = new Helianz.UI.CheckBox();
			...
			this.checkAllowPrePayToTpProcs = new Helianz.UI.CheckBox();
			this.checkIsRefundable = new Helianz.UI.CheckBox();
			this.label57 = new System.Windows.Forms.Label();
			this.comboTpUnearnedType = new Helianz.UI.ComboBox();
			this.label4 = new System.Windows.Forms.Label();
			this.checkIncomeTransfersMadeUponClaimReceived = new Helianz.UI.CheckBox();
			this.labelIncomeTransfersMadeUponClaimReceivedDesc = new System.Windows.Forms.Label();
			this.checkAdjustmentsOffset = new Helianz.UI.CheckBox();
    ...
    "ous)";
		...
		private Helianz.UI.CheckBox checkClaimPayByTotalSplitsAuto;
		private Helianz.UI.CheckBox checkShowIncomeTransferManager;
		private System.Windows.Forms.Label label40;
		private UI.Button butLineItem;
		private UI.Button butSimple;
		private Helianz.UI.CheckBox checkHidePaysplits;
		...
		private Helianz.UI.CheckBox checkAllowPrePayToTpProcs;
		private Helianz.UI.CheckBox checkIsRefundable;
		...
		private Helianz.UI.CheckBox checkIncomeTransfersMadeUponClaimReceived;
		private System.Windows.Forms.Label labelIncomeTransfersMadeUponClaimReceivedDesc;
		private Helianz.UI.CheckBox checkAdjustmentsOffset;
	}
}