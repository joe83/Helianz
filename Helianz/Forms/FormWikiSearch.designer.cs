namespace Helianz{
	partial class FormWikiSearch {
		...
		private void InitializeComponent() {
			...
			this.checkIgnoreContent = new Helianz.UI.CheckBox();
			this.checkArchivedOnly = new Helianz.UI.CheckBox();
			...
			this.checkBoxMatchWholeWord = new Helianz.UI.CheckBox();
			this.checkBoxShowMainPages = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkIgnoreContent;
		private Helianz.UI.CheckBox checkArchivedOnly;
		private UI.Button butRestore;
		private Helianz.UI.CheckBox checkBoxMatchWholeWord;
		private Helianz.UI.CheckBox checkBoxShowMainPages;
