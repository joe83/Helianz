namespace Helianz{
	partial class FormShutdown {
		...
		private void InitializeComponent() {
			...
			this.butCloseSessions = new Helianz.UI.Button();
			this.butShutdown = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// gridActiveInstances
			// 
			...
			this.gridActiveInstances.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.Button butShutdown;
