namespace Helianz{
	partial class FormAdjustSelect {
		...
		private void InitializeComponent() {
			...
			this.groupBoxBreakdown = new Helianz.UI.GroupBox();
			...
			this.gridAdjusts = new Helianz.UI.GridOD();
			...
			this.gridAdjusts.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAdjusts_CellDoubleClick);
			this.gridAdjusts.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAdjusts_CellClick);
			// 
			// label1
			// 
    ...
    "le.";
		...
		private Helianz.UI.GroupBox groupBoxBreakdown;
