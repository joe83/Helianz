namespace Helianz{
	partial class FormEvaluationReport {
		...
		private void InitializeComponent() {
			...
			this.checkAllCourses = new Helianz.UI.CheckBox();
			this.checkAllInstructors = new Helianz.UI.CheckBox();
			this.textDateStart = new Helianz.ValidDate();
			this.textDateEnd = new Helianz.ValidDate();
			this.gridCourses = new Helianz.UI.GridOD();
			this.gridInstructors = new Helianz.UI.GridOD();
			this.gridStudents = new Helianz.UI.GridOD();
			this.butAllStudents = new Helianz.UI.Button();
			...
			this.gridCourses.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridCourses.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCourses_CellClick);
			// 
			// gridInstructors
			// 
			...
			this.gridInstructors.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridInstructors.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridInstructors_CellClick);
			// 
			// gridStudents
			// 
			...
			this.gridStudents.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.CheckBox checkAllCourses;
		private Helianz.UI.CheckBox checkAllInstructors;
