namespace Helianz{
	partial class FormInsBlueBookRules {
		...
		private void InitializeComponent() {
			...
			this.checkEnableAnonFeeShare = new Helianz.UI.CheckBox();
			this.checkUsePlanNumInHierarchy = new Helianz.UI.CheckBox();
			this.listAllowedFeeMethod = new Helianz.UI.ListBox();
			this.labelAllowedFeeMethod = new System.Windows.Forms.Label();
			this.labelBlueBookFeature = new System.Windows.Forms.Label();
			this.listBlueBookFeature = new Helianz.UI.ListBox();
			this.butDown = new Helianz.UI.Button();
			this.butUp = new Helianz.UI.Button();
			this.labelArrowButtons = new System.Windows.Forms.Label();
			this.textUcrFeePercent = new Helianz.ValidNum();
			this.labelUcrFeePercent = new System.Windows.Forms.Label();
			this.groupBlueBookSettings = new Helianz.UI.GroupBox();
			this.gridInsBlueBookRules = new Helianz.UI.GridOD();
			...
			this.gridInsBlueBookRules.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.GridInsBlueBookRules_CellDoubleClick);
			// 
		...
		private Helianz.UI.CheckBox checkEnableAnonFeeShare;
		private Helianz.UI.CheckBox checkUsePlanNumInHierarchy;
		private Helianz.UI.ListBox listAllowedFeeMethod;
		private System.Windows.Forms.Label labelAllowedFeeMethod;
		private System.Windows.Forms.Label labelBlueBookFeature;
		private Helianz.UI.ListBox listBlueBookFeature;
		...
		private Helianz.UI.GroupBox groupBlueBookSettings;
	}
}