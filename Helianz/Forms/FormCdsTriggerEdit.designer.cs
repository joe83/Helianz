namespace Helianz{
	partial class FormCdsTriggerEdit {
		...
		private void InitializeComponent() {
			...
			this.butAddSnomed = new Helianz.UI.Button();
			this.butAddIcd10 = new Helianz.UI.Button();
			this.butAddIcd9 = new Helianz.UI.Button();
			this.butAddProblem = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.butAddCvx = new Helianz.UI.Button();
			this.butAddRxNorm = new Helianz.UI.Button();
			this.butAddMed = new Helianz.UI.Button();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.butAddAllergy = new Helianz.UI.Button();
			this.groupBox4 = new Helianz.UI.GroupBox();
			this.butAddGender = new Helianz.UI.Button();
			this.butAddAge = new Helianz.UI.Button();
			this.groupBox5 = new Helianz.UI.GroupBox();
			this.butAddLab = new Helianz.UI.Button();
			this.groupBox6 = new Helianz.UI.GroupBox();
			this.butAddBMI = new Helianz.UI.Button();
			this.butAddBP = new Helianz.UI.Button();
			this.butAddWeight = new Helianz.UI.Button();
			this.butAddHeight = new Helianz.UI.Button();
			this.textDescription = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.comboCardinality = new Helianz.UI.ComboBox();
			...
			this.butAddSnomed.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddIcd10.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddIcd9.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddProblem.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddCvx.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddRxNorm.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddMed.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddGender.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddAge.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddLab.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddBMI.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddBP.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddWeight.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddHeight.Icon = Helianz.UI.EnumIcons.Add;
    ...
    " below must be met.";
		...
		private Helianz.UI.ComboBox comboCardinality;
