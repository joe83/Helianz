...
namespace Helianz{
	...
	public partial class FormApptViewEdit : FormODBase {
		...
		private void gridUR_CellClick(object sender,Helianz.UI.ODGridClickEventArgs e) {
		...
		private void gridLR_CellClick(object sender,Helianz.UI.ODGridClickEventArgs e) {
		...
		private void gridUR_CellDoubleClick(object sender,Helianz.UI.ODGridClickEventArgs e) {
			FrmApptViewItemEdit frmApptViewItemEdit=new FrmApptViewItemEdit();
		...
		private void gridLR_CellDoubleClick(object sender,Helianz.UI.ODGridClickEventArgs e) {
			FrmApptViewItemEdit frmApptViewItemEdit=new FrmApptViewItemEdit();
