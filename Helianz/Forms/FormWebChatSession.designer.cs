namespace Helianz{
	partial class FormWebChatSession {
		...
		private void InitializeComponent() {
			...
			this.butTakeOwnership = new Helianz.UI.Button();
			this.butEndSession = new Helianz.UI.Button();
			...
			this.checkIsCustomer = new Helianz.UI.CheckBox();
			this.textCustomer = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.butSearchAndAttach = new Helianz.UI.Button();
			this.tabControlMain = new Helianz.UI.TabControl();
			this.tabPageMessages = new Helianz.UI.TabPage();
			this.butAskAi = new Helianz.UI.Button();
			this.butSend = new Helianz.UI.Button();
			this.textChatMessage = new Helianz.ODtextBox();
			this.webChatThread = new Helianz.SmsThreadView();
			this.tabPageNotes = new Helianz.UI.TabPage();
			this.gridODNotes = new Helianz.UI.GridOD();
			this.butAttachSuggestion = new Helianz.UI.Button();
			...
			this.butEndSession.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.textChatMessage.QuickPasteType = HelianzBusiness.EnumQuickPasteType.WebChat;
			...
			this.gridODNotes.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridODNotes_CellDoubleClick);
			// 
			// butAttachSuggestion
			// 
		...
		private Helianz.UI.Button butTakeOwnership;
		...
		private Helianz.UI.CheckBox checkIsCustomer;
