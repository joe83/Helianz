namespace Helianz{
	partial class FormCreditCardEdit {
		...
		private void InitializeComponent() {
			...
			this.groupChargeFrequency = new Helianz.UI.GroupBox();
			this.comboDays = new Helianz.UI.ComboBox();
			this.comboFrequency = new Helianz.UI.ComboBox();
			this.butAddDay = new Helianz.UI.Button();
			this.butClearDayOfMonth = new Helianz.UI.Button();
			...
			this.groupProcedures = new Helianz.UI.GroupBox();
			this.checkExcludeProcSync = new Helianz.UI.CheckBox();
			this.listProcs = new Helianz.UI.ListBox();
			this.butRemoveProc = new Helianz.UI.Button();
			this.label15 = new System.Windows.Forms.Label();
			this.butAddProc = new Helianz.UI.Button();
			this.groupRecurringCharges = new Helianz.UI.GroupBox();
			this.textDateStop = new Helianz.ValidDate();
			this.textDateStart = new Helianz.ValidDate();
			this.labelNextChargeDate = new System.Windows.Forms.Label();
			this.textNextChargeDate = new Helianz.ValidDate();
			this.labelPreviousStartDate = new System.Windows.Forms.Label();
			this.textPreviousStartDate = new Helianz.ValidDate();
			this.checkIsRecurringActive = new Helianz.UI.CheckBox();
			this.comboPaymentType = new Helianz.UI.ComboBox();
			this.label9 = new System.Windows.Forms.Label();
			this.checkChrgWithNoBal = new Helianz.UI.CheckBox();
			this.labelPayPlan = new System.Windows.Forms.Label();
			this.comboPaymentPlans = new Helianz.UI.ComboBox();
			this.butToday = new Helianz.UI.Button();
			this.butClear = new Helianz.UI.Button();
			this.textNote = new Helianz.ODtextBox();
			this.label7 = new System.Windows.Forms.Label();
			this.textChargeAmt = new Helianz.ValidDouble();
			...
			// butRemoveProc
			// 
			this.butRemoveProc.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// butAddProc
			// 
			this.butAddProc.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.FinancialNotes;
		...
		private Helianz.UI.ComboBox comboDays;
		private Helianz.UI.ComboBox comboFrequency;
		private UI.Button butAddDay;
		private UI.Button butClearDayOfMonth;
		private System.Windows.Forms.Label label8;
		private Helianz.UI.CheckBox checkChrgWithNoBal;
		private UI.ComboBox comboPaymentType;
		private System.Windows.Forms.Label label9;
		private System.Windows.Forms.TextBox textClinic;
		private System.Windows.Forms.Label labelClinic;
		private Helianz.UI.CheckBox checkIsRecurringActive;
