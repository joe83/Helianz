namespace Helianz{
	partial class FormLateCharges {
		...
		private void InitializeComponent() {
			...
			this.textMinCharge = new Helianz.ValidDouble();
			this.labelMinCharge = new System.Windows.Forms.Label();
			this.textMaxCharge = new Helianz.ValidDouble();
			this.labelMaxCharge = new System.Windows.Forms.Label();
			this.labelChargePercent = new System.Windows.Forms.Label();
			this.textChargePercent = new Helianz.ValidNum();
			this.labelDateRange1 = new System.Windows.Forms.Label();
			this.textDateRangeEnd = new Helianz.ValidNum();
			this.labelDateRange2 = new System.Windows.Forms.Label();
			this.textDateRangeStart = new Helianz.ValidNum();
			this.labelDateRange3 = new System.Windows.Forms.Label();
			this.butSaveDefaults = new Helianz.UI.Button();
			this.groupLateCharge = new Helianz.UI.GroupBox();
			this.checkExcludeExistingLateCharges = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.Button butRun;
		...
		private Helianz.UI.GroupBox groupBoxUndo;
		...
		private Helianz.UI.GroupBox groupLateCharge;
		...
		private Helianz.UI.CheckBox checkExcludeExistingLateCharges;
	}
}