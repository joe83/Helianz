namespace Helianz{
	partial class FormScheduledProcesses {
		...
		private void InitializeComponent() {
			...
			this.groupBoxInsVerifyChecks = new Helianz.UI.GroupBox();
			this.checkChangeEffectiveDates = new Helianz.UI.CheckBox();
			this.checkChangeInsHist = new Helianz.UI.CheckBox();
			this.checkCheckDeductable = new Helianz.UI.CheckBox();
			this.checkCheckAnnualMax = new Helianz.UI.CheckBox();
			this.checkCreateAdjustments = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkCheckDeductable;
		private Helianz.UI.CheckBox checkCheckAnnualMax;
		private Helianz.UI.CheckBox checkCreateAdjustments;
		private Helianz.UI.CheckBox checkChangeInsHist;
		private Helianz.UI.CheckBox checkChangeEffectiveDates;
	}
}