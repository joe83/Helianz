namespace Helianz{
	partial class FormWebChatTools {
		...
		private void InitializeComponent() {
			...
			this.gridWebChatSessions = new Helianz.UI.GridOD();
			this.menuGridRight = new System.Windows.Forms.ContextMenu();
			this.menuItemAiChat = new System.Windows.Forms.MenuItem();
			this.checkShowEndedSessions = new Helianz.UI.CheckBox();
			this.dateRangeWebChat = new Helianz.UI.ODDateRangePicker();
			this.labelUsers = new System.Windows.Forms.Label();
			this.comboUsers = new Helianz.UI.ComboBox();
			this.labelChatTextContains = new System.Windows.Forms.Label();
			this.textChatTextContains = new Helianz.ODtextBox();
			this.textSessionNum = new Helianz.ODtextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.groupFilters = new Helianz.UI.GroupBox();
			this.checkShowAi = new Helianz.UI.CheckBox();
			this.butClearFilters = new Helianz.UI.Button();
			this.comboSupervisors = new Helianz.UI.ComboBox();
			...
			this.gridWebChatSessions.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridWebChatSessions_CellDoubleClick);
			// 
			// menuGridRight
			// 
			...
			this.textChatTextContains.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textSessionNum.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
		...
		private Helianz.UI.CheckBox checkShowEndedSessions;
