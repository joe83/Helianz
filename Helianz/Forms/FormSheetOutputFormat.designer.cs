namespace Helianz{
	partial class FormSheetOutputFormat {
		...
		private void InitializeComponent() {
			...
			this.checkEmailPat = new Helianz.UI.CheckBox();
			this.textEmailPat = new System.Windows.Forms.TextBox();
			this.textEmail2 = new System.Windows.Forms.TextBox();
			this.checkEmail2 = new Helianz.UI.CheckBox();
			this.textPaperCopies = new Helianz.ValidNum();
