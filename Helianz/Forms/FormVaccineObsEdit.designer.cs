namespace Helianz{
	partial class FormVaccineObsEdit {
		...
		private void InitializeComponent() {
			...
			this.listValueType = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.comboObservationQuestion = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.textValue = new System.Windows.Forms.TextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.listCodeSystem = new Helianz.UI.ListBox();
			...
			this.comboUnits = new Helianz.UI.ComboBox();
			this.butDelete = new Helianz.UI.Button();
			this.textDateObserved = new Helianz.ValidDate();
			this.butSave = new Helianz.UI.Button();
			this.butTodayDateObserved = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// listValueType
			// 
		...
		private Helianz.UI.ListBox listValueType;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label2;
		private Helianz.UI.ComboBox comboObservationQuestion;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.TextBox textValue;
		private System.Windows.Forms.Label label4;
		private Helianz.UI.ListBox listCodeSystem;
		...
		private Helianz.UI.ComboBox comboUnits;
