...
namespace Helianz {
	public partial class FormJournal {
		...
		private void InitializeComponent()
		{
			...
			this.butDropFrom = new Helianz.UI.Button();
			this.butDropTo = new Helianz.UI.Button();
			this.calendarTo = new System.Windows.Forms.MonthCalendar();
			this.textAmountFrom = new Helianz.ValidDouble();
			this.labelAmout = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.textFindText = new System.Windows.Forms.TextBox();
			this.textAmountTo = new Helianz.ValidDouble();
		...
		private Helianz.UI.Button butDropFrom;
		private Helianz.UI.Button butDropTo;
