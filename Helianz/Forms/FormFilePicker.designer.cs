namespace Helianz{
	partial class FormFilePicker {
		...
		private void InitializeComponent() {
			...
			this.butFileChoose = new Helianz.UI.Button();
			this.butGo = new Helianz.UI.Button();
			this.groupThumbnail = new Helianz.UI.GroupBox();
			this.labelThumbnail = new System.Windows.Forms.Label();
			this.odPictureBox = new Helianz.UI.ODPictureBox();
			...
			this.butGo.Image = global::Helianz.Properties.Resources.Right;
		...
		private Helianz.UI.GroupBox groupThumbnail;
