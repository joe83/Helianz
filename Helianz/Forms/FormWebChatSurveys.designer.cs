namespace Helianz{
	partial class FormWebChatSurveys {
		...
		private void InitializeComponent() {
			...
			this.textSurveyTextContains = new Helianz.ODtextBox();
			this.labelSurveyTextContains = new System.Windows.Forms.Label();
			this.labelUsers = new System.Windows.Forms.Label();
			this.gridWebChatSurveys = new Helianz.UI.GridOD();
			...
			this.textSurveyTextContains.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.gridWebChatSurveys.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridWebChatSurveys_CellDoubleClick);
			// 
			// butPrint
			// 
