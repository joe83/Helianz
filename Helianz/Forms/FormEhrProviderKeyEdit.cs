...
namespace Helianz {
	public partial class FormEhrProviderKeyEdit:FormODBase {
		...
		private void butDelete_Click(object sender,EventArgs e) {
			...
			//if the radiology proc alert is enabled and they just deleted the last ehrprovkey, disable the alert (HelianzService will stop alerting)
		...
		private void butSave_Click(object sender,EventArgs e) {
			...
			if(_keyCur.IsNew) {
				...
				//if radiology procs alert is disabled and this is the first ehrprovkey, enable the alert (alert handled by the HelianzService)
