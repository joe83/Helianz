...
namespace Helianz {
	partial class FormEServicesAutoMsgingAdvanced {
		...
		private void InitializeComponent() {
			...
			this.groupAutomationStatuses = new Helianz.UI.GroupBox();
			this.butExclusionDays = new Helianz.UI.Button();
			this.radio2ClickConfirm = new System.Windows.Forms.RadioButton();
			this.radio1ClickConfirm = new System.Windows.Forms.RadioButton();
			this.comboStatusEFailed = new Helianz.UI.ComboBox();
			this.label50 = new System.Windows.Forms.Label();
			this.comboStatusEDeclined = new Helianz.UI.ComboBox();
			this.comboStatusESent = new Helianz.UI.ComboBox();
			this.comboStatusEAccepted = new Helianz.UI.ComboBox();
			this.label51 = new System.Windows.Forms.Label();
			this.label52 = new System.Windows.Forms.Label();
			this.label53 = new System.Windows.Forms.Label();
			this.checkEnableNoClinic = new Helianz.UI.CheckBox();
			...
			this.checkUseDefault = new Helianz.UI.CheckBox();
			...
			this.gridMain.SelectionMode = Helianz.UI.GridSelectionMode.None;
		...
		private Helianz.UI.GroupBox groupAutomationStatuses;
		...
		private Helianz.UI.CheckBox checkEnableNoClinic;
        ...
        private Helianz.UI.CheckBox checkUseDefault;
