...
namespace Helianz {
	public partial class FormMedicationEdit {
		...
		private void InitializeComponent()
		{
			...
			this.textNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
		...
		private Helianz.UI.ComboBox comboPatients;
		...
		private Helianz.UI.ComboBox comboBrands;//does not allow changing to non generic.
		...
		private Helianz.UI.ComboBox comboPatientAllergy;
	}
}
