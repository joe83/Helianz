...
namespace Helianz {
	public partial class FormClockEventEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butNow1 = new Helianz.UI.Button();
			...
			this.butNow2 = new Helianz.UI.Button();
			...
			this.groupTimeSpans = new Helianz.UI.GroupBox();
			...
			this.groupRate2orRate3 = new Helianz.UI.GroupBox();
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.CommLog;
		...
		private Helianz.UI.Button butNow2;
		private Helianz.UI.Button butClear;
		private Helianz.UI.Button butNow1;
		...
		private Helianz.UI.GroupBox groupTimeSpans;
		...
		private Helianz.UI.GroupBox groupRate2orRate3;
