...
namespace Helianz {
	public partial class FormConfirmList {
		...
		private void InitializeComponent()
		{
			...
			this.comboViewStatus = new Helianz.UI.ComboBox();
			this.comboShowRecall = new Helianz.UI.ComboBox();
			...
			this.butPostcards.Image = global::Helianz.Properties.Resources.butPrintSmall;
			...
			this.gridMain.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellDoubleClick);
			this.gridMain.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellClick);
		...
		private Helianz.UI.ComboBox comboShowRecall;
		...
		private Helianz.UI.ComboBox comboViewStatus;
