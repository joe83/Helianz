...
namespace Helianz {
	public partial class FormEhrVaccines:FormODBase {
		...
		private void gridVaccine_CellDoubleClick(object sender,Helianz.UI.ODGridClickEventArgs e) {
		...
		private void butExport_Click(object sender,EventArgs e) {
			...
			HelianzBusiness.HL7.EhrVXU vxu=null;
			try {
				vxu=new HelianzBusiness.HL7.EhrVXU(PatCur,vaccines);
			}
