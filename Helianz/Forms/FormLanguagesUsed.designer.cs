...
namespace Helianz {
	public partial class FormLanguagesUsed {
		...
		private void InitializeComponent() {
			...
			this.listUsed = new Helianz.UI.ListBox();
			...
			this.comboLanguagesIndicateNone = new Helianz.UI.ComboBox();
    ...
    "sed when interacting with patients.";
			...
			// butAddCustom
			// 
			this.butAddCustom.Image = global::Helianz.Properties.Resources.Right;
    ...
    "ingon, etc.\r\nDo not type in an existing language, like Spanish.";
		...
		private Helianz.UI.ListBox listUsed;
		...
		private Helianz.UI.ComboBox comboLanguagesIndicateNone;
