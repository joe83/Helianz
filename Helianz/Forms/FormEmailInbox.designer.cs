namespace Helianz{
	partial class FormEmailInbox {
		...
		private void InitializeComponent() {
			...
			this.gridInbox = new Helianz.UI.GridOD();
			this.emailPreviewControlInbox = new Helianz.EmailPreviewControl();
			...
			this.groupShowIn = new Helianz.UI.GroupBox();
			this.listShowIn = new Helianz.UI.ListBox();
			this.checkShowHiddenEmails = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.comboEmailAddress = new Helianz.UI.ComboBox();
			this.butMarkUnread = new Helianz.UI.Button();
			this.butMarkRead = new Helianz.UI.Button();
			this.butChangePat = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butCompose = new Helianz.UI.Button();
			...
			this.checkSearchAttach = new Helianz.UI.CheckBox();
			...
			this.butPickPat = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.textSearchPat = new System.Windows.Forms.TextBox();
			this.butRefresh = new Helianz.UI.Button();
			this.gridSent = new Helianz.UI.GridOD();
			this.emailPreviewControlSent = new Helianz.EmailPreviewControl();
			this.butReplyAll = new Helianz.UI.Button();
			this.butForward = new Helianz.UI.Button();
			this.menuMain = new Helianz.UI.MenuOD();
			this.groupSentMessageSource = new Helianz.UI.GroupBox();
			this.butAutomatedNone = new Helianz.UI.Button();
			this.butManualNone = new Helianz.UI.Button();
			this.labelAutomatedMsgSource = new System.Windows.Forms.Label();
			this.labelManualMsgSource = new System.Windows.Forms.Label();
			this.butAutomatedAll = new Helianz.UI.Button();
			this.butAllManual = new Helianz.UI.Button();
			this.listAutomatedMessageSource = new Helianz.UI.ListBox();
			this.listManualMessageSource = new Helianz.UI.ListBox();
			this.checkShowFailedSent = new Helianz.UI.CheckBox();
			this.tabControl = new Helianz.UI.TabControl();
			this.tabPage3 = new Helianz.UI.TabPage();
			this.splitContainerInbox = new Helianz.UI.SplitContainer();
			...
			this.splitContainerSent = new Helianz.UI.SplitContainer();
			...
			this.gridInbox.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridInbox.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridInboxSent_CellDoubleClick);
			this.gridInbox.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridInboxSent_CellClick);
			// 
			...
			this.listShowIn.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridSent.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridSent.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridInboxSent_CellDoubleClick);
			this.gridSent.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridInboxSent_CellClick);
			// 
			...
			this.listAutomatedMessageSource.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listManualMessageSource.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.tabControl.TabAlignment = Helianz.UI.EnumTabAlignment.LeftHorizontal;
    ...
    private Helianz.UI.ComboBox comboEmailAddress;
    ...
    private Helianz.UI.CheckBox checkSearchAttach;
    ...
    private System.Windows.Forms.Label label2;
		...
		private Helianz.UI.CheckBox checkShowHiddenEmails;
		private UI.ListBox listShowIn;
		private Helianz.UI.GroupBox groupShowIn;
		private UI.MenuOD menuMain;
		private Helianz.UI.GroupBox groupSentMessageSource;
		private UI.ListBox listManualMessageSource;
		private Helianz.UI.CheckBox checkShowFailedSent;
