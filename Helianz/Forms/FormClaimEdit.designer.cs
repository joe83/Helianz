namespace Helianz {
	partial class FormClaimEdit {
		...
		private void InitializeComponent() {
			...
			this.butViewEob = new Helianz.UI.Button();
			this.groupFinalizePayment = new Helianz.UI.GroupBox();
			this.butBatch = new Helianz.UI.Button();
			this.butThisClaimOnly = new Helianz.UI.Button();
			this.labelBatch = new System.Windows.Forms.Label();
			this.tabControlMain = new Helianz.UI.TabControl();
			this.tabGeneral = new Helianz.UI.TabPage();
			this.panel2 = new System.Windows.Forms.Panel();
			this.groupProsth = new Helianz.UI.GroupBox();
			this.labelMissingTeeth = new System.Windows.Forms.Label();
			this.textPriorDate = new Helianz.ValidDate();
			...
			this.groupReferral = new Helianz.UI.GroupBox();
			this.label45 = new System.Windows.Forms.Label();
			this.textRefProv = new System.Windows.Forms.TextBox();
			this.butReferralEdit = new Helianz.UI.Button();
			this.label47 = new System.Windows.Forms.Label();
			this.butReferralNone = new Helianz.UI.Button();
			this.butReferralSelect = new Helianz.UI.Button();
			this.textRefNum = new System.Windows.Forms.TextBox();
			this.label46 = new System.Windows.Forms.Label();
			this.groupAccident = new Helianz.UI.GroupBox();
			this.comboAccident = new Helianz.UI.ComboBox();
			this.label44 = new System.Windows.Forms.Label();
			this.textAccidentDate = new Helianz.ValidDate();
			this.label42 = new System.Windows.Forms.Label();
			this.textAccidentST = new System.Windows.Forms.TextBox();
			this.labelAccidentST = new System.Windows.Forms.Label();
			this.groupOrtho = new Helianz.UI.GroupBox();
			this.textOrthoTotalM = new Helianz.ValidNum();
			this.label96 = new System.Windows.Forms.Label();
			this.textOrthoDate = new Helianz.ValidDate();
			this.labelOrthoDate = new System.Windows.Forms.Label();
			this.textOrthoRemainM = new Helianz.ValidNum();
			this.checkIsOrtho = new Helianz.UI.CheckBox();
			this.labelOrthoRemainM = new System.Windows.Forms.Label();
			this.comboEmployRelated = new Helianz.UI.ComboBox();
			this.labelNote = new System.Windows.Forms.Label();
			this.comboPlaceService = new Helianz.UI.ComboBox();
			this.textNote = new Helianz.ODtextBox();
			this.label48 = new System.Windows.Forms.Label();
			this.label49 = new System.Windows.Forms.Label();
			this.tabAttachments = new Helianz.UI.TabPage();
			this.panel1 = new System.Windows.Forms.Panel();
			this.tabControlAttach = new Helianz.UI.TabControl();
			this.tabDXC = new Helianz.UI.TabPage();
			this.labelWorkflowMsg = new System.Windows.Forms.Label();
			this.tabNEA = new Helianz.UI.TabPage();
			this.groupAttachments = new Helianz.UI.GroupBox();
			...
			this.checkAttachMisc = new Helianz.UI.CheckBox();
			this.checkAttachPerio = new Helianz.UI.CheckBox();
			this.checkAttachNarrative = new Helianz.UI.CheckBox();
			this.checkAttachEoB = new Helianz.UI.CheckBox();
			this.label63 = new System.Windows.Forms.Label();
			this.textAttachModels = new Helianz.ValidNum();
			this.labelOralImages = new System.Windows.Forms.Label();
			this.textAttachImages = new Helianz.ValidNum();
			this.labelRadiographs = new System.Windows.Forms.Label();
			this.textRadiographs = new Helianz.ValidNum();
			this.groupAttachedImages = new Helianz.UI.GroupBox();
			this.butExport = new Helianz.UI.Button();
			this.butAttachAdd = new Helianz.UI.Button();
			this.butAttachPerio = new Helianz.UI.Button();
			this.labelAttachedImagesWillNotBeSent = new System.Windows.Forms.Label();
			this.listAttachments = new Helianz.UI.ListBox();
			this.tabEDS = new Helianz.UI.TabPage();
			this.butEDSClaimAttachment = new Helianz.UI.Button();
			this.textEDSAttachmentID = new Helianz.ODtextBox();
			this.label7 = new System.Windows.Forms.Label();
			this.gridEDSSent = new Helianz.UI.GridOD();
			this.tabCanadianAttachments = new Helianz.UI.TabPage();
			this.groupCanadianAttachedImages = new Helianz.UI.GroupBox();
			this.butCanadianExport = new Helianz.UI.Button();
			this.butCanadianAttachAdd = new Helianz.UI.Button();
			this.butCanadianAttachPerio = new Helianz.UI.Button();
			this.listCanadianAttachments = new Helianz.UI.ListBox();
			this.butSendCanadaAttachments = new Helianz.UI.Button();
			this.tabMisc = new Helianz.UI.TabPage();
			this.panel3 = new System.Windows.Forms.Panel();
			this.comboCorrectionType = new Helianz.UI.ComboBox();
			this.textClaimIdOriginal = new System.Windows.Forms.TextBox();
			this.textShareOfCost = new Helianz.ValidDouble();
			...
			this.comboSpecialProgram = new Helianz.UI.ComboBox();
			...
			this.tabUB04 = new Helianz.UI.TabPage();
			this.panel4 = new System.Windows.Forms.Panel();
			this.groupBox4 = new Helianz.UI.GroupBox();
			this.butPickOrderProvInternal = new Helianz.UI.Button();
			this.textOrderingProviderOverride = new System.Windows.Forms.TextBox();
			this.butPickOrderProvReferral = new Helianz.UI.Button();
			this.butNoneOrderProv = new Helianz.UI.Button();
			this.groupDateOtherCondOrTreatment = new Helianz.UI.GroupBox();
			this.textDateOther = new Helianz.ValidDate();
			this.labelDateOtherQualifier = new System.Windows.Forms.Label();
			this.labelDateOther = new System.Windows.Forms.Label();
			this.comboDateOtherQualifier = new Helianz.UI.ComboBox();
			this.groupUb04 = new Helianz.UI.GroupBox();
			this.labelBillType = new System.Windows.Forms.Label();
			this.groupValueCodes = new Helianz.UI.GroupBox();
			...
			this.checkIsOutsideLab = new Helianz.UI.CheckBox();
			this.groupDateIllnessInjuryPreg = new Helianz.UI.GroupBox();
			this.comboDateIllnessQualifier = new Helianz.UI.ComboBox();
			this.textDateIllness = new Helianz.ValidDate();
			this.labelDateIllness = new System.Windows.Forms.Label();
			this.labelDateIllnessQualifier = new System.Windows.Forms.Label();
			this.tabCanadian = new Helianz.UI.TabPage();
			this.panel5 = new System.Windows.Forms.Panel();
			this.groupBox9 = new Helianz.UI.GroupBox();
			this.label73 = new System.Windows.Forms.Label();
			this.label72 = new System.Windows.Forms.Label();
			this.comboReferralReason = new Helianz.UI.ComboBox();
			this.textReferralProvider = new System.Windows.Forms.TextBox();
			this.textCanadaTransRefNum = new System.Windows.Forms.TextBox();
			this.textCanadianAccidentDate = new Helianz.ValidDate();
			this.groupCanadaOrthoPredeterm = new Helianz.UI.GroupBox();
			...
			this.textDateCanadaEstTreatStartDate = new Helianz.ValidDate();
			this.groupBox8 = new Helianz.UI.GroupBox();
			this.checkImages = new Helianz.UI.CheckBox();
			this.checkXrays = new Helianz.UI.CheckBox();
			this.checkModels = new Helianz.UI.CheckBox();
			this.checkCorrespondence = new Helianz.UI.CheckBox();
			this.checkEmail = new Helianz.UI.CheckBox();
			this.label76 = new System.Windows.Forms.Label();
			this.groupMaxPros = new Helianz.UI.GroupBox();
			this.comboMaxProsth = new Helianz.UI.ComboBox();
			this.label69 = new System.Windows.Forms.Label();
			this.textDateInitialUpper = new Helianz.ValidDate();
			this.label70 = new System.Windows.Forms.Label();
			this.comboMaxProsthMaterial = new Helianz.UI.ComboBox();
			this.label71 = new System.Windows.Forms.Label();
			this.butReverse = new Helianz.UI.Button();
			this.groupMandPros = new Helianz.UI.GroupBox();
			this.comboMandProsth = new System.Windows.Forms.ComboBox();
			this.label66 = new System.Windows.Forms.Label();
			this.textDateInitialLower = new Helianz.ValidDate();
			this.label67 = new System.Windows.Forms.Label();
			this.comboMandProsthMaterial = new Helianz.UI.ComboBox();
			this.label68 = new System.Windows.Forms.Label();
			this.textMissingTeeth = new System.Windows.Forms.TextBox();
			this.butMissingTeethHelp = new Helianz.UI.Button();
			...
			this.checkCanadianIsOrtho = new Helianz.UI.CheckBox();
			this.listExtractedTeeth = new Helianz.UI.ListBox();
			this.tabHistory = new Helianz.UI.TabPage();
			this.labelHistoryNone = new System.Windows.Forms.Label();
			this.butAdd = new Helianz.UI.Button();
			this.gridStatusHistory = new Helianz.UI.GridOD();
			this.butViewEra = new Helianz.UI.Button();
			this.butPickProvTreat = new Helianz.UI.Button();
			this.butPickProvBill = new Helianz.UI.Button();
			this.butResend = new Helianz.UI.Button();
			this.textDateSent = new Helianz.ValidDate();
			this.labelDateSent = new System.Windows.Forms.Label();
			this.comboClaimForm = new Helianz.UI.ComboBox();
			this.label87 = new System.Windows.Forms.Label();
			this.comboMedType = new Helianz.UI.ComboBox();
			this.label86 = new System.Windows.Forms.Label();
			this.comboClaimType = new Helianz.UI.ComboBox();
			this.butHistory = new Helianz.UI.Button();
			this.textReasonUnder = new System.Windows.Forms.TextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.gridPay = new Helianz.UI.GridOD();
			this.groupEnterPayment = new Helianz.UI.GroupBox();
			this.butPaySupp = new Helianz.UI.Button();
			this.butPayTotal = new Helianz.UI.Button();
			this.butPayProc = new Helianz.UI.Button();
			this.label20 = new System.Windows.Forms.Label();
			this.butSend = new Helianz.UI.Button();
			this.gridProc = new Helianz.UI.GridOD();
			this.butSplit = new Helianz.UI.Button();
			this.butLabel = new Helianz.UI.Button();
			this.comboClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.textDateService = new Helianz.ValidDate();
			this.textWriteOff = new Helianz.ValidDouble();
			this.textInsPayEst = new System.Windows.Forms.TextBox();
			this.textInsPayAmt = new Helianz.ValidDouble();
			this.textClaimFee = new System.Windows.Forms.TextBox();
			this.textDedApplied = new Helianz.ValidDouble();
			this.textPredeterm = new System.Windows.Forms.TextBox();
			this.textDateSentOrig = new Helianz.ValidDate();
			this.textDateRec = new Helianz.ValidDate();
			this.butPreview = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.butRecalc = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.butOtherNone = new Helianz.UI.Button();
			this.butOtherCovChange = new Helianz.UI.Button();
			this.comboPatRelat2 = new Helianz.UI.ComboBox();
			this.label10 = new System.Windows.Forms.Label();
			this.textPlan2 = new System.Windows.Forms.TextBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.comboPatRelat = new Helianz.UI.ComboBox();
			this.label5 = new System.Windows.Forms.Label();
			this.textPlan = new System.Windows.Forms.TextBox();
			this.label9 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.comboProvTreat = new Helianz.UI.ComboBox();
			this.comboProvBill = new Helianz.UI.ComboBox();
			...
			this.comboClaimStatus = new Helianz.UI.ComboBox();
			this.textPatResp = new Helianz.ValidDouble();
			this.groupBoxPendingPayment = new Helianz.UI.GroupBox();
			this.butInsuranceOverpaid = new Helianz.UI.Button();
			this.butInsuranceUnderpaid = new Helianz.UI.Button();
			this.warningIntegrity = new Helianz.UI.WarningIntegrity();
			...
			// butBatch
			// 
			this.butBatch.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butThisClaimOnly
			// 
			this.butThisClaimOnly.Icon = Helianz.UI.EnumIcons.Add;
    ...
    "arrier.";
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Claim;
			...
			this.textEDSAttachmentID.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Claim;
			...
			this.gridEDSSent.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSent_CellDoubleClick);
			// 
			...
			this.gridStatusHistory.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridStatusHistory_CellDoubleClick);
			// 
			// butViewEra
			// 
			...
			this.gridPay.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPay_CellDoubleClick);
			this.gridPay.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPay_CellClick);
			// 
			// groupEnterPayment
			// 
			...
			this.gridProc.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProc.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProc_CellDoubleClick);
			this.gridProc.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridProc_CellClick);
			// 
			// butSplit
			// 
			...
			this.butLabel.Image = global::Helianz.Properties.Resources.butLabel;
			...
			this.butPreview.Image = global::Helianz.Properties.Resources.butPreview;
		...
		private Helianz.UI.GroupBox groupProsth;
		private System.Windows.Forms.Label labelMissingTeeth;
		private System.Windows.Forms.TextBox textPredeterm;
		private Helianz.ValidDate textDateRec;
		private Helianz.ValidDate textDateSentOrig;
		...
		private Helianz.ValidDouble textDedApplied;
		private Helianz.ValidDouble textInsPayAmt;
		private Helianz.ValidDate textPriorDate;
		private Helianz.UI.GroupBox groupOrtho;
		private System.Windows.Forms.Label labelOrthoRemainM;
		private Helianz.UI.CheckBox checkIsOrtho;
		private Helianz.ValidNum textOrthoRemainM;
		private Helianz.ValidDate textOrthoDate;
		...
		private Helianz.UI.ComboBox comboPatRelat;
		private Helianz.UI.ComboBox comboPatRelat2;
		private System.Windows.Forms.TextBox textPlan2;
		private Helianz.UI.Button butRecalc;
		private System.Windows.Forms.TextBox textInsPayEst;
		private Helianz.ValidDouble textWriteOff;
		private Helianz.UI.Button butPreview;
		private Helianz.UI.Button butPrint;
		private Helianz.UI.Button butOtherNone;
		private Helianz.UI.Button butOtherCovChange;
		private Helianz.ODtextBox textNote;
		private UI.ComboBoxClinicPicker comboClinic;
		private Helianz.UI.Button butLabel;
		private Helianz.UI.Button butSplit;
		private Helianz.UI.Button butSend;
		private Helianz.UI.Button butHistory;
		private Helianz.ValidDate textDateService;
		private UI.Button butExport;
		private UI.Button butAttachAdd;
		private UI.Button butAttachPerio;
		private Helianz.UI.Button butPaySupp;
		private Helianz.UI.Button butPayTotal;
		private Helianz.UI.Button butPayProc;
		private Helianz.UI.Button butReferralSelect;
		private Helianz.UI.Button butReferralNone;
		private Helianz.UI.Button butReferralEdit;
		private Helianz.UI.Button butMissingTeethHelp;
		...
		private Helianz.UI.CheckBox checkImages;
		private Helianz.UI.CheckBox checkXrays;
		private Helianz.UI.CheckBox checkModels;
		private Helianz.UI.CheckBox checkCorrespondence;
		private Helianz.UI.CheckBox checkEmail;
		private Helianz.UI.ComboBox comboReferralReason;
		private System.Windows.Forms.TextBox textReferralProvider;
		private Helianz.UI.ComboBox comboMaxProsth;
		private Helianz.UI.GroupBox groupMandPros;
		private System.Windows.Forms.ComboBox comboMandProsth;
		private ValidDate textDateInitialLower;
		private Helianz.UI.ComboBox comboMandProsthMaterial;
		private ValidDate textCanadianAccidentDate;
		private Helianz.UI.GroupBox groupAccident;
		private Helianz.UI.CheckBox checkCanadianIsOrtho;
		...
		private Helianz.UI.ListBox listExtractedTeeth;
		private Helianz.UI.GroupBox groupValueCodes;
		...
		private Helianz.UI.ComboBox comboAccident;
		private System.Windows.Forms.Label labelAccidentST;
		private Helianz.UI.ComboBox comboEmployRelated;
		private System.Windows.Forms.TextBox textAccidentST;
		private Helianz.UI.ComboBox comboPlaceService;
		...
		private Helianz.UI.GroupBox groupMaxPros;
		private ValidDate textDateInitialUpper;
		private Helianz.UI.ComboBox comboMaxProsthMaterial;
		private Helianz.UI.GroupBox groupCanadaOrthoPredeterm;
		...
		private Helianz.UI.ComboBox comboMedType;
		private Helianz.UI.ComboBox comboClaimForm;
		...
		private Helianz.UI.ComboBox comboCorrectionType;
		private Helianz.UI.GroupBox groupAttachments;
		...
		private Helianz.UI.CheckBox checkAttachMisc;
		private Helianz.UI.CheckBox checkAttachPerio;
		private Helianz.UI.CheckBox checkAttachNarrative;
		private Helianz.UI.CheckBox checkAttachEoB;
		...
		private Helianz.UI.GroupBox groupEnterPayment;
		private Helianz.UI.GroupBox groupReferral;
		private Helianz.UI.GroupBox groupUb04;
		private Helianz.UI.GroupBox groupAttachedImages;
		private Helianz.UI.ListBox listAttachments;
		private Helianz.UI.TabControl tabControlMain;
		private Helianz.UI.TabPage tabUB04;
		private Helianz.UI.TabPage tabGeneral;
		private Helianz.UI.TabPage tabCanadian;
		private Helianz.UI.TabPage tabCanadianAttachments;
		private ValidNum textOrthoTotalM;
		private Helianz.UI.TabPage tabHistory;
		private Helianz.UI.TabPage tabAttachments;
		private Helianz.UI.TabPage tabMisc;
		...
		private Helianz.UI.GroupBox groupFinalizePayment;
		private UI.Button butThisClaimOnly;
		private UI.Button butViewEob;
		private Helianz.UI.TabControl tabControlAttach;
		private Helianz.UI.TabPage tabNEA;
		private Helianz.UI.TabPage tabDXC;
		private System.Windows.Forms.ErrorProvider _recalcErrorProvider;
		private Helianz.UI.GroupBox groupDateOtherCondOrTreatment;
		...
		private Helianz.UI.GroupBox groupDateIllnessInjuryPreg;
		private Helianz.UI.CheckBox checkIsOutsideLab;
		private Helianz.UI.ComboBox comboClaimStatus;
