namespace Helianz{
	partial class FormQuickBooksSetup {
		...
		private void InitializeComponent() {
			...
			this.buttonRemoveClassRefQB = new Helianz.UI.Button();
			this.buttonAddClassRefQB = new Helianz.UI.Button();
			this.listBoxClassRefsQB = new Helianz.UI.ListBox();
			this.labelClass = new System.Windows.Forms.Label();
			this.butRemoveIncomeQB = new Helianz.UI.Button();
			this.checkQuickBooksClassRefsEnabled = new Helianz.UI.CheckBox();
			this.butAddIncomeQB = new Helianz.UI.Button();
			this.listBoxIncomeAccountsQB = new Helianz.UI.ListBox();
			...
			this.butConnectQB = new Helianz.UI.Button();
			this.butBrowseQB = new Helianz.UI.Button();
			this.labelCompanyFile = new System.Windows.Forms.Label();
			this.textCompanyFileQB = new System.Windows.Forms.TextBox();
			this.listBoxDepositAccountsQB = new Helianz.UI.ListBox();
			this.butRemoveDepositQB = new Helianz.UI.Button();
			this.butAddDepositQB = new Helianz.UI.Button();
    ...
    " first time using QuickBooks with Helianz. (Only need to do this once)";
			...
			this.labelWarning.Text = "Helianz will run faster if your QuickBooks company file is open in the backgr" +
    "ound.";
    ...
    "";
		...
		private Helianz.UI.ListBox listBoxClassRefsQB;
		private System.Windows.Forms.Label labelClass;
		private UI.Button butRemoveIncomeQB;
		private Helianz.UI.CheckBox checkQuickBooksClassRefsEnabled;
		private UI.Button butAddIncomeQB;
		private Helianz.UI.ListBox listBoxIncomeAccountsQB;
		...
		private Helianz.UI.ListBox listBoxDepositAccountsQB;
