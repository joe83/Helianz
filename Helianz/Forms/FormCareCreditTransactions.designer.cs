namespace Helianz{
	partial class FormCareCreditTransactions {
		...
		private void InitializeComponent() {
			...
			this.tabTrans = new Helianz.UI.TabPage();
			this.tabQSBatchTrans = new Helianz.UI.TabPage();
			this.butNoneQSBatch = new Helianz.UI.Button();
			this.butButAllQSTrans = new Helianz.UI.Button();
			this.labelProcessQSBatches = new System.Windows.Forms.Label();
			this.butProcessBatchQS = new Helianz.UI.Button();
			this.gridQSBatchTrans = new Helianz.UI.GridOD();
			this.tabErrors = new Helianz.UI.TabPage();
			this.butNone = new Helianz.UI.Button();
			this.butAll = new Helianz.UI.Button();
			this.butAck = new Helianz.UI.Button();
			this.gridError = new Helianz.UI.GridOD();
			this.checkIncludeAck = new Helianz.UI.CheckBox();
			this.labelStatus = new System.Windows.Forms.Label();
			this.comboStatuses = new Helianz.UI.ComboBox();
			...
			this.gridMain.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCur_CellDoubleClick);
			// 
			// butRefresh
			// 
			...
			this.gridQSBatchTrans.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridError.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridError.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCur_CellDoubleClick);
			// 
			// checkIncludeAck
			// 
		...
		private Helianz.UI.TabPage tabTrans;
		private Helianz.UI.TabPage tabErrors;
		...
		private Helianz.UI.TabPage tabQSBatchTrans;
