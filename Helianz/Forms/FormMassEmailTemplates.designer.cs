namespace Helianz{
	partial class FormMassEmailTemplates {
		...
		private void InitializeComponent() {
			...
			this.userControlEmailTemplate = new Helianz.UserControlEmailTemplate();
			this.butEditTemplate = new Helianz.UI.Button();
			this.butImport = new Helianz.UI.Button();
			this.butNewTemplate = new Helianz.UI.Button();
			...
			this.butExamples = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			...
			// butNewTemplate
			// 
			this.butNewTemplate.Icon = Helianz.UI.EnumIcons.Add;
