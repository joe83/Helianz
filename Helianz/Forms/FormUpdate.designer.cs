namespace Helianz {
	partial class FormUpdate {
		...
		private void InitializeComponent() {
			...
			this.butDownload = new Helianz.UI.Button();
			this.textConnectionMessage = new System.Windows.Forms.TextBox();
			this.groupBuild = new Helianz.UI.GroupBox();
			this.butDownloadMsiBuild = new Helianz.UI.Button();
			this.textBuild = new System.Windows.Forms.TextBox();
			this.butInstallBuild = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.groupBeta = new Helianz.UI.GroupBox();
			this.checkAcknowledgeBeta = new Helianz.UI.CheckBox();
			this.butDownloadMsiBeta = new Helianz.UI.Button();
			this.textBeta = new System.Windows.Forms.TextBox();
			this.butInstallBeta = new Helianz.UI.Button();
			this.label5 = new System.Windows.Forms.Label();
			this.groupStable = new Helianz.UI.GroupBox();
			this.butDownloadMsiStable = new Helianz.UI.Button();
			this.textStable = new System.Windows.Forms.TextBox();
			this.butInstallStable = new Helianz.UI.Button();
			this.label11 = new System.Windows.Forms.Label();
			this.butCheck2 = new Helianz.UI.Button();
			this.butShowUpdateHistory = new Helianz.UI.Button();
			this.groupAlpha = new Helianz.UI.GroupBox();
			this.butDownloadMsiAlpha = new Helianz.UI.Button();
			this.textAlpha = new System.Windows.Forms.TextBox();
			this.butInstallAlpha = new Helianz.UI.Button();
    ...
    "ersion only if you demand the latest features.  Be sure to update regularly.";
		...
		private Helianz.UI.Button butDownload;
		...
		private Helianz.UI.GroupBox groupBuild;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.TextBox textBuild;
		private Helianz.UI.Button butInstallBuild;
		private Helianz.UI.GroupBox groupBeta;
		private System.Windows.Forms.TextBox textBeta;
		private Helianz.UI.Button butInstallBeta;
		private System.Windows.Forms.Label label5;
		private Helianz.UI.GroupBox groupStable;
		private System.Windows.Forms.TextBox textStable;
		private Helianz.UI.Button butInstallStable;
		private System.Windows.Forms.Label label11;
		private Helianz.UI.Button butCheck2;//OD1
		private Helianz.UI.Button butDownloadMsiBuild;
		private Helianz.UI.Button butDownloadMsiBeta;
		private Helianz.UI.Button butDownloadMsiStable;
		private Helianz.UI.Button butShowUpdateHistory;
		private Helianz.UI.GroupBox groupAlpha;
		...
		private Helianz.UI.CheckBox checkAcknowledgeBeta;
