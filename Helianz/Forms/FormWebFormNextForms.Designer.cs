namespace Helianz{
	partial class FormWebFormNextForms {
		...
		private void InitializeComponent() {
			...
			this.gridWebFormsAvailable = new Helianz.UI.GridOD();
			this.gridWebFormsSelected = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.gridWebFormsAvailable.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridWebFormsSelected.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
