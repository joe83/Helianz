	...
	public partial class FormXchargeSetup : FormODBase {
		...
		private void FormXchargeSetup_Load(object sender,EventArgs e) {
			...
			if(ODEnvironment.IsCloudServer) {
				linkLabel1.Text+="\r\n"+Lans.g(this,"X-Charge is not supported while using Helianz Cloud. Use EdgeExpress instead.");
			}
		...
		private void linkLabel1_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			string url="https://helianz.com/resources/redirects/redirectopenedge.html";
