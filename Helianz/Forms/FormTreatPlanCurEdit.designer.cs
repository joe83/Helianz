namespace Helianz{
	partial class FormTreatPlanCurEdit {
		...
		private void InitializeComponent() {
			...
			this.gridAll = new Helianz.UI.GridOD();
			this.gridTP = new Helianz.UI.GridOD();
			this.butMakeActive = new Helianz.UI.Button();
			...
			this.gridAll.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAll.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grids_CellClick);
			...
			this.gridTP.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridTP.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grids_CellClick);
