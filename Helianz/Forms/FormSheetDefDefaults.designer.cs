namespace Helianz{
	partial class FormSheetDefDefaults {
		...
		private void InitializeComponent() {
			...
			this.comboClinicDefault = new Helianz.UI.ComboBoxClinicPicker();
			this.comboRx = new Helianz.UI.ComboBox();
			this.label7 = new System.Windows.Forms.Label();
			this.comboBoxChartLayout = new Helianz.UI.ComboBox();
			...
			this.comboTreatmentPlan = new Helianz.UI.ComboBox();
			this.groupBoxOD2 = new Helianz.UI.GroupBox();
			this.comboReceipt = new Helianz.UI.ComboBox();
			this.comboInvoice = new Helianz.UI.ComboBox();
			this.comboLimited = new Helianz.UI.ComboBox();
			this.comboStatements = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.comboLabel = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.ComboBoxClinicPicker comboClinicDefault;
