namespace Helianz {
	partial class FormEtrans835s {
		...
		private void InitializeComponent() {
			...
			this.smsService1 = new Helianz.CallFireService.SMSService();
			this.listStatus = new Helianz.UI.ListBox();
			this.butRefresh = new Helianz.UI.Button();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.textRangeMin = new Helianz.ValidNum();
			this.textRangeMax = new Helianz.ValidNum();
			...
			this.textControlId = new Helianz.ODtextBox();
			this.textCarrier = new Helianz.ODtextBox();
			this.textCheckTrace = new Helianz.ODtextBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.checkAutomatableCarriersOnly = new Helianz.UI.CheckBox();
			this.checkShowFinalizedOnly = new Helianz.UI.CheckBox();
			this.butAutoProcessedEras = new Helianz.UI.Button();
			...
			this.listStatus.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.textControlId.QuickPasteType = HelianzBusiness.EnumQuickPasteType.InsPlan;
			...
			this.textCarrier.QuickPasteType = HelianzBusiness.EnumQuickPasteType.InsPlan;
			...
			this.textCheckTrace.QuickPasteType = HelianzBusiness.EnumQuickPasteType.FinancialNotes;
		...
		private Helianz.UI.CheckBox checkAutomatableCarriersOnly;
		private Helianz.UI.CheckBox checkShowFinalizedOnly;
