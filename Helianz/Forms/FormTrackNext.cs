...
namespace Helianz{
	...
	public partial class FormTrackNext : FormODBase {
		...
		private void SendPinboard_Click() {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Appointments, listPinApptNums:listAptNum,dateSelected:DateTime.Today);//This will send all appointments in _listAptSelected to the pinboard, and will select the patient attached to the last appointment in _listAptSelected.
			FillGrid();
		}
