...
///<summary></summary>
	public partial class FormUnsched:FormODBase {
		...
		private void SelectPatient_Click() {
			...
			GlobalFormHelianz.PatientSelected(patient,true);
		}
		...
		private void SendPinboard_Click() {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Appointments, listPinApptNums:_listAptNumsSelected, dateSelected:DateTime.Today);//This will send all appointments in _listAptSelected to the pinboard, and will select the patient attached to the last appointment in _listAptSelected.
		}
