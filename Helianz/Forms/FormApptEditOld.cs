...
namespace Helianz{
	...
	public class FormApptEditOld : System.Windows.Forms.Form{
		...
		private Helianz.UI.Button butCalcTime;
		...
		private Helianz.TableApptProcs tbProc;// Required designer variable.
		///<summary></summary>
		public bool IsNew;
		private Procedure[] arrayProc;
		private ApptProc[] ApptProc2;
		private Helianz.ValidNum textAddTime;
		...
		private Helianz.TableCommLog tbCommlog;
		...
		public FormApptEditOld(Appointment aptCur){
			...
			tbTime.CellClicked += new Helianz.ContrTable.CellEventHandler(tbTime_CellClicked);
			tbProc.CellClicked += new Helianz.ContrTable.CellEventHandler(tbProc_CellClicked);
			tbCommlog.CellDoubleClicked+=new Helianz.ContrTable.CellEventHandler(tbCommlog_CellDoubleClicked);
			Lan.F(this);
			AptCur=aptCur;
			AptOld=aptCur.Copy();
		}
		...
		private void InitializeComponent(){
			...
			this.butCalcTime = new Helianz.UI.Button();
			...
			this.tbProc = new Helianz.TableApptProcs();
			...
			this.textAddTime = new Helianz.ValidNum();
			...
			this.tbCommlog = new Helianz.TableCommLog();
			...
			this.butCalcTime.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butCalcTime.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
    ...
    "pointment";
			...
			this.butAddComm.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butAddComm.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butAddComm.CornerRadius = 4F;
			this.butAddComm.Image = global::Helianz.Properties.Resources.Add;
			...
			this.butPin.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butPin.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.textNote.QuickPasteType = HelianzBusiness.QuickPasteType.Appointment;
			...
			this.butTask.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butTask.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butAudit.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butAudit.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
