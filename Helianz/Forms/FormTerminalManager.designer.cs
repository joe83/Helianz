namespace Helianz {
	partial class FormTerminalManager {
		...
		private void InitializeComponent()
		{
			...
			this.groupBoxPassword = new Helianz.UI.GroupBox();
			this.textPassword = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.butSave = new Helianz.UI.Button();
			this.groupBoxPatient = new Helianz.UI.GroupBox();
			this.butRemoveTreatPlan = new Helianz.UI.Button();
			this.listTreatPlans = new Helianz.UI.ListBox();
			this.labelTreatPlans = new System.Windows.Forms.Label();
			this.butPatForms = new Helianz.UI.Button();
			this.labelSheets = new System.Windows.Forms.Label();
			this.labelPatient = new System.Windows.Forms.Label();
			this.listSheets = new Helianz.UI.ListBox();
			this.butByod = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.contrClinicPicker = new Helianz.UI.ComboBoxClinicPicker();
    ...
    "ght.  You will need to enter this password:";
		...
		private Helianz.UI.GroupBox groupBoxPatient;
		private Helianz.UI.ListBox listSheets;
		private System.Windows.Forms.Label labelSheets;
		private System.Windows.Forms.Label labelPatient;
		private Helianz.UI.GroupBox groupBoxPassword;
