...
namespace Helianz {
	public partial class FormSchedule {
		...
		private void InitializeComponent()
		{
			...
			this.checkWarnProvOverlap = new Helianz.UI.CheckBox();
			this.checkPracticeNotes = new Helianz.UI.CheckBox();
			this.listBoxEmps = new Helianz.UI.ListBox();
			this.tabControl1 = new Helianz.UI.TabControl();
			this.tabPageProv = new Helianz.UI.TabPage();
			this.tabPageEmp = new Helianz.UI.TabPage();
			this.checkClinicNotes = new Helianz.UI.CheckBox();
			this.butClearWeek = new Helianz.UI.Button();
			...
			this.checkShowClinicSchedules = new Helianz.UI.CheckBox();
			this.groupCopy = new Helianz.UI.GroupBox();
			this.butCopyWeek = new Helianz.UI.Button();
			this.butCopyDay = new Helianz.UI.Button();
			this.textClipboard = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.groupPaste = new Helianz.UI.GroupBox();
			this.butRepeat = new Helianz.UI.Button();
			this.label4 = new System.Windows.Forms.Label();
			this.checkReplace = new Helianz.UI.CheckBox();
			this.textRepeat = new System.Windows.Forms.TextBox();
			this.butPaste = new Helianz.UI.Button();
			this.groupBoxFilter = new Helianz.UI.GroupBox();
			this.groupBoxWeekFilter = new Helianz.UI.GroupBox();
			...
			this.listBoxEmps.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			// butClearWeek
			// 
			this.butClearWeek.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.Button butRefresh;
		...
		private Helianz.UI.Button butClearWeek;
		private Helianz.UI.CheckBox checkPracticeNotes;
		private Helianz.UI.ListBox listBoxEmps;
		private Helianz.UI.TabControl tabControl1;
		private Helianz.UI.TabPage tabPageProv;
		private Helianz.UI.TabPage tabPageEmp;
		private Helianz.UI.CheckBox checkClinicNotes;
		private UI.ComboBoxClinicPicker comboClinic;
		private Helianz.UI.CheckBox checkShowClinicSchedules;
		private Helianz.UI.CheckBox checkWarnProvOverlap;
		private Helianz.UI.GroupBox groupCopy;
		private UI.Button butCopyWeek;
		private UI.Button butCopyDay;
		private TextBox textClipboard;
		private Label label3;
		private Helianz.UI.GroupBox groupPaste;
		private UI.Button butRepeat;
		private Label label4;
		private Helianz.UI.CheckBox checkReplace;
		private TextBox textRepeat;
		private UI.Button butPaste;
		private Helianz.UI.GroupBox groupBoxFilter;
		private Helianz.UI.GroupBox groupBoxWeekFilter;
