...
namespace Helianz {
	public partial class FormFeesForIns {
		...
		private void InitializeComponent()
		{
			...
			this.comboFeeSchedWithout = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.comboFeeSchedWith = new Helianz.UI.ComboBox();
			this.label4 = new System.Windows.Forms.Label();
			this.comboFeeSchedNew = new Helianz.UI.ComboBox();
			...
			this.butChangeFeeSchedule = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.comboInsPlanTypeWith = new Helianz.UI.ComboBox();
			this.comboInsPlanType = new Helianz.UI.ComboBox();
			this.label7 = new System.Windows.Forms.Label();
			this.butChangeInsPlanType = new Helianz.UI.Button();
    ...
    "ched.";
		...
		#endregion
		private Helianz.UI.Button butChangeFeeSchedule;
		private Helianz.UI.GridOD gridMain;
		private TextBox textCarrier;
		private Label label2;
		private Label label1;
		private Helianz.UI.ComboBox comboFeeSchedWithout;
		private Label label3;
		private Helianz.UI.ComboBox comboFeeSchedWith;
		private Label label4;
		private Helianz.UI.ComboBox comboFeeSchedNew;
