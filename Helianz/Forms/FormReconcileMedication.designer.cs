namespace Helianz{
	partial class FormReconcileMedication {
		...
		private void InitializeComponent() {
			...
			this.gridMedExisting = new Helianz.UI.GridOD();
			this.gridMedImport = new Helianz.UI.GridOD();
			this.gridMedReconcile = new Helianz.UI.GridOD();
			...
			this.gridMedExisting.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridMedImport.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridMedReconcile.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
