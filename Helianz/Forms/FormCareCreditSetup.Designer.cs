namespace Helianz {
	partial class FormCareCreditSetup {
		...
		private void InitializeComponent() {
			...
			this.listBoxQSOptions = new Helianz.UI.ListBox();
			...
			this.groupQSBatch = new Helianz.UI.GroupBox();
			this.comboBoxDaysOut = new Helianz.UI.ComboBox();
			...
			this.groupPromotions = new Helianz.UI.GroupBox();
			this.butPromotions = new Helianz.UI.Button();
			this.comboClinics = new Helianz.UI.ComboBoxClinicPicker();
			this.comboPatFieldDef = new Helianz.UI.ComboBox();
			...
			this.checkMerchantNumByProv = new Helianz.UI.CheckBox();
			this.checkHideAdvertising = new Helianz.UI.CheckBox();
			this.labelMerchantClosedDescription = new System.Windows.Forms.Label();
			this.comboPatFieldPreApprvAmt = new Helianz.UI.ComboBox();
			this.labelPreApprvAmt = new System.Windows.Forms.Label();
			this.comboPatFieldAvailableCredit = new Helianz.UI.ComboBox();
    ...
    " the manual for more information.";
		...
		private Helianz.UI.GroupBox groupPromotions;
		private UI.Button butPromotions;
		private Helianz.UI.GroupBox groupQSBatch;
		...
		private Helianz.UI.CheckBox checkMerchantNumByProv;
		private Helianz.UI.CheckBox checkHideAdvertising;
