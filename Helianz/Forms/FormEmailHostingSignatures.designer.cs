namespace Helianz {
	partial class FormEmailHostingSignatures {
		...
		private void InitializeComponent() {
			...
			this.butEditSignature = new Helianz.UI.Button();
			...
			this.comboClinicMassEmail = new Helianz.UI.ComboBoxClinicPicker();
			...
			this.butEditSignature.Image = global::Helianz.Properties.Resources.editPencil;
