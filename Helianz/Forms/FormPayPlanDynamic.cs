...
namespace Helianz {
	///<summary>This window is used to set up Dyanmic Payment Plans.  These rules will be used by the HelianzService for making charges.</summary>
	public partial class FormPayPlanDynamic : FormODBase {
		...
		private void gridCharges_CellDoubleClick(object sender,Helianz.UI.ODGridClickEventArgs e) {
