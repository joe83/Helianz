...
namespace Helianz {
	public partial class FormTimeCardSetup {
		...
		private void InitializeComponent() {
			...
			this.checkUseDecimal = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.checkShowSeconds = new Helianz.UI.CheckBox();
			this.checkAdjOverBreaks = new Helianz.UI.CheckBox();
			this.butAddRule = new Helianz.UI.Button();
			this.gridRules = new Helianz.UI.GridOD();
			...
			this.butGenerate = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.checkHideOlder = new Helianz.UI.CheckBox();
			this.butDeleteRules = new Helianz.UI.Button();
			...
			this.butAddRule.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridRules.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridRules.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridRules_CellDoubleClick);
			// 
			// gridMain
			// 
			...
			this.butGenerate.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butDeleteRules.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.CheckBox checkUseDecimal;
		private UI.GridOD gridRules;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.Button butAddRule;
		private Helianz.UI.CheckBox checkAdjOverBreaks;
		private Label label2;
		private TextBox textADPCompanyCode;
		private Helianz.UI.CheckBox checkShowSeconds;
		private UI.Button butGenerate;
		private UI.Button butDelete;
		private Helianz.UI.CheckBox checkHideOlder;
