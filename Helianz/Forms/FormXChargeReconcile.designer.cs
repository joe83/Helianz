namespace Helianz{
	partial class FormXChargeReconcile {
		...
		private void InitializeComponent() {
			...
			this.butExtra = new Helianz.UI.Button();
			this.butMissing = new Helianz.UI.Button();
			this.butPayments = new Helianz.UI.Button();
			this.butViewImported = new Helianz.UI.Button();
			this.butImport = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.butValidate = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label5
			// 
			...
			this.label7.Text = "View credit card payments in Helianz.";
