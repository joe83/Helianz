namespace Helianz{
	partial class FormEmailAddresses {
		...
		private void InitializeComponent() {
			...
			this.groupEmailPrefs = new Helianz.UI.GroupBox();
			this.label1 = new System.Windows.Forms.Label();
			this.butSetDefault = new Helianz.UI.Button();
			this.butWebMailNotify = new Helianz.UI.Button();
			...
			this.checkEmailDisclaimer = new Helianz.UI.CheckBox();
    ...
    "red.";
		...
		private Helianz.UI.Button butSetDefault;
		...
		private Helianz.UI.GroupBox groupEmailPrefs;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label2;
		private Helianz.UI.CheckBox checkEmailDisclaimer;
	}
}