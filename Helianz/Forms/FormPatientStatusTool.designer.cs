namespace Helianz {
	partial class FormPatientStatusTool {
		...
		private void InitializeComponent() {
			...
			this.comboPatientStatusCur = new Helianz.UI.ComboBox();
