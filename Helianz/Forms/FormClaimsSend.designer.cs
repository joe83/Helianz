...
namespace Helianz {
	public partial class FormClaimsSend {
		...
		private void InitializeComponent(){
			...
			this.comboHistoryType = new Helianz.UI.ComboBox();
			this.gridHistory = new Helianz.UI.GridOD();
			this.panel1 = new System.Windows.Forms.Panel();
			this.ToolBarHistory = new Helianz.UI.ToolBarOD();
			this.comboClinic = new Helianz.UI.ComboBox();
			this.labelClinic = new System.Windows.Forms.Label();
			this.contextMenuEclaims = new System.Windows.Forms.ContextMenu();
			this.comboCustomTracking = new Helianz.UI.ComboBox();
			this.labelCustomTracking = new System.Windows.Forms.Label();
			this.butNextUnsent = new Helianz.UI.Button();
			...
			this.gridHistory.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridHistory.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridHistory_CellDoubleClick);
			// 
			// panel1
			// 
			...
			this.ToolBarHistory.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.ToolBarHistory_ButtonClick);
			// 
			// comboClinic
			// 
		...
		private Helianz.UI.GridOD gridHistory;
		private Helianz.UI.ToolBarOD ToolBarHistory;
		private Panel panelSplitter;
		private Panel panelHistory;
		private Panel panel1;
		private Helianz.UI.ComboBox comboClinic;
		private Label labelClinic;
		private Helianz.UI.ComboBox comboCustomTracking;
		private Label labelCustomTracking;
		private Helianz.UI.ComboBox comboHistoryType;
