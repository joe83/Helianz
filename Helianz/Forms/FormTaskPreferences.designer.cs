namespace Helianz{
	partial class FormTaskPreferences {
		...
		private void InitializeComponent() {
			...
			this.checkTaskSortApptDateTime = new Helianz.UI.CheckBox();
			this.checkShowOpenTickets = new Helianz.UI.CheckBox();
			this.checkTasksNewTrackedByUser = new Helianz.UI.CheckBox();
			this.groupBoxComputerDefaults = new Helianz.UI.GroupBox();
			this.radioRight = new System.Windows.Forms.RadioButton();
			this.radioBottom = new System.Windows.Forms.RadioButton();
			this.validNumY = new Helianz.ValidNum();
			this.labelY = new System.Windows.Forms.Label();
			this.validNumX = new Helianz.ValidNum();
			this.labelX = new System.Windows.Forms.Label();
			this.checkBoxTaskKeepListHidden = new Helianz.UI.CheckBox();
			this.checkTaskListAlwaysShow = new Helianz.UI.CheckBox();
			this.checkShowLegacyRepeatingTasks = new Helianz.UI.CheckBox();
			this.groupBoxDatabase = new Helianz.UI.GroupBox();
			this.checkTaskToApptOneToOne = new Helianz.UI.CheckBox();
			this.labelImageCategoryFolder = new System.Windows.Forms.Label();
			this.comboImageCategoryFolders = new Helianz.UI.ComboBox();
			this.labelGlobalFilter = new System.Windows.Forms.Label();
			this.butTaskInboxSetup = new Helianz.UI.Button();
			this.comboFilterDefault = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.CheckBox checkTaskSortApptDateTime;
		private Helianz.UI.CheckBox checkShowOpenTickets;
		private Helianz.UI.CheckBox checkTasksNewTrackedByUser;
		private Helianz.UI.GroupBox groupBoxComputerDefaults;
		...
		private Helianz.UI.CheckBox checkBoxTaskKeepListHidden;
		private Helianz.UI.CheckBox checkTaskListAlwaysShow;
		private Helianz.UI.CheckBox checkShowLegacyRepeatingTasks;
		private Helianz.UI.GroupBox groupBoxDatabase;
