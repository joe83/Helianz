namespace Helianz{
	partial class FormFHIRSetup {
		...
		private void InitializeComponent() {
			...
			this.listPermissions = new Helianz.UI.ListBox();
			this.butGenerateKey = new Helianz.UI.Button();
			this.checkEnabled = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.textSubInterval = new Helianz.ValidDouble();
			this.label1 = new System.Windows.Forms.Label();
			this.comboPayType = new Helianz.UI.ComboBox();
			this.butViewLicense = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butSave
			// 
			...
			this.listPermissions.SelectionMode = Helianz.UI.SelectionMode.None;
