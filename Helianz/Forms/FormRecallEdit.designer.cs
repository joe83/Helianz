...
namespace Helianz {
	public partial class FormRecallEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkIsDisabled = new Helianz.UI.CheckBox();
			this.label9 = new System.Windows.Forms.Label();
			this.comboType = new Helianz.UI.ComboBox();
			this.label10 = new System.Windows.Forms.Label();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.textBalance = new Helianz.ValidDouble();
			this.textDisableDate = new Helianz.ValidDate();
			...
			this.textDateDue = new Helianz.ValidDate();
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Recall;
		...
		private Helianz.ValidNum textYears;
		...
		private Helianz.ValidNum textMonths;
		private Helianz.ValidNum textDays;
		private Helianz.ValidNum textWeeks;
		private Helianz.UI.CheckBox checkIsDisabled;
		private Helianz.UI.Button butSave;
		private Helianz.UI.Button butDelete;
		private System.Windows.Forms.TextBox textDateDueCalc;
		private Helianz.ValidDate textDateDue;
		private Helianz.ODtextBox textNote;
		private Helianz.UI.ComboBox comboType;
