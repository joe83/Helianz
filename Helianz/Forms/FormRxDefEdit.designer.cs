...
namespace Helianz {
	public partial class FormRxDefEdit {
		...
		private void InitializeComponent(){
			...
			this.listAlerts = new Helianz.UI.ListBox();
			...
			// butAddMedication
			// 
			this.butAddMedication.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.textPatInstruction.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Rx;
		...
		private Helianz.UI.ListBox listAlerts;
