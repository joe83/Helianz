namespace Helianz{
	partial class FormWebSchedCarrierRule {
		...
		private void InitializeComponent() {
			...
			this.gridWebSchedCarrierRules = new Helianz.UI.GridOD();
			this.labelCarriers = new System.Windows.Forms.Label();
			this.listBoxCarriers = new Helianz.UI.ListBox();
			this.checkNewPatRequestIns = new Helianz.UI.CheckBox();
			this.checkExistingPatRequestIns = new Helianz.UI.CheckBox();
			this.butRight = new Helianz.UI.Button();
			this.butLeft = new Helianz.UI.Button();
			this.butCopyRules = new Helianz.UI.Button();
			this.comboClinics = new Helianz.UI.ComboBoxClinicPicker();
			this.labelTitle = new System.Windows.Forms.Label();
			this.butSuggest = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			...
			this.gridWebSchedCarrierRules.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.listBoxCarriers.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
    ...
    "nline appointments. Rules can be set up to allow or block specific carriers.";
		...
		private Helianz.UI.CheckBox checkNewPatRequestIns;
		private Helianz.UI.CheckBox checkExistingPatRequestIns;
