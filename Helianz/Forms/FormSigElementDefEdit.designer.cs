...
namespace Helianz {
	public partial class FormSigElementDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butRecordNew = new Helianz.UI.Button();
			this.butDeleteSound = new Helianz.UI.Button();
			this.butRecord = new Helianz.UI.Button();
			this.butExport = new Helianz.UI.Button();
			this.butImport = new Helianz.UI.Button();
			this.butPlay = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.textLightRow = new Helianz.ValidNum();
    ...
    "re handled separately.";
		...
		private Helianz.UI.Button butPlay;
		private Helianz.UI.Button butImport;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.Button butRecord;
		private Helianz.UI.Button butExport;
		private Helianz.UI.Button butDeleteSound;
