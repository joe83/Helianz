namespace Helianz{
	partial class FormReplicationSetup {
		...
		private void InitializeComponent() {
			...
			this.checkRandomPrimaryKeys = new Helianz.UI.CheckBox();
			...
			this.butSynch = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.groupBoxReplicationFailure = new Helianz.UI.GroupBox();
			this.butClearReplicationFailureAtServer_id = new Helianz.UI.Button();
			this.label6 = new System.Windows.Forms.Label();
			this.textReplicaitonFailureAtServer_id = new System.Windows.Forms.TextBox();
			this.butTest = new Helianz.UI.Button();
			this.butSetRanges = new Helianz.UI.Button();
