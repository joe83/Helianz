namespace Helianz{
	partial class FormMassEmailSetup {
		...
		private void InitializeComponent() {
			...
			this.gridClinics.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			this.gridClinics.Size = new System.Drawing.Size(444, 490);
			this.gridClinics.TabIndex = 137;
			this.gridClinics.CellSelectionCommitted += new Helianz.UI.ODGridClickEventHandler(this.gridClinics_CellSelectionCommitted);
			this.gridClinics.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridClinics_CellClick);
			// 
			// butSignup
			// 
		...
		private Helianz.UI.GroupBox groupSetup;
