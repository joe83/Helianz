namespace Helianz{
	partial class FormBenefitFrequencyEdit {
		...
		private void InitializeComponent() {
			...
			this.listBoxCodeGroup = new Helianz.UI.ListBox();
			this.textNumber = new Helianz.ValidNum();
			this.butSave = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.listBoxTimePeriod = new Helianz.UI.ListBox();
			this.listBoxTreatArea = new Helianz.UI.ListBox();
