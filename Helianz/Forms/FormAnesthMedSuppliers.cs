...
namespace Helianz {
	...
	public class FormAnesthMedSuppliers:System.Windows.Forms.Form {
		private Helianz.UI.Button butAddNew;
		...
		private Helianz.UI.ODGrid gridMain;
		...
		private void InitializeComponent() {
			...
			this.gridMain = new Helianz.UI.ODGrid();
			...
			this.butAddNew.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butAddNew.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butAddNew.CornerRadius = 4F;
			this.butAddNew.Image = global::Helianz.Properties.Resources.Add;
