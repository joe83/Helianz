namespace Helianz{
	partial class FormSupplyOrders {
		...
		private void InitializeComponent() {
			...
			this.gridItems = new Helianz.UI.GridOD();
			this.gridOrders = new Helianz.UI.GridOD();
			this.butPrint = new Helianz.UI.Button();
			this.butAddSupply = new Helianz.UI.Button();
			this.butNewOrder = new Helianz.UI.Button();
			this.checkShowReceived = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// comboSupplier
			// 
			...
			this.gridItems.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridItems.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridOrderItem_CellDoubleClick);
			this.gridItems.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridItems_CellLeave);
			// 
			// gridOrders
			// 
			...
			this.gridOrders.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridOrder_CellDoubleClick);
			this.gridOrders.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridOrder_CellClick);
			// 
			// butPrint
			// 
			...
			this.butAddSupply.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butNewOrder
			// 
			this.butNewOrder.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.CheckBox checkShowReceived;
	}
}