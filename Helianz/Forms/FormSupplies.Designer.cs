namespace Helianz{
	partial class FormSupplies {
		...
		private void InitializeComponent() {
			...
			this.comboSuppliers = new Helianz.UI.ComboBox();
			this.checkShowHidden = new Helianz.UI.CheckBox();
			this.butAdd = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.label2 = new System.Windows.Forms.Label();
			this.comboCategories = new Helianz.UI.ComboBox();
			this.labelPrint = new System.Windows.Forms.Label();
			this.labelCreateOrder = new System.Windows.Forms.Label();
			this.butCreateOrders = new Helianz.UI.Button();
			this.groupCreateOrders = new Helianz.UI.GroupBox();
			this.butCreateOrdersQty = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.checkEnterQty = new Helianz.UI.CheckBox();
    ...
    "hether that order then gets entered back into the software";
		...
		private Helianz.UI.GroupBox groupCreateOrders;
		private UI.Button butCreateOrdersQty;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.CheckBox checkEnterQty;
