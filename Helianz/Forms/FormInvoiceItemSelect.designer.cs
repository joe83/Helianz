namespace Helianz{
	partial class FormInvoiceItemSelect {
		...
		private void InitializeComponent()
		{
			...
			this._gridMain = new Helianz.UI.GridOD();
			...
			this.checkIsFilteringZeroAmount = new Helianz.UI.CheckBox();
    ...
    "hat have not been attached to an invoice.";
			...
			this._gridMain.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this._gridMain.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridMain_CellDoubleClick);
			// 
			// butOK
			// 
