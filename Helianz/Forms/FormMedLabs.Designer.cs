namespace Helianz {
	partial class FormMedLabs {
		...
		private void InitializeComponent() {
			...
			this.checkIncludeNoPat = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.comboClinic = new Helianz.UI.ComboBox();
			this.labelClinic = new System.Windows.Forms.Label();
			this.checkOnlyNoPat = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkIncludeNoPat;
		...
		private Helianz.UI.CheckBox checkOnlyNoPat;
