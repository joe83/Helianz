namespace Helianz{
	partial class FormeConfimationExclusionDays {
		...
		private void InitializeComponent() {
			...
			this.checkUseHQ = new Helianz.UI.CheckBox();
			this.comboBoxClinicPicker = new Helianz.UI.ComboBoxClinicPicker();
			this.listBoxExclusionDays = new Helianz.UI.ListBox();
			this.listBoxExclusionDates = new Helianz.UI.ListBox();
			...
			this.checkShowPastDates = new Helianz.UI.CheckBox();
			...
			this.listBoxExclusionDays.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			// butDelete
			// 
			this.butDelete.Image = global::Helianz.Properties.Resources.deleteX18;
			...
			// butAdd
			// 
			this.butAdd.Image = global::Helianz.Properties.Resources.Add;
    ...
    "ed Recalls";
        ...
        private Helianz.UI.CheckBox checkUseHQ;
        ...
        private Helianz.UI.CheckBox checkShowPastDates;
