namespace Helianz{
	partial class FormOrthoRxSelect {
		...
		private void InitializeComponent() {
			...
			this.listBoxAvail = new Helianz.UI.ListBox();
			this.listBoxSelected = new Helianz.UI.ListBox();
			...
			this.listBoxAvail.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxSelected.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			// butRemove
			// 
			this.butRemove.Image = global::Helianz.Properties.Resources.Left;
			...
			// butSelect
			// 
			this.butSelect.Image = global::Helianz.Properties.Resources.Right;
