namespace Helianz{
	partial class FormErxAccess {
		...
		private void InitializeComponent() {
			...
			this.gridProviders = new Helianz.UI.GridOD();
			this.butNotIdpd = new Helianz.UI.Button();
			this.butIdpd = new Helianz.UI.Button();
			this.butEnable = new Helianz.UI.Button();
			this.butDisable = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.butNotEPCS = new Helianz.UI.Button();
			this.butEPCS = new Helianz.UI.Button();
			this.butChangePatNum = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.gridProviders.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
