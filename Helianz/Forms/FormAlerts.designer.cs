namespace Helianz{
	partial class FormAlerts {
		...
		private void InitializeComponent() {
			...
			this.butViewDetails = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butOpenForm = new Helianz.UI.Button();
			this.butMarkAsRead = new Helianz.UI.Button();
			...
			this.gridMain.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAlerts_CellClick);
			// 
			// labelOpenForm
			// 
