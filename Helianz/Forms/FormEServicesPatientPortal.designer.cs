namespace Helianz{
	partial class FormEServicesPatientPortal {
		...
		private void InitializeComponent() {
			...
			this.comboPPClinicUrl = new Helianz.UI.ComboBoxClinicPicker();
			...
			this.groupBoxNotification = new Helianz.UI.GroupBox();
			this.butEditWebMailNotificationBody = new Helianz.UI.Button();
			...
			this.butUseHosted = new Helianz.UI.Button();
			this.butCustomUrl = new Helianz.UI.Button();
    ...
    "l. This is also the URL that will be on the printout given to patients.";
		...
		private Helianz.UI.GroupBox groupBoxNotification;
