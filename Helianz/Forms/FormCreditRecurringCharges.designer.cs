...
namespace Helianz{
	partial class FormCreditRecurringCharges {
		...
		private void InitializeComponent() {
			...
			this.checkHideBold = new Helianz.UI.CheckBox();
			this.groupCounts = new Helianz.UI.GroupBox();
			...
			this.groupDateFilter = new Helianz.UI.GroupBox();
			this.checkForceDuplicates = new Helianz.UI.CheckBox();
			this.butHistory = new Helianz.UI.Button();
			this.checkShowInactive = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.GroupBox groupCounts;
		...
		private Helianz.UI.CheckBox checkHideBold;
		...
		private Helianz.UI.GroupBox groupClinics;
		private ValidDate textDate;
		private UI.Button butToday;
		private Helianz.UI.GroupBox groupDateFilter;
		private Helianz.UI.CheckBox checkForceDuplicates;
		private UI.Button butHistory;
		private Helianz.UI.CheckBox checkShowInactive;
	}
}