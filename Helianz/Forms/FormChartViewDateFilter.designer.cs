namespace Helianz{
	partial class FormChartViewDateFilter {
		...
		private void InitializeComponent() {
			...
			this.listPresetDateRanges = new Helianz.UI.ListBox();
			this.textDateEnd = new Helianz.ValidDate();
			this.textDateStart = new Helianz.ValidDate();
			this.butOK = new Helianz.UI.Button();
			this.butNowStart = new Helianz.UI.Button();
			this.butNowEnd = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.listPresetDateRanges.SelectionMode = Helianz.UI.SelectionMode.None;
		...
		private Helianz.UI.ListBox listPresetDateRanges;
