...
namespace Helianz {
	public partial class FormClaimFormEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listItems = new Helianz.UI.ListBox();
			...
			this.checkPrintImages = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.textOffsetX = new Helianz.ValidNum();
			this.textOffsetY = new Helianz.ValidNum();
			this.labelInternal = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.label10 = new System.Windows.Forms.Label();
			this.textFormHeight = new Helianz.ValidNum();
			this.textFormWidth = new Helianz.ValidNum();
			...
			this.listItems.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listItems;
		...
		private Helianz.UI.CheckBox checkPrintImages;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label8;
		private Helianz.ValidNum textOffsetX;
		private Helianz.ValidNum textOffsetY;
