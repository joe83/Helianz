namespace Helianz {
	partial class FormClaimCustomTrackingUpdate {
		...
		private void InitializeComponent() {
			...
			this.comboErrorCode = new Helianz.UI.ComboBox();
			this.label = new System.Windows.Forms.Label();
			this.textErrorDesc = new Helianz.ODtextBox();
			this.SuspendLayout();
			// 
			// butSave
			// 
			...
			this.textNotes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.ClaimCustomTrack;
			...
			this.textErrorDesc.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Claim;
