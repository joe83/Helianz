namespace Helianz{
	partial class FormReportSetup {
		...
		private void InitializeComponent() {
			...
			this.tabDisplaySettings = new Helianz.UI.TabPage();
			...
			this.tabReportServer = new Helianz.UI.TabPage();
			this.label8 = new System.Windows.Forms.Label();
			this.textSkySQL = new System.Windows.Forms.TextBox();
			this.checkUseReportServer = new Helianz.UI.CheckBox();
			...
			this.groupConnectionSettings = new Helianz.UI.GroupBox();
			...
			this.groupMiddleTier = new Helianz.UI.GroupBox();
			this.textMiddleTierURI = new System.Windows.Forms.TextBox();
			this.label11 = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.tabMiscOptions = new Helianz.UI.TabPage();
			this.checkUserQueryDefaultRaw = new Helianz.UI.CheckBox();
			this.butIncompleteProcsExcludeCodes = new Helianz.UI.Button();
			this.label7 = new System.Windows.Forms.Label();
			this.textIncompleteProcsExcludeCodes = new Helianz.ODtextBox();
			this.checkReportDisplayUnearnedTP = new Helianz.UI.CheckBox();
			this.comboReportWriteoff = new Helianz.UI.ComboBox();
			this.checkOutstandingRpDateTab = new Helianz.UI.CheckBox();
			this.checkBenefitAssumeGeneral = new Helianz.UI.CheckBox();
			this.checkReportsIncompleteProcsUnsigned = new Helianz.UI.CheckBox();
			this.checkReportsIncompleteProcsNoNotes = new Helianz.UI.CheckBox();
			this.checkNetProdDetailUseSnapshotToday = new Helianz.UI.CheckBox();
			this.checkProviderPayrollAllowToday = new Helianz.UI.CheckBox();
			this.checkReportsShowHistory = new Helianz.UI.CheckBox();
			this.checkReportProdWO = new Helianz.UI.CheckBox();
			this.checkReportPIClinic = new Helianz.UI.CheckBox();
			this.checkReportsShowPatNum = new Helianz.UI.CheckBox();
			this.checkReportPIClinicInfo = new Helianz.UI.CheckBox();
			this.checkReportPrintWrapColumns = new Helianz.UI.CheckBox();
    ...
    "dle Tier database.";
			...
			this.textIncompleteProcsExcludeCodes.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Adjustment;
    ...
    "report";
		...
		private Helianz.UI.CheckBox checkReportProdWO;
		private Helianz.UI.CheckBox checkReportsShowPatNum;
		private Helianz.UI.CheckBox checkReportPIClinic;
		private Helianz.UI.CheckBox checkReportPrintWrapColumns;
    private Helianz.UI.CheckBox checkReportPIClinicInfo;
		private Helianz.UI.TabControl tabControl1;
		private Helianz.UI.TabPage tabMiscOptions;
		private Helianz.UI.TabPage tabDisplaySettings;
		private Helianz.UI.CheckBox checkReportsShowHistory;
		private Helianz.UI.CheckBox checkProviderPayrollAllowToday;
		private Helianz.UI.CheckBox checkNetProdDetailUseSnapshotToday;
		private Helianz.UI.CheckBox checkReportsIncompleteProcsUnsigned;
		private Helianz.UI.CheckBox checkReportsIncompleteProcsNoNotes;
    private Helianz.UI.TabPage tabReportServer;
    ...
    private Helianz.UI.GroupBox groupConnectionSettings;
    private Helianz.UI.GroupBox groupMiddleTier;
    ...
    private Helianz.UI.CheckBox checkUseReportServer;
		private Helianz.UI.TabPage tabReportPermissions;
		private User_Controls.UserControlReportSetup userControlReportSetup;
		private Helianz.UI.CheckBox checkBenefitAssumeGeneral;
		private Helianz.UI.CheckBox checkOutstandingRpDateTab;
