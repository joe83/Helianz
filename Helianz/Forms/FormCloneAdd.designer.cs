namespace Helianz{
	partial class FormCloneAdd {
		...
		private void InitializeComponent() {
			...
			this.butClone = new Helianz.UI.Button();
		...
		private Helianz.UI.ComboBox comboPriProv;
	}
}