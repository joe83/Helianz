namespace Helianz {
	partial class FormEduResourceEdit {
		...
		private void InitializeComponent() {
			...
			this.groupLabResults = new Helianz.UI.GroupBox();
			...
			this.groupProblems = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.GroupBox groupLabResults;
		...
		private Helianz.UI.GroupBox groupProblems;
