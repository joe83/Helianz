namespace Helianz{
	partial class FormLimitedStatementSelect {
		...
		private void InitializeComponent() {
			...
			this.listBoxShowFamilyMembers = new Helianz.UI.ListBox();
			this.labelTo = new System.Windows.Forms.Label();
			this.odDatePickerTo = new Helianz.UI.ODDatePicker();
			this.labelFrom = new System.Windows.Forms.Label();
			this.odDatePickerFrom = new Helianz.UI.ODDatePicker();
			this.listBoxTransTypes = new Helianz.UI.ListBox();
    ...
    " to include on the limited statement";
        ...
        "Procedure"};
			...
			this.listBoxTransTypes.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
