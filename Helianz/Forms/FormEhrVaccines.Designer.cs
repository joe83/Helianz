namespace Helianz {
	partial class FormEhrVaccines {
		...
		private void InitializeComponent() {
			...
			this.gridVaccine = new Helianz.UI.GridOD();
			...
			this.gridVaccine.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridVaccine.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridVaccine_CellDoubleClick);
			// 
			// listVacShareOk
			// 
		...
		private Helianz.UI.GridOD gridVaccine;
