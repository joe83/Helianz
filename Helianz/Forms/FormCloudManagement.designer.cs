namespace Helianz{
	partial class FormCloudManagement {
		...
		private void InitializeComponent() {
			...
			this.butCloseSession = new Helianz.UI.Button();
			...
			this.butChangeSessionLimit = new Helianz.UI.Button();
			this.groupSessionManagement = new Helianz.UI.GroupBox();
			this.gridActiveInstances = new Helianz.UI.GridOD();
			this.butChangePassword = new Helianz.UI.Button();
			this.groupStorageManagement = new Helianz.UI.GroupBox();
			...
			this.groupAllowedAddresses = new Helianz.UI.GroupBox();
			this.textAddress = new System.Windows.Forms.TextBox();
			this.labelStaticIp = new System.Windows.Forms.Label();
			this.butAddCurrent = new Helianz.UI.Button();
			this.butDeleteAddress = new Helianz.UI.Button();
			this.butAllowAddress = new Helianz.UI.Button();
			this.gridAllowedAddresses = new Helianz.UI.GridOD();
    ...
    "static IP address.";
			...
			this.butAddCurrent.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butDeleteAddress.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.gridAllowedAddresses.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.GroupBox groupSessionManagement;
		private UI.Button butChangePassword;
		private Helianz.UI.GroupBox groupStorageManagement;
		...
		private Helianz.UI.GroupBox groupAllowedAddresses;
