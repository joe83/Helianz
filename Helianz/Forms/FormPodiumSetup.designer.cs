namespace Helianz{
	partial class FormPodiumSetup {
		...
		private void InitializeComponent() {
			...
			this.checkUseService = new Helianz.UI.CheckBox();
			...
			this.textApptSetComplete = new Helianz.ValidDouble();
			this.label1 = new System.Windows.Forms.Label();
			this.textApptTimeArrived = new Helianz.ValidDouble();
			this.textApptTimeDismissed = new Helianz.ValidDouble();
			...
			this.checkShowCommlogsInChart = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkUseService;
		private Helianz.UI.CheckBox checkShowCommlogsInChart;
	}
}