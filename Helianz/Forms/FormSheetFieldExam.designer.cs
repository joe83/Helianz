namespace Helianz{
	partial class FormSheetFieldExam {
		...
		private void InitializeComponent() {
			...
			this.listBoxExamSheets = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.butOK = new Helianz.UI.Button();
			this.label10 = new System.Windows.Forms.Label();
			this.listBoxAvailFields = new Helianz.UI.ListBox();
			this.SuspendLayout();
			// 
			// label2
			// 
    ...
    "";
		...
		private Helianz.UI.ListBox listBoxExamSheets;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label10;
		private Helianz.UI.ListBox listBoxAvailFields;
	}
}