namespace Helianz{
	partial class FormEhrAptObsEdit {
		...
		private void InitializeComponent() {
			...
			this.butPickValueIcd10 = new Helianz.UI.Button();
			this.butPickValueIcd9 = new Helianz.UI.Button();
			this.butPickValueSnomedct = new Helianz.UI.Button();
			this.butPickValueLoinc = new Helianz.UI.Button();
