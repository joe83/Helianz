...
namespace Helianz {
	public partial class FormSheetDefs {
		...
		private void InitializeComponent()
		{
			...
			this.butCopy2 = new Helianz.UI.Button();
			this.butCopy = new Helianz.UI.Button();
			this.grid1 = new Helianz.UI.GridOD();
			this.grid2 = new Helianz.UI.GridOD();
			this.butNew = new Helianz.UI.Button();
			this.listFilter = new Helianz.UI.ListBox();
			this.SuspendLayout();
			// 
			// label3
			// 
			...
			this.butCopy2.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.grid1.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.grid1_CellDoubleClick);
			...
			this.grid2.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.grid2_CellDoubleClick);
			...
			this.listFilter.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.GridOD grid2;
		private UI.GridOD grid1;
		private Helianz.UI.Button butCopy;
		private Helianz.UI.Button butCopy2;
