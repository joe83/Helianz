namespace Helianz{
	partial class FormTimePick {
		...
		private void InitializeComponent() {
			...
			this.comboMinute = new Helianz.UI.ComboBox();
			this.comboHour = new Helianz.UI.ComboBox();
			this.groupDate = new Helianz.UI.GroupBox();
			this.groupTime = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.ComboBox comboHour;
		private Helianz.UI.ComboBox comboMinute;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.RadioButton radioAM;
		private System.Windows.Forms.RadioButton radioPM;
		private System.Windows.Forms.DateTimePicker dateTimePicker;
		private Helianz.UI.GroupBox groupDate;
		private Helianz.UI.GroupBox groupTime;
	}
}