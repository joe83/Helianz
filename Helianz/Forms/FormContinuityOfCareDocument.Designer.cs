namespace Helianz {
	partial class FormContinuityOfCareDocument {
		...
		private void InitializeComponent() {
			...
			this.butExportToFile = new Helianz.UI.Button();
			this.butShowAndPrint = new Helianz.UI.Button();
    ...
    "ctronically.";
			...
			this.textInstructions.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicalSummary;
