namespace Helianz{
	partial class FormDiscountPlanMerge {
		...
		private void InitializeComponent() {
			...
			this.butChangePlanInto = new Helianz.UI.Button();
			...
			this.butChangePlanFrom = new Helianz.UI.Button();
    ...
    "e.";
		...
		private Helianz.UI.Button butChangePlanInto;
		private Helianz.UI.Button butChangePlanFrom;
