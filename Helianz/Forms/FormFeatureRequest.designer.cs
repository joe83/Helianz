...
namespace Helianz {
	...
	private System.ComponentModel.IContainer components = null;
		...
		private void InitializeComponent()
		{
			...
			this.buttonAdd = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.butOK = new Helianz.UI.Button();
			this.butEdit = new Helianz.UI.Button();
			this.checkMine = new Helianz.UI.CheckBox();
			this.checkMyVotes = new Helianz.UI.CheckBox();
    ...
    "y time estimates.";
			...
			this.buttonAdd.Icon = Helianz.UI.EnumIcons.Add;
    ...
    "dd a request, put votes on it right away.";
		...
		private Helianz.UI.Button buttonAdd;
		private Helianz.UI.Button butSearch;
		private UI.Button butOK;
		private UI.Button butEdit;
		private Helianz.UI.CheckBox checkMine;
		private Helianz.UI.CheckBox checkMyVotes;
