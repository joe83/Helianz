namespace Helianz{
	partial class FormUpdateInProgress {
		...
		private void InitializeComponent() {
			...
			this.butTryAgain = new Helianz.UI.Button();
			this.butOverride = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// labelWarning
			// 
		...
		private Helianz.UI.Button butTryAgain;
		private Helianz.UI.Button butOverride;
