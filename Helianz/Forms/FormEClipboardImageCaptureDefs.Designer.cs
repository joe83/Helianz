namespace Helianz{
	partial class FormEClipboardImageCaptureDefs {
		...
		private void InitializeComponent() {
			...
			this.gridEClipboardImagesInUse = new Helianz.UI.GridOD();
			this.gridAvailableEClipboardImages = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butSave
			// 
			...
			this.gridEClipboardImagesInUse.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridEClipboardImagesInUse.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridEClipboardImagesInUse_CellDoubleClick);
			// 
			...
			this.gridAvailableEClipboardImages.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
