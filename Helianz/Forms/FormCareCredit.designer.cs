namespace Helianz {
	partial class FormCareCredit {
		...
		private void InitializeComponent() {
			...
			this.comboProviders = new Helianz.UI.ComboBox();
			this.labelProviders = new System.Windows.Forms.Label();
			this.comboClinics = new Helianz.UI.ComboBoxClinicPicker();
			this.butApply = new Helianz.UI.Button();
			this.butLookup = new Helianz.UI.Button();
			this.butTransactions = new Helianz.UI.Button();
