...
///<summary></summary>
	public partial class FormClaimsSend:FormODBase {
		...
		public FormClaimsSend(){
			...
			//tbQueue.CellDoubleClicked += new Helianz.ContrTable.CellEventHandler(tbQueue_CellDoubleClicked);
			Lan.F(this);
		}
		...
		private void formProcNotBilled_GoToChanged(ODEventArgs e) {
			...
			GlobalFormHelianz.GoToModule(EnumModuleType.Account,patNum:(long)e.Tag);
		}
