namespace Helianz{
	partial class FormERoutings {
		...
		private void InitializeComponent() {
			...
			this.gridERoutings.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridFlowsCellDoubleClick);
			// 
			// comboClinic
			// 
