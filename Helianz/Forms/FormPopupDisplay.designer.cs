...
namespace Helianz {
	public partial class FormPopupDisplay {
		...
		private void InitializeComponent()
		{
			...
			this.comboMinutes = new Helianz.UI.ComboBox();
			this.comboHours = new Helianz.UI.ComboBox();
			this.butPerm = new Helianz.UI.Button();
			this.butMinutes = new Helianz.UI.Button();
			this.butHours = new Helianz.UI.Button();
			...
			this.textDescription.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Popup;
		...
		private Helianz.UI.Button butMinutes;
		private Helianz.UI.Button butHours;
		private Helianz.UI.ComboBox comboMinutes;
		private Helianz.UI.ComboBox comboHours;
		private Label label3;
		private Label label2;
		private Label label1;
		private Helianz.UI.Button butPerm;
