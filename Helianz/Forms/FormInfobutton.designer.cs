namespace Helianz{
	partial class FormInfobutton {
		...
		private void InitializeComponent() {
			...
			this.groupBoxContext = new Helianz.UI.GroupBox();
			...
			this.butProvSelect = new Helianz.UI.Button();
			...
			this.butAddLoinc = new Helianz.UI.Button();
			...
			this.butPreviewRequest = new Helianz.UI.Button();
			...
			this.butAddLoinc.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.button3.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.GroupBox groupBoxContext;
