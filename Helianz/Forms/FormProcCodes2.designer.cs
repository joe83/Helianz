...
namespace Helianz {
	public partial class FormProcCodes {
		...
		private void InitializeComponent() {
			...
			this.butEditFeeSched = new Helianz.UI.Button();
			this.butTools = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.listCategories = new Helianz.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.butEditCategories = new Helianz.UI.Button();
			this.checkShowHidden = new Helianz.UI.CheckBox();
			this.label4 = new System.Windows.Forms.Label();
			this.butAll = new Helianz.UI.Button();
			this.textCode = new System.Windows.Forms.TextBox();
			this.textAbbreviation = new System.Windows.Forms.TextBox();
			this.textDescription = new System.Windows.Forms.TextBox();
			this.butShowHiddenDefault = new Helianz.UI.Button();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.label6 = new System.Windows.Forms.Label();
			this.comboSort = new Helianz.UI.ComboBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.label5 = new System.Windows.Forms.Label();
			this.butNew = new Helianz.UI.Button();
			this.butExport = new Helianz.UI.Button();
			this.butImport = new Helianz.UI.Button();
			this.butProcTools = new Helianz.UI.Button();
			this.groupProcCodeSetup = new Helianz.UI.GroupBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.comboFeeSchedGroup1 = new Helianz.UI.ComboBox();
			this.checkGroups1 = new Helianz.UI.CheckBox();
			this.butPickProv1 = new Helianz.UI.Button();
			this.butPickClinic1 = new Helianz.UI.Button();
			this.butPickSched1 = new Helianz.UI.Button();
			...
			this.comboProvider1 = new Helianz.UI.ComboBox();
			this.comboClinic1 = new Helianz.UI.ComboBoxClinicPicker();
			this.comboFeeSched1 = new Helianz.UI.ComboBox();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.comboFeeSchedGroup2 = new Helianz.UI.ComboBox();
			this.checkGroups2 = new Helianz.UI.CheckBox();
			this.butPickProv2 = new Helianz.UI.Button();
			this.butPickClinic2 = new Helianz.UI.Button();
			this.butPickSched2 = new Helianz.UI.Button();
			this.labelSched2 = new System.Windows.Forms.Label();
			this.comboProvider2 = new Helianz.UI.ComboBox();
			this.labelClinic2 = new System.Windows.Forms.Label();
			this.comboClinic2 = new Helianz.UI.ComboBoxClinicPicker();
			this.labelProvider2 = new System.Windows.Forms.Label();
			this.comboFeeSched2 = new Helianz.UI.ComboBox();
			this.groupBox4 = new Helianz.UI.GroupBox();
			this.comboFeeSchedGroup3 = new Helianz.UI.ComboBox();
			this.checkGroups3 = new Helianz.UI.CheckBox();
			this.butPickProv3 = new Helianz.UI.Button();
			this.butPickClinic3 = new Helianz.UI.Button();
			this.butPickSched3 = new Helianz.UI.Button();
			this.labelSched3 = new System.Windows.Forms.Label();
			this.comboProvider3 = new Helianz.UI.ComboBox();
			this.labelClinic3 = new System.Windows.Forms.Label();
			this.labelProvider3 = new System.Windows.Forms.Label();
			this.comboClinic3 = new Helianz.UI.ComboBoxClinicPicker();
			this.comboFeeSched3 = new Helianz.UI.ComboBox();
			...
			this.listCategories.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridMain.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridMain_CellLeave);
			this.gridMain.CellEnter += new Helianz.UI.ODGridClickEventHandler(this.GridMain_CellEnter);
			// 
			// label5
			// 
		...
		private Helianz.UI.CheckBox checkShowHidden;
		...
		private Helianz.UI.ComboBox comboSort;
		private Label label6;
		private Helianz.UI.CheckBox checkGroups1;
		private Helianz.UI.CheckBox checkGroups2;
		private Helianz.UI.CheckBox checkGroups3;
