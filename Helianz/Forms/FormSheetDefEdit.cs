	...
	public partial class FormSheetDefEdit:FormODBase {
		...
		private void LoadImageOne(SheetFieldDef sheetFieldDef){
			...
			if(sheetFieldDef.FieldName=="Patient Info.gif") {
				sheetFieldDef.ImageField=HelianzBusiness.Properties.Resources.Patient_Info;
				return;
			}
		...
		private void DrawInsurance(SheetFieldDef sheetFieldDef,Graphics g,Pen pen,SolidBrush solidBrush) {
			...
			Rectangle rectangleBound=HelianzBusiness.SheetPrinting.DrawScaledImage(sheetFieldDef.XPos,sheetFieldDef.YPos,sheetFieldDef.Width,sheetFieldDef.Height,g,null,bitmapIns);
			...
			switch(sheetFieldDef.FieldName) {
				...
				case "toothChart":
					if(_imageToothChart!=null){
						Rectangle rectangleBoundingBox=HelianzBusiness.SheetPrinting.DrawScaledImage(sheetFieldDef.XPos,sheetFieldDef.YPos,sheetFieldDef.Width,sheetFieldDef.Height,g,null,_imageToothChart);
				...
				case "toothChartLegend":
					...
					HelianzBusiness.SheetPrinting.DrawToothChartLegend(sheetFieldDef.XPos,sheetFieldDef.YPos,width,0,listDefs,g,null,SheetDefs.IsDashboardType(SheetDef_),LayoutManager.GetScaleMS());
					break;
				case "familyInsurance":
				case "individualInsurance":
				...
				case "ChartModuleTabs":
					...
					FormHelianz.S_Contr_TabProcPageTitles.ForEach(x => tabControlPrimary.TabPages.Add(new UI.TabPage(x)));
				...
				case "ButtonNewTP":
					...
					if(sheetFieldDef.FieldName=="ButtonNewTP") {
						button.Image=Helianz.Properties.Resources.Add;
