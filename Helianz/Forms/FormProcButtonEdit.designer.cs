...
namespace Helianz {
	public partial class FormProcButtonEdit {
		...
		private void InitializeComponent(){
			...
			this.listADA = new Helianz.UI.ListBox();
			...
			this.checkMultiVisit = new Helianz.UI.CheckBox();
			...
			this.listAutoCodes.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listADA;
		...
		private Helianz.UI.CheckBox checkMultiVisit;
