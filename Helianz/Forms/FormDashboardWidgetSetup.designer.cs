namespace Helianz{
	partial class FormDashboardWidgetSetup {
		...
		private void InitializeComponent() {
			...
			this.gridCustom.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridCustom.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustom_CellClick);
			// 
			// comboUserGroup
			// 
			...
			this.butDuplicate.Icon = Helianz.UI.EnumIcons.Add;
