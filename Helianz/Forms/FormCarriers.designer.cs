...
namespace Helianz {
	public partial class FormCarriers {
		...
		private void InitializeComponent()
		{
			...
			this.butCombine = new Helianz.UI.Button();
			this.butItransUpdateCarriers = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.checkCDAnet = new Helianz.UI.CheckBox();
			...
			this.groupItrans = new Helianz.UI.GroupBox();
			this.checkItransMissing = new Helianz.UI.CheckBox();
			this.checkItransAddress = new Helianz.UI.CheckBox();
			this.checkITransPhone = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.Button butCombine;
		private Helianz.UI.GridOD gridMain;
		private Helianz.UI.CheckBox checkCDAnet;
		...
		private Helianz.UI.GroupBox groupItrans;
		private Helianz.UI.CheckBox checkITransPhone;
		private Helianz.UI.CheckBox checkItransAddress;
		private Helianz.UI.CheckBox checkItransMissing;
