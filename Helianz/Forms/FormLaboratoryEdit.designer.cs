...
namespace Helianz {
	public partial class FormLaboratoryEdit {
		...
		private void InitializeComponent()
		{
			...
			this.comboSlip = new Helianz.UI.ComboBox();
			...
			this.butDeleteTurnaround = new Helianz.UI.Button();
			...
			// butDeleteTurnaround
			// 
			this.butDeleteTurnaround.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.Button butDeleteTurnaround;
		private Helianz.UI.ComboBox comboSlip;
