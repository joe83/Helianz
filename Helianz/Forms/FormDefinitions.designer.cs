...
namespace Helianz {
	public partial class FormDefinitions {
		...
		private void InitializeComponent()
		{
			...
			this.groupEdit = new Helianz.UI.GroupBox();
			this.butAlphabetize = new Helianz.UI.Button();
			this.butHide = new Helianz.UI.Button();
			...
			this.gridDefs = new Helianz.UI.GridOD();
			...
			this.gridDefs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridDefs_CellDoubleClick);
			// 
			// FormDefinitions
			// 
		...
		private Helianz.UI.GroupBox groupEdit;
		...
		private Helianz.UI.Button butHide;
