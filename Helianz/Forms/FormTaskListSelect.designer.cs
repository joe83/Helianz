...
namespace Helianz {
	public partial class FormTaskListSelect {
		...
		private void InitializeComponent()
		{
			...
			this.checkMulti = new Helianz.UI.CheckBox();
			this.textFilter = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.checkIncludeAll = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkMulti;
		private Helianz.UI.CheckBox checkIncludeAll;
