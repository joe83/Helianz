...
namespace Helianz {
	public partial class FormReportsMore {
		...
		private void InitializeComponent() {
			...
			this.groupBusiness = new Helianz.UI.GroupBox();
			this.picturePracticeByNumbers = new Helianz.UI.ODPictureBox();
			this.groupPatientReviews = new Helianz.UI.GroupBox();
			this.picturePodium = new Helianz.UI.ODPictureBox();
			...
			this.butPatExport = new Helianz.UI.Button();
			this.butPatList = new Helianz.UI.Button();
			this.listArizonaPrimaryCare = new Helianz.UI.ListBox();
			this.butLaserLabels = new Helianz.UI.Button();
			this.listDaily = new Helianz.UI.ListBox();
			this.listProdInc = new Helianz.UI.ListBox();
			this.butPW = new Helianz.UI.Button();
			this.butUserQuery = new Helianz.UI.Button();
			this.listPublicHealth = new Helianz.UI.ListBox();
			this.listLists = new Helianz.UI.ListBox();
			this.listMonthly = new Helianz.UI.ListBox();
			...
			this.picturePracticeByNumbers.Image = global::Helianz.Properties.Resources.PracticeByNumbers_100x24;
			...
			this.picturePodium.Image = global::Helianz.Properties.Resources.Podium_logo_Black;
			...
			this.listArizonaPrimaryCare.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listDaily.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listProdInc.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listPublicHealth.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listLists.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listMonthly.SelectionMode = Helianz.UI.SelectionMode.None;
		...
		private Helianz.UI.ListBox listLists;
		private Helianz.UI.ListBox listPublicHealth;
		private Helianz.UI.Button butUserQuery;
		private Helianz.UI.Button butPW;
		private Helianz.UI.ListBox listProdInc;
		private Label labelProdInc;
		private Helianz.UI.ListBox listDaily;
		private Label labelDaily;
		private Label label6;
		private Helianz.UI.Button butLaserLabels;
		private Helianz.UI.ListBox listArizonaPrimaryCare;
		private Label labelArizonaPrimaryCare;
		private Helianz.UI.ListBox listMonthly;
		private UI.Button butPatList;
		private UI.Button butPatExport;
		private Helianz.UI.GroupBox groupPatientReviews;
		private UI.ODPictureBox picturePodium;
		private Helianz.UI.GroupBox groupBusiness;
