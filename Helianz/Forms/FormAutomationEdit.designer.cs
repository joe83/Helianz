...
namespace Helianz {
	public partial class FormAutomationEdit {
		...
		private void InitializeComponent()
		{
			...
			this.comboTrigger = new Helianz.UI.ComboBox();
			this.comboAction = new Helianz.UI.ComboBox();
			this.comboActionObject = new Helianz.UI.ComboBox();
			this.butAdd = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.butProcCode = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			butDelete = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butDelete
			// 
			...
			butDelete.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.ComboBox comboTrigger;
		private Helianz.UI.ComboBox comboAction;
		private UI.ComboBox comboActionObject;
		private Helianz.UI.Button butProcCode;
