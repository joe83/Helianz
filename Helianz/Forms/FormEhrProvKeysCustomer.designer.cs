namespace Helianz{
	partial class FormEhrProvKeysCustomer {
		...
		private void InitializeComponent() {
			...
			this.gridQ = new Helianz.UI.GridOD();
			this.butAddQuarterly = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
    ...
    "should be";
			...
			this.gridQ.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridQ_CellDoubleClick);
			// 
			// butAddQuarterly
			// 
			this.butAddQuarterly.Icon = Helianz.UI.EnumIcons.Add;
