namespace Helianz{
	partial class FormFeeSchedGroupEdit {
		...
		private void InitializeComponent() {
			...
			this.gridGroup = new Helianz.UI.GridOD();
			...
			this.butPickFeeSched = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// butSave
			// 
			...
			this.gridGroup.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAvailable.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
