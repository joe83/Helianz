...
namespace Helianz {
	...
	private System.ComponentModel.IContainer components = null;// Required designer variable.
		...
		private void InitializeComponent(){
			...
			this.gridBill = new Helianz.UI.GridOD();
			...
			this.gridBill.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridBill.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBill_CellDoubleClick);
			this.gridBill.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridBill_CellClick);
    ...
    "ils them";
		...
		#endregion
		private Helianz.UI.Button butAll;
		private Helianz.UI.Button butNone;
		private Helianz.UI.Button butSend;
		private Helianz.UI.GridOD gridBill;
		...
		private Helianz.UI.ComboBox comboOrder;
		private Label label4;
		private Helianz.UI.Button butPrintList;
		...
		private Helianz.UI.ComboBox comboEmailFrom;
