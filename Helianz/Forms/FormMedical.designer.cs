...
namespace Helianz {
	public partial class FormMedical {
		...
		private void InitializeComponent()
		{
			...
			this.butAddDisease = new Helianz.UI.Button();
			this.gridMeds = new Helianz.UI.GridOD();
			this.gridDiseases = new Helianz.UI.GridOD();
			this.checkDiscontinued = new Helianz.UI.CheckBox();
			this.gridAllergies = new Helianz.UI.GridOD();
			this.butAddAllergy = new Helianz.UI.Button();
			this.checkShowInactiveAllergies = new Helianz.UI.CheckBox();
			this.butPrint = new Helianz.UI.Button();
			this.checkShowInactiveProblems = new Helianz.UI.CheckBox();
			this.imageListInfoButton = new System.Windows.Forms.ImageList(this.components);
			this.gridFamilyHealth = new Helianz.UI.GridOD();
			this.butAddFamilyHistory = new Helianz.UI.Button();
			this.tabControlFormMedical = new Helianz.UI.TabControl();
			this.tabMedical = new Helianz.UI.TabPage();
			this.label4 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.textMedical = new Helianz.ODtextBox();
			this.butPrintMedical = new Helianz.UI.Button();
			this.textService = new Helianz.ODtextBox();
			this.textMedUrgNote = new Helianz.ODtextBox();
			this.checkPremed = new Helianz.UI.CheckBox();
			this.groupMedsDocumented = new Helianz.UI.GroupBox();
			...
			this.textMedicalComp = new Helianz.ODtextBox();
			this.tabProblems = new Helianz.UI.TabPage();
			this.tabMedications = new Helianz.UI.TabPage();
			this.tabAllergies = new Helianz.UI.TabPage();
			this.tabFamHealthHist = new Helianz.UI.TabPage();
			this.tabVitalSigns = new Helianz.UI.TabPage();
			this.butGrowthChart = new Helianz.UI.Button();
			this.butAddVitalSign = new Helianz.UI.Button();
			this.gridVitalSigns = new Helianz.UI.GridOD();
			this.tabTobaccoUse = new Helianz.UI.TabPage();
			...
			this.checkPatientDeclined = new Helianz.UI.CheckBox();
			...
			this.gridInterventions = new Helianz.UI.GridOD();
			this.label5 = new System.Windows.Forms.Label();
			this.radioMedInterventions = new System.Windows.Forms.RadioButton();
			this.label7 = new System.Windows.Forms.Label();
			this.butAddIntervention = new Helianz.UI.Button();
			...
			this.butAddDisease.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridMeds.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridMeds_CellDoubleClick);
			this.gridMeds.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridMeds_CellClick);
			// 
			// gridDiseases
			// 
			...
			this.gridDiseases.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridDiseases_CellDoubleClick);
			this.gridDiseases.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridDiseases_CellClick);
			// 
			// checkDiscontinued
			// 
			...
			this.gridAllergies.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAllergies_CellDoubleClick);
			this.gridAllergies.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAllergies_CellClick);
			// 
			// butAddAllergy
			// 
			this.butAddAllergy.AdjustImageLocation = new System.Drawing.Point(0, 1);
			this.butAddAllergy.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridFamilyHealth.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridFamilyHealth_CellDoubleClick);
			// 
			// butAddFamilyHistory
			// 
			this.butAddFamilyHistory.AdjustImageLocation = new System.Drawing.Point(0, 1);
			this.butAddFamilyHistory.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.textMedical.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicalSummary;
			...
			// butPrintMedical
			// 
			this.butPrintMedical.Image = global::Helianz.Properties.Resources.butPrintSmall;
			...
			this.textService.QuickPasteType = HelianzBusiness.EnumQuickPasteType.ServiceNotes;
			...
			this.textMedUrgNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicalUrgent;
			...
			this.textMedicalComp.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicalHistory;
			...
			this.butAddVitalSign.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridVitalSigns.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridVitalSigns_CellDoubleClick);
			// 
			// tabTobaccoUse
			// 
			...
			this.gridAssessments.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAssessments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAssessments_CellDoubleClick);
			// 
			// labelTobaccoStatus
			// 
			...
			this.gridInterventions.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridInterventions.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridInterventions_CellDoubleClick);
			// 
			// label5
			// 
		...
		private Helianz.UI.Button butAddDisease;// Required designer variable.
		private Helianz.UI.GridOD gridMeds;
		private Helianz.UI.GridOD gridDiseases;
		private Helianz.UI.CheckBox checkDiscontinued;
		private UI.GridOD gridAllergies;
		private UI.Button butAddAllergy;
		private Helianz.UI.CheckBox checkShowInactiveAllergies;
		private UI.Button butPrint;
		private Helianz.UI.CheckBox checkShowInactiveProblems;
		private ImageList imageListInfoButton;
		private UI.GridOD gridFamilyHealth;
		private UI.Button butAddFamilyHistory;
		private Helianz.UI.TabControl tabControlFormMedical;
		private Helianz.UI.TabPage tabProblems;
		private Helianz.UI.TabPage tabMedications;
		private Helianz.UI.TabPage tabAllergies;
		private Helianz.UI.TabPage tabFamHealthHist;
		private Helianz.UI.TabPage tabMedical;
		...
		private Helianz.UI.CheckBox checkPatientDeclined;
