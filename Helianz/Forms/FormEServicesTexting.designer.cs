namespace Helianz{
	partial class FormEServicesTexting {
		...
		private void InitializeComponent() {
			...
			this.groupShortCode = new Helianz.UI.GroupBox();
			this.labelUnsavedShortCodeChanges = new System.Windows.Forms.Label();
			this.butSaveShortCodes = new Helianz.UI.Button();
			...
			this.checkOptInPrompt = new Helianz.UI.CheckBox();
			this.comboShortCodeClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.butDefaultClinicClear = new Helianz.UI.Button();
			this.butDefaultClinic = new Helianz.UI.Button();
			this.butBackMonth = new Helianz.UI.Button();
			this.dateTimePickerSms = new System.Windows.Forms.DateTimePicker();
			this.gridSmsSummary = new Helianz.UI.GridOD();
		...
		private Helianz.UI.GroupBox groupShortCode;
		private Helianz.UI.CheckBox checkOptInPrompt;
