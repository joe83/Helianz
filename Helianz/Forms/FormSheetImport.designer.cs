namespace Helianz{
	partial class FormSheetImport {
		...
		private void InitializeComponent() {
			...
			this.pictureBoxSecondaryInsuranceBack = new Helianz.UI.ODPictureBox();
			this.pictureBoxSecondaryInsuranceFront = new Helianz.UI.ODPictureBox();
			this.pictureBoxPrimaryInsuranceBack = new Helianz.UI.ODPictureBox();
			this.pictureBoxPrimaryInsuranceFront = new Helianz.UI.ODPictureBox();
			this.SuspendLayout();
			// 
			// label1
			// 
