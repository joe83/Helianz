namespace Helianz{
	partial class FormEhrTimeSynch {
		...
		private void InitializeComponent() {
			...
			this.textMessage = new Helianz.ODtextBox();
			this.textLocalTime = new Helianz.ODtextBox();
			this.textServerTime = new Helianz.ODtextBox();
			this.textNistTime = new Helianz.ODtextBox();
			this.butRefreshTime = new Helianz.UI.Button();
			this.textNistUrl = new Helianz.ODtextBox();
			this.SuspendLayout();
			// 
			// label2
			// 
			...
			this.textMessage.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textLocalTime.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textServerTime.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textNistTime.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textNistUrl.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
