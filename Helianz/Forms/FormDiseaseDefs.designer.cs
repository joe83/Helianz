...
namespace Helianz {
	public partial class FormDiseaseDefs {
		...
		private void InitializeComponent()
		{
			...
			this.textSnoMed = new Helianz.ODtextBox();
			this.textDescript = new Helianz.ODtextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.textICD10 = new Helianz.ODtextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textICD9 = new Helianz.ODtextBox();
			...
			this.textSnoMed.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textDescript.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textICD10.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textICD9.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
