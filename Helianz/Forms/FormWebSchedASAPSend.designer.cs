namespace Helianz{
	partial class FormWebSchedASAPSend {
		...
		private void InitializeComponent() {
			...
			this.groupSendMode = new Helianz.UI.GroupBox();
			...
			this.textTextTemplate = new Helianz.ODtextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.textEmailSubject = new Helianz.ODtextBox();
			...
			this.gridSendDetails = new Helianz.UI.GridOD();
			...
			this.textTextTemplate.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
			...
			this.textEmailSubject.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
    ...
    " Send is clicked.";
			...
			this.gridSendDetails.SelectionMode = Helianz.UI.GridSelectionMode.None;
		...
		private Helianz.UI.GroupBox groupSendMode;
