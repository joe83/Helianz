namespace Helianz {
	partial class FormEhrSummaryOfCare {
		...
		private void InitializeComponent() {
			...
			this.gridRec = new Helianz.UI.GridOD();
			...
			this.gridRec.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridRec.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridRec_CellDoubleClick);
			// 
			// gridSent
			// 
			...
			this.gridSent.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSent_CellDoubleClick);
			// 
			// groupBox2
			// 
		...
		private Helianz.UI.GridOD gridSent;
				private System.Windows.Forms.Button butDelete;
				private Helianz.UI.GridOD gridRec;
