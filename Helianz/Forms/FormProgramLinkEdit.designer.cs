...
namespace Helianz {
	public partial class FormProgramLinkEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listToolBars = new Helianz.UI.ListBox();
			...
			this.butOutputFile = new Helianz.UI.Button();
			this.checkHideButtons = new Helianz.UI.CheckBox();
			this.labelCloudMessage = new System.Windows.Forms.Label();
			this.butClinicLink = new Helianz.UI.Button();
			this.groupboxPLbuttons = new Helianz.UI.GroupBox();
			...
			this.listToolBars.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
    ...
    " contact an administrator.";
		...
		private Helianz.UI.ListBox listToolBars;
		...
		private Helianz.UI.GroupBox groupboxPLbuttons;
