...
namespace Helianz {
	public partial class FormTreatPlanEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butDocumentDetach.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.ValidDate textDateTP;
