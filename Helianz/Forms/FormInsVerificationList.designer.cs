namespace Helianz{
	partial class FormInsVerificationList {
		...
		private void InitializeComponent() {
			...
			this.tabVerify = new Helianz.UI.TabPage();
			this.tabControlVerificationList = new Helianz.UI.TabControl();
			this.tabCurrent = new Helianz.UI.TabPage();
			this.gridMain = new Helianz.UI.GridOD();
			this.tabPastDue = new Helianz.UI.TabPage();
			this.gridPastDue = new Helianz.UI.GridOD();
			this.butVerifyPat = new Helianz.UI.Button();
			this.textPatBirthdate = new System.Windows.Forms.TextBox();
			this.labelPatBirthdate = new System.Windows.Forms.Label();
			this.comboSetVerifyStatus = new Helianz.UI.ComboBox();
			this.butVerifyPlan = new Helianz.UI.Button();
			...
			this.groupInsurancePlan = new Helianz.UI.GroupBox();
			this.textInsPlanNote = new System.Windows.Forms.TextBox();
			this.textCarrierPhoneNumber = new Helianz.ValidPhone();
			...
			this.tabAssignStandard = new Helianz.UI.TabPage();
			this.gridAssignStandard = new Helianz.UI.GridOD();
			this.groupAssignVerificationStandard = new Helianz.UI.GroupBox();
			...
			this.butAssignUserPickStandard = new Helianz.UI.Button();
			this.butAssignUserStandard = new Helianz.UI.Button();
			this.tabAssignMedicaid = new Helianz.UI.TabPage();
			this.butAssignUserMedicaid = new Helianz.UI.Button();
			this.groupAssignVerificationMedicaid = new Helianz.UI.GroupBox();
			...
			this.butAssignUserPickMedicaid = new Helianz.UI.Button();
			this.gridAssignMedicaid = new Helianz.UI.GridOD();
			this.groupVerificationFilters = new Helianz.UI.GroupBox();
			this.labelMedicaid = new System.Windows.Forms.Label();
			this.labelStandard = new System.Windows.Forms.Label();
			this.textAppointmentScheduledDaysMedicaid = new Helianz.ValidNum();
			this.textPatientEnrollmentDaysMedicaid = new Helianz.ValidNum();
			this.textInsBenefitEligibilityDaysMedicaid = new Helianz.ValidNum();
			this.listBoxVerifyRegions = new Helianz.UI.ListBox();
			this.listBoxVerifyClinics = new Helianz.UI.ListBox();
			this.butRefresh = new Helianz.UI.Button();
			this.comboVerifyUser = new Helianz.UI.ComboBox();
			this.labelPlanBenefitsNotVerifiedIn = new System.Windows.Forms.Label();
			this.labelClinic = new System.Windows.Forms.Label();
			this.comboFilterVerifyStatus = new Helianz.UI.ComboBox();
			...
			this.butVerifyUserPick = new Helianz.UI.Button();
			...
			this.textAppointmentScheduledDaysStandard = new Helianz.ValidNum();
			this.textPatientEnrollmentDaysStandard = new Helianz.ValidNum();
			this.textInsBenefitEligibilityDaysStandard = new Helianz.ValidNum();
			...
			this.gridPastDue.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPastDue_CellDoubleClick);
			this.gridPastDue.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridPastDue_CellClick);
			// 
			// butVerifyPat
			// 
			...
			this.gridAssignStandard.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAssignMedicaid.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.listBoxVerifyRegions.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxVerifyClinics.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.GroupBox groupVerificationFilters;
		...
		private Helianz.UI.GroupBox groupInsurancePlan;
		...
		private Helianz.UI.GroupBox groupAssignVerificationStandard;
		...
		private Helianz.UI.ComboBox comboFilterVerifyStatus;
		...
		private Helianz.UI.TabPage tabVerify;
		private Helianz.UI.TabPage tabAssignStandard;
		...
		private Helianz.UI.ComboBox comboVerifyUser;
		private System.Windows.Forms.Label labelVerifyStatusSet;
		private Helianz.UI.ComboBox comboSetVerifyStatus;
		...
		private Helianz.UI.TabControl tabControlVerificationList;
		private Helianz.UI.TabPage tabCurrent;
		private Helianz.UI.TabPage tabPastDue;
		private UI.GridOD gridPastDue;
		private UI.ListBox listBoxVerifyClinics;
		private UI.ListBox listBoxVerifyRegions;
		private Helianz.UI.TabPage tabAssignMedicaid;
