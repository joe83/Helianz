...
namespace Helianz {
	public partial class FormProgramLinks {
		...
		private void InitializeComponent(){
			...
			this.gridProgram = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butAdd
			// 
			...
			this.gridProgram.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProgram_CellDoubleClick);
			// 
			// FormProgramLinks
			// 
		...
		#endregion
		private Helianz.UI.Button butAdd;// Required designer variable.
