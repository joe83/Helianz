namespace Helianz{
	partial class FormCertifications {
		...
		private void InitializeComponent() {
			...
			this.listBoxEmployee = new Helianz.UI.ListBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.listBoxCategories = new Helianz.UI.ListBox();
			this.butSetup = new Helianz.UI.Button();
			this.labelEmployee = new System.Windows.Forms.Label();
			this.labelCategories = new System.Windows.Forms.Label();
			this.groupBoxOrderBy = new Helianz.UI.GroupBox();
			...
			this.listBoxCertification = new Helianz.UI.ListBox();
			...
			this.checkIncomplete = new Helianz.UI.CheckBox();
			this.checkSortDate = new Helianz.UI.CheckBox();
			this.labelCategories2 = new System.Windows.Forms.Label();
			this.listBoxCategories2 = new Helianz.UI.ListBox();
			this.comboSupervisor = new Helianz.UI.ComboBox();
			this.labelReportsTo = new System.Windows.Forms.Label();
			this.checkSortDateCertComplete = new Helianz.UI.CheckBox();
			...
			this.listBoxCategories.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxCategories2.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.GroupBox groupBoxOrderBy;
		...
		private Helianz.UI.CheckBox checkIncomplete;
		private Helianz.UI.CheckBox checkSortDate;
		...
		private Helianz.UI.CheckBox checkSortDateCertComplete;
	}
}