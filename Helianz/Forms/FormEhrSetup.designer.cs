namespace Helianz{
	partial class FormEhrSetup {
		...
		private void InitializeComponent() {
			...
			this.groupCodeSystems = new Helianz.UI.GroupBox();
			this.butCodeImport = new Helianz.UI.Button();
			this.butRxNorm = new Helianz.UI.Button();
			this.butICD9s = new Helianz.UI.Button();
			this.butSnomeds = new Helianz.UI.Button();
			this.butProviderKeys = new Helianz.UI.Button();
			this.butPortalSetup = new Helianz.UI.Button();
			this.butOIDs = new Helianz.UI.Button();
			this.butEhrTriggers = new Helianz.UI.Button();
			this.butTimeSynch = new Helianz.UI.Button();
			this.butLoincs = new Helianz.UI.Button();
			this.butEducationalResources = new Helianz.UI.Button();
			this.butInboundEmail = new Helianz.UI.Button();
			this.butReminderRules = new Helianz.UI.Button();
			this.panelEmergencyNow = new Helianz.UI.PanelOD();
			this.butEmergencyNow = new Helianz.UI.Button();
			this.butDrugUnit = new Helianz.UI.Button();
			this.butDrugManufacturer = new Helianz.UI.Button();
			this.butVaccineDef = new Helianz.UI.Button();
			this.butAllergies = new Helianz.UI.Button();
		...
		private Helianz.UI.GroupBox groupCodeSystems;
