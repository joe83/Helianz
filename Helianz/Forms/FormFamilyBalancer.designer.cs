namespace Helianz{
	partial class FormFamilyBalancer {
		...
		private void InitializeComponent() {
			...
			this.butRigorous = new Helianz.UI.Button();
			...
			this.checkDeleteTransfers = new Helianz.UI.CheckBox();
			this.labelDeleteTransfers = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.label5 = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this.butFIFO = new Helianz.UI.Button();
			...
			this.groupBoxIncomeTransfers = new Helianz.UI.GroupBox();
			this.butConfigureAuto = new Helianz.UI.Button();
			this.checkChangedSinceDate = new Helianz.UI.CheckBox();
			...
			this.groupBoxRecreateSplits = new Helianz.UI.GroupBox();
			this.labelAsOfDateDescRecreate = new System.Windows.Forms.Label();
			this.butRecreate = new Helianz.UI.Button();
			...
			this.checkDeleteTransfersRecreate = new Helianz.UI.CheckBox();
			this.labelDeleteTransfersRecreate = new System.Windows.Forms.Label();
			this.label11 = new System.Windows.Forms.Label();
			this.label15 = new System.Windows.Forms.Label();
			this.textOutput = new System.Windows.Forms.TextBox();
			this.checkOutputVerbose = new Helianz.UI.CheckBox();
			this.timerOutput = new System.Windows.Forms.Timer(this.components);
			this.butLog = new Helianz.UI.Button();
			this.groupBoxInsuranceOverpayments = new Helianz.UI.GroupBox();
			this.label8 = new System.Windows.Forms.Label();
			this.label56 = new System.Windows.Forms.Label();
			this.comboOverpayPayType = new Helianz.UI.ComboBox();
			this.label2 = new System.Windows.Forms.Label();
			this.datePickerOverpayPayDate = new System.Windows.Forms.DateTimePicker();
			this.label3 = new System.Windows.Forms.Label();
			this.butOverpay = new Helianz.UI.Button();
    ...
    "et this to the date of the conversion.\r\nFor bi-weekly usage, use today\'s date.";
		...
		private Helianz.UI.CheckBox checkDeleteTransfers;
		...
		private Helianz.UI.CheckBox checkDeleteTransfersRecreate;
		private System.Windows.Forms.Label labelDeleteTransfersRecreate;
		private System.Windows.Forms.Label label15;
		private System.Windows.Forms.TextBox textOutput;
		private Helianz.UI.CheckBox checkOutputVerbose;
		private System.Windows.Forms.Timer timerOutput;
		private UI.Button butLog;
		private Helianz.UI.CheckBox checkChangedSinceDate;
