namespace Helianz{
	partial class FormTxtMsgEdit {
		...
		private void InitializeComponent() {
			...
			this.groupRecipient = new Helianz.UI.GroupBox();
			...
			this.textMessage.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
		...
		private Helianz.UI.GroupBox groupRecipient;
