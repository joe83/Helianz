namespace Helianz{
	partial class FormResellerEdit {
		...
		private void InitializeComponent() {
			...
			this.gridServices = new Helianz.UI.GridOD();
			...
			this.comboBillingType = new Helianz.UI.ComboBox();
			this.label8 = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.textNote = new System.Windows.Forms.TextBox();
			this.textVotesAllotted = new System.Windows.Forms.TextBox();
			this.checkAllowSignupPortal = new Helianz.UI.CheckBox();
			...
			this.gridServices.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridServices_CellDoubleClick);
			// 
			// label1
			// 
