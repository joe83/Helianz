namespace Helianz{
	partial class FormERoutingDefEdit {
		...
		private void InitializeComponent() {
			...
			this.gridERoutingActions = new Helianz.UI.GridOD();
			this.butAdd = new Helianz.UI.Button();
			this.groupBoxActions = new Helianz.UI.GroupBox();
			this.groupBoxOD2 = new Helianz.UI.GroupBox();
			this.butRemoveLinkType = new Helianz.UI.Button();
			this.gridLinkTypes = new Helianz.UI.GridOD();
			this.groupBoxOD3 = new Helianz.UI.GroupBox();
			this.labelGenAppts = new System.Windows.Forms.Label();
			this.butAddLinkType = new Helianz.UI.Button();
			this.butAddSpecificTypes = new Helianz.UI.Button();
			this.comboLinkType = new Helianz.UI.ComboBox();
			...
			this.gridERoutingActions.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridERoutingActions_CellDoubleClick);
			// 
			// butAdd
			// 
			...
			// butRemoveLinkType
			// 
			this.butRemoveLinkType.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// butAddLinkType
			// 
			this.butAddLinkType.Icon = Helianz.UI.EnumIcons.Add;
