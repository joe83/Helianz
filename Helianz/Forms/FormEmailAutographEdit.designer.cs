...
namespace Helianz {
	public partial class FormEmailAutographEdit {
		...
		private void InitializeComponent()
		{
			...
			this.textAutographText = new Helianz.ODtextBox();
			...
			this.textAutographText.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
		...
		private Helianz.ODtextBox textAutographText;
