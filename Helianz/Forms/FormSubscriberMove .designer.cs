namespace Helianz{
	partial class FormSubscriberMove {
		...
		private void InitializeComponent() {
			...
			this.butViewInsPlanInto = new Helianz.UI.Button();
			this.butPickInsPlanInto = new Helianz.UI.Button();
			this.textCarrierNameInto = new System.Windows.Forms.TextBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.butViewInsPlanFrom = new Helianz.UI.Button();
			this.butPickInsPlanFrom = new Helianz.UI.Button();
		...
		private Helianz.UI.Button butPickInsPlanInto;
		private Helianz.UI.Button butPickInsPlanFrom;
