namespace Helianz{
	partial class FormProcNoteAppend {
		...
		private void InitializeComponent() {
			...
			this.textAppended = new Helianz.ODtextBox();
			...
			this.signatureBoxWrapper.SignatureMode = Helianz.UI.SignatureBoxWrapper.SigMode.Default;
			...
			this.textAppended.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Procedure;
