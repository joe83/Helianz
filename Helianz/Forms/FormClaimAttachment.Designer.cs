namespace Helianz {
	partial class FormClaimAttachment {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormClaimAttachment));
			...
			this.butPasteImage = new Helianz.UI.Button();
			this.labelCharCount = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.textClaimStatus = new Helianz.ODtextBox();
			this.gridAttachedImages = new Helianz.UI.GridOD();
			this.butSnipTool = new Helianz.UI.Button();
			this.butAddImage = new Helianz.UI.Button();
			this.textNarrative = new Helianz.ODtextBox();
			...
			this.textClaimStatus.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Claim;
			...
			this.gridAttachedImages.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAttachedImages_CellDoubleClick);
			this.gridAttachedImages.SelectionCommitted += new System.EventHandler(this.gridAttachedImages_SelectionCommitted);
			// 
			// butSnipTool
			// 
			...
			this.textNarrative.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Claim;
    ...
    "the first image category.";
			...
			this.butSave.Location = new System.Drawing.Point(516, 365);
			this.butSave.Name = "butSave";
			this.butSave.Size = new System.Drawing.Size(75, 24);
			this.butSave.TabIndex = 4;
			this.butSave.Text = "&Save";
			this.butSave.UseVisualStyleBackColor = true;
			this.butSave.Click += new System.EventHandler(this.buttonOK_Click);
			// 
