namespace Helianz{
	partial class FormTimeCardRuleEdit {
		...
		private void InitializeComponent() {
			...
			this.checkIsOvertimeExempt = new Helianz.UI.CheckBox();
			...
			this.but6am = new Helianz.UI.Button();
			this.textAfterTimeOfDay = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.but5pm = new Helianz.UI.Button();
			...
			this.checkUseRate3 = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.Button but5pm;
		...
		private Helianz.UI.CheckBox checkIsOvertimeExempt;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.TextBox textClockInMin;
		private Helianz.UI.CheckBox checkUseRate3;
	}
}