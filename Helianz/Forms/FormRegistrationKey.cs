...
namespace Helianz{
	...
	public partial class FormRegistrationKey : FormODBase {
		...
		private void FillListBoxRegistration() {
			listBoxRegistration.Items.Add("Helianz",Properties.Resources.HelianzLicense);
		...
		///FormHelianz will handle subsequent attempts on load. </summary>
		private void SignLicenseAgreement(string regKey) {
			...
			} //Will try to send again next time Helianz is launched
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			FormHelianz.IsRegKeyForTesting=PrefL.IsRegKeyForTesting();
