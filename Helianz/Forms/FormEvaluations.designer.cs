namespace Helianz{
	partial class FormEvaluations {
		...
		private void InitializeComponent() {
			...
			this.groupStudents = new Helianz.UI.GroupBox();
			...
			this.groupAdmin = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.ComboBox comboInstructor;
		private System.Windows.Forms.Label label2;
		private Helianz.UI.GroupBox groupStudents;
		...
		private Helianz.UI.GroupBox groupAdmin;
