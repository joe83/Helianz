namespace Helianz{
	partial class FormReconcileAllergy {
		...
		private void InitializeComponent() {
			...
			this.gridAllergyExisting = new Helianz.UI.GridOD();
			this.gridAllergyImport = new Helianz.UI.GridOD();
			this.butRemoveRec = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.butAddNew = new Helianz.UI.Button();
			this.butAddExist = new Helianz.UI.Button();
			this.gridAllergyReconcile = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// labelBatch
			// 
			...
			this.gridAllergyExisting.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAllergyImport.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.butAddNew.Image = global::Helianz.Properties.Resources.down;
			...
			this.butAddExist.Image = global::Helianz.Properties.Resources.down;
			...
			this.gridAllergyReconcile.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
