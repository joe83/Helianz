...
namespace Helianz {
	public partial class FormUpdate : FormODBase {
		...
		private void DownloadAndStartMSI(string updateCode) {
			...
			string fileName=PrefC.GetString(PrefName.UpdateWebsitePath)+updateCode+"/Helianz.msi";
			try {
		...
		///<summary>Downloads the build update MSI file and starts the install, closing Helianz.</summary>
		...
		///<summary>Downloads the stable update MSI file and starts the install, closing Helianz.</summary>
		...
		///<summary>Downloads the beta update MSI file and starts the install, closing Helianz.</summary>
