namespace Helianz{
	partial class FormEmailCertRegister {
		...
		private void InitializeComponent() {
			...
			this.groupStep1 = new Helianz.UI.GroupBox();
			this.textEmailAddress = new System.Windows.Forms.TextBox();
			this.labelEmailAddress = new System.Windows.Forms.Label();
			this.butSendCode = new Helianz.UI.Button();
			this.groupStep2 = new Helianz.UI.GroupBox();
			...
			this.groupStep3 = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.GroupBox groupStep3;
