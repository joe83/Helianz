namespace Helianz{
	partial class FormEvaluationEdit {
		...
		private void InitializeComponent() {
			...
			this.gridGrades = new Helianz.UI.GridOD();
			this.textDate = new Helianz.ValidDate();
			this.butStudentPicker = new Helianz.UI.Button();
			this.gridCriterion = new Helianz.UI.GridOD();
			...
			this.gridGrades.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridGrades_CellClick);
			// 
			// textDate
			// 
			...
			this.gridCriterion.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridCriterion.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCriterion_CellClick);
			this.gridCriterion.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridCriterion_CellLeave);
			this.gridCriterion.CellEnter += new Helianz.UI.ODGridClickEventHandler(this.gridCriterion_CellEnter);
			// 
			// butSave
			// 
