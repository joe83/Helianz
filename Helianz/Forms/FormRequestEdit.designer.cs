namespace Helianz{
	partial class FormRequestEdit {
		...
		private void InitializeComponent() {
			...
			this.checkIsMine = new Helianz.UI.CheckBox();
			...
			this.groupMyVotes = new Helianz.UI.GroupBox();
			this.textMyPointsRemain = new System.Windows.Forms.TextBox();
			this.label8 = new System.Windows.Forms.Label();
			this.checkIsCritical = new Helianz.UI.CheckBox();
			...
			this.comboApproval = new Helianz.UI.ComboBox();
			...
			this.butAddDiscuss = new Helianz.UI.Button();
			this.butSetOD = new Helianz.UI.Button();
    ...
    ".  Try to prepend your name to the note.";
			...
			this.butAddDiscuss.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.CheckBox checkIsMine;
		...
		private Helianz.UI.ComboBox comboApproval;
		...
		private Helianz.UI.Button butSetOD;
		private System.Windows.Forms.Label label17;
		private System.Windows.Forms.Label label16;
		private System.Windows.Forms.Label labelDiscuss;
		private Helianz.UI.Button butAddDiscuss;
