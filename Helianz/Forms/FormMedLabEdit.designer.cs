namespace Helianz{
	partial class FormMedLabEdit {
		...
		private void InitializeComponent() {
			...
			this.groupPat = new Helianz.UI.GroupBox();
			...
			this.groupOrderingPhys = new Helianz.UI.GroupBox();
			...
			this.gridFacilities = new Helianz.UI.GridOD();
			this.gridResults = new Helianz.UI.GridOD();
			this.butShowHL7 = new Helianz.UI.Button();
			this.butPDF = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.textGenComments = new Helianz.ODtextBox();
			this.textTestsOrd = new Helianz.ODtextBox();
			this.textAddlInfo = new Helianz.ODtextBox();
			...
			this.gridResults.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridResults_CellDoubleClick);
			// 
			// butShowHL7
			// 
			...
			this.textGenComments.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Lab;
			...
			this.textTestsOrd.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Lab;
			...
			this.textAddlInfo.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Lab;
		...
		private Helianz.UI.GroupBox groupPat;
		...
		private Helianz.UI.GroupBox groupOrderingPhys;
