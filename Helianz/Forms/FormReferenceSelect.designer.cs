namespace Helianz{
	partial class FormReference {
		...
		private void InitializeComponent() {
			...
			this.checkBadRefs = new Helianz.UI.CheckBox();
			this.groupFilter = new Helianz.UI.GroupBox();
			this.listBillingType = new Helianz.UI.ListBox();
			this.label10 = new System.Windows.Forms.Label();
			this.checkUsedRefs = new Helianz.UI.CheckBox();
			this.checkGuarOnly = new Helianz.UI.CheckBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.checkRefresh = new Helianz.UI.CheckBox();
			this.butGetAll = new Helianz.UI.Button();
			...
			this.listBillingType.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.CheckBox checkBadRefs;
		...
		private Helianz.UI.CheckBox checkUsedRefs;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.CheckBox checkRefresh;
		...
		private Helianz.UI.CheckBox checkGuarOnly;
		private System.Windows.Forms.Label label10;
		private System.Windows.Forms.Label label11;
		private Helianz.UI.ListBox listBillingType;
