namespace Helianz{
	partial class FormSheetFieldComboBox {
		...
		private void InitializeComponent() {
			...
			this.listComboType = new Helianz.UI.ListBox();
			...
			this.listboxComboOptions = new Helianz.UI.ListBox();
        ...
        "Urgency"};
			...
			this.butRemove.Image = global::Helianz.Properties.Resources.deleteX18;
			...
			// butAdd
			// 
			this.butAdd.Image = global::Helianz.Properties.Resources.Right;
		...
		private Helianz.UI.ListBox listboxComboOptions;
		...
		private Helianz.UI.ListBox listComboType;
