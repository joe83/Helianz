...
namespace Helianz {
	public partial class FormMountDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkAdjModeAfterSeries = new Helianz.UI.CheckBox();
			this.checkFlipOnAcquire = new Helianz.UI.CheckBox();
			this.comboDefaultCat = new Helianz.UI.ComboBox();
			...
			this.butReorder = new Helianz.UI.Button();
			...
			this.controlDrawing = new Helianz.UI.ControlDoubleBuffered();
			this.checkTransparent = new Helianz.UI.CheckBox();
    ...
    " Mount.  Consider enlarging your mount to find it.";
		...
		private Helianz.UI.CheckBox checkFlipOnAcquire;
		private Helianz.UI.CheckBox checkAdjModeAfterSeries;
		private Helianz.UI.CheckBox checkTransparent;
	}
}
