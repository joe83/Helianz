namespace Helianz{
	partial class FormRecurringChargesHistory {
		...
		private void InitializeComponent() {
			...
			this.groupView = new Helianz.UI.GroupBox();
			this.comboAutomated = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.GroupBox groupView;
		...
		private Helianz.UI.ComboBox comboAutomated;
	}
}