...
namespace Helianz {
	public partial class FormMessagingSetup {
		...
		private void InitializeComponent()
		{
			...
			this.listMessages = new Helianz.UI.ListBox();
			this.label5 = new System.Windows.Forms.Label();
			this.listExtras = new Helianz.UI.ListBox();
			this.label4 = new System.Windows.Forms.Label();
			this.listToFrom = new Helianz.UI.ListBox();
		...
		#endregion
		private Helianz.UI.ListBox listMessages;
		private Label label5;
		private Helianz.UI.ListBox listExtras;
		private Label label4;
		private Helianz.UI.ListBox listToFrom;
