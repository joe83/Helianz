namespace Helianz{
	partial class FormSheetDef {
		...
		private void InitializeComponent() {
			...
			this.listSheetType = new Helianz.UI.ListBox();
			...
			this.checkIsLandscape = new Helianz.UI.CheckBox();
			...
			this.checkHasMobileLayout = new Helianz.UI.CheckBox();
			this.checkAutoSaveCheck = new Helianz.UI.CheckBox();
			this.comboAutoSaveOverride = new Helianz.UI.ComboBox();
			...
			this.butAbout = new Helianz.UI.Button();
		...
		private Helianz.UI.ListBox listSheetType;
		...
		private Helianz.UI.CheckBox checkIsLandscape;
		private Helianz.UI.CheckBox checkBypassLockDate;
		private Helianz.UI.CheckBox checkHasMobileLayout;
		private Helianz.UI.CheckBox checkAutoSaveCheck;
