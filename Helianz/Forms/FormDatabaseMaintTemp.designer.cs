namespace Helianz{
	partial class FormDatabaseMaintTemp {
		...
		private void InitializeComponent() {
			...
			this.comboDbs = new Helianz.UI.ComboBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.textResults = new System.Windows.Forms.TextBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butFix3 = new Helianz.UI.Button();
			this.label8 = new System.Windows.Forms.Label();
			this.butFix2 = new Helianz.UI.Button();
			this.label7 = new System.Windows.Forms.Label();
			this.butFix1 = new Helianz.UI.Button();
    ...
    "s described at\r\nhttp://www.helianz.com/manual/bugcp.html\r\n";
    ...
    "ight will be available.";
		...
		private Helianz.UI.ComboBox comboDbs;
		...
		private Helianz.UI.Button butFix1;
		private System.Windows.Forms.Label label6;
		private Helianz.UI.Button butFix3;
		private System.Windows.Forms.Label label8;
		private Helianz.UI.Button butFix2;
