namespace Helianz{
	partial class FormAdvertisingPostcardsSetup {
		...
		private void InitializeComponent() {
			...
			this.gridAccounts = new Helianz.UI.GridOD();
			this.gridClinics = new Helianz.UI.GridOD();
			this.label2 = new System.Windows.Forms.Label();
			this.butManageAccount = new Helianz.UI.Button();
			...
			this.gridAccounts.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridAccounts.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAccounts_CellDoubleClick);
			this.gridAccounts.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAccounts_CellClick);
			// 
			// gridClinics
			// 
