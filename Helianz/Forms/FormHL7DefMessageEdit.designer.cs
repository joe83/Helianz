namespace Helianz{
	partial class FormHL7DefMessageEdit {
		...
		private void InitializeComponent() {
			...
			this.comboMessageStructure = new Helianz.UI.ComboBox();
			this.comboMsgType = new Helianz.UI.ComboBox();
    ...
    " list.";
		...
		private Helianz.UI.ComboBox comboMessageStructure;
		private Helianz.UI.ComboBox comboMsgType;
