namespace Helianz{
	partial class FormWebSchedCarrierRuleCopyToClinics{
		...
		private void InitializeComponent() {
			...
			this.listClinicsCopyTo.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.CheckBox checkOverride;
