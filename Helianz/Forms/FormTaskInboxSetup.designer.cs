namespace Helianz{
	partial class FormTaskInboxSetup {
		...
		private void InitializeComponent() {
			...
			this.listMain = new Helianz.UI.ListBox();
			this.butSet = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			// butSet
			// 
			this.butSet.Image = global::Helianz.Properties.Resources.Left;
		...
		private Helianz.UI.ListBox listMain;
		private Helianz.UI.Button butSet;
	}
}