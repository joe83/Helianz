...
namespace Helianz {
	public partial class FormCCDPrint:FormODBase {
		...
		private void pd_PrintPage(object sender,System.Drawing.Printing.PrintPageEventArgs e){
			...
			if(_isDirty){//Only render the document containers the first time through.
				...
				try {
					...
					//Printing will fail if the user switched to Helianz from another software system and Helianz gets a response from ITRANS with 
		...
		private void PrintDentaide(Graphics g){
			...
			//Dependant NO. should be same for both primary and secondary insurance, because it is the patient account number from within Helianz.
