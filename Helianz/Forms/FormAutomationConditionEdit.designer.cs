namespace Helianz{
	partial class FormAutomationConditionEdit {
		...
		private void InitializeComponent() {
			...
			this.listCompareField = new Helianz.UI.ListBox();
			this.listComparison = new Helianz.UI.ListBox();
		...
		private Helianz.UI.ListBox listCompareField;
		private Helianz.UI.ListBox listComparison;
