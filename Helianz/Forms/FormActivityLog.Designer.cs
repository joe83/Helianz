...
namespace Helianz {
	partial class FormActivityLog {
		...
		private void InitializeComponent() {
			...
			this.checkDistinctLogGuid = new Helianz.UI.CheckBox();
			this.groupBoxFilters = new Helianz.UI.GroupBox();
			this.textPatNum = new Helianz.ValidNum();
			...
			this.comboBoxTypes = new Helianz.UI.ComboBox();
			this.comboBoxActions = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.CheckBox checkDistinctLogGuid;
