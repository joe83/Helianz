...
namespace Helianz {
	public partial class FormTasks {
		...
		private void InitializeComponent()
		{
			...
			this.userControlTasks1 = new Helianz.UserControlTasks();
			...
			this.userControlTasks1.TaskTab = Helianz.UserControlTasksTab.ForUser;
			this.userControlTasks1.FillGridEvent += new Helianz.UserControlTasks.FillGridEventHandler(this.UserControlTasks1_FillGridEvent);
