namespace Helianz {
	partial class FormUserPrefAdditional {
		...
		private void InitializeComponent() {
			...
			this.gridUserProperties = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.gridUserProperties.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridUserProperties.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridProvProperties_CellLeave);
			// 
