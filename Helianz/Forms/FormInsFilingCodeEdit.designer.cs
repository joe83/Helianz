...
namespace Helianz {
	public partial class FormInsFilingCodeEdit {
		...
		private void InitializeComponent()
		{
			...
			this.gridInsFilingCodeSubtypes = new Helianz.UI.GridOD();
			...
			this.checkExcludeOtherCoverage = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.gridInsFilingCodeSubtypes.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridInsFilingCodeSubtypes_CellDoubleClick);
			// 
			// butDelete
			// 
		...
		private Helianz.UI.GridOD gridInsFilingCodeSubtypes;
		private Helianz.UI.Button butAdd;
		private Label label3;
		private UI.ComboBox comboGroup;
		private Helianz.UI.CheckBox checkExcludeOtherCoverage;
	}
}
