...
namespace Helianz {
	public partial class FormPractice {
		...
		private void InitializeComponent(){
			...
			this.listPlaceService = new Helianz.UI.ListBox();
			...
			this.groupSwiss = new Helianz.UI.GroupBox();
			...
			this.textBillingPhone = new Helianz.ValidPhone();
			...
			this.textPayToPhone = new Helianz.ValidPhone();
    ...
    "ddress.";
		...
		private Helianz.UI.ListBox listPlaceService;
		...
		private Helianz.UI.GroupBox groupSwiss;
		...
		private Helianz.UI.GroupBox groupBox4;// Required designer variable.
