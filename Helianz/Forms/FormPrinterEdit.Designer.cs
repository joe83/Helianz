namespace Helianz {
	partial class FormPrinterEdit {
		...
		private void InitializeComponent() {
			...
			this.checkPrompt = new Helianz.UI.CheckBox();
			this.comboPrinter = new Helianz.UI.ComboBox();
			this.labelPrinter = new System.Windows.Forms.Label();
			this.checkVirtualPrinter = new Helianz.UI.CheckBox();
			this.labelExtension = new System.Windows.Forms.Label();
			this.textFileExtension = new Helianz.ODtextBox();
			this.labelSituation = new System.Windows.Forms.Label();
			this.textSituation = new Helianz.ODtextBox();
			...
			this.textFileExtension.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Letter;
			...
			this.textSituation.QuickPasteType = HelianzBusiness.EnumQuickPasteType.FAQ;
