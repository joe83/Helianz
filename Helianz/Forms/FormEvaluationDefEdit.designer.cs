namespace Helianz{
	partial class FormEvaluationDefEdit {
		...
		private void InitializeComponent() {
			...
			this.butCoursePicker = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butCriterionAdd = new Helianz.UI.Button();
			this.butGradingScale = new Helianz.UI.Button();
			...
			this.butCriterionAdd.Icon = Helianz.UI.EnumIcons.Add;
