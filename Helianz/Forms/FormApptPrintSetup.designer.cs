namespace Helianz{
	partial class FormApptPrintSetup {
		...
		private void InitializeComponent() {
			...
			this.groupBoxPrintRouting = new Helianz.UI.GroupBox();
			this.butSelectedView = new Helianz.UI.Button();
			this.butSelectedDay = new Helianz.UI.Button();
			...
			this.comboStop = new Helianz.UI.ComboBox();
			this.comboStart = new Helianz.UI.ComboBox();
			this.label3 = new System.Windows.Forms.Label();
			this.textFontSize = new Helianz.ValidNum();
			this.labelStopTime = new System.Windows.Forms.Label();
			this.labelStartTime = new System.Windows.Forms.Label();
			this.labelFontSize = new System.Windows.Forms.Label();
			this.textColumnsPerPage = new Helianz.ValidNum();
