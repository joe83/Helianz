namespace Helianz{
	partial class FormRpEraAutoProcessed {
		...
		private void InitializeComponent() {
			...
			this.checkShowAcknowledged = new Helianz.UI.CheckBox();
			...
			this.gridEras = new Helianz.UI.GridOD();
			this.gridClaims = new Helianz.UI.GridOD();
			this.butAcknowledge = new Helianz.UI.Button();
			this.comboClinics = new Helianz.UI.ComboBoxClinicPicker();
			this.listAutoProcessStatuses = new Helianz.UI.ListBox();
			this.labelAutoProcessStatus = new System.Windows.Forms.Label();
			this.butSelectEob = new Helianz.UI.Button();
			this.gridClaimProcedureAdjustments = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// dateRangePicker
			// 
			...
			this.gridEras.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridEras.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridEras_CellDoubleClick);
			...
			this.gridClaims.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridClaims_CellDoubleClick);
			...
			this.listAutoProcessStatuses.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.CheckBox checkShowAcknowledged;
