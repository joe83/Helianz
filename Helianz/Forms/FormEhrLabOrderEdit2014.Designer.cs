namespace Helianz {
	partial class FormEhrLabOrderEdit2014 {
		...
		private void InitializeComponent() {
			...
			this.checkAutoID = new Helianz.UI.CheckBox();
			...
			this.butProvPicker = new Helianz.UI.Button();
			...
			this.butServicePicker = new Helianz.UI.Button();
			...
			this.checkResultsHandlingN = new Helianz.UI.CheckBox();
			this.checkResultsHandlingF = new Helianz.UI.CheckBox();
			...
			this.butViewParent = new Helianz.UI.Button();
			this.butParentPicker = new Helianz.UI.Button();
			this.gridResultsCopyTo = new Helianz.UI.GridOD();
			this.butPatientPick = new Helianz.UI.Button();
			this.gridClinicalInformation = new Helianz.UI.GridOD();
			this.gridNotes = new Helianz.UI.GridOD();
			this.gridSpecimen = new Helianz.UI.GridOD();
			...
			this.gridSpecimen.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSpecimen_CellDoubleClick);
			// 
			// gridMain
			// 
		...
		private Helianz.UI.CheckBox checkResultsHandlingN;
		private Helianz.UI.CheckBox checkResultsHandlingF;
		...
		private Helianz.UI.CheckBox checkAutoID;
