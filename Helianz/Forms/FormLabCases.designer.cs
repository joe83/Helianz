...
namespace Helianz {
	public partial class FormLabCases {
		...
		private void InitializeComponent()
		{
			...
			this.checkShowUnattached = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.Button butRefresh;// Required designer variable.
		private Helianz.UI.CheckBox checkShowAll;
		private ContextMenu contextMenu1;
		private MenuItem menuItemGoTo;
		private Helianz.UI.CheckBox checkShowUnattached;
