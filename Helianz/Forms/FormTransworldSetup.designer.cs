namespace Helianz{
	partial class FormTransworldSetup {
		...
		private void InitializeComponent() {
			...
			this.checkEnabled = new Helianz.UI.CheckBox();
			...
			this.groupClinicSettings = new Helianz.UI.GroupBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.comboNegAdjType = new Helianz.UI.ComboBox();
			this.comboPosAdjType = new Helianz.UI.ComboBox();
			this.checkThankYouLetter = new Helianz.UI.CheckBox();
			this.groupServicesEnabled = new Helianz.UI.GroupBox();
			this.checkAccelService = new Helianz.UI.CheckBox();
			this.checkPRService = new Helianz.UI.CheckBox();
			this.checkCollService = new Helianz.UI.CheckBox();
			this.groupSftpServerInfo = new Helianz.UI.GroupBox();
			this.labelSftpPort = new System.Windows.Forms.Label();
			this.textSftpPort = new Helianz.ValidNum();
			this.groupClientIDs = new Helianz.UI.GroupBox();
			...
			this.checkHideButtons = new Helianz.UI.CheckBox();
			...
			this.groupSendActivity = new Helianz.UI.GroupBox();
			this.labelPaidInFullBillType = new System.Windows.Forms.Label();
			this.comboPaidInFullBillType = new Helianz.UI.ComboBox();
			this.numericSendFrequency = new System.Windows.Forms.NumericUpDown();
			this.comboSendFrequencyUnits = new Helianz.UI.ComboBox();
    ...
    " and login credentials for that clinic.";
			...
			this.labelSendTimeOfDay.Text = "HelianzService Send Time";
			...
			this.labelODService.Text = "(by HelianzService)";
		...
		private Helianz.UI.CheckBox checkEnabled;
		...
		private Helianz.UI.ComboBox comboClinic;
		private Helianz.UI.GroupBox groupClinicSettings;
		private System.Windows.Forms.TextBox textClientIdCollection;
		private System.Windows.Forms.Label labelClientIdCollection;
		private Helianz.UI.CheckBox checkThankYouLetter;
		...
		private Helianz.UI.GroupBox groupSftpServerInfo;
		private Helianz.UI.GroupBox groupClientIDs;
		private Helianz.UI.CheckBox checkHideButtons;
		...
		private Helianz.UI.GroupBox groupSendActivity;
		private System.Windows.Forms.NumericUpDown numericSendFrequency;
		private Helianz.UI.ComboBox comboSendFrequencyUnits;
		private System.Windows.Forms.Label labelSendFrequency;
		private Helianz.UI.GroupBox groupServicesEnabled;
		private Helianz.UI.CheckBox checkAccelService;
		private Helianz.UI.CheckBox checkPRService;
		private Helianz.UI.CheckBox checkCollService;
