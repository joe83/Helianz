namespace Helianz{
	partial class FormHL7DefEdit {
		...
		private void InitializeComponent() {
			...
			this.checkInternal = new Helianz.UI.CheckBox();
			...
			this.comboModeTx = new Helianz.UI.ComboBox();
			...
			this.groupShowDemographics = new Helianz.UI.GroupBox();
			...
			this.checkShowAccount = new Helianz.UI.CheckBox();
			this.checkShowAppts = new Helianz.UI.CheckBox();
			this.checkQuadAsToothNum = new Helianz.UI.CheckBox();
			this.labelLabImageCat = new System.Windows.Forms.Label();
			this.comboLabImageCat = new Helianz.UI.ComboBox();
			this.groupDelimeters = new Helianz.UI.GroupBox();
			this.groupHL7Comm = new Helianz.UI.GroupBox();
			this.butBrowseOut = new Helianz.UI.Button();
			this.butBrowseIn = new Helianz.UI.Button();
			...
			this.checkLongDCodes = new Helianz.UI.CheckBox();
			this.checkProcsAppt = new Helianz.UI.CheckBox();
    ...
    " list.";
			...
			this.label16.Text = "--Typically HelianzHL7.";
			...
			this.label19.Text = "Helianz HL7 Server";
    ...
    "messages.";
		...
		private Helianz.UI.CheckBox checkInternal;
		...
		private Helianz.UI.ComboBox comboModeTx;
		...
		private Helianz.UI.GroupBox groupShowDemographics;
		...
		private Helianz.UI.CheckBox checkShowAccount;
		private Helianz.UI.CheckBox checkShowAppts;
		private System.Windows.Forms.Label label20;
		private Helianz.UI.CheckBox checkQuadAsToothNum;
		private System.Windows.Forms.Label labelLabImageCat;
		private Helianz.UI.ComboBox comboLabImageCat;
		private Helianz.UI.GroupBox groupDelimeters;
		private System.Windows.Forms.TextBox textFieldSep;
		private Helianz.UI.GroupBox groupHL7Comm;
		private Helianz.UI.CheckBox checkLongDCodes;
		private Helianz.UI.CheckBox checkProcsAppt;
	}
}