...
namespace Helianz {
	public partial class FormInsCatsSetup {
		...
		private void InitializeComponent() {
			...
			this.butAddSpan.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butAddCat
			// 
			this.butAddCat.Icon = Helianz.UI.EnumIcons.Add;
