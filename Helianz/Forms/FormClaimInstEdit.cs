...
///<summary></summary>
	public class FormClaimInstEdit:System.Windows.Forms.Form {
		...
		private Helianz.ValidDate textDateSent;
		...
		private Helianz.UI.ODGrid gridProc;
		...
		public FormClaimInstEdit(Claim claimCur,Patient patCur,Family famCur) {
			...
			//tbPay.CellDoubleClicked += new Helianz.ContrTable.CellEventHandler(tbPay_CellDoubleClicked);
			//tbProc.CellClicked += new Helianz.ContrTable.CellEventHandler(tbProc_CellClicked);
			//tbPay.CellClicked += new Helianz.ContrTable.CellEventHandler(tbPay_CellClicked);
			Lan.F(this);
    }
		...
		private void InitializeComponent()
		{
			...
			this.gridProc = new Helianz.UI.ODGrid();
			...
			this.butOtherNone.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butOtherNone.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butOtherCovChange.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butOtherCovChange.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butHistory.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butHistory.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butSend.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butSend.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butLabel.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butLabel.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butPreview.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butPreview.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butPrint.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butPrint.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			...
			this.butDelete.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butDelete.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butDelete.CornerRadius = 4F;
			this.butDelete.Image = global::Helianz.Properties.Resources.deleteX;
