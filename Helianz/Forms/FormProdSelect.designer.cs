namespace Helianz{
	partial class FormProdSelect {
		...
		private void InitializeComponent() {
			...
			this.gridProduction = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.gridProduction.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProduction.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProduction_CellDoubleClick);
			// 
			// FormProdSelect
			// 
