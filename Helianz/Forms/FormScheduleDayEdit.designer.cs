...
namespace Helianz {
	public partial class FormScheduleDayEdit {
		...
		private void InitializeComponent()
		{
			...
			this.graphScheduleDay = new Helianz.GraphScheduleDay();
			this.groupPractice = new Helianz.UI.GroupBox();
			this.butHoliday = new Helianz.UI.Button();
			this.butNote = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.butSave = new Helianz.UI.Button();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.tabControl2 = new Helianz.UI.TabControl();
			...
			this.listEmp = new Helianz.UI.ListBox();
			this.butProvNote = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.butAddTime = new Helianz.UI.Button();
			this.labelDate = new System.Windows.Forms.Label();
			this.butCloseOffice = new Helianz.UI.Button();
			this.butOkSchedule = new Helianz.UI.Button();
			this.butViewGraph = new Helianz.UI.Button();
			...
			this.listEmp.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.butAddTime.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butCloseOffice.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.Button butAddTime;
		private Helianz.UI.Button butCloseOffice;
		...
		private Helianz.UI.GroupBox groupPractice;
		private Helianz.UI.Button butNote;
		private Helianz.UI.Button butHoliday;
		private Helianz.UI.Button butProvNote;
		private Helianz.UI.ListBox listEmp;
		...
		private Helianz.UI.TabControl tabControl2;
