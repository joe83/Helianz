namespace Helianz{
	partial class FormEtrans270Edit {
		...
		private void InitializeComponent() {
			...
			this.butShowResponse = new Helianz.UI.Button();
			this.butShowRequest = new Helianz.UI.Button();
			this.labelImport = new System.Windows.Forms.Label();
			this.gridBen = new Helianz.UI.GridOD();
			this.gridDates = new Helianz.UI.GridOD();
			...
			this.groupImportBenefit = new Helianz.UI.GroupBox();
			...
			this.gridBen.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBen_CellDoubleClick);
			// 
			// gridDates
			// 
			...
			// butImport
			// 
			this.butImport.Image = global::Helianz.Properties.Resources.down;
		...
		private Helianz.UI.Button butShowRequest;
		private Helianz.UI.GroupBox groupBox2;
		private Helianz.UI.Button butShowResponse;
		private Helianz.UI.GridOD gridDates;
		private Helianz.UI.GridOD gridBen;
		private Helianz.UI.Button butImport;
		private System.Windows.Forms.Label labelImport;
		private Helianz.UI.GroupBox groupImport;
		...
		private Helianz.UI.GroupBox groupImportBenefit;
