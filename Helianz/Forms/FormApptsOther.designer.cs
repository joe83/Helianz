namespace Helianz {
	partial class FormApptsOther {
		...
		private void InitializeComponent(){
			...
			this.butRecallFamily = new Helianz.UI.Button();
			this.checkShowCompletePlanned = new Helianz.UI.CheckBox();
			...
			this.butPin.Image = global::Helianz.Properties.Resources.butPin;
			...
			this.butRecall.Icon = Helianz.UI.EnumIcons.Recall;
			...
			this.butRecallFamily.Icon = Helianz.UI.EnumIcons.Recall;
		...
		private Helianz.UI.Button butRecall;
		private System.Windows.Forms.TextBox textFinUrg;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.Button butNote;
		private Helianz.UI.Button butRecallFamily;
		private Helianz.UI.CheckBox checkShowCompletePlanned;
