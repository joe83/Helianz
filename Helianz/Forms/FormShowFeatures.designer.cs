...
namespace Helianz {
	partial class FormShowFeatures {
		...
		private void InitializeComponent()
		{
			...
			this.checkCapitation = new Helianz.UI.CheckBox();
			this.checkMedicaid = new Helianz.UI.CheckBox();
			this.checkClinical = new Helianz.UI.CheckBox();
			this.checkBasicModules = new Helianz.UI.CheckBox();
			this.checkPublicHealth = new Helianz.UI.CheckBox();
			this.checkEnableClinics = new Helianz.UI.CheckBox();
			this.checkDentalSchools = new Helianz.UI.CheckBox();
			this.checkRepeatCharges = new Helianz.UI.CheckBox();
			this.checkInsurance = new Helianz.UI.CheckBox();
			this.checkHospitals = new Helianz.UI.CheckBox();
			this.checkMedicalIns = new Helianz.UI.CheckBox();
			this.checkEhr = new Helianz.UI.CheckBox();
			this.checkSuperFam = new Helianz.UI.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.checkPatClone = new Helianz.UI.CheckBox();
			this.checkShowEnterprise = new Helianz.UI.CheckBox();
			this.checkShowReactivations = new Helianz.UI.CheckBox();
			this.checkEraShowControlId = new Helianz.UI.CheckBox();
			this.groupEnterprise = new Helianz.UI.GroupBox();
			this.groupFamilyModule = new Helianz.UI.GroupBox();
			this.groupGeneral = new Helianz.UI.GroupBox();
			this.groupInsurance = new Helianz.UI.GroupBox();
			this.groupSpecialUseOnly = new Helianz.UI.GroupBox();
			this.groupChargeTools = new Helianz.UI.GroupBox();
			this.groupBoxCharges = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.CheckBox checkClinical;
		private Helianz.UI.CheckBox checkBasicModules;
		private Helianz.UI.CheckBox checkPublicHealth;
		private Helianz.UI.CheckBox checkEnableClinics;
		private Helianz.UI.CheckBox checkDentalSchools;
		private Helianz.UI.CheckBox checkRepeatCharges;
		private Helianz.UI.CheckBox checkInsurance;
		private Helianz.UI.CheckBox checkHospitals;
		private Helianz.UI.CheckBox checkMedicalIns;
		private Helianz.UI.CheckBox checkEhr;
		private Helianz.UI.CheckBox checkSuperFam;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.CheckBox checkPatClone;
		///<summary>Keeps track the clinic preference state when the window was loaded.</summary>
		private Helianz.UI.CheckBox checkShowEnterprise;
		private Helianz.UI.CheckBox checkMedicaid;
		private Helianz.UI.CheckBox checkCapitation;
		private Helianz.UI.CheckBox checkShowReactivations;
		private Helianz.UI.CheckBox checkEraShowControlId;
		private Helianz.UI.GroupBox groupEnterprise;
		private Helianz.UI.GroupBox groupFamilyModule;
		private Helianz.UI.GroupBox groupGeneral;
		private Helianz.UI.GroupBox groupInsurance;
		private Helianz.UI.GroupBox groupSpecialUseOnly;
		private Helianz.UI.GroupBox groupChargeTools;
		private System.Windows.Forms.RadioButton radioLateCharges;
		private System.Windows.Forms.RadioButton radioBillingFinance;
		private Helianz.UI.GroupBox groupBoxCharges;
	}
}
