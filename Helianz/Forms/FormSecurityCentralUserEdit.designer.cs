namespace Helianz{
	partial class FormSecurityCentralUserEdit {
		...
		private void InitializeComponent() {
			...
			this.gridCentralUsers = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butEdit
			// 
			...
			this.gridCentralUsers.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCentralUsers_CellDoubleClick);
			// 
