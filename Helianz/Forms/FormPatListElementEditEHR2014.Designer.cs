namespace Helianz {
	partial class FormPatListElementEditEHR2014 {
		...
		private void InitializeComponent() {
			...
			this.listRestriction = new Helianz.UI.ListBox();
			this.listOperand = new Helianz.UI.ListBox();
			...
			this.comboLabValueType = new Helianz.UI.ComboBox();
			this.SuspendLayout();
			// 
			// labelOperand
			// 
		...
		private Helianz.UI.ListBox listRestriction;
		private Helianz.UI.ListBox listOperand;
		...
		private Helianz.UI.ComboBox comboLabValueType;
	}
}