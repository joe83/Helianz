...
namespace Helianz {
	public partial class FormDefEditImages {
		...
		private void InitializeComponent()
		{
			...
			this.checkClaimResponses = new Helianz.UI.CheckBox();
			this.checkThumbnails = new Helianz.UI.CheckBox();
			this.checkTaskAttachments = new Helianz.UI.CheckBox();
			this.checkAutoSaveForm = new Helianz.UI.CheckBox();
			this.checkLabCases = new Helianz.UI.CheckBox();
			this.checkClaimAttachments = new Helianz.UI.CheckBox();
			this.checkPaymentPlans = new Helianz.UI.CheckBox();
			this.checkPatientPortal = new Helianz.UI.CheckBox();
			this.checkTreatmentPlans = new Helianz.UI.CheckBox();
			this.checkPatientForms = new Helianz.UI.CheckBox();
			this.checkToothCharts = new Helianz.UI.CheckBox();
			this.checkStatements = new Helianz.UI.CheckBox();
			this.checkPatientPictures = new Helianz.UI.CheckBox();
			this.checkChartModule = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkToothCharts;
		private Helianz.UI.CheckBox checkStatements;
		private Helianz.UI.CheckBox checkPatientPictures;
		private Helianz.UI.CheckBox checkChartModule;
		private Helianz.UI.CheckBox checkPatientForms;
		private Helianz.UI.CheckBox checkTreatmentPlans;
		private Helianz.UI.CheckBox checkPatientPortal;
		private Helianz.UI.CheckBox checkPaymentPlans;
		private Helianz.UI.CheckBox checkClaimAttachments;
		private Helianz.UI.CheckBox checkLabCases;
		private Helianz.UI.CheckBox checkAutoSaveForm;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.CheckBox checkTaskAttachments;
		private Helianz.UI.CheckBox checkThumbnails;
