...
namespace Helianz {
	public partial class FormFinanceCharges {
		...
		private void InitializeComponent() {
			...
			this.checkExcludeAccountNoTil = new Helianz.UI.CheckBox();
			...
			this.groupBoxAssignCharge = new Helianz.UI.GroupBox();
			this.comboSpecificProv = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.GroupBox groupBoxAssignCharge;
