...
namespace Helianz {
	public partial class FormUserEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butDoseSpotAdditional = new Helianz.UI.Button();
			this.textDoseSpotUserID = new System.Windows.Forms.TextBox();
			this.label8 = new System.Windows.Forms.Label();
			this.checkRequireReset = new Helianz.UI.CheckBox();
			...
			this.listEmployee = new Helianz.UI.ListBox();
			...
			this.listClinicMulti = new Helianz.UI.ListBox();
			this.listClinic = new Helianz.UI.ListBox();
			this.labelClinic = new System.Windows.Forms.Label();
			this.tabAlertSubs = new Helianz.UI.TabPage();
			this.labelAlertClinic = new System.Windows.Forms.Label();
			this.listAlertSubsClinicsMulti = new Helianz.UI.ListBox();
			this.listAlertSubMulti = new Helianz.UI.ListBox();
			this.label7 = new System.Windows.Forms.Label();
			this.butJobRoles = new Helianz.UI.Button();
			...
			this.listClinicMulti.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listAlertSubsClinicsMulti.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listAlertSubMulti.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listClinic;
		private Label label1;
		private Label label3;
		private Helianz.UI.ListBox listUserGroup;
		private TextBox textUserName;
		private Label label2;
		private Helianz.UI.ListBox listEmployee;
		...
		private Helianz.UI.ListBox listClinicMulti;
		private Label label6;
		private Helianz.UI.TabPage tabAlertSubs;
		private Helianz.UI.ListBox listAlertSubMulti;
		private Label label7;
		private Label labelAlertClinic;
		private Helianz.UI.ListBox listAlertSubsClinicsMulti;
		...
		private Helianz.UI.CheckBox checkRequireReset;
