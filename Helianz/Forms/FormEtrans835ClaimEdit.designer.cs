namespace Helianz{
	partial class FormEtrans835ClaimEdit {
		...
		private void InitializeComponent() {
			...
			this.groupBalancing = new Helianz.UI.GroupBox();
			this.gridClaimAdjustments = new Helianz.UI.GridOD();
			this.gridAdjudicationInfo = new Helianz.UI.GridOD();
			this.gridProcedureBreakdown = new Helianz.UI.GridOD();
			this.gridSupplementalInfo = new Helianz.UI.GridOD();
    ...
    "um          =    Ins Paid Calc";
			...
			this.gridAdjudicationInfo.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAdjudicationInfo.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAdjudicationInfo_CellDoubleClick);
			// 
			...
			this.gridSupplementalInfo.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridSupplementalInfo.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridSupplementalInfo_CellDoubleClick);
			// 
		...
		private Helianz.UI.GroupBox groupBalancing;
