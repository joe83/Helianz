...
namespace Helianz {
	public partial class FormAudit {
		...
		private void InitializeComponent()
		{
			...
			this.textDateEditedFrom = new Helianz.ValidDate();
			this.textDateEditedTo = new Helianz.ValidDate();
			this.label7 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.textRows = new Helianz.ValidNum();
			this.label6 = new System.Windows.Forms.Label();
			this.butPrint = new Helianz.UI.Button();
			this.butCurrent = new Helianz.UI.Button();
			this.butAll = new Helianz.UI.Button();
			this.butFind = new Helianz.UI.Button();
			this.textPatient = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.comboUser = new Helianz.UI.ComboBox();
			this.label4 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.comboPermission = new Helianz.UI.ComboBox();
			...
			this.comboLogSource = new Helianz.UI.ComboBox();
			...
			this.grid.Name = "grid";
			this.grid.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.ComboBox comboUser;
		private Label label4;
		private Label label1;
		private Helianz.UI.ComboBox comboPermission;
