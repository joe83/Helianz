...
namespace Helianz {
	public partial class FormComputers {
		...
		private void InitializeComponent(){
			...
			this.listComputer = new Helianz.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.butDelete = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.butSetSimpleGraphics = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.label4 = new System.Windows.Forms.Label();
			this.butResetZoom = new Helianz.UI.Button();
        ...
        ""};
			...
			this.label1.Text = "Computers are added to this list every time you use Helianz.  You can safely " +
    ...
    "he button below.";
		...
		private Helianz.UI.ListBox listComputer;
		private Helianz.UI.Button butDelete;
		private System.Windows.Forms.Label label2;
		private UI.Button butSetSimpleGraphics;
		private Label label3;
		private Helianz.UI.GroupBox groupBox1;// Required designer variable.
