namespace Helianz{
	partial class FormEtrans834Import {
		...
		private void InitializeComponent() {
			...
			this.folderBrowserImportPath = new Helianz.FolderBrowserDialog();
			this.gridInsPlanFiles = new Helianz.UI.GridOD();
			this.label2 = new System.Windows.Forms.Label();
			this.butRefresh = new Helianz.UI.Button();
			this.butImportPathPick = new Helianz.UI.Button();
			this.textImportPath = new Helianz.ODtextBox();
			...
			this.gridInsPlanFiles.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.textImportPath.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Etrans834Import;
		...
		private Helianz.FolderBrowserDialog folderBrowserImportPath;
