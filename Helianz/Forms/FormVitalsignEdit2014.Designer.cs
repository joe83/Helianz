namespace Helianz {
	partial class FormVitalsignEdit2014 {
		...
		private void InitializeComponent() {
			...
			this.comboHeightExamCode = new Helianz.UI.ComboBox();
			this.comboWeightExamCode = new Helianz.UI.ComboBox();
			...
			this.checkPregnant = new Helianz.UI.CheckBox();
			this.textPregCode = new System.Windows.Forms.TextBox();
			this.label6 = new System.Windows.Forms.Label();
			this.groupExclusion = new Helianz.UI.GroupBox();
			this.butChangeDefault = new Helianz.UI.Button();
			...
			this.checkNotPerf = new Helianz.UI.CheckBox();
			this.labelPregNotice = new System.Windows.Forms.Label();
			this.groupInterventions = new Helianz.UI.GroupBox();
    ...
    "story with a start date equal to the date of this exam.";
		...
		private Helianz.UI.ComboBox comboHeightExamCode;
		private Helianz.UI.ComboBox comboWeightExamCode;
		...
		private Helianz.UI.CheckBox checkPregnant;
		private System.Windows.Forms.TextBox textPregCode;
		private System.Windows.Forms.Label label6;
		private Helianz.UI.GroupBox groupExclusion;
		private Helianz.UI.CheckBox checkNotPerf;
		...
		private Helianz.UI.GroupBox groupInterventions;
		private Helianz.UI.GridOD gridInterventions;
