...
namespace Helianz {
	public partial class FormDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkIncludeSend = new Helianz.UI.CheckBox();
			this.checkIncludeConfirm = new Helianz.UI.CheckBox();
			this.groupEConfirm = new Helianz.UI.GroupBox();
			this.butSelect = new Helianz.UI.Button();
			this.butClearValue = new Helianz.UI.Button();
			this.groupBoxEReminders = new Helianz.UI.GroupBox();
			this.checkIncludeRemind = new Helianz.UI.CheckBox();
			this.checkNoColor = new Helianz.UI.CheckBox();
			this.groupBoxEThanks = new Helianz.UI.GroupBox();
			this.checkIncludeThanks = new Helianz.UI.CheckBox();
			this.groupBoxArrivals = new Helianz.UI.GroupBox();
			this.checkIncludeArrivalSend = new Helianz.UI.CheckBox();
			this.checkIncludeArrivalResponse = new Helianz.UI.CheckBox();
			this.groupBoxEClipboard = new Helianz.UI.GroupBox();
			this.checkIncludeEClipboard = new Helianz.UI.CheckBox();
			this.checkByod = new Helianz.UI.CheckBox();
			this.groupBoxGeneralMessages = new Helianz.UI.GroupBox();
			this.checkIncludeGeneralSend = new Helianz.UI.CheckBox();
			...
			this.butClearValue.Image = global::Helianz.Properties.Resources.deleteX18;
		...
		private Helianz.UI.CheckBox checkIncludeSend;
		private Helianz.UI.CheckBox checkIncludeConfirm;
		private Helianz.UI.GroupBox groupEConfirm;
		private UI.Button butClearValue;
		private Helianz.UI.GroupBox groupBoxEReminders;
		private Helianz.UI.CheckBox checkIncludeRemind;
		private Helianz.UI.CheckBox checkNoColor;
		private Helianz.UI.GroupBox groupBoxEThanks;
		private Helianz.UI.CheckBox checkIncludeThanks;
		private Helianz.UI.GroupBox groupBoxArrivals;
		private Helianz.UI.CheckBox checkIncludeArrivalSend;
		private Helianz.UI.CheckBox checkIncludeArrivalResponse;
		private Helianz.UI.GroupBox groupBoxEClipboard;
		private Helianz.UI.CheckBox checkIncludeEClipboard;
		private Helianz.UI.CheckBox checkByod;
		private UI.GroupBox groupBoxGeneralMessages;
		private Helianz.UI.CheckBox checkIncludeGeneralSend;
	}
}
