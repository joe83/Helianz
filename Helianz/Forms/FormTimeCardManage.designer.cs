namespace Helianz{
	partial class FormTimeCardManage {
		...
		private void InitializeComponent() {
			...
			this.butDaily = new Helianz.UI.Button();
			this.butCompute = new Helianz.UI.Button();
			this.butPrintAll = new Helianz.UI.Button();
			this.butClearAuto = new Helianz.UI.Button();
			this.butClearManual = new Helianz.UI.Button();
			this.butPrintSelected = new Helianz.UI.Button();
			...
			this.butTimeCardBenefits = new Helianz.UI.Button();
			...
			this.butPrintAll.Image = global::Helianz.Properties.Resources.butPrint;
			...
			this.butPrintSelected.Image = global::Helianz.Properties.Resources.butPrint;
