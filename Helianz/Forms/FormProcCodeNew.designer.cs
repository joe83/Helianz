...
namespace Helianz {
	public partial class FormProcCodeNew {
		...
		private void InitializeComponent(){
			...
			this.comboPaintType = new Helianz.UI.ComboBox();
			this.comboTreatArea = new Helianz.UI.ComboBox();
			...
			this.butAnother = new Helianz.UI.Button();
		...
		private Helianz.UI.Button butAnother;
		private Label label2;
		public TextBox textDescription;
		private Label labelListType;
		private Helianz.UI.ListBox listType;
		...
		private Helianz.UI.ComboBox comboPaintType;
		private Helianz.UI.ComboBox comboTreatArea;
