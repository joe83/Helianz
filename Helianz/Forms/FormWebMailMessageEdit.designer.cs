namespace Helianz{
	partial class FormWebMailMessageEdit {
		...
		private void InitializeComponent() {
			...
			this.comboRegardingPatient = new Helianz.UI.ComboBox();
    ...
    "to this patient.";
			...
			this.textBody.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
		...
		private Helianz.UI.ComboBox comboRegardingPatient;
