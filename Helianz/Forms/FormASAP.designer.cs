...
namespace Helianz {
	public partial class FormASAP {
		...
		private void InitializeComponent() {
			...
			this.comboSite = new Helianz.UI.ComboBox();
			this.labelSite = new System.Windows.Forms.Label();
			this.comboClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.butText = new Helianz.UI.Button();
			this.comboEnd = new Helianz.UI.ComboBox();
			this.comboStart = new Helianz.UI.ComboBox();
			this.labelEnd = new System.Windows.Forms.Label();
			this.labelStart = new System.Windows.Forms.Label();
			this.butSendWebSched = new Helianz.UI.Button();
			this.butWebSchedHist = new Helianz.UI.Button();
			this.groupWebSched = new Helianz.UI.GroupBox();
			this.butWebSchedNotify = new Helianz.UI.Button();
			this.labelOperatory = new System.Windows.Forms.Label();
			this.tabControl = new Helianz.UI.TabControl();
			this.tabPageAppts = new Helianz.UI.TabPage();
			this.label5 = new System.Windows.Forms.Label();
			this.comboShowHygiene = new Helianz.UI.ComboBox();
			this.comboAptStatus = new Helianz.UI.ComboBox();
			this.labelAptStatus = new System.Windows.Forms.Label();
			this.gridAppts = new Helianz.UI.GridOD();
			...
			this.comboNumberReminders = new Helianz.UI.ComboBox();
			this.textDateEnd = new Helianz.ValidDate();
			this.label3 = new System.Windows.Forms.Label();
			this.checkGroupFamilies = new Helianz.UI.CheckBox();
			this.gridWebSched = new Helianz.UI.GridOD();
			this.butRefresh = new Helianz.UI.Button();
			this.codeRangeFilter = new Helianz.UI.ODCodeRangeFilter();
			...
			this.gridAppts.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridAppts.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAppts_CellDoubleClick);
			...
			this.gridWebSched.SelectionMode = Helianz.UI.GridSelectionMode.None;
		...
		private Helianz.UI.ComboBox comboEnd;
		private Helianz.UI.ComboBox comboStart;
		private Label labelEnd;
		private Label labelStart;
		private UI.Button butSendWebSched;
		private UI.Button butWebSchedHist;
		private Helianz.UI.GroupBox groupWebSched;
		private Helianz.UI.GridOD gridWebSched;
		private Label labelOperatory;
		private Helianz.UI.TabControl tabControl;
		private Helianz.UI.TabPage tabPageAppts;
		private Helianz.UI.TabPage tabPageRecalls;
		private Helianz.UI.GridOD gridRecalls;
		private Helianz.UI.ComboBox comboNumberReminders;
		private Label label3;
		private Helianz.UI.CheckBox checkGroupFamilies;
		private ValidDate textDateEnd;
		private ValidDate textDateStart;
		private Label label2;
		private Label label1;
		private Helianz.UI.ComboBox comboAptStatus;
