...
namespace Helianz {
	public partial class FormMedPat {
		...
		private void InitializeComponent()
		{
			...
			this.textPatNote = new Helianz.ODtextBox();
			this.groupOrder = new Helianz.UI.GroupBox();
			this.label8 = new System.Windows.Forms.Label();
			this.comboProv = new Helianz.UI.ComboBox();
			this.butTodayStop = new Helianz.UI.Button();
			this.butTodayStart = new Helianz.UI.Button();
			...
			this.textPatNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationPat;
		...
		private Helianz.ODtextBox textPatNote;
		private Helianz.UI.GroupBox groupOrder;
