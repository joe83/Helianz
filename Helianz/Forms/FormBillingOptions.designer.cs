...
namespace Helianz {
	...
	private System.ComponentModel.IContainer components = null;// Required designer variable.
		...
		private void InitializeComponent(){
			...
			this.butCreate = new Helianz.UI.Button();
			this.label1 = new System.Windows.Forms.Label();
			this.butSaveDefault = new Helianz.UI.Button();
			this.textExcludeLessThan = new Helianz.ValidDouble();
			...
			this.textDaysInsPendingExclude = new Helianz.ValidNum();
			this.comboInsFilingCodes = new Helianz.UI.ComboBox();
			this.labelInsFilingCodes = new System.Windows.Forms.Label();
			this.comboClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.checkUseClinicDefaults = new Helianz.UI.CheckBox();
			this.checkExcludeIfProcs = new Helianz.UI.CheckBox();
			this.checkIgnoreInPerson = new Helianz.UI.CheckBox();
			this.labelSaveDefaults = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this.comboAge = new Helianz.UI.ComboBox();
			this.checkExcludeInsPending = new Helianz.UI.CheckBox();
			this.checkIncludeChanged = new Helianz.UI.CheckBox();
			this.textLastStatement = new Helianz.ValidDate();
			this.label5 = new System.Windows.Forms.Label();
			this.checkShowNegative = new Helianz.UI.CheckBox();
			this.checkBadAddress = new Helianz.UI.CheckBox();
			this.listBillType = new Helianz.UI.ListBox();
			this.checkBoxBillShowTransSinceZero = new Helianz.UI.CheckBox();
			this.gridDunning = new Helianz.UI.GridOD();
			this.butDunningSetup = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.textNote = new Helianz.ODtextBox();
			this.groupDateRange = new Helianz.UI.GroupBox();
			this.but30days = new Helianz.UI.Button();
			...
			this.checkIntermingled = new Helianz.UI.CheckBox();
			this.butDefaults = new Helianz.UI.Button();
			this.butUndo = new Helianz.UI.Button();
			this.checkSuperFam = new Helianz.UI.CheckBox();
			this.checkSinglePatient = new Helianz.UI.CheckBox();
			this.labelModesToText = new System.Windows.Forms.Label();
			this.listModeToText = new Helianz.UI.ListBox();
    ...
    "e the last bill";
			...
			this.listBillType.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridDunning.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridDun_CellDoubleClick);
			// 
			// butDunningSetup
			// 
    ...
    "InstallmentPlanTerms] allowed)";
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Statement;
			...
			this.listModeToText.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
    ...
    "ly one clinic to see message";
		...
		private Helianz.UI.Button butSaveDefault;
		private Helianz.ValidDouble textExcludeLessThan;
		private Helianz.UI.CheckBox checkExcludeInactive;
		private Helianz.UI.GroupBox groupBox2;
		private Helianz.UI.Button butDunningSetup;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.GridOD gridDunning;
		private System.Windows.Forms.Label label4;
		private Helianz.ODtextBox textNote;
		private Helianz.UI.CheckBox checkBadAddress;
		private Helianz.UI.CheckBox checkShowNegative;
		private System.Windows.Forms.Label label5;
		private Helianz.UI.CheckBox checkIncludeChanged;
		private Helianz.ValidDate textLastStatement;
		private Helianz.UI.Button butCreate;
		private Helianz.UI.CheckBox checkExcludeInsPending;
		private Helianz.UI.GroupBox groupDateRange;
		private ValidDate textDateStart;
		private Label labelStartDate;
		private Label labelEndDate;
		private ValidDate textDateEnd;
		private Helianz.UI.Button but45days;
		private Helianz.UI.Button but90days;
		private Helianz.UI.Button butDatesAll;
		private Helianz.UI.CheckBox checkIntermingled;
		private Helianz.UI.Button butDefaults;
		private Helianz.UI.Button but30days;
		private Helianz.UI.ComboBox comboAge;
		private Label label6;
		private Label label7;
		private Helianz.UI.ListBox listBillType;
		private Label labelSaveDefaults;
		private Helianz.UI.Button butUndo;
		private Helianz.UI.CheckBox checkIgnoreInPerson;
		private Helianz.UI.CheckBox checkExcludeIfProcs;
		private Helianz.UI.CheckBox checkSuperFam;
		private Helianz.UI.CheckBox checkUseClinicDefaults;
		private Helianz.UI.CheckBox checkBoxBillShowTransSinceZero;
		private Helianz.UI.CheckBox checkSinglePatient;
		private Label labelModesToText;
		private Helianz.UI.ListBox listModeToText;
