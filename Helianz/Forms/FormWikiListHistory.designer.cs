namespace Helianz{
	partial class FormWikiListHistory {
		...
		private void InitializeComponent() {
			...
			this.butRevert = new Helianz.UI.Button();
			this.gridOld = new Helianz.UI.GridOD();
			this.gridCur = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// gridMain
			// 
			...
			this.gridOld.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridCur.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
