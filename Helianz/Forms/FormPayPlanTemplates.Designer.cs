namespace Helianz {
	partial class FormPayPlanTemplates {
		...
		private void InitializeComponent() {
			...
			this.gridPayPlanTemplates = new Helianz.UI.GridOD();
			...
			this.gridPayPlanTemplates.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPayPlanTemplates_CellDoubleClick);
			// 
			// butOK
			// 
