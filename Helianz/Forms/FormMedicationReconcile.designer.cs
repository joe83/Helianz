namespace Helianz{
	partial class FormMedicationReconcile {
		...
		private void InitializeComponent() {
			...
			this.butAddEvent = new Helianz.UI.Button();
			this.gridReconcileEvents = new Helianz.UI.GridOD();
			this.label2 = new System.Windows.Forms.Label();
			this.gridMeds = new Helianz.UI.GridOD();
			this.butPickRxListImage = new Helianz.UI.Button();
			...
			this.gridReconcileEvents.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
