...
namespace Helianz{
	...
	public partial class FormLicense : FormODBase {
		...
		///<summary>If selectedLicense is null, then HelianzLicense will be the selected license by default. To ensure correct selection, use Properties.Resources.LicenseName to set selectedLicense value.</summary>
		public FormLicense(string selectedLicense=null) {
			InitializeComponent();
			InitializeLayoutManager();
			Lan.F(this);
			_selectedLicense=Properties.Resources.HelianzLicense;
		...
		private void FillListBoxLicense() {
			listBoxLicense.Items.Add("Helianz",Properties.Resources.HelianzLicense);
			listBoxLicense.Items.Add("Helianz API End User",Properties.Resources.HelianzApiEndUserLicense);
