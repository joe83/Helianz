namespace Helianz {
	partial class FormMultiVisitGroup {
		...
		private void InitializeComponent() {
			...
			this.gridGroupedProcs = new Helianz.UI.GridOD();
			this.butUngroup = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// gridGroupedProcs
			// 
			...
			this.gridGroupedProcs.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
