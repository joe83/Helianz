...
namespace Helianz {
	public partial class FormPayPlanChargeEdit {
		...
		private void InitializeComponent(){
			...
			this.textInterest = new Helianz.ValidDouble();
			this.labelInterest = new System.Windows.Forms.Label();
			this.textDate = new Helianz.ValidDate();
			this.label2 = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.textDateEdit = new Helianz.ValidDate();
			this.label6 = new System.Windows.Forms.Label();
			this.textDateEntry = new Helianz.ValidDate();
			this.comboBoxClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.comboBoxProv = new Helianz.UI.ComboBox();
			this.SuspendLayout();
			// 
			// label4
			// 
		...
		private Helianz.ValidDouble textPrincipal;
		private System.Windows.Forms.Label labelInterest;
		private System.Windows.Forms.Label label2;
		private Helianz.ValidDouble textInterest;
