...
namespace Helianz {
	public partial class FormReconcileEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkLocked = new Helianz.UI.CheckBox();
			...
			this.textEnd = new Helianz.ValidDouble();
			this.textStart = new Helianz.ValidDouble();
		...
		private Helianz.UI.CheckBox checkLocked;
