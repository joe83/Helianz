namespace Helianz{
	partial class FormPatientMerge {
		...
		private void InitializeComponent() {
			...
			this.butChangePatientInto = new Helianz.UI.Button();
			...
			this.butChangePatientFrom = new Helianz.UI.Button();
    ...
    "ccount will be archived if not marked deceased.";
		...
		private Helianz.UI.Button butChangePatientInto;
		private Helianz.UI.Button butChangePatientFrom;
