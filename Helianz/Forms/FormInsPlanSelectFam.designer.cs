...
namespace Helianz {
	public partial class FormInsPlanSelectFam {
		...
		private void InitializeComponent(){
			...
			this.listRelat = new Helianz.UI.ListBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.butNone = new Helianz.UI.Button();
			this.checkShowPlansNotInUse = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// butOK
			// 
