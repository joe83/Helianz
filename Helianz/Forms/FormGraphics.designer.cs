...
namespace Helianz {
	public partial class FormGraphics {
		...
		private void InitializeComponent()
		{
			...
			this.checkHardwareAccel = new Helianz.UI.CheckBox();
			this.checkDoubleBuffering = new Helianz.UI.CheckBox();
			this.group3DToothChart = new Helianz.UI.GroupBox();
			...
			this.checkAllFormats = new Helianz.UI.CheckBox();
			this.gridFormats = new Helianz.UI.GridOD();
    ...
    "hen the 3D tooth chart is not working properly.";
			...
			this.gridFormats.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridFormats_CellClick);
			// 
			// radioSimpleChart
			// 
    ...
    "driver issue";
		...
		private Helianz.UI.CheckBox checkHardwareAccel;
		private Helianz.UI.CheckBox checkDoubleBuffering;
		private Helianz.UI.GroupBox group3DToothChart;
		private Helianz.UI.GridOD gridFormats;
		private Helianz.UI.CheckBox checkAllFormats;
