namespace Helianz{
	partial class FormCanadaSummaryReconciliation {
		...
		private void InitializeComponent() {
			...
			this.listCarriers = new Helianz.UI.ListBox();
			this.listNetworks = new Helianz.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.listTreatingProvider = new Helianz.UI.ListBox();
			this.label4 = new System.Windows.Forms.Label();
			this.textDateReconciliation = new System.Windows.Forms.TextBox();
			this.butSave = new Helianz.UI.Button();
			this.groupCarrierOrNetwork = new Helianz.UI.GroupBox();
			this.checkGetForAllCarriers = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.ListBox listCarriers;
		private Helianz.UI.ListBox listNetworks;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.ListBox listTreatingProvider;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.TextBox textDateReconciliation;
		private Helianz.UI.GroupBox groupCarrierOrNetwork;
		private Helianz.UI.CheckBox checkGetForAllCarriers;
	}
}