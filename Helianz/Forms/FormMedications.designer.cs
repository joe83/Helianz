...
namespace Helianz {
	public partial class FormMedications {
		...
		private void InitializeComponent()
		{
			...
			this.butAddGeneric = new Helianz.UI.Button();
			this.butAddBrand = new Helianz.UI.Button();
			this.gridAllMedications = new Helianz.UI.GridOD();
			this.textSearch = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.tabMedications = new Helianz.UI.TabControl();
			this.tabAllMedications = new Helianz.UI.TabPage();
			this.butExportMedications = new Helianz.UI.Button();
			this.butImportMedications = new Helianz.UI.Button();
			this.tabMissing = new Helianz.UI.TabPage();
			this.butConvertBrand = new Helianz.UI.Button();
			this.butConvertGeneric = new Helianz.UI.Button();
			this.gridMissing = new Helianz.UI.GridOD();
			...
			// butAddGeneric
			// 
			this.butAddGeneric.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butAddBrand
			// 
			this.butAddBrand.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridAllMedications.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAllMedications_CellDoubleClick);
			this.gridAllMedications.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridAllMedications_CellClick);
			// 
			// textSearch
			// 
			...
			// butConvertBrand
			// 
			this.butConvertBrand.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butConvertGeneric
			// 
			this.butConvertGeneric.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.Button butAddGeneric;
		private Helianz.UI.Button butAddBrand;
		private Helianz.UI.GridOD gridAllMedications;
		public TextBox textSearch;
		private Label label1;
		private Helianz.UI.TabControl tabMedications;
		private Helianz.UI.TabPage tabAllMedications;
