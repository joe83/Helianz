...
namespace Helianz {
	public partial class FormEhrSummaryOfCare:FormODBase {
		...
		///<summary>Returns true if user performed a print job on the CCD.  Cannot be moved to HelianzBusiness/Misc/EhrCCD.cs, because this function uses windows UI components.  
							...
							writer.WriteStartElement("table");
								...
								writer.WriteStartElement("tbody");
									writer.WriteStartElement("tr");
										...
										writer.WriteEndElement();
										writer.WriteStartElement("td");//"Helianz PatNum"
											writer.WriteString("Helianz PatNum");
										writer.WriteEndElement();
