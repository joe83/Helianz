...
namespace Helianz {
	public partial class FormTimeAdjustEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkOvertime = new Helianz.UI.CheckBox();
			...
			this.comboPTO = new Helianz.UI.ComboBox();
			this.labelPTO = new System.Windows.Forms.Label();
			this.checkUnpaidProtectedLeave = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkOvertime;
		...
		private Helianz.UI.ComboBox comboPTO;
		private Label labelPTO;
		private Helianz.UI.CheckBox checkUnpaidProtectedLeave;
