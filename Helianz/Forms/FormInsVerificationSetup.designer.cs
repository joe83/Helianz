namespace Helianz{
	partial class FormInsVerificationSetup {
		...
		private void InitializeComponent() {
			...
			this.checkExcludePatientClones = new Helianz.UI.CheckBox();
			this.checkInsVerifyExcludePatVerify = new Helianz.UI.CheckBox();
			this.groupStandard = new Helianz.UI.GroupBox();
			this.labelPastDueDaysStandard = new System.Windows.Forms.Label();
			this.textPastDueDaysStandard = new Helianz.ValidNum();
			...
			this.textScheduledAppointmentDaysStandard = new Helianz.ValidNum();
			...
			this.checkInsVerifyUseCurrentUser = new Helianz.UI.CheckBox();
			this.butSave = new Helianz.UI.Button();
			this.checkFutureDateBenefitYear = new Helianz.UI.CheckBox();
			this.checkFutureDatePatEnrollmentYear = new Helianz.UI.CheckBox();
			this.groupMedicaid = new Helianz.UI.GroupBox();
			this.labelInsuranceFilingCodeInMedicaid = new System.Windows.Forms.Label();
			this.listBoxInsFilingCodes = new Helianz.UI.ListBox();
			this.labelPastDueDaysMedicaid = new System.Windows.Forms.Label();
			this.textPastDueDaysMedicaid = new Helianz.ValidNum();
			...
			this.textScheduledAppointmentDaysMedicaid = new Helianz.ValidNum();
			...
			this.listBoxInsFilingCodes.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.CheckBox checkInsVerifyUseCurrentUser;
		...
		private Helianz.UI.GroupBox groupStandard;
		private System.Windows.Forms.Label labelSchedApptDaysStandard;
		private Helianz.UI.CheckBox checkInsVerifyExcludePatVerify;
		private Helianz.UI.CheckBox checkExcludePatientClones;
		private Helianz.UI.CheckBox checkFutureDateBenefitYear;
		...
		private Helianz.UI.CheckBox checkFutureDatePatEnrollmentYear;
