...
namespace Helianz {
	public partial class FormXchargeSetup {
		...
		private void InitializeComponent()
		{
			...
			this.checkWebPayEnabled = new Helianz.UI.CheckBox();
			...
			this.checkPrintReceipt = new Helianz.UI.CheckBox();
			this.checkPromptSig = new Helianz.UI.CheckBox();
			...
			this.checkForceDuplicate = new Helianz.UI.CheckBox();
    ...
    "eb.";
		...
		private Helianz.UI.CheckBox checkPrintReceipt;
		private Helianz.UI.CheckBox checkPromptSig;
		private Label labelClinicEnable;
		private UI.ComboBoxClinicPicker comboClinic;
		private Helianz.UI.GroupBox groupPaySettings;
		private Helianz.UI.CheckBox checkWebPayEnabled;
		private Helianz.UI.CheckBox checkForceDuplicate;
