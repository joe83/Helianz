...
namespace Helianz {
	public partial class FormLabCaseEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listLab = new Helianz.UI.ListBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butCheckedNow = new Helianz.UI.Button();
			this.butRecdNow = new Helianz.UI.Button();
			this.butSentNow = new Helianz.UI.Button();
			this.butCreatedNow = new Helianz.UI.Button();
			this.listTurnaround = new Helianz.UI.ListBox();
			this.label12 = new System.Windows.Forms.Label();
			this.textWeekday = new System.Windows.Forms.TextBox();
			this.butSlip = new Helianz.UI.Button();
			this.butDetachPlanned = new Helianz.UI.Button();
			...
			this.textLabFee = new Helianz.ValidDouble();
			this.labelInvoiceNumber = new System.Windows.Forms.Label();
			this.textInvoiceNumber = new System.Windows.Forms.TextBox();
			this.textInstructions = new Helianz.ODtextBox();
			...
			this.textInstructions.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Lab;
		...
		private Helianz.UI.Button butDetach;
		private Helianz.UI.Button butDetachPlanned;
		...
		private Helianz.UI.ListBox listLab;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.Button butCheckedNow;
		private Helianz.UI.Button butRecdNow;
		private Helianz.UI.Button butSentNow;
		private Helianz.UI.Button butCreatedNow;
		private Helianz.UI.ListBox listTurnaround;
		private Label label12;
		private TextBox textWeekday;
		private Helianz.UI.Button butSlip;
