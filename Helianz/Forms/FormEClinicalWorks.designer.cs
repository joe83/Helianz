...
namespace Helianz {
	public partial class FormEClinicalWorks {
		...
		private void InitializeComponent()
		{
			...
			this.service11 = new Helianz.localhost.Service1();
			...
			this.checkLBSessionId = new Helianz.UI.CheckBox();
			this.label12 = new System.Windows.Forms.Label();
			this.checkHideButChartRx = new Helianz.UI.CheckBox();
			this.checkProcRequireSignature = new Helianz.UI.CheckBox();
			this.checkProcNotesNoIncomplete = new Helianz.UI.CheckBox();
			...
			this.label6.Text = "Helianz Database Server";
			...
			this.label7.Text = "Helianz HL7 Server";
			...
			this.label9.Text = "Typically HelianzHL7.";
		...
		private Helianz.UI.ComboBox comboDefaultUserGroup;
		private Helianz.UI.CheckBox checkShowImages;
		private RadioButton radioModeTight;
		private RadioButton radioModeStandalone;
		private Helianz.UI.CheckBox checkFeeSchedules;
		...
		private Helianz.UI.CheckBox checkLBSessionId;
		private Label label12;
		private Helianz.UI.CheckBox checkHideButChartRx;
		private Label labelHL7FolderIn;
		private Helianz.UI.CheckBox checkProcRequireSignature;
		private Helianz.UI.CheckBox checkProcNotesNoIncomplete;
