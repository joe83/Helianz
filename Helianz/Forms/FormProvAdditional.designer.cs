namespace Helianz {
	partial class FormProvAdditional {
		...
		private void InitializeComponent() {
			...
			this.gridProvProperties = new Helianz.UI.GridOD();
			...
			this.gridProvProperties.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridProvProperties.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridProvProperties_CellLeave);
			// 
			// butOK
			// 
