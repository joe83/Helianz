...
namespace Helianz {
	public partial class FormProcTools {
		...
		private void InitializeComponent()
		{
			...
			this.checkAutocodes = new Helianz.UI.CheckBox();
			this.checkTcodes = new Helianz.UI.CheckBox();
			this.checkDcodes = new Helianz.UI.CheckBox();
			this.checkNcodes = new Helianz.UI.CheckBox();
			this.label5 = new System.Windows.Forms.Label();
			this.checkProcButtons = new Helianz.UI.CheckBox();
			this.checkApptProcsQuickAdd = new Helianz.UI.CheckBox();
			this.checkRecallTypes = new Helianz.UI.CheckBox();
			...
			this.checkTreatAreas = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// checkAutocodes
			// 
    ...
    " the USA.";
		...
		#endregion
		private Helianz.UI.CheckBox checkAutocodes;
		private Helianz.UI.CheckBox checkTcodes;
		private Helianz.UI.CheckBox checkDcodes;
		private Helianz.UI.CheckBox checkNcodes;
		private Label label5;
		private Helianz.UI.CheckBox checkProcButtons;
		private Helianz.UI.Button butRun;
		private Helianz.UI.CheckBox checkApptProcsQuickAdd;
		private Helianz.UI.CheckBox checkRecallTypes;
