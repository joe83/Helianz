namespace Helianz{
	partial class FormDiscountPlanSubEdit {
		...
		private void InitializeComponent() {
			...
			this.textSubNote = new Helianz.ODtextBox();
			this.label6 = new System.Windows.Forms.Label();
			this.textDateTerm = new Helianz.ValidDate();
			this.textDateEffective = new Helianz.ValidDate();
			this.label5 = new System.Windows.Forms.Label();
			this.butDrop = new Helianz.UI.Button();
			this.butDiscountPlans = new Helianz.UI.Button();
			...
			this.textSubNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.InsPlan;
		...
		private Helianz.ODtextBox textSubNote;
