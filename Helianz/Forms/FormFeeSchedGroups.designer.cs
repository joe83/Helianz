namespace Helianz{
	partial class FormFeeSchedGroups {
		...
		private void InitializeComponent() {
			...
			this.gridGroups = new Helianz.UI.GridOD();
			...
			this.gridGroups.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridGroups_CellDoubleClick);
			this.gridGroups.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridGroups_CellClick);
			// 
			// gridClinics
			// 
