...
namespace Helianz {
	public partial class FormScheduleBlockEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listOp = new Helianz.UI.ListBox();
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Schedule;
			...
			this.listOp.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listOp;
