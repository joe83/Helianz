namespace Helianz{
	partial class FormMassEmailTemplate {
		...
		private void InitializeComponent() {
			...
			this.textTemplateName = new Helianz.ODtextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this.butBodyFieldsPlainText = new Helianz.UI.Button();
			this.textboxPlainText = new Helianz.ODtextBox();
			...
			this.textTemplateName.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textboxPlainText.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
