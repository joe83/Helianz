...
namespace Helianz {
	partial class FormEClipboardSheetRule {
		...
		private void InitializeComponent() {
			...
			this.listSheetsToIgnore.SelectionMode = Helianz.UI.SelectionMode.None;
