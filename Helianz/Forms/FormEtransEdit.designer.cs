...
namespace Helianz {
	public partial class FormEtransEdit {
		...
		private void InitializeComponent()
		{
			...
			this.groupAck = new Helianz.UI.GroupBox();
			this.label10 = new System.Windows.Forms.Label();
			this.butPrintAck = new Helianz.UI.Button();
			...
			this.checkAttachments = new Helianz.UI.CheckBox();
			...
			this.butPrintAck.Image = global::Helianz.Properties.Resources.butPreview;
		...
		private Helianz.UI.GroupBox groupAck;
		...
		private Helianz.UI.CheckBox checkAttachments;
		private Helianz.UI.Button butPrintAck;
