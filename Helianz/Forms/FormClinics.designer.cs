...
namespace Helianz {
	public partial class FormClinics {
		...
		private void InitializeComponent()
		{
			...
			this.groupClinicOrder = new Helianz.UI.GroupBox();
			this.butUp = new Helianz.UI.Button();
			this.butDown = new Helianz.UI.Button();
			this.checkOrderAlphabetical = new Helianz.UI.CheckBox();
			this.groupMovePats = new Helianz.UI.GroupBox();
			this.butMovePats = new Helianz.UI.Button();
			this.butClinicPick = new Helianz.UI.Button();
			...
			this.butSelectNone = new Helianz.UI.Button();
