...
namespace Helianz {
	public partial class FormDefEditBlockout {
		...
		private void InitializeComponent()
		{
			...
			this.groupBoxUsage = new Helianz.UI.GroupBox();
			this.checkOverlap = new Helianz.UI.CheckBox();
			this.checkCutCopyPaste = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkCutCopyPaste;
		private Helianz.UI.CheckBox checkOverlap;
		private Button butColor;
		private Label labelColor;
		private TextBox textName;
		private Helianz.UI.GroupBox groupBoxUsage;
	}
}
