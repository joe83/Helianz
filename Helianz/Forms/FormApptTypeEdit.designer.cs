namespace Helianz{
	partial class FormApptTypeEdit {
		...
		private void InitializeComponent() {
			...
			this.listBoxProcCodes = new Helianz.UI.ListBox();
			...
			this.listBoxProcCodesRequired = new Helianz.UI.ListBox();
			this.butAddRequired = new Helianz.UI.Button();
			this.butRemoveRequired = new Helianz.UI.Button();
			this.listBoxBlockoutTypes = new Helianz.UI.ListBox();
			...
			this.tbTime.CellClicked += new Helianz.ContrTable.CellEventHandler(this.tbTime_CellClicked);
			// 
			// labelTime
			// 
			...
			this.listBoxProcCodes.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxProcCodesRequired.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.listBoxBlockoutTypes.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listBoxProcCodes;
