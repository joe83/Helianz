...
namespace Helianz {
	public partial class FormPatFieldDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.buttonDelete = new Helianz.UI.Button();
			this.labelStatus = new System.Windows.Forms.Label();
			this.comboFieldType = new Helianz.UI.ComboBox();
			this.labelFieldType = new System.Windows.Forms.Label();
			this.checkHidden = new Helianz.UI.CheckBox();
			this.gridPickListItems = new Helianz.UI.GridOD();
			...
			this.buttonDelete.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.gridPickListItems.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridPickListItems.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridPickListItems_CellDoubleClick);
			// 
			// butDown
			// 
		...
		private Helianz.UI.Button buttonDelete;
