namespace Helianz {
	partial class FormEhrEduResourcesPat {
		...
		private void InitializeComponent() {
			...
			this.gridEdu = new Helianz.UI.GridOD();
			this.label1 = new System.Windows.Forms.Label();
			this.gridProvided = new Helianz.UI.GridOD();
			...
			this.gridEdu.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridEdu.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridEdu_CellClick);
			// 
			// label1
			// 
    ...
    " then print.";
			...
			this.gridProvided.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
    ...
    "sources for patients who have no medications, problems, or lab results.";
		...
		#endregion
		private Helianz.UI.GridOD gridEdu;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.GridOD gridProvided;
