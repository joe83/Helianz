namespace Helianz{
	partial class FormMarkupTableEdit {
		...
		private void InitializeComponent() {
			...
			this.butColumnDelete = new Helianz.UI.Button();
			this.butHeaders = new Helianz.UI.Button();
			this.butColumnInsert = new Helianz.UI.Button();
			this.butColumnRight = new Helianz.UI.Button();
			this.butColumnLeft = new Helianz.UI.Button();
			this.groupRow = new Helianz.UI.GroupBox();
			this.butRowDelete = new Helianz.UI.Button();
			this.butRowInsert = new Helianz.UI.Button();
			this.butRowDown = new Helianz.UI.Button();
			this.butRowUp = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butManEdit = new Helianz.UI.Button();
		...
		private Helianz.UI.GroupBox groupRow;
