...
namespace Helianz {
	public partial class FormPopupsForFam:FormODBase {
		...
		private void FillGrid() {
			...
			List<long> listAutomationNums=FormHelianz.DicBlockedAutomations.Keys.ToList();
			...
			for(int i=0;i<listAutomationNums.Count();i++){
				dictionaryPatDate=FormHelianz.DicBlockedAutomations[listAutomationNums[i]];//Gets all patnums for current automation.
