...
namespace Helianz {
	public partial class FormEmailAddressEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkSSL = new Helianz.UI.CheckBox();
			this.butDelete = new Helianz.UI.Button();
			this.groupOutgoing = new Helianz.UI.GroupBox();
			this.label13 = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.groupIncoming = new Helianz.UI.GroupBox();
			...
			this.butRegisterCertificate = new Helianz.UI.Button();
			this.butPickUserod = new Helianz.UI.Button();
			...
			this.groupAuthentication = new Helianz.UI.GroupBox();
			this.panelPassword = new System.Windows.Forms.Panel();
			this.groupMicrosoft = new Helianz.UI.GroupBox();
			...
			this.checkDownloadMicrosoft = new Helianz.UI.CheckBox();
			this.textAccessTokenMicrosoft = new System.Windows.Forms.TextBox();
			this.butClearTokensMicrosoft = new Helianz.UI.Button();
			...
			// butAuthGoogle
			// 
			this.butAuthGoogle.Image = global::Helianz.Properties.Resources.google_signin_normal;
		...
		private Helianz.UI.CheckBox checkSSL;
		private UI.Button butDelete;
		private Helianz.UI.GroupBox groupOutgoing;
		private Helianz.UI.GroupBox groupIncoming;
		...
		private Helianz.UI.GroupBox groupGmail;
