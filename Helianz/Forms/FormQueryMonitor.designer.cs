namespace Helianz {
	partial class FormQueryMonitor {
		...
		private void InitializeComponent() {
			...
			this.butStart = new Helianz.UI.Button();
			this.butLog = new Helianz.UI.Button();
			this.gridFeed = new Helianz.UI.GridOD();
			...
			this.textCommand = new Helianz.ODtextBox();
			this.butCopy = new Helianz.UI.Button();
			this.buttonClear = new Helianz.UI.Button();
			...
			this.gridFeed.CellClick += new Helianz.UI.ODGridClickEventHandler(this.GridFeed_CellClick);
			// 
			// timerProcessQueue
			// 
			...
			this.textCommand.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Query;
