namespace Helianz{
	partial class FormEServicesMobileAppDeviceManage {
		...
		private void InitializeComponent() {
			...
			this.gridMobileAppDevices = new Helianz.UI.GridOD();
			...
			this.gridMobileAppDevices.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridMobileAppDevices.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridMobileAppDevices_CellClick);
			// 
			// butSave
			// 
