...
namespace Helianz {
	public partial class FormEHR:FormODBase {
		...
		private void butPatList14_Click(object sender,EventArgs e) {
			MessageBox.Show("This form was moved to the Helianz project and should be launched from Reports ?");
			//using Helianz.FormPatList2014 FormPL14=new Helianz.FormPatList2014();
			//FormPL14.ShowDialog();
		}
