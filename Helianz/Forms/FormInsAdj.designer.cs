...
namespace Helianz {
	public partial class FormInsAdj {
		...
		private void InitializeComponent()
		{
			...
			this.textInsUsed = new Helianz.ValidDouble();
			this.textDedUsed = new Helianz.ValidDouble();
		...
		private Helianz.ValidDouble textInsUsed;
		private Helianz.ValidDouble textDedUsed;
