namespace Helianz{
	partial class FormWikiListHeaders {
		...
		private void InitializeComponent() {
			...
			this.gridPickList.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridPickList.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridPickList_CellLeave);
			this.gridPickList.CellEnter += new Helianz.UI.ODGridClickEventHandler(this.gridPickList_CellEnter);
			// 
			// butAdd
			// 
