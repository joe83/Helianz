namespace Helianz{
	partial class FormEtrans835ProcEdit {
		...
		private void InitializeComponent() {
			...
			this.gridProcedureAdjustments = new Helianz.UI.GridOD();
			this.gridRemarks = new Helianz.UI.GridOD();
			...
			this.gridProcedureAdjustments.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProcedureAdjustments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProcedureAdjustments_CellDoubleClick);
			// 
			// gridRemarks
			// 
			...
			this.gridRemarks.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridRemarks.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridRemarks_CellDoubleClick);
			// 
			// butPrint
			// 
