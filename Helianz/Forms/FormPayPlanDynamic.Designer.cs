...
namespace Helianz {
	partial class FormPayPlanDynamic {
		...
		private void InitializeComponent() {
			...
			this.textTotalTxAmt = new Helianz.ValidDouble();
			this.label1 = new System.Windows.Forms.Label();
			this.textCompletedAmt = new Helianz.ValidDouble();
			...
			this.butGoToPat = new Helianz.UI.Button();
			this.textPatient = new System.Windows.Forms.TextBox();
			this.butGoToGuar = new Helianz.UI.Button();
			this.textDate = new Helianz.ValidDate();
			this.butChangeGuar = new Helianz.UI.Button();
			...
			this.groupTerms = new Helianz.UI.GroupBox();
			this.butTemplates = new Helianz.UI.Button();
			this.groupTreatmentPlanned = new Helianz.UI.GroupBox();
			...
			this.textDateInterestStart = new Helianz.ValidDate();
			this.labelInterestDelay2 = new System.Windows.Forms.Label();
			this.labelInterestDelay1 = new System.Windows.Forms.Label();
			this.textInterestDelay = new Helianz.ValidDouble();
			this.label16 = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.textPaymentCount = new Helianz.ValidNum();
			this.textPeriodPayment = new Helianz.ValidDouble();
			this.groupBoxFrequency = new Helianz.UI.GroupBox();
			...
			this.butSaveTerms = new Helianz.UI.Button();
			this.butCancelTerms = new Helianz.UI.Button();
			this.label8 = new System.Windows.Forms.Label();
			this.textAPR = new Helianz.ValidDouble();
			this.textDownPayment = new Helianz.ValidDouble();
			this.label11 = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this.textDateFirstPay = new Helianz.ValidDate();
			this.label5 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.textTotalPrincipal = new Helianz.ValidDouble();
			this.butCreateSched = new Helianz.UI.Button();
			...
			this.butClosePlan = new Helianz.UI.Button();
			this.labelClosed = new System.Windows.Forms.Label();
			this.butSignPrint = new Helianz.UI.Button();
			this.groupBoxSignature = new Helianz.UI.GroupBox();
			...
			this.tabSchedule = new Helianz.UI.TabPage();
			this.butAddCharge = new Helianz.UI.Button();
			this.checkUngrouped = new Helianz.UI.CheckBox();
			this.textBalanceSum = new Helianz.ValidDouble();
			this.checkExcludePast = new Helianz.UI.CheckBox();
			this.textDueSum = new System.Windows.Forms.TextBox();
			this.textInterestSum = new System.Windows.Forms.TextBox();
			this.textPaymentSum = new Helianz.ValidDouble();
			this.textPrincipalSum = new Helianz.ValidDouble();
			this.labelTotals = new System.Windows.Forms.Label();
			this.gridCharges = new Helianz.UI.GridOD();
			this.tabProduction = new Helianz.UI.TabPage();
			this.checkShowAttachedPnI = new Helianz.UI.CheckBox();
			this.butAddProd = new Helianz.UI.Button();
			this.butDeleteProduction = new Helianz.UI.Button();
			this.butPrintProduction = new Helianz.UI.Button();
			this.gridLinkedProduction = new Helianz.UI.GridOD();
			this.contextMenuLinkedProduction = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.toolStripMenuItem1 = new System.Windows.Forms.ToolStripMenuItem();
			this.checkProductionLock = new Helianz.UI.CheckBox();
			this.labelOverchargedWarning = new System.Windows.Forms.Label();
			this.butSendToDevice = new Helianz.UI.Button();
			...
			this.butClosePlan.Image = global::Helianz.Properties.Resources.close_door;
			...
			this.tabSchedule.Tag = "gridCharges[Helianz.UI.ODGrid]";
			...
			this.butAddCharge.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridCharges.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCharges_CellDoubleClick);
			// 
			// tabProduction
			// 
			...
			this.tabProduction.Tag = "gridLinkedProduction[Helianz.UI.ODGrid]";
			...
			this.butAddProd.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butDeleteProduction.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.butPrintProduction.Image = global::Helianz.Properties.Resources.butPrintSmall;
			...
			this.gridLinkedProduction.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridLinkedProduction.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridLinkedProduction_CellClick);
			this.gridLinkedProduction.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.gridLinkedProduction_CellLeave);
			// 
    ...
    "tion";
			...
			this.butSendToDevice.Image = global::Helianz.Properties.Resources.arrowRightLine;
			...
			this.textNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.PayPlan;
		...
		private Helianz.UI.GroupBox groupTerms;
		private Helianz.ValidDate textDate;
		private Helianz.ValidDouble textTotalPrincipal;
		private Helianz.ValidDate textDateFirstPay;
		private Helianz.ValidDouble textAPR;
		private Helianz.UI.Button butPrint;
		private System.Windows.Forms.TextBox textGuarantor;
		private Helianz.UI.Button butGoToGuar;
		private Helianz.UI.Button butGoToPat;
		private System.Windows.Forms.TextBox textPatient;
		private System.Windows.Forms.Label label9;
		private System.Windows.Forms.Label label11;
		private Helianz.ValidDouble textDownPayment;
		...
		private Helianz.UI.Button butCreateSched;
		private Helianz.ValidDouble textPeriodPayment;
		private Helianz.UI.Button butChangeGuar;
		...
		private Helianz.UI.GroupBox groupBoxSignature;
		...
		private Helianz.UI.TabPage tabSchedule;
		private ValidDouble textBalanceSum;
		private Helianz.UI.CheckBox checkExcludePast;
		...
		private Helianz.UI.TabPage tabProduction;
		private UI.GridOD gridLinkedProduction;
		private UI.Button butPrintProduction;
		private Helianz.UI.GroupBox groupBoxFrequency;
		...
		private Helianz.UI.CheckBox checkProductionLock;
		...
		private Helianz.UI.GroupBox groupTreatmentPlanned;
