namespace Helianz{
	partial class FormEquipmentEdit {
		...
		private void InitializeComponent() {
			...
			this.textMarketValue = new Helianz.ValidDouble();
			this.textDateSold = new Helianz.ValidDate();
			this.textDatePurchased = new Helianz.ValidDate();
			this.textPurchaseCost = new Helianz.ValidDouble();
			...
			this.textStatus = new Helianz.ODtextBox();
			...
			this.textStatus.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Equipment;
