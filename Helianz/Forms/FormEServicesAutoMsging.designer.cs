namespace Helianz{
	partial class FormEServicesAutoMsging{
		...
		private void InitializeComponent() {
			...
			this.butAddReminder = new Helianz.UI.Button();
			this.butAddConfirmation = new Helianz.UI.Button();
			this.label54 = new System.Windows.Forms.Label();
			this.comboClinicEConfirm = new Helianz.UI.ComboBox();
			this.checkIsConfirmEnabled = new Helianz.UI.CheckBox();
			this.butActivateConfirm = new Helianz.UI.Button();
			this.butActivateReminder = new Helianz.UI.Button();
			this.butAddThankYouVerify = new Helianz.UI.Button();
			this.butActivateThanks = new Helianz.UI.Button();
			this.gridRemindersMain = new Helianz.UI.GridOD();
			...
			this.butAddArrival = new Helianz.UI.Button();
			this.textStatusArrivals = new System.Windows.Forms.TextBox();
			this.butActivateArrivals = new Helianz.UI.Button();
			this.textStatusNotifications = new System.Windows.Forms.TextBox();
			this.butActivateInvites = new Helianz.UI.Button();
			this.menuMain = new Helianz.UI.MenuOD();
			this.butAddPatientPortalInvite = new Helianz.UI.Button();
			this.checkUseDefaultNewPatTY = new Helianz.UI.CheckBox();
			this.checkUseDefaultsInviteBefore = new Helianz.UI.CheckBox();
			this.butAddNewPatThanks = new Helianz.UI.Button();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butAddPatientPortalInviteBefore = new Helianz.UI.Button();
			this.checkUseDefaultThanks = new Helianz.UI.CheckBox();
			this.checkUseDefaultsConfirmation = new Helianz.UI.CheckBox();
			this.checkUseDefaultsReminder = new Helianz.UI.CheckBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.checkUseDefaultsArrival = new Helianz.UI.CheckBox();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.checkUseDefaultsGeneralMessage = new Helianz.UI.CheckBox();
			this.butAddGeneralMessage = new Helianz.UI.Button();
			this.checkUseDefaultsInvite = new Helianz.UI.CheckBox();
			this.butActivateNewPatThanks = new Helianz.UI.Button();
			...
			this.butActivateGeneralMessages = new Helianz.UI.Button();
			...
			// butAddReminder
			// 
			this.butAddReminder.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butAddConfirmation
			// 
			this.butAddConfirmation.Icon = Helianz.UI.EnumIcons.Add;
			...
			// 
			this.butAddThankYouVerify.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridRemindersMain.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.GridRemindersMain_CellDoubleClick);
			// 
			...
			// butAddArrival
			// 
			this.butAddArrival.Icon = Helianz.UI.EnumIcons.Add;
			...
			// 
			this.butAddPatientPortalInvite.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butAddNewPatThanks
			// 
			this.butAddNewPatThanks.Icon = Helianz.UI.EnumIcons.Add;
			...
			// 
			this.butAddPatientPortalInviteBefore.Icon = Helianz.UI.EnumIcons.Add;
			...
			// 
			this.butAddGeneralMessage.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.ComboBox comboClinicEConfirm;
		private Helianz.UI.CheckBox checkIsConfirmEnabled;
		...
		private Helianz.UI.CheckBox checkUseDefaultThanks;
		private Helianz.UI.CheckBox checkUseDefaultsConfirmation;
		private Helianz.UI.CheckBox checkUseDefaultsReminder;
		private Helianz.UI.CheckBox checkUseDefaultsArrival;
		private Helianz.UI.CheckBox checkUseDefaultsInvite;
		...
		private Helianz.UI.CheckBox checkUseDefaultsInviteBefore;
		private UI.Button butAddPatientPortalInviteBefore;
		private Helianz.UI.CheckBox checkUseDefaultsGeneralMessage;
		private UI.Button butAddGeneralMessage;
		private Helianz.UI.CheckBox checkUseDefaultNewPatTY;
