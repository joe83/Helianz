namespace Helianz {
	partial class FormPayPlanCredits {
		...
		private void InitializeComponent() {
			...
			this.groupCreditInfo = new Helianz.UI.GroupBox();
			this.textCode = new System.Windows.Forms.TextBox();
			this.label6 = new System.Windows.Forms.Label();
			this.butAddOrUpdate = new Helianz.UI.Button();
			...
			this.checkHideUnattached = new Helianz.UI.CheckBox();
			this.butPrint = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.checkShowImplicit = new Helianz.UI.CheckBox();
    ...
    " Credits              ";
			...
			this.butAddOrUpdate.Image = global::Helianz.Properties.Resources.Left;
		...
		private Helianz.UI.GroupBox groupCreditInfo;
		...
		private Helianz.UI.CheckBox checkHideUnattached;
		private UI.Button butPrint;
		private System.Windows.Forms.Label label3;
		private Helianz.UI.CheckBox checkShowImplicit;
	}
}