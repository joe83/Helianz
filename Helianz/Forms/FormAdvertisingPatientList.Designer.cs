namespace Helianz{
	partial class FormAdvertisingPatientList {
		...
		private void InitializeComponent() {
			...
			this.checkUserQuery = new Helianz.UI.CheckBox();
			this.butRefreshPatientFilters = new Helianz.UI.Button();
			this.labelNumberPatientsSelected = new System.Windows.Forms.Label();
			this.labelPatsSelected = new System.Windows.Forms.Label();
			this.panelFilterControls = new Helianz.UI.PanelOD();
			this.groupAppt = new Helianz.UI.GroupBox();
			this.checkHidePatientsNotSeenSince = new Helianz.UI.CheckBox();
			this.checkHidePatientsSeenSince = new Helianz.UI.CheckBox();
			this.datePickerPatientsSeenSince = new Helianz.UI.ODDatePicker();
			this.datePickerPatientsNotSeenSince = new Helianz.UI.ODDatePicker();
			this.checkHiddenFutureAppt = new Helianz.UI.CheckBox();
			this.labelPatBillingType = new System.Windows.Forms.Label();
			this.listBoxPatientBillingType = new Helianz.UI.ListBox();
			this.labelPatStatus = new System.Windows.Forms.Label();
			this.labelContact = new System.Windows.Forms.Label();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.textPatientAgeTo = new Helianz.ValidNum();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.textPatientAgeFrom = new Helianz.ValidNum();
			this.listBoxPatientStatuses = new Helianz.UI.ListBox();
			this.listBoxContactMethods = new Helianz.UI.ListBox();
			this.panelUserQuery = new Helianz.UI.PanelOD();
			...
			this.butClearAll = new Helianz.UI.Button();
			this.butClearSelected = new Helianz.UI.Button();
			this.butSetSelected = new Helianz.UI.Button();
			this.butSelectAll = new Helianz.UI.Button();
			this.butCommitList = new Helianz.UI.Button();
		...
		private Helianz.UI.CheckBox checkUserQuery;
		...
		private Helianz.UI.CheckBox checkHidePatientsSeenSince;
		...
		private Helianz.UI.CheckBox checkHidePatientsNotSeenSince;
		private Helianz.UI.CheckBox checkHiddenFutureAppt;
