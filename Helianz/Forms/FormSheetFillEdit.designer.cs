namespace Helianz{
	partial class FormSheetFillEdit {
		...
		private void InitializeComponent() {
			...
			this.panelScroll = new Helianz.PanelScrollManual();
			this.panelMain = new Helianz.UI.ControlDoubleBuffered();
			this.checkErase = new Helianz.UI.CheckBox();
			...
			this.textShowInTerminal = new Helianz.ValidNum();
			this.butDelete = new Helianz.UI.Button();
			this.butPrintOrEmail = new Helianz.UI.Button();
			...
			this.butToKiosk = new Helianz.UI.Button();
			this.butPDF = new Helianz.UI.Button();
			this.checkSaveToImages = new Helianz.UI.CheckBox();
			this.butAddField = new Helianz.UI.Button();
			this.timerTextChanged = new System.Windows.Forms.Timer(this.components);
			this.butReduceFontSize = new Helianz.UI.Button();
			this.butFontAbout = new Helianz.UI.Button();
			...
			this.butToKiosk.Image = global::Helianz.Properties.Resources.up;
			...
			this.butAddField.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.PanelScrollManual panelScroll;
		private Helianz.UI.ControlDoubleBuffered panelMain;
		private Helianz.UI.Button butDelete;
		private Helianz.UI.Button butPrintOrEmail;
		private Helianz.UI.CheckBox checkErase;
		...
		private Helianz.UI.CheckBox checkSaveToImages;
