...
namespace Helianz {
	public partial class FormOperatoryEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkIsWebSched = new Helianz.UI.CheckBox();
			this.comboClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.label3 = new System.Windows.Forms.Label();
			this.label9 = new System.Windows.Forms.Label();
			this.checkSetProspective = new Helianz.UI.CheckBox();
			this.checkIsHygiene = new Helianz.UI.CheckBox();
			this.label8 = new System.Windows.Forms.Label();
			this.comboHyg = new Helianz.UI.ComboBox();
			...
			this.groupBoxApptType = new Helianz.UI.GroupBox();
			this.labelWSEPDesc = new System.Windows.Forms.Label();
			this.butWSEPPickApptTypes = new Helianz.UI.Button();
			...
			this.butWSNPAPickApptTypes = new Helianz.UI.Button();
			this.label10 = new System.Windows.Forms.Label();
			this.butUpdateProvs = new Helianz.UI.Button();
			this.label5 = new System.Windows.Forms.Label();
			this.label11 = new System.Windows.Forms.Label();
			this.comboOpType = new Helianz.UI.ComboBox();
    ...
    "e is required to be considered for Web Sched New Pat Appt.";
		...
		private Helianz.UI.CheckBox checkSetProspective;
		private Label label3;
		private Label label4;
		private Helianz.UI.CheckBox checkIsWebSched;
		private UI.Button butPickProv;
		private UI.Button butPickHyg;
		private Label labelApptType;
		private Helianz.UI.GroupBox groupBoxApptType;
