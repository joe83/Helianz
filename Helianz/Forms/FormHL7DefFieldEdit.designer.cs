namespace Helianz{
	partial class FormHL7DefFieldEdit {
		...
		private void InitializeComponent() {
			...
			this.listFieldNames = new Helianz.UI.ListBox();
			this.comboDataType = new Helianz.UI.ComboBox();
    ...
    " list.";
		...
		private Helianz.UI.ListBox listFieldNames;
		private Helianz.UI.ComboBox comboDataType;
