namespace Helianz{
	partial class FormSheetFieldSigBox {
		...
		private void InitializeComponent() {
			...
			this.checkAllowElectronicSig = new Helianz.UI.CheckBox();
			this.checkRestrictSigProvider = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// textUiLabelMobile
			// 
		...
		private Helianz.UI.CheckBox checkAllowElectronicSig;
		private Helianz.UI.CheckBox checkRestrictSigProvider;
	}
}