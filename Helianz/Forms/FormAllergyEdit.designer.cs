namespace Helianz{
	partial class FormAllergyEdit {
		...
		private void InitializeComponent() {
			...
			this.checkActive = new Helianz.UI.CheckBox();
			...
			this.comboAllergies = new Helianz.UI.ComboBox();
			this.textDate = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.textSnomedReaction = new System.Windows.Forms.TextBox();
			this.butNoneSnomedReaction = new Helianz.UI.Button();
			this.butSnomedReactionSelect = new Helianz.UI.Button();
		...
		private Helianz.UI.CheckBox checkActive;
		...
		private Helianz.UI.ComboBox comboAllergies;
