namespace Helianz{
	partial class FormSheetFieldCheckBox {
		...
		private void InitializeComponent() {
			...
			this.checkRequired = new Helianz.UI.CheckBox();
			this.groupRadioMisc = new Helianz.UI.GroupBox();
			...
			this.listRadio = new Helianz.UI.ListBox();
			this.groupRadio = new Helianz.UI.GroupBox();
			...
			this.listMedical = new Helianz.UI.ListBox();
			...
			this.textTabOrder = new Helianz.ValidNum();
			this.butDelete = new Helianz.UI.Button();
			this.textHeight = new Helianz.ValidNum();
			this.textWidth = new Helianz.ValidNum();
			this.textYPos = new Helianz.ValidNum();
			this.textXPos = new Helianz.ValidNum();
    ...
    "tton group.";
			...
			// butAddAllergy
			// 
			this.butAddAllergy.Image = global::Helianz.Properties.Resources.Add;
			...
			// butAddProblem
			// 
			this.butAddProblem.Image = global::Helianz.Properties.Resources.Add;
			...
			// butAddProc
			// 
			this.butAddProc.Image = global::Helianz.Properties.Resources.Add;
		...
		private Helianz.UI.CheckBox checkRequired;
		private Helianz.UI.GroupBox groupRadioMisc;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.ListBox listRadio;
		private Helianz.UI.GroupBox groupRadio;
		private ValidNum textTabOrder;
		private System.Windows.Forms.Label labelTabOrder;
		private Helianz.UI.ListBox listMedical;
