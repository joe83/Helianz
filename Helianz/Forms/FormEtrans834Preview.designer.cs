namespace Helianz{
	partial class FormEtrans834Preview {
		...
		private void InitializeComponent() {
			...
			this.gridInsPlans = new Helianz.UI.GridOD();
			this.label1 = new System.Windows.Forms.Label();
			this.butSave = new Helianz.UI.Button();
			this.labelProgress = new System.Windows.Forms.Label();
			this.checkDropExistingIns = new Helianz.UI.CheckBox();
			this.checkIsEmployerCreate = new Helianz.UI.CheckBox();
			this.checkIsPatientCreate = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// gridInsPlans
			// 
			...
			this.gridInsPlans.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridInsPlans_CellDoubleClick);
			// 
			// label1
			// 
    ...
    "unchecked, you can still add patients by selecting manually.";
		...
		private Helianz.UI.CheckBox checkDropExistingIns;
		private Helianz.UI.CheckBox checkIsEmployerCreate;
		private Helianz.UI.CheckBox checkIsPatientCreate;
	}
}