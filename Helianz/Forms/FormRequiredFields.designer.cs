namespace Helianz {
	partial class FormRequiredFields {
		...
		private void InitializeComponent() {
			...
			this.listAvailableFields.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridConditions.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridConditions.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridConditions_CellDoubleClick);
			// 
			// butRight
			// 
		...
		private Helianz.UI.ListBox listAvailableFields;
		...
		private Helianz.UI.CheckBox checkMedicaidLength;
		private Helianz.UI.ComboBox comboFieldTypes;
	}
}