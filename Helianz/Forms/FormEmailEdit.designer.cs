namespace Helianz{
	partial class FormEmailEdit {
		...
		private void InitializeComponent() {
			...
			this.textContentEmail = new Helianz.ODcodeBox();
			this.webBrowserEmail = new System.Windows.Forms.WebBrowser();
			this.butSave = new Helianz.UI.Button();
			this.toolBarBottom = new Helianz.UI.ToolBarOD();
			this.toolBarTop = new Helianz.UI.ToolBarOD();
			...
			this.checkIsRaw = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// imageListMain
			// 
			...
			this.toolBarBottom.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.toolBarBottom_ButtonClick);
			// 
			// toolBarTop
			// 
			...
			this.toolBarTop.ButtonClick += new Helianz.UI.ODToolBarButtonClickEventHandler(this.toolBarTop_ButtonClick);
			// 
			// labelPreview
			// 
		...
		private Helianz.UI.CheckBox checkIsRaw;
	}
}