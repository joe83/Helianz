...
namespace Helianz {
	public partial class FormTranslation {
		...
		private void InitializeComponent(){
			...
			this.gridLan = new Helianz.UI.GridOD();
			this.butDeleteUnused = new Helianz.UI.Button();
			...
			this.gridLan.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridLan.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridLan_CellDoubleClick);
			// 
			// butDeleteUnused
			// 
			...
			this.butDeleteUnused.Icon = Helianz.UI.EnumIcons.DeleteX;
    ...
    "ack.";
		...
		#endregion
		private Helianz.UI.GridOD gridLan;
		private Helianz.UI.Button butDeleteUnused;
