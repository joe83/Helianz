namespace Helianz{
	partial class FormEtrans835Edit {
		...
		private void InitializeComponent() {
			...
			this.butClaimDetails = new Helianz.UI.Button();
			...
			this.butDetachClaim = new Helianz.UI.Button();
			this.butPreview = new Helianz.UI.Button();
			this.buttonFindClaimMatch = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butAutoProcess = new Helianz.UI.Button();
			this.gridProviderAdjustments = new Helianz.UI.GridOD();
			this.gridClaimDetails = new Helianz.UI.GridOD();
			...
			this.gridProviderAdjustments.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridProviderAdjustments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProviderAdjustments_CellDoubleClick);
			// 
			// gridClaimDetails
			// 
			...
			this.gridClaimDetails.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridClaimDetails.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridClaimDetails_CellDoubleClick);
			// 
			// FormEtrans835Edit
			// 
		...
		private Helianz.UI.GridOD gridClaimDetails;
