namespace Helianz{
	partial class FormEncounterEdit {
		...
		private void InitializeComponent() {
			...
			this.textDateEnc = new Helianz.ValidDate();
			this.butCpt = new Helianz.UI.Button();
			this.butHcpcs = new Helianz.UI.Button();
			this.butSnomed = new Helianz.UI.Button();
			this.butCdt = new Helianz.UI.Button();
