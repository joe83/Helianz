namespace Helianz{
	partial class FormTaskSearch {
		...
		private void InitializeComponent() {
			...
			this.groupText = new Helianz.UI.GroupBox();
			...
			this.checkIncludeAttachments = new Helianz.UI.CheckBox();
			this.groupUsers = new Helianz.UI.GroupBox();
			this.checkShowHiddenUsers = new Helianz.UI.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.comboUsers = new Helianz.UI.ComboBox();
			this.butUserPicker = new Helianz.UI.Button();
			this.checkBoxIncludeCompleted = new Helianz.UI.CheckBox();
			this.checkBoxIncludesTaskNotes = new Helianz.UI.CheckBox();
			this.comboPriority = new Helianz.UI.ComboBox();
			this.label12 = new System.Windows.Forms.Label();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.butClearCompleted = new Helianz.UI.Button();
			...
			this.butClearCreated = new Helianz.UI.Button();
			...
			this.butPatPicker = new Helianz.UI.Button();
			...
			this.checkLimit = new Helianz.UI.CheckBox();
			this.gridTasks = new Helianz.UI.GridOD();
			this.butRefresh = new Helianz.UI.Button();
			this.butNewTask = new Helianz.UI.Button();
			...
			this.gridTasks.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.CheckBox checkLimit;
		private UI.Button butPatPicker;
		private Helianz.UI.ComboBox comboUsers;
		...
		private Helianz.UI.CheckBox checkBoxIncludeCompleted;
		private Helianz.UI.CheckBox checkBoxIncludesTaskNotes;
		private Helianz.UI.CheckBox checkReportServer;
		private Helianz.UI.CheckBox checkShowHiddenUsers;
		private UI.GroupBox groupUsers;
		private Helianz.UI.CheckBox checkIncludeAttachments;
