namespace Helianz{
	partial class FormOrthoCase {
		...
		private void InitializeComponent() {
			...
			this.groupVisit = new Helianz.UI.GroupBox();
			this.textVisitPercent = new Helianz.ValidDouble();
			this.labelVisitsCompleted = new System.Windows.Forms.Label();
			this.TextVisitCountComplete = new Helianz.ValidNum();
			this.labelVisitAmount = new System.Windows.Forms.Label();
			this.labelVisitPercent = new System.Windows.Forms.Label();
			this.textVisitAmount = new Helianz.ValidDouble();
			this.labelVisitsPlanned = new System.Windows.Forms.Label();
			this.textVisitCountPlanned = new Helianz.ValidNum();
			this.textAllVisitsPercent = new Helianz.ValidDouble();
			this.textDebondPercent = new Helianz.ValidDouble();
			this.textBandingPercent = new Helianz.ValidDouble();
			this.labelFeesAmount = new System.Windows.Forms.Label();
			this.textAllVisitsAmount = new Helianz.ValidDouble();
			this.textDebondAmount = new Helianz.ValidDouble();
			this.textBandingAmount = new Helianz.ValidDouble();
			...
			this.textTreatmentLength = new Helianz.ValidNum();
			this.textPatAR = new Helianz.ValidDouble();
			this.textPrimaryInsAR = new Helianz.ValidDouble();
			this.textTotalAR = new Helianz.ValidDouble();
			this.labelAR = new System.Windows.Forms.Label();
			this.textBandingProc = new System.Windows.Forms.TextBox();
			this.butAddBandingProcedure = new Helianz.UI.Button();
			this.checkIsTransfer = new Helianz.UI.CheckBox();
			this.labelRemaining = new System.Windows.Forms.Label();
			this.labelCompleted = new System.Windows.Forms.Label();
			this.labelTotal = new System.Windows.Forms.Label();
			this.textPatRemaining = new Helianz.ValidDouble();
			this.labelPatientFee = new System.Windows.Forms.Label();
			this.textPatCompleted = new Helianz.ValidDouble();
			this.textPatientFee = new Helianz.ValidDouble();
			this.textPrimaryInsRemaining = new Helianz.ValidDouble();
			this.labelPrimaryInsuranceFee = new System.Windows.Forms.Label();
			this.textPrimaryInsCompleted = new Helianz.ValidDouble();
			this.textPrimaryInsuranceFee = new Helianz.ValidDouble();
			this.textTotalRemaining = new Helianz.ValidDouble();
			this.textExpectedDebondDate = new Helianz.ValidDate();
			this.textTotalCompleted = new Helianz.ValidDouble();
			this.labelExpectedDebondDate = new System.Windows.Forms.Label();
			this.textBandingDate = new Helianz.ValidDate();
			this.labelBandingDate = new System.Windows.Forms.Label();
			this.labelTotalFee = new System.Windows.Forms.Label();
			this.textTotalFee = new Helianz.ValidDouble();
			this.gridOrthoSchedule = new Helianz.UI.GridOD();
			this.butCloseOrthoCase = new Helianz.UI.Button();
			this.butDeleteOrthoCase = new Helianz.UI.Button();
			this.butDetachProcs = new Helianz.UI.Button();
			this.groupFee = new Helianz.UI.GroupBox();
			this.textSecondaryInsuranceFee = new Helianz.ValidDouble();
			this.textSecondaryInsCompleted = new Helianz.ValidDouble();
			this.textSecondaryInsAR = new Helianz.ValidDouble();
			this.labelSecondaryInsuranceFee = new System.Windows.Forms.Label();
			this.textSecondaryInsRemaining = new Helianz.ValidDouble();
			this.groupDates = new Helianz.UI.GroupBox();
			this.groupProcBreakdown = new Helianz.UI.GroupBox();
			this.label3 = new System.Windows.Forms.Label();
			this.labelBandingProc = new System.Windows.Forms.Label();
			this.butPatPayPlan = new Helianz.UI.Button();
			...
			this.gridOrthoSchedule.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridOrthoSchedule_CellDoubleClick);
			this.gridOrthoSchedule.CellClick += new Helianz.UI.ODGridClickEventHandler(this.GridOrthoSchedule_CellClick);
			// 
			// butCloseOrthoCase
			// 
			...
			this.butCloseOrthoCase.Image = global::Helianz.Properties.Resources.close_door;
			...
			this.butDeleteOrthoCase.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.GroupBox groupVisit;
		...
		private Helianz.UI.CheckBox checkIsTransfer;
		...
		private Helianz.UI.GroupBox groupFee;
		private Helianz.UI.GroupBox groupDates;
		private Helianz.UI.GroupBox groupProcBreakdown;
