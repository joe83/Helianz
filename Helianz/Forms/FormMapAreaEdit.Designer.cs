namespace Helianz {
	partial class FormMapAreaEdit {
		...
		private void InitializeComponent() {
			...
			this.textXPos = new Helianz.ValidDouble();
			this.textYPos = new Helianz.ValidDouble();
			this.textWidth = new Helianz.ValidDouble();
			this.textHeight = new Helianz.ValidDouble();
			this.textExtension = new Helianz.ValidNum();
			...
			this.textFontSize = new Helianz.ValidDouble();
