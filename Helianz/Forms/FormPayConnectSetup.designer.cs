...
namespace Helianz {
	public partial class FormPayConnectSetup {
		...
		private void InitializeComponent() {
			...
			this.groupPaySettings = new Helianz.UI.GroupBox();
			this.butMerchantInfo = new Helianz.UI.Button();
			this.groupBoxVersion = new Helianz.UI.GroupBox();
			this.radioVersion2 = new System.Windows.Forms.RadioButton();
			this.radioVersion1 = new System.Windows.Forms.RadioButton();
			this.checkSurcharge = new Helianz.UI.CheckBox();
			this.textAPISecret = new System.Windows.Forms.TextBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butGenerateToken = new Helianz.UI.Button();
			this.label4 = new System.Windows.Forms.Label();
			this.textToken = new System.Windows.Forms.TextBox();
			this.checkPatientPortalPayEnabled = new Helianz.UI.CheckBox();
			this.checkPreventSavingNewCC = new Helianz.UI.CheckBox();
			this.comboDefaultProcessing = new Helianz.UI.ComboBox();
			this.labelDefaultProcMethod = new System.Windows.Forms.Label();
			this.checkForceRecurring = new Helianz.UI.CheckBox();
			this.checkTerminal = new Helianz.UI.CheckBox();
			this.butDownloadDriver = new Helianz.UI.Button();
			this.labelClinicEnable = new System.Windows.Forms.Label();
			this.butSave = new Helianz.UI.Button();
			this.groupBoxTerminals = new Helianz.UI.GroupBox();
			this.butAddTerminal = new Helianz.UI.Button();
			this.gridODTerminals = new Helianz.UI.GridOD();
			...
			this.butAddTerminal.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridODTerminals.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridODTerminals_CellDoubleClick);
			// 
			// FormPayConnectSetup
			// 
		...
		private Helianz.UI.ComboBox comboPaymentType;
		...
		private Helianz.UI.GroupBox groupPaySettings;
		private Label labelClinicEnable;
		private Helianz.UI.CheckBox checkTerminal;
		private UI.Button butDownloadDriver;
		private Helianz.UI.CheckBox checkForceRecurring;
		private Helianz.UI.ComboBox comboDefaultProcessing;
		private Label labelDefaultProcMethod;
		private Helianz.UI.CheckBox checkPreventSavingNewCC;
		private Helianz.UI.GroupBox groupBox1;
		private Helianz.UI.CheckBox checkPatientPortalPayEnabled;
