...
namespace Helianz {
	public partial class FormClaimForms {
		...
		private void InitializeComponent()
		{
			...
			this.gridCustom = new Helianz.UI.GridOD();
			this.gridInternal = new Helianz.UI.GridOD();
    ...
    " first.";
			...
			this.gridCustom.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustom_CellDoubleClick);
			// 
			// gridInternal
			// 
			...
			this.gridInternal.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridInternal_CellDoubleClick);
			// 
			// butCopy
			// 
		...
		private Helianz.UI.Button butDuplicate;
		...
		private Helianz.UI.Button butReassign;
		private Label label2;
		private Helianz.UI.ComboBox comboReassign;
