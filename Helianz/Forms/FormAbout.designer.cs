...
namespace Helianz{
	public partial class FormAbout {
		...
		private void InitializeComponent(){
			...
			this.butLicense = new Helianz.UI.Button();
			...
			this.pictureHelianz = new Helianz.UI.ODPictureBox();
			this.butDiagnostics = new Helianz.UI.Button();
			...
			// pictureHelianz
			// 
			this.pictureHelianz.HasBorder = false;
			this.pictureHelianz.Image = global::Helianz.Properties.Resources.ODLogo;
			this.pictureHelianz.Location = new System.Drawing.Point(143, 5);
			this.pictureHelianz.Name = "pictureHelianz";
			this.pictureHelianz.Size = new System.Drawing.Size(106, 48);
			this.pictureHelianz.TabIndex = 58;
			this.pictureHelianz.TextNullImage = null;
			// 
			// butDiagnostics
			// 
			...
			this.Controls.Add(this.pictureHelianz);
		...
		private Helianz.UI.Button butLicense;
		...
		private UI.ODPictureBox pictureHelianz;
