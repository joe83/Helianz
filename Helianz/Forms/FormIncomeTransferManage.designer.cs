namespace Helianz{
	partial class FormIncomeTransferManage {
		...
		private void InitializeComponent() {
			...
			this.gridImbalances = new Helianz.UI.GridOD();
			this.gridTransfers = new Helianz.UI.GridOD();
			this.butTransfer = new Helianz.UI.Button();
			this.checkShowBreakdown = new Helianz.UI.CheckBox();
			...
			this.gridImbalances.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridTransfers.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridTransfers_CellDoubleClick);
			// 
			// butTransfer
			// 
			this.butTransfer.Image = global::Helianz.Properties.Resources.Left;
    ...
    " main Transfer button.";
		...
		private Helianz.UI.CheckBox checkShowBreakdown;
