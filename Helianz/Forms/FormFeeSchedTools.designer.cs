...
namespace Helianz {
	public partial class FormFeeSchedTools {
		...
		private void InitializeComponent()
		{
			...
			this.checkShowGroups = new Helianz.UI.CheckBox();
			this.comboClinicTo = new Helianz.UI.ComboBoxClinicPicker();
			this.groupBox7 = new Helianz.UI.GroupBox();
			this.comboProvider = new Helianz.UI.ComboBox();
			this.comboGroup = new Helianz.UI.ComboBox();
			...
			this.butPickGroup = new Helianz.UI.Button();
			this.butPickSched = new Helianz.UI.Button();
			this.label8 = new System.Windows.Forms.Label();
			this.labelGroup = new System.Windows.Forms.Label();
			this.groupGlobalUpdateFees = new Helianz.UI.GroupBox();
			this.label9 = new System.Windows.Forms.Label();
			this.butUpdateWriteoffs = new Helianz.UI.Button();
			this.comboGlobalUpdateClinics = new Helianz.UI.ComboBoxClinicPicker();
			this.label4 = new System.Windows.Forms.Label();
			this.butUpdate = new Helianz.UI.Button();
			this.groupBox5 = new Helianz.UI.GroupBox();
			this.butImportCanada = new Helianz.UI.Button();
			...
			this.butIncrease = new Helianz.UI.Button();
			...
			this.butPickGroupTo = new Helianz.UI.Button();
			this.labelGroupTo = new System.Windows.Forms.Label();
			this.comboGroupTo = new Helianz.UI.ComboBox();
			this.comboProviderTo = new Helianz.UI.ComboBox();
			this.comboFeeSchedTo = new Helianz.UI.ComboBox();
			this.label7 = new System.Windows.Forms.Label();
			this.butPickProvTo = new Helianz.UI.Button();
			this.butPickSchedTo = new Helianz.UI.Button();
    ...
    "and discount plan amounts.";
		...
		private Helianz.UI.Button butCopy;
		private Helianz.UI.ComboBox comboFeeSchedTo;
		private Helianz.UI.GroupBox groupBox2;
		private Helianz.UI.Button butClear;
		private Helianz.UI.GroupBox groupBox3;
		private Helianz.UI.Button butIncrease;
		...
		private Helianz.UI.Button butExport;
		private Helianz.UI.Button butImport;
		private Helianz.UI.GroupBox groupGlobalUpdateFees;
		private Label label4;
		private Helianz.UI.Button butUpdate;
		...
		private Helianz.UI.ComboBox comboFeeSched;
		...
		private Helianz.UI.ComboBox comboProviderTo;
		...
		private Helianz.UI.CheckBox checkShowGroups;
		private Helianz.UI.ComboBox comboGroup;
		private Helianz.UI.ComboBox comboGroupTo;
