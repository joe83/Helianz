...
namespace Helianz {
	public partial class FormInsBenefits {
		...
		private void InitializeComponent()
		{
			...
			this.gridAgeLimits = new Helianz.UI.GridOD();
			this.label14 = new System.Windows.Forms.Label();
			this.textAnnualMaxFam = new Helianz.ValidDouble();
			this.textDeductibleFam = new Helianz.ValidDouble();
			this.label13 = new System.Windows.Forms.Label();
			this.textAnnualMax = new Helianz.ValidDouble();
			this.label1 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.textDeductible = new Helianz.ValidDouble();
			this.groupBox3 = new Helianz.UI.GroupBox();
			this.textOrthoAge = new Helianz.ValidNum();
			this.labelOrthoThroughAge = new System.Windows.Forms.Label();
			this.textOrthoPercent = new Helianz.ValidNum();
			this.label11 = new System.Windows.Forms.Label();
			this.textOrthoMax = new Helianz.ValidDouble();
			this.label10 = new System.Windows.Forms.Label();
			this.labelSubscNote = new System.Windows.Forms.Label();
			this.groupYear = new Helianz.UI.GroupBox();
			this.checkCalendarYear = new Helianz.UI.CheckBox();
			this.textMonth = new Helianz.ValidNum();
			this.label30 = new System.Windows.Forms.Label();
			this.checkSimplified = new Helianz.UI.CheckBox();
			this.butDelete = new Helianz.UI.Button();
			this.butAddBenefit = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.groupCategories = new Helianz.UI.GroupBox();
			this.labelWaitingPeriod = new System.Windows.Forms.Label();
			this.textWaitProsth = new Helianz.ValidNum();
			this.textWaitCrowns = new Helianz.ValidNum();
			this.labelMonths = new System.Windows.Forms.Label();
			this.textWaitOralSurg = new Helianz.ValidNum();
			this.textWaitPerio = new Helianz.ValidNum();
			this.textWaitEndo = new Helianz.ValidNum();
			this.textWaitRestorative = new Helianz.ValidNum();
			this.textDeductDiagFam = new Helianz.ValidDouble();
			this.textDeductXrayFam = new Helianz.ValidDouble();
			this.textDeductDiag = new Helianz.ValidDouble();
			this.label3 = new System.Windows.Forms.Label();
			this.textDeductXray = new Helianz.ValidDouble();
			this.label21 = new System.Windows.Forms.Label();
			this.label29 = new System.Windows.Forms.Label();
			this.label27 = new System.Windows.Forms.Label();
			this.label26 = new System.Windows.Forms.Label();
			this.textDeductPreventFam = new Helianz.ValidDouble();
			this.textXray = new Helianz.ValidNum();
			this.label25 = new System.Windows.Forms.Label();
			this.label12 = new System.Windows.Forms.Label();
			this.panel3 = new System.Windows.Forms.Panel();
			this.panel2 = new System.Windows.Forms.Panel();
			this.panel1 = new System.Windows.Forms.Panel();
			this.textStand4 = new Helianz.ValidNum();
			this.textAccident = new Helianz.ValidNum();
			this.label23 = new System.Windows.Forms.Label();
			this.textStand2 = new Helianz.ValidNum();
			this.textMaxProsth = new Helianz.ValidNum();
			this.textDeductPrevent = new Helianz.ValidDouble();
			this.label22 = new System.Windows.Forms.Label();
			this.textStand1 = new Helianz.ValidNum();
			this.textProsth = new Helianz.ValidNum();
			this.textOralSurg = new Helianz.ValidNum();
			this.label20 = new System.Windows.Forms.Label();
			this.textPerio = new Helianz.ValidNum();
			this.label19 = new System.Windows.Forms.Label();
			this.textEndo = new Helianz.ValidNum();
			this.label18 = new System.Windows.Forms.Label();
			this.textRoutinePrev = new Helianz.ValidNum();
			this.label9 = new System.Windows.Forms.Label();
			this.textCrowns = new Helianz.ValidNum();
			this.label15 = new System.Windows.Forms.Label();
			this.textRestorative = new Helianz.ValidNum();
			this.label16 = new System.Windows.Forms.Label();
			this.textDiagnostic = new Helianz.ValidNum();
			this.label17 = new System.Windows.Forms.Label();
			this.checkShowProcCodes = new Helianz.UI.CheckBox();
			this.butAddFrequency = new Helianz.UI.Button();
			this.gridFrequencies = new Helianz.UI.GridOD();
			...
			this.gridAgeLimits.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.butAddBenefit.Icon = Helianz.UI.EnumIcons.Add;
			...
			// butAddFrequency
			// 
			this.butAddFrequency.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridFrequencies.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridFrequencies.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridFrequencies_CellClick);
			// 
			// textSubscNote
			// 
    ...
    "rt.\n5 lines in 72 vert\n6 lines in 85 vert\n7 lines in 98";
			...
			this.gridBenefits.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridBenefits.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridBenefits_CellDoubleClick);
			// 
			// FormInsBenefits
			// 
		...
		private Helianz.UI.Button butAddBenefit;
		private Helianz.UI.GridOD gridBenefits;
		private Helianz.UI.CheckBox checkSimplified;
		...
		private Helianz.UI.GroupBox groupCategories;
		...
		private Helianz.UI.GroupBox groupYear;
		private Helianz.UI.CheckBox checkCalendarYear;
