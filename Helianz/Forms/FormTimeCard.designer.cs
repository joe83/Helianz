...
namespace Helianz {
	public partial class FormTimeCard {
		...
		private void InitializeComponent()
		{
			...
			this.butCalcDaily = new Helianz.UI.Button();
			this.butPrint = new Helianz.UI.Button();
			this.butCalcWeekOT = new Helianz.UI.Button();
			this.butAdj = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.groupEmployee = new Helianz.UI.GroupBox();
			this.butPrevEmp = new Helianz.UI.Button();
			this.butNextEmp = new Helianz.UI.Button();
			...
			this.butBenefits = new Helianz.UI.Button();
		...
		private Helianz.UI.Button butAdj;
		private Label labelOvertime;
		private TextBox textOvertime;
		private Helianz.UI.Button butCalcWeekOT;
