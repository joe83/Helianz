...

{
	partial class FormAnesthMedDelDose
	{
		...
		private void InitializeComponent()
		{
			...
			this.butDelAnesthMeds = new Helianz.UI.Button();
			...
			this.butDelAnesthMeds.BtnShape = Helianz.UI.enumType.BtnShape.Rectangle;
			this.butDelAnesthMeds.BtnStyle = Helianz.UI.enumType.XPStyle.Silver;
			this.butDelAnesthMeds.CornerRadius = 4F;
			this.butDelAnesthMeds.Image = global::Helianz.Properties.Resources.deleteX;
		...
		private Helianz.UI.Button butDelAnesthMeds;
