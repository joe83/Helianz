...
namespace Helianz {
	public partial class FormTransactionEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkMemoSame = new Helianz.UI.CheckBox();
			...
			this.butOpenInvoice = new Helianz.UI.Button();
			this.butAttachInvoice = new Helianz.UI.Button();
			...
			this.butAttachPay = new Helianz.UI.Button();
			this.textSourceDeposit = new System.Windows.Forms.TextBox();
			this.butAttachDep = new Helianz.UI.Button();
		...
		private Helianz.UI.Button butAttachPay;
