...
namespace Helianz {
	public partial class FormElectIDs {
		...
		private void InitializeComponent()
		{
			...
			this.gridElectIDs = new Helianz.UI.GridOD();
			...
			this.gridElectIDs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridElectIDs_CellDoubleClick);
			this.gridElectIDs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridElectIDs_CellClick);
			// 
			// butOK
			// 
