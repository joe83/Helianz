		...
		private void butRefresh_Click(object sender,EventArgs e) {
			...
			if(GetActiveMailbox()==MailboxType.Inbox) {
				try {
					...
					else {//Insert a signal that will cause the Helianz Service to retrieve emails when using the inbox feature.
						if(!AlertItems.IsODServiceRunning()) {
							MessageBox.Show(Lans.g("Alerts","No instance of Helianz Service is running."));
							return;
						}
