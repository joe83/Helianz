namespace Helianz {
	partial class FormClaimAttachSnipDXC {
		...
		private void InitializeComponent() {
			...
			this.textDateCreated = new Helianz.ValidDate();
			this.labelDateTimeCreate = new System.Windows.Forms.Label();
			this.butSend = new Helianz.UI.Button();
			this.textFileName = new System.Windows.Forms.TextBox();
			this.listBoxImageType = new Helianz.UI.ListBox();
			this.checkIsXrayMirrored = new Helianz.UI.CheckBox();
			this.pictureBoxImagePreview = new System.Windows.Forms.PictureBox();
			this.butSendAndAgain = new Helianz.UI.Button();
    ...
    "the first image category.";
		...
		private Helianz.UI.CheckBox checkIsXrayMirrored;
