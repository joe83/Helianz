namespace Helianz{
	partial class FormFamilyHealthEdit {
		...
		private void InitializeComponent() {
			...
			this.listRelationship = new Helianz.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.textName = new Helianz.ODtextBox();
			this.textSnomed = new Helianz.ODtextBox();
			this.textProblem = new Helianz.ODtextBox();
			...
			this.textName.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
			...
			this.textProblem.QuickPasteType = HelianzBusiness.EnumQuickPasteType.MedicationEdit;
		...
		private Helianz.UI.ListBox listRelationship;
