namespace Helianz{
	partial class FormDispensary {
		...
		private void InitializeComponent() {
			...
			this.groupSupply = new Helianz.UI.GroupBox();
			...
			this.gridEquip = new Helianz.UI.GridOD();
			this.gridDispSupply = new Helianz.UI.GridOD();
			this.gridSupply = new Helianz.UI.GridOD();
			this.gridStudents = new Helianz.UI.GridOD();
			this.butScan = new Helianz.UI.Button();
			this.butCheckOut = new Helianz.UI.Button();
			this.butCheckIn = new Helianz.UI.Button();
		...
		private Helianz.UI.GroupBox groupSupply;
