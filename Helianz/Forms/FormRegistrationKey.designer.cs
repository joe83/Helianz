...
namespace Helianz {
	public partial class FormRegistrationKey {
		...
		private Helianz.UI.CheckBox checkAgree;
		private Helianz.UI.ListBox listBoxRegistration;
