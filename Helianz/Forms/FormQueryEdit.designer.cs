...
namespace Helianz {
	public partial class FormQueryEdit {
		...
		private void InitializeComponent(){
			...
			this.checkReleased = new Helianz.UI.CheckBox();
			this.checkIsPromptSetup = new Helianz.UI.CheckBox();
			this.radioHuman = new System.Windows.Forms.RadioButton();
			this.radioRaw = new System.Windows.Forms.RadioButton();
			this.groupFormat = new Helianz.UI.GroupBox();
		...
		private Helianz.ODtextBox textQuery;// Required designer variable.
		private Helianz.UI.CheckBox checkReleased;
		private Helianz.UI.CheckBox checkIsPromptSetup;
