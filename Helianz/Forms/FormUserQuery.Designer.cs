...
namespace Helianz {
	partial class FormUserQuery {
		...
		private Helianz.UI.Button butExportTxt;
		...
		private void InitializeComponent() {
			...
			this._gridResults = new Helianz.UI.GridOD();
			...
			this.butExportCsv = new Helianz.UI.Button();
			...
			this.butExportTxt.Image = global::Helianz.Properties.Resources.butExport;
			...
			this._gridResults.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.butExportCsv.Image = global::Helianz.Properties.Resources.butExport;
		...
		private Helianz.UI.CheckBox checkWordWrap;
		private System.Windows.Forms.Label labelRowCount;
		private Helianz.UI.CheckBox checkNumberedRows;
