...
namespace Helianz {
	public partial class FormReqNeededs {
		...
		private void InitializeComponent(){
			...
			this.comboClassFrom = new Helianz.UI.ComboBox();
			this.label2 = new System.Windows.Forms.Label();
			this.comboCourseFrom = new Helianz.UI.ComboBox();
			this.groupBox1 = new Helianz.UI.GroupBox();
			this.butCopy = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.comboClassTo = new Helianz.UI.ComboBox();
			this.comboCourseTo = new Helianz.UI.ComboBox();
			...
			this.butDeleteReq = new Helianz.UI.Button();
			...
			this.butDeleteReq.Icon = Helianz.UI.EnumIcons.DeleteX;
		...
		private Helianz.UI.ComboBox comboClassFrom;
		private Label label1;
		private Label label2;
		private Helianz.UI.ComboBox comboCourseFrom;
		private Helianz.UI.GroupBox groupBox1;
		private Label label3;
		private Helianz.UI.ComboBox comboClassTo;
		private Helianz.UI.ComboBox comboCourseTo;
