namespace Helianz{
	partial class FormAsapSetup {
		...
		private void InitializeComponent() {
			...
			this.checkUseDefaults = new Helianz.UI.CheckBox();
			this.textWebSchedPerDay = new Helianz.ValidNum();
			this.labelMaxWebSched = new System.Windows.Forms.Label();
			this.labelLeaveBlank = new System.Windows.Forms.Label();
			this.checkAsapPromptEnabled = new Helianz.UI.CheckBox();
			this.groupBoxASAPPrompt = new Helianz.UI.GroupBox();
    ...
    "r if the appointment has already started.)";
		...
		private Helianz.UI.CheckBox checkUseDefaults;
		...
		private Helianz.UI.CheckBox checkAsapPromptEnabled;
