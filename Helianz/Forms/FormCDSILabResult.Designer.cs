namespace Helianz {
	partial class FormCDSILabResult {
		...
		private void InitializeComponent() {
			...
			this.comboComparator = new Helianz.UI.ComboBox();
			...
			this.checkAllResults = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.ComboBox comboComparator;
		...
		private Helianz.UI.CheckBox checkAllResults;
