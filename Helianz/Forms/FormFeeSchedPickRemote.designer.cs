namespace Helianz{
	partial class FormFeeSchedPickRemote {
		...
		private void InitializeComponent() {
			...
			this.gridFeeSchedFiles = new Helianz.UI.GridOD();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.gridFeeSchedFiles.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridFeeSchedFiles_CellDoubleClick);
			this.gridFeeSchedFiles.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridFeeSchedFiles_CellClick);
			// 
