...
namespace Helianz{
	...
	public partial class FormPerio : FormODBase {
		...
		private void RefreshListExams(bool skipRefreshMeasures=false) {
			...
			Helianz.UI.GridColumn gridColumn;
			gridColumn=new Helianz.UI.GridColumn(Lan.g("TablePerioExam","Exam Date"),75,HorizontalAlignment.Center);
			gridODExam.Columns.Add(gridColumn);
			gridColumn=new Helianz.UI.GridColumn(Lan.g("TablePerioExam","Provider"),75,HorizontalAlignment.Center);
			gridODExam.Columns.Add(gridColumn);
			gridColumn=new Helianz.UI.GridColumn(Lan.g("TablePerioExam","Exam Notes"),150,HorizontalAlignment.Center);
			gridODExam.Columns.Add(gridColumn);
			for(int i=0;i<contrPerio.ListPerioExams.Count;i++) {
				Helianz.UI.GridRow gridRow=new Helianz.UI.GridRow();
