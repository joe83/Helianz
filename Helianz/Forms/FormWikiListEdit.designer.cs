namespace Helianz{
	partial class FormWikiListEdit {
		...
		private void InitializeComponent() {
			...
			this.butRenameList = new Helianz.UI.Button();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.butAddItem = new Helianz.UI.Button();
			...
			this.checkBoxIncludeHiddenColumns = new Helianz.UI.CheckBox();
			this.gridMain = new Helianz.UI.GridOD();
			this.butAdvSearch = new Helianz.UI.Button();
			this.butClearAdvSearch = new Helianz.UI.Button();
		...
		private Helianz.UI.CheckBox checkBoxIncludeHiddenColumns;
	}
}