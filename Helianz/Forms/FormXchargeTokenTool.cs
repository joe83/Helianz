...
namespace Helianz {
	public partial class FormXchargeTokenTool:FormODBase {
		...
		///<summary>The X-Charge Username for the FormHelianz.ClinicNum clinic.  Validated on load.</summary>
		private string _xUsername;
		///<summary>The X-Charge Password for the FormHelianz.ClinicNum clinic.  Validated on load.</summary>
		...
		private void FormXchargeTokenTool_Load(object sender,EventArgs e) {
			...
			//Therefore, we will validate the credentials and payment type using FormHelianz.ClinicNum
