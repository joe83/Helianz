...
namespace Helianz {
	public partial class FormReqStudentEdit {
		...
		private void InitializeComponent()
		{
			...
			this.butDetachPat = new Helianz.UI.Button();
			this.butDetachApt = new Helianz.UI.Button();
			...
			this.butSelectPat = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
		...
		private Helianz.UI.Button butDetachApt;
		private Helianz.UI.Button butDetachPat;
		...
		private Helianz.UI.Button butSelectPat;
	}
}
