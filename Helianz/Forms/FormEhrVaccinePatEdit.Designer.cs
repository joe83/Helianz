namespace Helianz {
	partial class FormEhrVaccinePatEdit {
		...
		private void InitializeComponent() {
			...
			this.listCompletionStatus = new Helianz.UI.ListBox();
			this.label7 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.listAdministrationNote = new Helianz.UI.ListBox();
			...
			this.listRefusalReason = new Helianz.UI.ListBox();
			this.label14 = new System.Windows.Forms.Label();
			this.listAction = new Helianz.UI.ListBox();
			...
			this.gridObservations = new Helianz.UI.GridOD();
			this.butUngroupObservations = new Helianz.UI.Button();
			this.butGroupObservations = new Helianz.UI.Button();
			this.butAddObservation = new Helianz.UI.Button();
			this.butSave = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.butNoneProvAdministering = new Helianz.UI.Button();
			this.butNoneProvOrdering = new Helianz.UI.Button();
			this.textDateExpiration = new Helianz.ValidDate();
			this.butPickProvAdministering = new Helianz.UI.Button();
			this.butPickProvOrdering = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// label5
			// 
    ...
    "effect, intollerance, patient declines, specific disease, etc.";
			...
			this.gridObservations.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
			...
			this.gridObservations.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridObservations_CellDoubleClick);
			this.gridObservations.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridObservations_CellClick);
			// 
			...
			// butAddObservation
			// 
			this.butAddObservation.Icon = Helianz.UI.EnumIcons.Add;
