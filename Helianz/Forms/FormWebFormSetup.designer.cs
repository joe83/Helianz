namespace Helianz{
	partial class FormWebFormSetup {
		...
		private void InitializeComponent() {
			...
			this.groupConstructURL = new Helianz.UI.GroupBox();
			...
			this.butCopyToClipboard = new Helianz.UI.Button();
			this.butNavigateTo = new Helianz.UI.Button();
			this.checkDisableTypedSig = new Helianz.UI.CheckBox();
			this.checkAutoFillNameAndBirthdate = new Helianz.UI.CheckBox();
			this.textURLs = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.comboClinic = new Helianz.UI.ComboBoxClinicPicker();
			this.butNextForms = new Helianz.UI.Button();
			this.textNextForms = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textRedirectURL = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.butSavePrefs = new Helianz.UI.Button();
			...
			this.checkDisableSigsPref = new Helianz.UI.CheckBox();
			this.groupPrefs = new Helianz.UI.GroupBox();
			this.label15 = new System.Windows.Forms.Label();
			this.checkAutoFillNameBDPref = new Helianz.UI.CheckBox();
			this.label8 = new System.Windows.Forms.Label();
			this.labelDateFormat = new System.Windows.Forms.Label();
			this.comboDateFormat = new Helianz.UI.ComboBox();
			this.checkEnableAutoDownload = new Helianz.UI.CheckBox();
    ...
    " the office website. Enter the full URL (Example: https://helianz.com) where " +
    ...
    "bSheetDefID";
		...
		private Helianz.UI.GroupBox groupConstructURL;
		...
		private Helianz.UI.CheckBox checkAutoFillNameAndBirthdate;
		private UI.Button butSave;
		private Helianz.UI.CheckBox checkDisableTypedSig;
		private UI.Button butCopyToClipboard;
		private UI.Button butNavigateTo;
		private Helianz.UI.CheckBox checkDisableSigsPref;
		private Helianz.UI.GroupBox groupPrefs;
		private Helianz.UI.CheckBox checkEnableAutoDownload;
