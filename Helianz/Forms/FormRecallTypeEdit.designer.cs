...
namespace Helianz {
	public partial class FormRecallTypeEdit {
		...
		private void InitializeComponent()
		{
			...
			this.groupInterval = new Helianz.UI.GroupBox();
			this.textWeeks = new Helianz.ValidNum();
			this.label7 = new System.Windows.Forms.Label();
			this.textDays = new Helianz.ValidNum();
			this.label6 = new System.Windows.Forms.Label();
			this.textMonths = new Helianz.ValidNum();
			this.label9 = new System.Windows.Forms.Label();
			this.textYears = new Helianz.ValidNum();
			...
			this.butSelectBlockouts = new Helianz.UI.Button();
			this.butAddProc = new Helianz.UI.Button();
			this.textRestrictToBlockouts = new System.Windows.Forms.TextBox();
			this.listTriggers = new Helianz.UI.ListBox();
			this.labelTriggers = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.comboSpecial = new Helianz.UI.ComboBox();
			this.labelSpecial = new System.Windows.Forms.Label();
			this.butRemoveTrigger = new Helianz.UI.Button();
			this.butAddTrigger = new Helianz.UI.Button();
			...
			this.groupAgeLimit = new Helianz.UI.GroupBox();
			this.textRecallAgeAdult = new Helianz.ValidNum();
			this.label8 = new System.Windows.Forms.Label();
			this.label17 = new System.Windows.Forms.Label();
			this.checkAppendToSpecial = new Helianz.UI.CheckBox();
			...
			// butRemoveTrigger
			// 
			this.butRemoveTrigger.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			// butAddTrigger
			// 
			this.butAddTrigger.Icon = Helianz.UI.EnumIcons.Add;
    ...
    "pe.";
		...
		private Helianz.UI.GroupBox groupInterval;
		...
		private Helianz.UI.Button butRemoveProc;
		private Helianz.UI.Button butAddProc;
		private Helianz.UI.Button butRemoveTrigger;
		private Helianz.UI.Button butAddTrigger;
		private Helianz.UI.ListBox listTriggers;
		private Label labelTriggers;
		private Label label3;
		private Helianz.UI.ComboBox comboSpecial;
		private Label labelSpecial;
		private Label labelTriggerDisable;
		private Helianz.UI.Button butDelete;
		private Label label4;
		private Label label5;
		private Helianz.UI.GroupBox groupAgeLimit;
		private ValidNum textRecallAgeAdult;
		private Label label8;
		private Label label17;
		private Helianz.UI.CheckBox checkAppendToSpecial;
