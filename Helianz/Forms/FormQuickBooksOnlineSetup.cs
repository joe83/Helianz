...
namespace Helianz {
	public partial class FormQuickBooksOnlineSetup:FormODBase {
		...
		///<summary>List of deposit accounts selected for use in Helianz.</summary>
		...
		///<summary>List of income accounts selected for use in Helianz.</summary>
		...
		///<summary>List of class refs selected for use in Helianz.</summary>
		...
		private void butAddDepositAccount_Click(object sender,EventArgs e) {
			...
			if(account.Name.Contains(",") || account.Name.Contains("|")) {
				MsgBox.Show(this,"Accounts from QuickBooks Online with names that contain commas or vertical bars cannot be used in Helianz.");
				return;
			}
		...
		private void butAddClass_Click(object sender,EventArgs e) {
			...
			if(classRef.Name.Contains(",") || classRef.Name.Contains("|")) {
				MsgBox.Show(this,"Classes from QuickBooks Online with names that contain commas or vertical bars cannot be used in Helianz.");
				return;
			}
