namespace Helianz{
	partial class FormPaySimpleSetup {
		...
		private void InitializeComponent() {
			...
			this.checkAllowOnlinePayments = new Helianz.UI.CheckBox();
			this.checkPrintReceipt = new Helianz.UI.CheckBox();
			this.comboPaymentTypeACH = new Helianz.UI.ComboBox();
			...
			this.comboPaymentTypeCC = new Helianz.UI.ComboBox();
			...
			this.linkLabel1.Text = "The PaySimple website is at www.paysimple.com/partner/helianzal";
