namespace Helianz {
	partial class FormClaimAttachHistory {
		...
		private void InitializeComponent() {
			...
			this.textAttachmentID = new Helianz.ODtextBox();
			this.butClear = new Helianz.UI.Button();
			this.labelCharCount = new System.Windows.Forms.Label();
			this.buttonDeleteImageAttachments = new Helianz.UI.Button();
			this.SuspendLayout();
			// 
			// gridMain
			// 
			...
			this.textAttachmentID.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Claim;
