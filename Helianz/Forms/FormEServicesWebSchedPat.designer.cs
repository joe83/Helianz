...
namespace Helianz{
	partial class FormEServicesWebSchedPat {
		...
		private void InitializeComponent() {
			...
			this.checkDoubleBooking = new Helianz.UI.CheckBox();
			this.checkAllowProvSelection = new Helianz.UI.CheckBox();
			this.checkNewPatForcePhoneFormatting = new Helianz.UI.CheckBox();
			this.labelWebSchedNewPatConfirmStatus = new System.Windows.Forms.Label();
			this.groupBox13 = new Helianz.UI.GroupBox();
			this.textApptMessage = new System.Windows.Forms.TextBox();
			this.groupBox11 = new Helianz.UI.GroupBox();
			this.butWSNPRestrictedToReasonsEdit = new Helianz.UI.Button();
			this.labelWSNPRestrictedToReasons = new System.Windows.Forms.Label();
			this.listboxRestrictedToReasons = new Helianz.UI.ListBox();
			this.listboxIgnoreBlockoutTypes = new Helianz.UI.ListBox();
			this.label33 = new System.Windows.Forms.Label();
			this.butWebSchedBlockouts = new Helianz.UI.Button();
			this.gridApptOps = new Helianz.UI.GridOD();
			...
			this.comboClinics = new Helianz.UI.ComboBox();
			this.comboDefApptType = new Helianz.UI.ComboBox();
			this.butWebSchedNewPatApptsToday = new Helianz.UI.Button();
			this.gridApptTimeSlots = new Helianz.UI.GridOD();
			this.textApptsDateStart = new Helianz.ValidDate();
			this.gridReasons = new Helianz.UI.GridOD();
			this.label40 = new System.Windows.Forms.Label();
			this.groupOtherSettings = new Helianz.UI.GroupBox();
			this.butInsRules = new Helianz.UI.Button();
			this.checkAllowDisabledRecalls = new Helianz.UI.CheckBox();
			this.textRecallDisplayName = new System.Windows.Forms.TextBox();
			this.labelRecallDisplayName = new System.Windows.Forms.Label();
			this.butNotify = new Helianz.UI.Button();
			this.comboConfirmStatuses = new Helianz.UI.ComboBox();
			this.textApptSearchDays = new Helianz.ValidNum();
			this.butEditReasons = new Helianz.UI.Button();
			this.butEditOps = new Helianz.UI.Button();
			...
			this.listboxRestrictedToReasons.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.listboxIgnoreBlockoutTypes.SelectionMode = Helianz.UI.SelectionMode.None;
			...
			this.gridApptOps.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridApptTimeSlots.SelectionMode = Helianz.UI.GridSelectionMode.None;
			...
			this.gridReasons.SelectionMode = Helianz.UI.GridSelectionMode.None;
		...
		private Helianz.UI.CheckBox checkDoubleBooking;
		private Helianz.UI.CheckBox checkAllowProvSelection;
		private Helianz.UI.CheckBox checkNewPatForcePhoneFormatting;
		private UI.ComboBox comboConfirmStatuses;
		private System.Windows.Forms.Label labelWebSchedNewPatConfirmStatus;
		private Helianz.UI.GroupBox groupBox13;
		private System.Windows.Forms.TextBox textApptMessage;
		private Helianz.UI.GroupBox groupBox11;
		...
		private Helianz.UI.GroupBox groupOtherSettings;
		...
		private Helianz.UI.CheckBox checkAllowDisabledRecalls;
	}
}