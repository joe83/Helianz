...
namespace Helianz {
	public partial class FormProvEdit {
		...
		private void InitializeComponent(){
			...
			this.gridProvIdent = new Helianz.UI.GridOD();
			this.butAdd = new Helianz.UI.Button();
			this.butDelete = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.comboSchoolClass = new Helianz.UI.ComboBox();
			this.labelSchoolClass = new System.Windows.Forms.Label();
			this.checkIsInstructor = new Helianz.UI.CheckBox();
			...
			this.tabControlProvider = new Helianz.UI.TabControl();
			this.tabGeneral = new Helianz.UI.TabPage();
			this.textPreferredName = new System.Windows.Forms.TextBox();
			this.label25 = new System.Windows.Forms.Label();
			this.odColorPickerOutline = new Helianz.UI.ODColorPicker();
			this.odColorPickerAppt = new Helianz.UI.ODColorPicker();
			this.groupClinicOverrides = new Helianz.UI.GroupBox();
			this.label15 = new System.Windows.Forms.Label();
			this.butClinicOverrides = new Helianz.UI.Button();
			...
			this.checkAllowLegacy = new Helianz.UI.CheckBox();
			this.labelTermDate = new System.Windows.Forms.Label();
			this.textProdGoalHr = new Helianz.ValidDouble();
			this.labelProdGoalHr = new System.Windows.Forms.Label();
			this.textBirthdate = new Helianz.ValidDate();
			this.label22 = new System.Windows.Forms.Label();
			this.textSchedRules = new System.Windows.Forms.TextBox();
			this.labelSchedRules = new System.Windows.Forms.Label();
			this.checkUseErx = new Helianz.UI.CheckBox();
			this.checkIsHiddenOnReports = new Helianz.UI.CheckBox();
			...
			this.comboEhrMu = new Helianz.UI.ComboBox();
			this.checkIsNotPerson = new Helianz.UI.CheckBox();
			this.textEcwID = new System.Windows.Forms.TextBox();
			this.labelEcwID = new System.Windows.Forms.Label();
			this.checkIsCDAnet = new Helianz.UI.CheckBox();
			this.textTaxonomyOverride = new System.Windows.Forms.TextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.groupAnesthProvType = new Helianz.UI.GroupBox();
			...
			this.checkSigOnFile = new Helianz.UI.CheckBox();
			...
			this.listSpecialty = new Helianz.UI.ListBox();
			this.listFeeSched = new Helianz.UI.ListBox();
			this.checkIsSecondary = new Helianz.UI.CheckBox();
			...
			this.tabSupplementalIDs = new Helianz.UI.TabPage();
			this.tabDentalSchools = new Helianz.UI.TabPage();
			this.tabWebSched = new Helianz.UI.TabPage();
			this.butPictureNone = new Helianz.UI.Button();
			this.butPickPict = new Helianz.UI.Button();
			...
			this.tabClinics = new Helianz.UI.TabPage();
			this.labelClinicsDesc = new System.Windows.Forms.Label();
			this.checkAllClinics = new Helianz.UI.CheckBox();
			this.listBoxClinics = new Helianz.UI.ListBox();
			...
			this.gridProvIdent.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridProvIdent_CellDoubleClick);
			// 
			// butAdd
			// 
    ...
    "e Anesthetic Record.";
        ...
        "Radiology"};
			...
			this.dateTerm.CalendarLocation = Helianz.UI.ODDatePicker.EnumCalendarLocation.ToTheRight;
			...
			this.listBoxClinics.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
		...
		private Helianz.UI.ComboBox comboSchoolClass;
		private System.Windows.Forms.Label labelSchoolClass;
		private Helianz.UI.CheckBox checkIsInstructor;
		...
		private Helianz.UI.TabControl tabControlProvider;
		...
		private Helianz.UI.CheckBox checkUseErx;
		private Helianz.UI.CheckBox checkIsHiddenOnReports;
		...
		private Helianz.UI.ComboBox comboEhrMu;
		private TextBox textStateWhereLicensed;
		private Label label15;
		private Helianz.UI.CheckBox checkIsNotPerson;
		private TextBox textStateRxID;
		private Label label12;
		private TextBox textEcwID;
		private Label labelEcwID;
		private Helianz.UI.CheckBox checkIsCDAnet;
		private TextBox textTaxonomyOverride;
		private Label label4;
		private Helianz.UI.GroupBox groupAnesthProvType;
		...
		private Helianz.UI.CheckBox checkSigOnFile;
		...
		private Helianz.UI.CheckBox checkIsSecondary;
		...
		private Helianz.UI.TabPage tabSupplementalIDs;
		private Helianz.UI.TabPage tabDentalSchools;
		private Helianz.UI.TabPage tabWebSched;
		...
		private Helianz.UI.TabPage tabClinics;
		private Helianz.UI.CheckBox checkAllClinics;
		...
		private Helianz.UI.CheckBox checkAllowLegacy;
		private UI.Button butClinicOverrides;
		private Helianz.UI.GroupBox groupClinicOverrides;
