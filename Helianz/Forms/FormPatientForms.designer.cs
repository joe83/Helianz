namespace Helianz{
	partial class FormPatientForms {
		...
		private void InitializeComponent() {
			...
			this.butPreFill = new Helianz.UI.Button();
			this.butImport = new Helianz.UI.Button();
			this.butTerminal = new Helianz.UI.Button();
			this.butAddSheet = new Helianz.UI.Button();
			this.gridMain = new Helianz.UI.GridOD();
			this.menuMain = new Helianz.UI.MenuOD();
			this.butCopy = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.butAddEForm = new Helianz.UI.Button();
			this.groupSortBy = new Helianz.UI.GroupBox();
			...
			this.butAddSheet.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.butAddEForm.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.Button butAddSheet;
		private Helianz.UI.Button butTerminal;
		private Helianz.UI.Button butImport;
		private System.Windows.Forms.Label label1;
		private Helianz.UI.Button butPreFill;
