...
namespace Helianz {
	public partial class FormClearinghouseEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkAllowAttachSend = new Helianz.UI.CheckBox();
			this.listBoxEraBehavior = new Helianz.UI.ListBox();
			this.checkIsClaimExportAllowed = new Helianz.UI.CheckBox();
			...
			this.textSenderTelephone = new Helianz.ValidPhone();
			...
			this.checkSaveAttachments = new Helianz.UI.CheckBox();
			this.checkSaveDXCSoap = new Helianz.UI.CheckBox();
    ...
    " ID\'s for a default Clearinghouse.";
		...
		private Helianz.UI.CheckBox checkIsClaimExportAllowed;
		private UI.ListBox listBoxEraBehavior;
		private Helianz.UI.CheckBox checkAllowAttachSend;
		private Helianz.UI.CheckBox checkSaveAttachments;
		private Helianz.UI.CheckBox checkSaveDXCSoap;
