namespace Helianz.UI {
	partial class BugSubmissionControl {
		...
		private void InitializeComponent() {
			...
			this.butCompare = new Helianz.UI.Button();
			this.butBugTask = new Helianz.UI.Button();
			this.butGoToAccount = new Helianz.UI.Button();
			this.tabControl1 = new System.Windows.Forms.TabControl();
			this.tabStackTrace = new System.Windows.Forms.TabPage();
			this.textStack = new Helianz.ODtextBox();
			this.tabOdStackSig = new System.Windows.Forms.TabPage();
			this.textODStack = new Helianz.ODtextBox();
			this.tabSimpleStack = new System.Windows.Forms.TabPage();
			this.textStrippedStack = new Helianz.ODtextBox();
			this.tabCategoryTags = new System.Windows.Forms.TabPage();
			this.butDeleteCategory = new Helianz.UI.Button();
			this.butAddCategory = new Helianz.UI.Button();
			this.listBoxCategories = new Helianz.UI.ListBox();
			this.textDevNote = new Helianz.ODtextBox();
			this.gridCustomerSubs = new Helianz.UI.GridOD();
			this.gridOfficeInfo = new Helianz.UI.GridOD();
			...
			this.textStack.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.textODStack.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.textStrippedStack.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.butDeleteCategory.Icon = Helianz.UI.EnumIcons.DeleteX;
			...
			this.butAddCategory.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.textDevNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.JobManager;
			...
			this.gridCustomerSubs.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomerSubs_CellDoubleClick);
			this.gridCustomerSubs.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridCustomerSubs_CellClick);
			// 
			// gridOfficeInfo
			// 
			...
			this.gridOfficeInfo.SelectionMode = Helianz.UI.GridSelectionMode.MultiExtended;
		...
		private Helianz.UI.ListBox listBoxCategories;
