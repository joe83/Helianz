namespace Helianz {
	partial class UserControlSecurityUserGroup {
		...
		private void InitializeComponent() {
			...
			this.tabPageUsers = new Helianz.UI.TabPage();
			this.panelUserGroups = new Helianz.UI.PanelOD();
			this.butCopyUser = new Helianz.UI.Button();
			this.labelUserCurr = new System.Windows.Forms.Label();
			this.listUserTabUserGroups = new Helianz.UI.ListBox();
			this.butAddUser = new Helianz.UI.Button();
			this.labelUserTabUserGroups = new System.Windows.Forms.Label();
			this.gridUsers = new Helianz.UI.GridOD();
			...
			this.comboShowOnly = new Helianz.UI.ComboBox();
			this.comboClinic = new Helianz.UI.ComboBox();
			this.textPowerSearch = new System.Windows.Forms.TextBox();
			this.labelClinic = new System.Windows.Forms.Label();
			this.comboGroups = new Helianz.UI.ComboBox();
			...
			this.tabPageUserGroups = new Helianz.UI.TabPage();
			this.butSetNone = new Helianz.UI.Button();
			this.butExpandAll = new Helianz.UI.Button();
			this.butCollapseAll = new Helianz.UI.Button();
			this.butEditGroup = new Helianz.UI.Button();
			this.butSetAll = new Helianz.UI.Button();
			this.butAddGroup = new Helianz.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.userControlSecurityTree = new Helianz.UserControlSecurityTree();
			this.listAssociatedUsers = new Helianz.UI.ListBox();
			this.label4 = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this.listUserGroupTabUserGroups = new Helianz.UI.ListBox();
			...
			this.listUserTabUserGroups.SelectionMode = Helianz.UI.SelectionMode.MultiExtended;
			...
			this.gridUsers.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridUsers_CellDoubleClick);
			this.gridUsers.CellClick += new Helianz.UI.ODGridClickEventHandler(this.gridUsers_CellClick);
			// 
			// securityTreeUser
			// 
			...
			this.butEditGroup.Image = global::Helianz.Properties.Resources.editPencil;
			...
			this.butAddGroup.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.userControlSecurityTree.ReportPermissionChecked += new Helianz.UserControlSecurityTree.SecurityTreeEventHandler(this.securityTreeUserGroup_ReportPermissionChecked);
			this.userControlSecurityTree.GroupPermissionChecked += new Helianz.UserControlSecurityTree.SecurityTreeEventHandler(this.securityTreeUserGroup_GroupPermissionChecked);
			this.userControlSecurityTree.AdjustmentTypeDenyPermissionChecked += new Helianz.UserControlSecurityTree.SecurityTreeEventHandler(this.securityTreeUserGroup_AdjustmentTypeDenyPermissionChecked);
			// 
			// listAssociatedUsers
			// 
			...
			this.listAssociatedUsers.SelectionMode = Helianz.UI.SelectionMode.None;
		...
		private Helianz.UI.TabPage tabPageUserGroups;
		...
		private Helianz.UI.TabPage tabPageUsers;
