...
namespace Helianz {
	public partial class DashToothChart:PictureBox,IDashWidgetField {
		...
		private Image GetToothChart(Patient pat,TreatPlan treatPlan,List<Procedure> listProcs=null,List<Appointment> listAppts=null) {
			...
			List<Procedure> listProcsFiltered=HelianzBusiness.SheetPrinting.FilterProceduresForToothChart(listProcs,treatPlan,true);
		...
		public void RefreshView() {
			...
			HelianzBusiness.SheetPrinting.DrawScaledImage(0,0,Width,Height,g,null,_imgToothChart);
			Image?.Dispose();
			Image=img;
		}
	}
