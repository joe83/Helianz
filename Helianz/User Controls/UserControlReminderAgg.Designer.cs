namespace Helianz {
	partial class UserControlReminderAgg {
		...
		private void InitializeComponent() {
			this.tabTemplates = new Helianz.UI.TabControl();
			this.tabEmailTemplate = new Helianz.UI.TabPage();
			this.groupBoxEmailSubjAggShared = new Helianz.UI.GroupBox();
			this.labelEmailSubjAggShared = new System.Windows.Forms.Label();
			this.textEmailSubjAggShared = new Helianz.ODtextBox();
			this.groupBoxEmailAggShared = new Helianz.UI.GroupBox();
			this.butEditEmail = new Helianz.UI.Button();
			this.browserEmailBody = new System.Windows.Forms.WebBrowser();
			this.labelEmailAggShared = new System.Windows.Forms.Label();
			this.groupBoxEmailAggPerAppt = new Helianz.UI.GroupBox();
			this.labelEmailAggPerAppt = new System.Windows.Forms.Label();
			this.textEmailAggPerAppt = new Helianz.ODtextBox();
			this.tabSMSTemplate = new Helianz.UI.TabPage();
			this.groupBoxSMSAggPerAppt = new Helianz.UI.GroupBox();
			this.labelSMSAggPerAppt = new System.Windows.Forms.Label();
			this.textSMSAggPerAppt = new Helianz.ODtextBox();
			this.groupBoxSMSAggShared = new Helianz.UI.GroupBox();
			this.labelSMSAggShared = new System.Windows.Forms.Label();
			this.textSMSAggShared = new Helianz.ODtextBox();
			this.tabAutoReplyTemplate = new Helianz.UI.TabPage();
			this.groupAggregateAutoReplyTemplate = new Helianz.UI.GroupBox();
			this.labelAggregateAutoReply = new System.Windows.Forms.Label();
			this.textAggregateAutoReply = new Helianz.ODtextBox();
			this.groupAutoReplySingle = new Helianz.UI.GroupBox();
			this.labelSingleAutoReply = new System.Windows.Forms.Label();
			this.textSingleAutoReply = new Helianz.ODtextBox();
			this.tabArrivalTemplate = new Helianz.UI.TabPage();
			this.groupArrivedReply = new Helianz.UI.GroupBox();
			this.label2 = new System.Windows.Forms.Label();
			this.textArrivalResponse = new Helianz.ODtextBox();
			this.groupComeIn = new Helianz.UI.GroupBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textComeIn = new Helianz.ODtextBox();
			this.groupBoxTags = new Helianz.UI.GroupBox();
			...
			this.textEmailSubjAggShared.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
    ...
    "essage.";
			...
			this.textEmailAggPerAppt.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
    ...
    "essage.";
			...
			this.textSMSAggPerAppt.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
			...
			this.textSMSAggShared.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
			...
			this.textAggregateAutoReply.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
			...
			this.textSingleAutoReply.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
    ...
    " disable.";
			...
			this.textArrivalResponse.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
    ...
    " appointment.";
			...
			this.textComeIn.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TxtMsg;
		...
		private Helianz.UI.TabControl tabTemplates;
		private Helianz.UI.TabPage tabEmailTemplate;
		private Helianz.UI.GroupBox groupBoxEmailSubjAggShared;
		private System.Windows.Forms.Label labelEmailSubjAggShared;
		private ODtextBox textEmailSubjAggShared;
		private Helianz.UI.GroupBox groupBoxEmailAggShared;
		...
		private Helianz.UI.GroupBox groupBoxEmailAggPerAppt;
		private System.Windows.Forms.Label labelEmailAggPerAppt;
		private ODtextBox textEmailAggPerAppt;
		private Helianz.UI.TabPage tabSMSTemplate;
		private Helianz.UI.GroupBox groupBoxSMSAggPerAppt;
		private System.Windows.Forms.Label labelSMSAggPerAppt;
		private ODtextBox textSMSAggPerAppt;
		private Helianz.UI.GroupBox groupBoxSMSAggShared;
		private System.Windows.Forms.Label labelSMSAggShared;
		private ODtextBox textSMSAggShared;
		private Helianz.UI.TabPage tabAutoReplyTemplate;
		private Helianz.UI.GroupBox groupAggregateAutoReplyTemplate;
		private System.Windows.Forms.Label labelAggregateAutoReply;
		private ODtextBox textAggregateAutoReply;
		private Helianz.UI.GroupBox groupAutoReplySingle;
		private System.Windows.Forms.Label labelSingleAutoReply;
		private ODtextBox textSingleAutoReply;
		private Helianz.UI.GroupBox groupBoxTags;
		private System.Windows.Forms.Label labelTags;
		private Helianz.UI.TabPage tabArrivalTemplate;
		private Helianz.UI.GroupBox groupArrivedReply;
		private System.Windows.Forms.Label label2;
		private ODtextBox textArrivalResponse;
		private Helianz.UI.GroupBox groupComeIn;
