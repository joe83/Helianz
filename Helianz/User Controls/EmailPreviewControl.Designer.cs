namespace Helianz {
	partial class EmailPreviewControl {
		...
		private void InitializeComponent() {
			...
			this.butAddFile = new Helianz.UI.Button();
			this.butAccountPicker = new Helianz.UI.Button();
			this.tabAttachmentsShowEmail = new Helianz.UI.TabControl();
			this.tabAttachments = new Helianz.UI.TabPage();
			this.gridAttachments = new Helianz.UI.GridOD();
			this.tabShowEmail = new Helianz.UI.TabPage();
			this.listShowIn = new Helianz.UI.ListBox();
			this.textBccAddress = new Helianz.ODtextBox();
			this.textCcAddress = new Helianz.ODtextBox();
			this.butShowImages = new Helianz.UI.Button();
			this.textSubject = new Helianz.ODtextBox();
			this.textSignedBy = new Helianz.ODtextBox();
			this.textToAddress = new Helianz.ODtextBox();
			this.textFromAddress = new Helianz.ODtextBox();
			this.butSig = new Helianz.UI.Button();
			this.webBrowser = new System.Windows.Forms.WebBrowser();
			this.textBodyText = new Helianz.ODtextBox();
			this.butAddImage = new Helianz.UI.Button();
			...
			this.butAddFile.Icon = Helianz.UI.EnumIcons.Add;
			...
			this.gridAttachments.CellDoubleClick += new Helianz.UI.ODGridClickEventHandler(this.gridAttachments_CellDoubleClick);
			...
			this.textBccAddress.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textCcAddress.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textSubject.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textSignedBy.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textToAddress.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textFromAddress.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.textBodyText.QuickPasteType = HelianzBusiness.EnumQuickPasteType.Email;
			...
			this.butAddImage.Icon = Helianz.UI.EnumIcons.Add;
		...
		private Helianz.UI.TabControl tabAttachmentsShowEmail;
		private Helianz.UI.TabPage tabAttachments;
		private Helianz.UI.TabPage tabShowEmail;
		private Helianz.UI.ListBox listShowIn;
