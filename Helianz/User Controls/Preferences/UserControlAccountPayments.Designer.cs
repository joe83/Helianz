...
namespace Helianz {
	partial class UserControlAccountPayments {
		...
		private void InitializeComponent() {
			this.groupBoxUnearnedIncome = new Helianz.UI.GroupBox();
			this.checkShowAllocateUnearnedPaymentPrompt = new Helianz.UI.CheckBox();
			this.checkAllowPrepayProvider = new Helianz.UI.CheckBox();
			this.comboUnallocatedSplits = new Helianz.UI.ComboBox();
			this.label28 = new System.Windows.Forms.Label();
			this.groupBoxPayPlans = new Helianz.UI.GroupBox();
			this.checkPayPlanRequireLockForAPR = new Helianz.UI.CheckBox();
			this.checkPayPlansExcludePastActivity = new Helianz.UI.CheckBox();
			this.labelTermsAndConditions = new System.Windows.Forms.Label();
			this.butPayPlanTermsAndConditions = new Helianz.UI.Button();
			this.checkPayPlansUseSheets = new Helianz.UI.CheckBox();
			this.checkPayPlanSaveSignedPdf = new Helianz.UI.CheckBox();
			this.label39 = new System.Windows.Forms.Label();
			this.comboPayPlansVersion = new Helianz.UI.ComboBox();
			this.comboDppUnearnedType = new Helianz.UI.ComboBox();
			this.checkHideDueNow = new Helianz.UI.CheckBox();
			this.label59 = new System.Windows.Forms.Label();
			this.label27 = new System.Windows.Forms.Label();
			this.textDynamicPayPlan = new Helianz.ValidTime();
			this.groupBoxPayments = new Helianz.UI.GroupBox();
			this.checkOnlinePaymentsMarkAsProcessed = new Helianz.UI.CheckBox();
			this.checkStoreCCTokens = new Helianz.UI.CheckBox();
			this.checkPaymentCompletedDisableMerchantButtons = new Helianz.UI.CheckBox();
			this.comboPaymentClinicSetting = new Helianz.UI.ComboBox();
			this.checkIncTxfrTreatNegProdAsIncome = new Helianz.UI.CheckBox();
			this.label38 = new System.Windows.Forms.Label();
			this.checkAllowEmailCCReceipt = new Helianz.UI.CheckBox();
			this.checkPaymentsPromptForPayType = new Helianz.UI.CheckBox();
			this.checkPayPlanItemDateShowProc = new Helianz.UI.CheckBox();
		...
		#endregion
		private Helianz.UI.CheckBox checkPaymentCompletedDisableMerchantButtons;
		private Helianz.UI.CheckBox checkIncTxfrTreatNegProdAsIncome;
		private Helianz.UI.CheckBox checkStoreCCTokens;
		private UI.ComboBox comboPaymentClinicSetting;
		private System.Windows.Forms.Label label38;
		private Helianz.UI.CheckBox checkPaymentsPromptForPayType;
		private Helianz.UI.CheckBox checkAllowPrepayProvider;
		private UI.ComboBox comboUnallocatedSplits;
		private System.Windows.Forms.Label label28;
		private Helianz.UI.CheckBox checkAllowEmailCCReceipt;
		...
		private Helianz.UI.CheckBox checkPayPlansExcludePastActivity;
		private Helianz.UI.CheckBox checkPayPlanSaveSignedPdf;
		private Helianz.UI.CheckBox checkPayPlansUseSheets;
		private System.Windows.Forms.Label label39;
		private Helianz.UI.CheckBox checkHideDueNow;
		...
		private Helianz.UI.CheckBox checkShowAllocateUnearnedPaymentPrompt;
		private UI.GroupBox groupBoxUnearnedIncome;
		private Helianz.UI.CheckBox checkOnlinePaymentsMarkAsProcessed;
