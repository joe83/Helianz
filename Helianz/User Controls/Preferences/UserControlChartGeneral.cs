...
namespace Helianz {
	public partial class UserControlChartGeneral:UserControl {
		...
		private void linkLabelIsAlertRadiologyProcsEnabledDetails_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://helianz.com/manual/ehrcpoeradapprove.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://helianz.com/manual/ehrcpoeradapprove.html"+"\r\n"
