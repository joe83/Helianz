...
namespace Helianz {
	partial class UserControlAccountClaimReceive {
		...
		private void InitializeComponent() {
			...
			this.checkClaimMedReceivedPromptForPrimaryClaim = new Helianz.UI.CheckBox();
			this.checkClaimMedReceivedForcePrimaryStatus = new Helianz.UI.CheckBox();
			this.groupBoxClaimsPayments = new Helianz.UI.GroupBox();
			this.comboClaimCredit = new Helianz.UI.ComboBox();
			this.checkClaimPaymentPickStatementType = new Helianz.UI.CheckBox();
			this.checkNoInitialPrimaryInsMoreThanProc = new Helianz.UI.CheckBox();
			this.checkAllowProcAdjFromClaim = new Helianz.UI.CheckBox();
			this.checkInsPayNoWriteoffMoreThanProc = new Helianz.UI.CheckBox();
			this.labelClaimCredit = new System.Windows.Forms.Label();
			this.groupBoxOD2 = new Helianz.UI.GroupBox();
			this.checkClaimPrimaryReceivedRecalcSecondary = new Helianz.UI.CheckBox();
			this.checkClaimFinalizeWarning = new Helianz.UI.CheckBox();
			this.checkInsAutoReceiveNoAssign = new Helianz.UI.CheckBox();
			this.checkShowClaimPatResp = new Helianz.UI.CheckBox();
			this.checkPromptForSecondaryClaim = new Helianz.UI.CheckBox();
			this.checkClaimPrimaryRecievedForceSecondaryStatus = new Helianz.UI.CheckBox();
			this.checkProviderIncomeShows = new Helianz.UI.CheckBox();
			this.checkShowClaimPayTracking = new Helianz.UI.CheckBox();
			this.checkInsEstRecalcReceived = new Helianz.UI.CheckBox();
			this.checkClaimTrackingExcludeNone = new Helianz.UI.CheckBox();
    ...
    "";
		...
		#endregion
		private Helianz.UI.CheckBox checkClaimPrimaryRecievedForceSecondaryStatus;
		private Helianz.UI.CheckBox checkShowClaimPayTracking;
		private Helianz.UI.CheckBox checkShowClaimPatResp;
		private Helianz.UI.CheckBox checkInsEstRecalcReceived;
		private Helianz.UI.CheckBox checkPromptForSecondaryClaim;
		private Helianz.UI.CheckBox checkInsPayNoWriteoffMoreThanProc;
		private Helianz.UI.CheckBox checkClaimTrackingExcludeNone;
		private System.Windows.Forms.Label labelClaimCredit;
		private UI.ComboBox comboClaimCredit;
		private Helianz.UI.CheckBox checkAllowProcAdjFromClaim;
		private Helianz.UI.CheckBox checkProviderIncomeShows;
		private UI.GroupBox groupBoxOD2;
		private UI.GroupBox groupBoxClaimsPayments;
		private Helianz.UI.CheckBox checkNoInitialPrimaryInsMoreThanProc;
		private Helianz.UI.CheckBox checkInsAutoReceiveNoAssign;
		private Helianz.UI.CheckBox checkClaimPaymentPickStatementType;
