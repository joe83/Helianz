...
namespace Helianz {
	partial class UserControlChartGeneral {
		...
		private void InitializeComponent() {
			this.checkBoxRxClinicUseSelected = new Helianz.UI.CheckBox();
			this.checkChartOrthoTabAutomaticCheckboxes = new Helianz.UI.CheckBox();
			this.groupBoxFunctionality = new Helianz.UI.GroupBox();
			this.comboProcCodeListSort = new Helianz.UI.ComboBox();
			this.comboToothNomenclature = new Helianz.UI.ComboBox();
			this.textMedDefaultStopDays = new System.Windows.Forms.TextBox();
			this.checkAutoClearEntryStatus = new Helianz.UI.CheckBox();
			this.checkProvColorChart = new Helianz.UI.CheckBox();
			this.label32 = new System.Windows.Forms.Label();
			this.labelToothNomenclature = new System.Windows.Forms.Label();
			this.checkIsAlertRadiologyProcsEnabled = new Helianz.UI.CheckBox();
			this.label11 = new System.Windows.Forms.Label();
			this.checkScreeningsUseSheets = new Helianz.UI.CheckBox();
			this.groupBoxPerio = new Helianz.UI.GroupBox();
			this.checkPerioSkipMissingTeeth = new Helianz.UI.CheckBox();
			this.checkPerioTreatImplantsAsNotMissing = new Helianz.UI.CheckBox();
			this.groupBoxAppointments = new Helianz.UI.GroupBox();
			this.checkChartNonPatientWarn = new Helianz.UI.CheckBox();
			this.checkShowPlannedApptPrompt = new Helianz.UI.CheckBox();
			this.groupBoxMedicalHistory = new Helianz.UI.GroupBox();
			...
			this.butProblemsIndicateNone = new Helianz.UI.Button();
			this.butAllergiesIndicateNone = new Helianz.UI.Button();
			this.butMedicationsIndicateNone = new Helianz.UI.Button();
			this.groupBoxMedicalCodes = new Helianz.UI.GroupBox();
			this.textICD9DefaultForNewProcs = new System.Windows.Forms.TextBox();
			this.checkMedicalFeeUsedForNewProcs = new Helianz.UI.CheckBox();
			this.checkDxIcdVersion = new Helianz.UI.CheckBox();
    ...
    "ction of Ortho tab ";
			...
			this.checkIsAlertRadiologyProcsEnabled.Text = "HelianzService alerts for scheduled non-CPOE radiology procedures";
			// 
			// label11
			// 
		...
		private Helianz.UI.CheckBox checkChartNonPatientWarn;
		...
		private Helianz.UI.CheckBox checkScreeningsUseSheets;
		private UI.Button butDiagnosisCode;
		private UI.Button butAllergiesIndicateNone;
		private Helianz.UI.CheckBox checkDxIcdVersion;
		private Helianz.UI.CheckBox checkMedicalFeeUsedForNewProcs;
		private Helianz.UI.CheckBox checkShowPlannedApptPrompt;
		private Helianz.UI.CheckBox checkIsAlertRadiologyProcsEnabled;
		private Helianz.UI.CheckBox checkBoxRxClinicUseSelected;
		...
		private Helianz.UI.CheckBox checkPerioTreatImplantsAsNotMissing;
		private Helianz.UI.CheckBox checkAutoClearEntryStatus;
		private Helianz.UI.CheckBox checkPerioSkipMissingTeeth;
		private Helianz.UI.CheckBox checkProvColorChart;
		...
		private Helianz.UI.CheckBox checkChartOrthoTabAutomaticCheckboxes;
	}
}
