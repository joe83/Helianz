...
namespace Helianz {
	partial class UserControlImagingGeneral {
		...
		private void InitializeComponent() {
			...
			this.checkImagingOrderDescending = new Helianz.UI.CheckBox();
			this.checkPDFLaunchWindow = new Helianz.UI.CheckBox();
			this.checkImagesModuleUsesOld2020 = new Helianz.UI.CheckBox();
			this.groupImport = new Helianz.UI.GroupBox();
			...
			this.butBrowseDefaultImageImportFolder = new Helianz.UI.Button();
			this.butBrowseAutoImportFolder = new Helianz.UI.Button();
			this.butVideoImageCategoryDefault = new Helianz.UI.Button();
			this.label41 = new System.Windows.Forms.Label();
			this.labelDefaultImageCategory = new System.Windows.Forms.Label();
			this.butBrowseImageCategoryDefault = new Helianz.UI.Button();
			this.groupBoxOD2 = new Helianz.UI.GroupBox();
			this.textDecimals = new Helianz.ValidNum();
			this.textScale = new Helianz.ValidDouble();
			...
			// 
			this.groupBoxFunctionality.Controls.Add(this.checkImagingOrderDescending);
			...
			this.groupBoxFunctionality.Size = new System.Drawing.Size(450, 98);
			this.groupBoxFunctionality.TabIndex = 320;
			this.groupBoxFunctionality.Text = "Functionality";
			// 
			// checkImagingOrderDescending
			// 
			this.checkImagingOrderDescending.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkImagingOrderDescending.Location = new System.Drawing.Point(5, 72);
			this.checkImagingOrderDescending.Name = "checkImagingOrderDescending";
			this.checkImagingOrderDescending.Size = new System.Drawing.Size(435, 17);
			this.checkImagingOrderDescending.TabIndex = 317;
			this.checkImagingOrderDescending.Text = "Sort images by date descending";
			// 
			...
			// label61
			// 
			this.label61.Location = new System.Drawing.Point(46, 13);
			...
			// label41
			// 
			this.label41.Location = new System.Drawing.Point(56, 115);
			...
			// 
			this.labelDefaultImageCategory.Location = new System.Drawing.Point(95, 81);
			...
			this.groupBoxOD2.Location = new System.Drawing.Point(20, 310);
			...
			this.label34.Location = new System.Drawing.Point(267, 44);
			...
			this.label35.Location = new System.Drawing.Point(273, 18);
			...
			this.label36.Location = new System.Drawing.Point(291, 70);
		...
		#endregion
		private Helianz.UI.CheckBox checkImagesModuleUsesOld2020;
		...
		private Helianz.UI.CheckBox checkPDFLaunchWindow;
		...
		private UI.CheckBox checkImagingOrderDescending;
	}
}
