...
namespace Helianz {
	partial class UserControlMainWindowMisc {
		...
		private void InitializeComponent() {
			...
			this.checkBackupIndexesDisabled = new Helianz.UI.CheckBox();
			this.textAuditEntries = new Helianz.ValidNum();
			this.comboTrackClinic = new Helianz.UI.ComboBox();
			this.textAlertCloudSessions = new Helianz.ValidNum();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.textLanguageAndRegion = new System.Windows.Forms.TextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.butLanguages = new Helianz.UI.Button();
			this.checkImeCompositionCompatibility = new Helianz.UI.CheckBox();
			this.label6 = new System.Windows.Forms.Label();
			this.butPickLanguageAndRegion = new Helianz.UI.Button();
			...
			this.textInactiveAlert = new Helianz.ValidNum();
			this.textAlertInterval = new Helianz.ValidNum();
			this.label3 = new System.Windows.Forms.Label();
			this.label5 = new System.Windows.Forms.Label();
			this.label11 = new System.Windows.Forms.Label();
			this.label10 = new System.Windows.Forms.Label();
			this.checkAuditTrailUseReportingServer = new Helianz.UI.CheckBox();
			this.checkSubmitExceptions = new Helianz.UI.CheckBox();
			this.butClearCode = new Helianz.UI.Button();
			this.butDecimal = new Helianz.UI.Button();
