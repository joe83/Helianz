...
namespace Helianz {
	partial class UserControlEnterpriseAccount {
		...
		private void InitializeComponent() {
			this.checkAgingCalculateOnBatchClaimReceipt = new Helianz.UI.CheckBox();
			this.label13 = new System.Windows.Forms.Label();
			this.label27 = new System.Windows.Forms.Label();
			this.checkAgingReportShowAgePatPayplanPayments = new Helianz.UI.CheckBox();
			this.textBillingElectBatchMax = new Helianz.ValidNum();
			this.comboPayPlansVersion = new Helianz.UI.ComboBox();
			this.checkClaimReportReceivedByService = new Helianz.UI.CheckBox();
			this.comboRigorousAdjustments = new Helianz.UI.ComboBox();
			this.checkPaymentWindowDefaultHideSplits = new Helianz.UI.CheckBox();
			...
			this.comboRigorousAccounting = new Helianz.UI.ComboBox();
			this.label39 = new System.Windows.Forms.Label();
			this.checkBillingShowTransSinceBalZero = new Helianz.UI.CheckBox();
			this.labelReportheckUnits = new System.Windows.Forms.Label();
			this.textAgingServiceTimeDue = new Helianz.ValidDate();
			...
			this.textClaimReportReceiveTime = new Helianz.ValidTime();
