...
namespace Helianz {
	partial class UserControlAccountClaimSend {
		...
		private void InitializeComponent() {
			...
			this.groupBoxClaimsMedical = new Helianz.UI.GroupBox();
			this.checkClaimMedTypeIsInstWhenInsPlanIsMedical = new Helianz.UI.CheckBox();
			this.checkEclaimsMedicalProvTreatmentAsOrdering = new Helianz.UI.CheckBox();
			this.groupBoxOD1 = new Helianz.UI.GroupBox();
			this.textClaimAttachPath = new System.Windows.Forms.TextBox();
			this.comboZeroDollarProcClaimBehavior = new Helianz.UI.ComboBox();
			this.checkEclaimsSubscIDUsesPatID = new Helianz.UI.CheckBox();
			this.checkPpoUseUcr = new Helianz.UI.CheckBox();
			this.checkClaimFormTreatDentSaysSigOnFile = new Helianz.UI.CheckBox();
			this.labelClaimAttachmentExportPath = new System.Windows.Forms.Label();
			this.checkEclaimsSeparateTreatProv = new Helianz.UI.CheckBox();
			this.labelCreatingClaimsZeroProcedures = new System.Windows.Forms.Label();
			this.checkPriClaimAllowSetToHoldUntilPriReceived = new Helianz.UI.CheckBox();
			this.groupBoxClaimIdPrefix = new Helianz.UI.GroupBox();
			this.butReplacements = new Helianz.UI.Button();
			this.textClaimIdPrefix = new System.Windows.Forms.TextBox();
			this.checkClaimsValidateACN = new Helianz.UI.CheckBox();
			this.checkCanadianPpoLabEst = new Helianz.UI.CheckBox();
			this.checkClaimEditRequireNoMissingData = new Helianz.UI.CheckBox();
			...
			// 
			this.textInsWriteoffDescript.Location = new System.Drawing.Point(330, 324);
			...
			// label17
			// 
			this.label17.Location = new System.Drawing.Point(75, 326);
			...
			this.groupBoxClaimsMedical.Location = new System.Drawing.Point(20, 266);
			...
			// groupBoxOD1
			// 
			this.groupBoxOD1.Controls.Add(this.checkClaimEditRequireNoMissingData);
			...
			this.groupBoxOD1.Size = new System.Drawing.Size(450, 251);
			...
			this.groupBoxClaimIdPrefix.Location = new System.Drawing.Point(40, 191);
			...
			this.checkCanadianPpoLabEst.Location = new System.Drawing.Point(93, 346);
			...
			// 
			// checkClaimEditRequireNoMissingData
			// 
			this.checkClaimEditRequireNoMissingData.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkClaimEditRequireNoMissingData.Location = new System.Drawing.Point(30, 169);
			this.checkClaimEditRequireNoMissingData.Name = "checkClaimEditRequireNoMissingData";
			this.checkClaimEditRequireNoMissingData.Size = new System.Drawing.Size(410, 17);
			this.checkClaimEditRequireNoMissingData.TabIndex = 285;
			this.checkClaimEditRequireNoMissingData.Text = "Require claims to have no missing data";
			// 
		...
		#endregion
		private Helianz.UI.CheckBox checkPriClaimAllowSetToHoldUntilPriReceived;
		private Helianz.UI.CheckBox checkCanadianPpoLabEst;
		...
		private Helianz.UI.CheckBox checkClaimFormTreatDentSaysSigOnFile;
		private Helianz.UI.CheckBox checkClaimMedTypeIsInstWhenInsPlanIsMedical;
		private Helianz.UI.CheckBox checkEclaimsMedicalProvTreatmentAsOrdering;
		...
		private Helianz.UI.CheckBox checkClaimsValidateACN;
		private System.Windows.Forms.TextBox textInsWriteoffDescript;
		private System.Windows.Forms.Label label17;
		private UI.GroupBox groupBoxOD1;
		private Helianz.UI.CheckBox checkPpoUseUcr;
		private UI.GroupBox groupBoxClaimsMedical;
		private Helianz.UI.CheckBox checkEclaimsSeparateTreatProv;
		private UI.CheckBox checkEclaimsSubscIDUsesPatID;
		private UI.CheckBox checkClaimEditRequireNoMissingData;
	}
