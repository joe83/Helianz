...
namespace Helianz {
	partial class UserControlEnterpriseGeneral {
		...
		private void InitializeComponent() {
			this.checkDatabaseGlobalVariablesDontSet = new Helianz.UI.CheckBox();
			this.checkEnterpriseCommlogOmitDefaults = new Helianz.UI.CheckBox();
			this.checkEnableEmailAddressAutoComplete = new Helianz.UI.CheckBox();
			this.checkUpdateAlterLargeTablesDirectly = new Helianz.UI.CheckBox();
			this.groupPatientSelect = new Helianz.UI.GroupBox();
			this.checkEnterpriseAllowRefreshWhileTyping = new Helianz.UI.CheckBox();
			this.label2 = new System.Windows.Forms.Label();
			this.textEnterpriseExactMatchPhoneNumDigits = new Helianz.ValidNum();
			this.checkEnterpriseExactMatchPhone = new Helianz.UI.CheckBox();
			this.checkPatientSelectFilterRestrictedClinics = new Helianz.UI.CheckBox();
			this.butSyncPhNums = new Helianz.UI.Button();
			this.checkPatientPhoneUsePhonenumberTable = new Helianz.UI.CheckBox();
			this.checkPatientSelectSearchWithEmptyParams = new Helianz.UI.CheckBox();
			this.labelPatSelectPauseMs = new System.Windows.Forms.Label();
			this.textPatientSelectSearchPauseMs = new Helianz.ValidNum();
			this.labelPatSelectMinChars = new System.Windows.Forms.Label();
			this.textPatientSelectSearchMinChars = new Helianz.ValidNum();
			this.checkUserNameManualEntry = new Helianz.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.checkUpdateStreamlinePassword = new Helianz.UI.CheckBox();
			this.textProcessSigsIntervalInSecs = new Helianz.ValidNum();
			this.textSecurityLogOffAfterMinutes = new System.Windows.Forms.TextBox();
			this.checkDatabaseMaintenanceSkipCheckTable = new Helianz.UI.CheckBox();
			this.checkDatabaseMaintenanceDisableOptimize = new Helianz.UI.CheckBox();
			this.label10 = new System.Windows.Forms.Label();
			this.checkPasswordsMustBeStrong = new Helianz.UI.CheckBox();
			this.textSignalInactiveMinutes = new Helianz.ValidNum();
			this.label12 = new System.Windows.Forms.Label();
			this.checkSecurityLockIncludesAdmin = new Helianz.UI.CheckBox();
			this.checkPasswordsWeakChangeToStrong = new Helianz.UI.CheckBox();
			this.checkPasswordsStrongIncludeSpecial = new Helianz.UI.CheckBox();
			...
			this.checkHasClinicsEnabled = new Helianz.UI.CheckBox();
