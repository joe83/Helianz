...
namespace Helianz {
	partial class UserControlServerConnections {
		...
		private void InitializeComponent() {
			this.checkUseReadOnlyServer = new Helianz.UI.CheckBox();
			this.groupBoxReadOnlyServerSetup = new Helianz.UI.GroupBox();
		...
		private Helianz.UI.CheckBox checkUseReadOnlyServer;
