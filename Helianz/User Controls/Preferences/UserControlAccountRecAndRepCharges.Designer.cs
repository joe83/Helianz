...
namespace Helianz {
	partial class UserControlAccountRecAndRepCharges {
		...
		private void InitializeComponent() {
			...
			this.checkRecurringChargesShowInactive = new Helianz.UI.CheckBox();
			this.checkRecurringChargesInactivateDeclinedCards = new Helianz.UI.CheckBox();
			this.checkRecurPatBal0 = new Helianz.UI.CheckBox();
			this.label56 = new System.Windows.Forms.Label();
			this.comboRecurringChargePayType = new Helianz.UI.ComboBox();
			this.labelRecurringChargesAutomatedTime = new System.Windows.Forms.Label();
			this.textRecurringChargesTime = new Helianz.ValidTime();
			this.checkRecurringChargesAutomated = new Helianz.UI.CheckBox();
			this.checkRecurringChargesUseTransDate = new Helianz.UI.CheckBox();
			this.checkRecurChargPriProv = new Helianz.UI.CheckBox();
			this.groupRepeatingCharges = new Helianz.UI.GroupBox();
			this.labelRepeatingChargesAutomatedTime = new System.Windows.Forms.Label();
			this.textRepeatingChargesAutomatedTime = new Helianz.ValidTime();
			this.checkRepeatingChargesRunAging = new Helianz.UI.CheckBox();
			this.checkRepeatingChargesAutomated = new Helianz.UI.CheckBox();
			...
			this.label56.Location = new System.Drawing.Point(186, 181);
			...
			this.labelRecurringChargesAutomatedTime.Location = new System.Drawing.Point(212, 147);
			...
			this.labelRepeatingChargesAutomatedTime.Location = new System.Drawing.Point(217, 75);
		...
		private Helianz.UI.CheckBox checkRecurringChargesShowInactive;
		private Helianz.UI.CheckBox checkRecurringChargesInactivateDeclinedCards;
		private Helianz.UI.CheckBox checkRecurPatBal0;
		...
		private Helianz.UI.CheckBox checkRecurringChargesAutomated;
		private Helianz.UI.CheckBox checkRecurringChargesUseTransDate;
		private Helianz.UI.CheckBox checkRecurChargPriProv;
		...
		private Helianz.UI.CheckBox checkRepeatingChargesRunAging;
		private Helianz.UI.CheckBox checkRepeatingChargesAutomated;
