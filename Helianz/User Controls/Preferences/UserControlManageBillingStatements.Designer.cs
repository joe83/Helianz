...
namespace Helianz {
	partial class UserControlManageBillingStatements {
		...
		private void InitializeComponent() {
			this.checkStatementsAlphabetically = new Helianz.UI.CheckBox();
			this.label24 = new System.Windows.Forms.Label();
			this.textBillingElectBatchMax = new Helianz.ValidNum();
			this.checkStatementShowAdjNotes = new Helianz.UI.CheckBox();
			this.checkIntermingleDefault = new Helianz.UI.CheckBox();
			this.checkStatementShowReturnAddress = new Helianz.UI.CheckBox();
			this.checkStatementShowProcBreakdown = new Helianz.UI.CheckBox();
			this.checkStatementShowNotes = new Helianz.UI.CheckBox();
			this.label2 = new System.Windows.Forms.Label();
			this.comboUseChartNum = new Helianz.UI.ComboBox();
			this.label10 = new System.Windows.Forms.Label();
			this.label18 = new System.Windows.Forms.Label();
			this.textStatementsCalcDueDate = new Helianz.ValidNum();
			this.textPayPlansBillInAdvanceDays = new Helianz.ValidNum();
			this.groupBoxBilling = new Helianz.UI.GroupBox();
			this.groupBoxStatements = new Helianz.UI.GroupBox();
			...
			this.checkStatementsAlphabetically.Location = new System.Drawing.Point(63, 74);
			...
			this.label24.Location = new System.Drawing.Point(63, 43);
			...
			this.label10.Location = new System.Drawing.Point(114, 137);
			...
			this.label18.Location = new System.Drawing.Point(34, 206);
			...
			this.groupBoxBilling.Size = new System.Drawing.Size(450, 100);
		...
		#endregion
		private Helianz.UI.CheckBox checkStatementsAlphabetically;
		private System.Windows.Forms.Label label24;
		private ValidNum textBillingElectBatchMax;
		private Helianz.UI.CheckBox checkStatementShowAdjNotes;
		private Helianz.UI.CheckBox checkIntermingleDefault;
		private Helianz.UI.CheckBox checkStatementShowReturnAddress;
		private Helianz.UI.CheckBox checkStatementShowProcBreakdown;
		private Helianz.UI.CheckBox checkStatementShowNotes;
