...
namespace Helianz {
	public partial class UserControlTreatPlanGeneral:UserControl {
		...
		private void linkLabelProcDiscountTypeDetails_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://www.helianz.com/manual/treatmentplandiscounts.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://www.helianz.com/manual/treatmentplandiscounts.html"+"\r\n"
		...
		private void linkLabelProcDiscountTypeDetails2_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://helianz.com/manual/definitionsadjtypes.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://helianz.com/manual/definitionsadjtypes.html"+"\r\n"
					+Lan.g(this,"Please set up a default web browser."));
			}
		}
