...
namespace Helianz {
	partial class UserControlEnterpriseAppts {
		...
		private void InitializeComponent() {
			this.checkEnterpriseHygProcUsePriProvFee = new Helianz.UI.CheckBox();
			this.checkEnterpriseNoneApptViewDefaultDisabled = new Helianz.UI.CheckBox();
			this.checkEnterpriseApptList = new Helianz.UI.CheckBox();
