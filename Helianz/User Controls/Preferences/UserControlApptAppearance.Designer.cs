...
namespace Helianz {
	partial class UserControlApptAppearance {
		...
		private void InitializeComponent() {
			...
			this.checkApptExclamation = new Helianz.UI.CheckBox();
			this.comboApptSchedEnforceSpecialty = new Helianz.UI.ComboBox();
			this.checkApptModuleDefaultToWeek = new Helianz.UI.CheckBox();
			this.checkApptSecondaryProviderConsiderOpOnly = new Helianz.UI.CheckBox();
			this.checkApptRefreshEveryMinute = new Helianz.UI.CheckBox();
			this.comboDelay = new Helianz.UI.ComboBox();
			this.apptClickDelay = new System.Windows.Forms.Label();
			this.label45 = new System.Windows.Forms.Label();
			this.comboWeekViewStartDay = new Helianz.UI.ComboBox();
			this.groupBoxBlockouts = new Helianz.UI.GroupBox();
			this.checkReplaceBlockouts = new Helianz.UI.CheckBox();
			this.checkSolidBlockouts = new Helianz.UI.CheckBox();
			this.groupBoxApptBubble = new Helianz.UI.GroupBox();
			this.textApptBubNoteLength = new System.Windows.Forms.TextBox();
			this.label21 = new System.Windows.Forms.Label();
			this.checkApptBubbleDelay = new Helianz.UI.CheckBox();
			this.checkAppointmentBubblesDisabled = new Helianz.UI.CheckBox();
			this.groupBoxAppearance = new Helianz.UI.GroupBox();
			this.label58 = new System.Windows.Forms.Label();
			this.label46 = new System.Windows.Forms.Label();
			this.textApptProvbarWidth = new Helianz.ValidNum();
			...
			this.groupBoxWaitingRoom = new Helianz.UI.GroupBox();
			this.label3 = new System.Windows.Forms.Label();
			this.comboTimeArrived = new Helianz.UI.ComboBox();
			this.comboTimeSeated = new Helianz.UI.ComboBox();
			this.label5 = new System.Windows.Forms.Label();
			this.comboTimeDismissed = new Helianz.UI.ComboBox();
			this.label6 = new System.Windows.Forms.Label();
			this.textWaitRoomWarn = new System.Windows.Forms.TextBox();
			this.label22 = new System.Windows.Forms.Label();
			this.checkWaitingRoomFilterByView = new Helianz.UI.CheckBox();
			...
			this.groupBoxOD1.Controls.Add(this.checkApptSecondaryProviderConsiderOpOnly);
			...
			// 
			this.labelApptSchedEnforceSpecialty.Location = new System.Drawing.Point(29, 32);
			...
			// 
			this.checkApptSecondaryProviderConsiderOpOnly.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.checkApptSecondaryProviderConsiderOpOnly.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkApptSecondaryProviderConsiderOpOnly.Location = new System.Drawing.Point(90, 10);
			this.checkApptSecondaryProviderConsiderOpOnly.Name = "checkApptSecondaryProviderConsiderOpOnly";
			this.checkApptSecondaryProviderConsiderOpOnly.Size = new System.Drawing.Size(350, 17);
			this.checkApptSecondaryProviderConsiderOpOnly.TabIndex = 331;
			...
			this.apptClickDelay.Location = new System.Drawing.Point(19, 93);
			...
			this.label45.Location = new System.Drawing.Point(142, 135);
			...
			this.label58.Location = new System.Drawing.Point(74, 58);
			...
			this.label54.Location = new System.Drawing.Point(16, 36);
			...
			this.label22.Location = new System.Drawing.Point(110, 101);
			...
			this.label23.Location = new System.Drawing.Point(169, 123);
		...
		private Helianz.UI.CheckBox checkAppointmentBubblesDisabled;
		private ValidNum textApptProvbarWidth;
		private Helianz.UI.CheckBox checkSolidBlockouts;
		private System.Windows.Forms.Label label58;
		private Helianz.UI.CheckBox checkApptExclamation;
		private System.Windows.Forms.TextBox textApptFontSize;
		private System.Windows.Forms.Button butApptLineColor;
		private Helianz.UI.CheckBox checkApptBubbleDelay;
		private System.Windows.Forms.Button butColor;
		private System.Windows.Forms.Label label23;
		private UI.ComboBox comboDelay;
		private System.Windows.Forms.Label label25;
		private Helianz.UI.CheckBox checkApptModuleDefaultToWeek;
		private Helianz.UI.CheckBox checkApptRefreshEveryMinute;
		...
		private Helianz.UI.CheckBox checkWaitingRoomFilterByView;
		...
		private Helianz.UI.CheckBox checkReplaceBlockouts;
		...
		private Helianz.UI.CheckBox checkApptSecondaryProviderConsiderOpOnly;
	}
}
