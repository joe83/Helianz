...
namespace Helianz {
	partial class UserControlEnterpriseFamily {
		...
		private void InitializeComponent() {
			this.checkShowFeeSchedGroups = new Helianz.UI.CheckBox();
			this.groupClaimSnapshot = new Helianz.UI.GroupBox();
			...
			this.checkShowFeaturePatientClone = new Helianz.UI.CheckBox();
			this.checkShowFeatureSuperfamilies = new Helianz.UI.CheckBox();
			this.checkClaimSnapshotEnabled = new Helianz.UI.CheckBox();
