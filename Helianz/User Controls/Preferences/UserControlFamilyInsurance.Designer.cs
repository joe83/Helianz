...
namespace Helianz {
	partial class UserControlFamilyInsurance {
		...
		private void InitializeComponent() {
			this.groupBoxPerVisitProcedureCodes = new Helianz.UI.GroupBox();
			this.butPickPerVisitInsAmountProcCode = new Helianz.UI.Button();
			this.butPickPerVisitPatAmountProcCode = new Helianz.UI.Button();
			...
			this.groupBoxCOB = new Helianz.UI.GroupBox();
			this.comboCobSendPaidByInsAt = new Helianz.UI.ComboBox();
			...
			this.groupBoxClaims = new Helianz.UI.GroupBox();
			this.checkClaimUseOverrideProcDescript = new Helianz.UI.CheckBox();
			this.checkClaimTrackingRequireError = new Helianz.UI.CheckBox();
			this.groupBoxOtherInsInfo = new Helianz.UI.GroupBox();
			this.checkInsPlanExclusionsUseUCR = new Helianz.UI.CheckBox();
			this.checkEnableZeroWriteoffOnLimitations = new Helianz.UI.CheckBox();
			this.checkEnableZeroWriteoffOnAnnualMax = new Helianz.UI.CheckBox();
			this.checkInsPlanExclusionsMarkDoNotBill = new Helianz.UI.CheckBox();
			this.checkInsDefaultShowUCRonClaims = new Helianz.UI.CheckBox();
			this.groupBoxInsuranceGeneral = new Helianz.UI.GroupBox();
			this.checkPatInitBillingTypeFromPriInsPlan = new Helianz.UI.CheckBox();
			this.checkInsurancePlansShared = new Helianz.UI.CheckBox();
			this.checkFixedBenefitBlankLikeZero = new Helianz.UI.CheckBox();
			this.checkCoPayFeeScheduleBlankLikeZero = new Helianz.UI.CheckBox();
			this.checkInsPPOsecWriteoffs = new Helianz.UI.CheckBox();
			this.checkPPOpercentage = new Helianz.UI.CheckBox();
			this.checkInsDefaultAssignmentOfBenefits = new Helianz.UI.CheckBox();
			this.checkOutOfNetworkBlankLikeZero = new Helianz.UI.CheckBox();
		...
		#endregion
		private Helianz.UI.CheckBox checkInsurancePlansShared;
		private Helianz.UI.CheckBox checkCoPayFeeScheduleBlankLikeZero;
		private Helianz.UI.CheckBox checkInsDefaultShowUCRonClaims;
		private Helianz.UI.CheckBox checkInsPPOsecWriteoffs;
		private Helianz.UI.CheckBox checkInsDefaultAssignmentOfBenefits;
		private Helianz.UI.CheckBox checkClaimUseOverrideProcDescript;
		private Helianz.UI.CheckBox checkInsPlanExclusionsUseUCR;
		private Helianz.UI.CheckBox checkPPOpercentage;
		private Helianz.UI.CheckBox checkInsPlanExclusionsMarkDoNotBill;
		private Helianz.UI.CheckBox checkClaimTrackingRequireError;
		private Helianz.UI.CheckBox checkFixedBenefitBlankLikeZero;
		private UI.GroupBox groupBoxInsuranceGeneral;
		private Helianz.UI.CheckBox checkPatInitBillingTypeFromPriInsPlan;
		private UI.GroupBox groupBoxOtherInsInfo;
		private UI.GroupBox groupBoxClaims;
		private Helianz.UI.CheckBox checkEnableZeroWriteoffOnLimitations;
		private Helianz.UI.CheckBox checkEnableZeroWriteoffOnAnnualMax;
		...
		private Helianz.UI.GroupBox groupBoxPerVisitProcedureCodes;
