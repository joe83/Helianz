...
namespace Helianz {
	partial class UserControlFamilyGeneral {
		...
		private void InitializeComponent() {
			this.groupBoxHIPAA = new Helianz.UI.GroupBox();
			this.checkFamPhiAccess = new Helianz.UI.CheckBox();
			this.checkPatientSSNMasked = new Helianz.UI.CheckBox();
			this.checkPatientDOBMasked = new Helianz.UI.CheckBox();
			this.groupBoxPatientEdit = new Helianz.UI.GroupBox();
			this.checkAddressVerifyWithUSPS = new Helianz.UI.CheckBox();
			this.checkTextMsgOkStatusTreatAsNo = new Helianz.UI.CheckBox();
			this.checkDoSendOptOutText = new Helianz.UI.CheckBox();
			this.checkAutoFillPatEmail = new Helianz.UI.CheckBox();
			this.checkPreferredPronouns = new Helianz.UI.CheckBox();
			this.checkSameForFamily = new Helianz.UI.CheckBox();
			this.checkPatientPhoneUsePhonenumberTable = new Helianz.UI.CheckBox();
			this.butSyncPhNums = new Helianz.UI.Button();
			this.checkPreferredReferrals = new Helianz.UI.CheckBox();
			this.checkAllowPatsAtHQ = new Helianz.UI.CheckBox();
			this.checkSelectProv = new Helianz.UI.CheckBox();
			this.checkGoogleAddress = new Helianz.UI.CheckBox();
			this.groupBoxClaimSnapshot = new Helianz.UI.GroupBox();
			this.comboClaimSnapshotTriggerType = new Helianz.UI.ComboBox();
			this.textClaimSnapshotRunTime = new System.Windows.Forms.TextBox();
			this.label30 = new System.Windows.Forms.Label();
			this.label31 = new System.Windows.Forms.Label();
			this.groupBoxSuperFamily = new Helianz.UI.GroupBox();
			this.comboSuperFamSort = new Helianz.UI.ComboBox();
			this.labelSuperFamSort = new System.Windows.Forms.Label();
			this.checkSuperFamSync = new Helianz.UI.CheckBox();
			this.checkSuperFamAddIns = new Helianz.UI.CheckBox();
			this.checkCloneCreateSuperFamily = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkSuperFamSync;
		private Helianz.UI.CheckBox checkSuperFamAddIns;
		private Helianz.UI.CheckBox checkCloneCreateSuperFamily;
		private UI.Button butSyncPhNums;
		private Helianz.UI.CheckBox checkPatientPhoneUsePhonenumberTable;
		private Helianz.UI.CheckBox checkSameForFamily;
		private Helianz.UI.CheckBox checkPatientDOBMasked;
		private Helianz.UI.CheckBox checkPatientSSNMasked;
		private Helianz.UI.CheckBox checkAllowPatsAtHQ;
		private Helianz.UI.CheckBox checkAutoFillPatEmail;
		private Helianz.UI.CheckBox checkPreferredReferrals;
		private Helianz.UI.CheckBox checkTextMsgOkStatusTreatAsNo;
		private Helianz.UI.CheckBox checkFamPhiAccess;
		private Helianz.UI.CheckBox checkSelectProv;
		private Helianz.UI.CheckBox checkGoogleAddress;
		private Helianz.UI.CheckBox checkPreferredPronouns;
