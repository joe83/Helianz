...
namespace Helianz {
	partial class UserControlChartProcedures {
		...
		private void InitializeComponent() {
			this.groupBoxProcedures = new Helianz.UI.GroupBox();
			this.checkProcProvChangesCp = new Helianz.UI.CheckBox();
			this.checkAllowSettingProcsComplete = new Helianz.UI.CheckBox();
			this.checkProcEditRequireAutoCode = new Helianz.UI.CheckBox();
			this.comboProcFeeUpdatePrompt = new Helianz.UI.ComboBox();
			this.checkClaimProcsAllowEstimatesOnCompl = new Helianz.UI.CheckBox();
			this.labelProcFeeUpdatePrompt = new System.Windows.Forms.Label();
			this.checkProcLockingIsAllowed = new Helianz.UI.CheckBox();
			this.groupProcNotes = new Helianz.UI.GroupBox();
			this.checkProcNoteSigsBlocked = new Helianz.UI.CheckBox();
			this.checkProcsPromptForAutoNote = new Helianz.UI.CheckBox();
			this.checkSignatureAllowDigital = new Helianz.UI.CheckBox();
			this.checkProcGroupNoteDoesAggregate = new Helianz.UI.CheckBox();
			this.checkNotesProviderSigOnly = new Helianz.UI.CheckBox();
			this.checkProcNoteConcurrencyMerge = new Helianz.UI.CheckBox();
			...
			this.labelProcFeeUpdatePrompt.Location = new System.Drawing.Point(17, 142);
		...
		private Helianz.UI.CheckBox checkAllowSettingProcsComplete;
		private Helianz.UI.CheckBox checkProcEditRequireAutoCode;
		private Helianz.UI.CheckBox checkClaimProcsAllowEstimatesOnCompl;
		private Helianz.UI.CheckBox checkProcLockingIsAllowed;
		private UI.ComboBox comboProcFeeUpdatePrompt;
		private System.Windows.Forms.Label labelProcFeeUpdatePrompt;
		private Helianz.UI.CheckBox checkSignatureAllowDigital;
		private Helianz.UI.CheckBox checkNotesProviderSigOnly;
		private Helianz.UI.CheckBox checkProcNoteConcurrencyMerge;
		private Helianz.UI.CheckBox checkProcGroupNoteDoesAggregate;
		private Helianz.UI.CheckBox checkProcsPromptForAutoNote;
		private UI.GroupBox groupProcNotes;
		private UI.GroupBox groupBoxProcedures;
		private Helianz.UI.CheckBox checkProcProvChangesCp;
		private Helianz.UI.CheckBox checkProcNoteSigsBlocked;
	}
}
