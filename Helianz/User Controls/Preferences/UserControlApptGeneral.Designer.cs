...
namespace Helianz {
	partial class UserControlApptGeneral {
		...
		private void InitializeComponent() {
			this.groupBoxProduction = new Helianz.UI.GroupBox();
			this.checkApptModuleAdjInProd = new Helianz.UI.CheckBox();
			this.checkApptModuleProductionUsesOps = new Helianz.UI.CheckBox();
			this.groupBoxOD2 = new Helianz.UI.GroupBox();
			this.labelApptProvChangePrompt = new System.Windows.Forms.Label();
			this.comboApptProvChangePrompt = new Helianz.UI.ComboBox();
			this.checkAppointmentTimeIsLocked = new Helianz.UI.CheckBox();
			this.checkApptsRequireProc = new Helianz.UI.CheckBox();
			this.checkApptAllowFutureComplete = new Helianz.UI.CheckBox();
			this.textApptWithoutProcsDefaultLength = new Helianz.ValidNum();
			this.checkUnscheduledListNoRecalls = new Helianz.UI.CheckBox();
			this.checkApptsAllowOverlap = new Helianz.UI.CheckBox();
			this.labelApptWithoutProcsDefaultLength = new System.Windows.Forms.Label();
			this.checkPreventChangesToComplAppts = new Helianz.UI.CheckBox();
			this.checkApptAllowEmptyComplete = new Helianz.UI.CheckBox();
			this.groupBoxCalendarBehavior = new Helianz.UI.GroupBox();
			this.textApptAutoRefreshRange = new Helianz.ValidNum();
			this.labelApptAutoRefreshRange = new System.Windows.Forms.Label();
			this.comboSearchBehavior = new Helianz.UI.ComboBox();
			this.label13 = new System.Windows.Forms.Label();
			this.checkApptTimeReset = new Helianz.UI.CheckBox();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.label37 = new System.Windows.Forms.Label();
			this.comboBrokenApptProc = new Helianz.UI.ComboBox();
			this.checkBrokenApptCommLog = new Helianz.UI.CheckBox();
			this.checkBrokenApptRequiredOnMove = new Helianz.UI.CheckBox();
			this.checkBrokenApptAdjustment = new Helianz.UI.CheckBox();
			this.comboBrokenApptAdjType = new Helianz.UI.ComboBox();
		...
		private Helianz.UI.CheckBox checkBrokenApptRequiredOnMove;
		private Helianz.UI.CheckBox checkApptsAllowOverlap;
		private Helianz.UI.CheckBox checkPreventChangesToComplAppts;
		private ValidNum textApptAutoRefreshRange;
		private System.Windows.Forms.Label labelApptAutoRefreshRange;
		private Helianz.UI.CheckBox checkUnscheduledListNoRecalls;
		private ValidNum textApptWithoutProcsDefaultLength;
		private System.Windows.Forms.Label labelApptWithoutProcsDefaultLength;
		private Helianz.UI.CheckBox checkApptAllowEmptyComplete;
		private Helianz.UI.CheckBox checkApptAllowFutureComplete;
		private Helianz.UI.CheckBox checkApptsRequireProc;
		private Helianz.UI.CheckBox checkApptModuleProductionUsesOps;
		private Helianz.UI.CheckBox checkApptModuleAdjInProd;
		private Helianz.UI.CheckBox checkApptTimeReset;
		...
		private Helianz.UI.CheckBox checkAppointmentTimeIsLocked;
