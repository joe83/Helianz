...
namespace Helianz {
	partial class UserControlManageGeneral {
		...
		private void InitializeComponent() {
			this.checkScheduleProvEmpSelectAll = new Helianz.UI.CheckBox();
			this.checkAccountingInvoiceAttachmentsSaveInDatabase = new Helianz.UI.CheckBox();
			this.groupBoxTimeCards = new Helianz.UI.GroupBox();
			this.comboTimeCardOvertimeFirstDayOfWeek = new Helianz.UI.ComboBox();
			this.checkTimeCardUseLocal = new Helianz.UI.CheckBox();
			this.label16 = new System.Windows.Forms.Label();
			this.checkTimeCardADP = new Helianz.UI.CheckBox();
			this.checkClockEventAllowBreak = new Helianz.UI.CheckBox();
			this.groupBoxDeposits = new Helianz.UI.GroupBox();
			this.comboDepositSoftware = new Helianz.UI.ComboBox();
			this.checkShowAutoDeposit = new Helianz.UI.CheckBox();
			this.labelDepositSoftware = new System.Windows.Forms.Label();
			this.groupBoxPrescriptions = new Helianz.UI.GroupBox();
			this.checkRxHideProvsWithoutDEA = new Helianz.UI.CheckBox();
			this.groupBoxClaims = new Helianz.UI.GroupBox();
			this.textClaimsReceivedDays = new Helianz.ValidNum();
			this.checkClaimsSendWindowValidateOnLoad = new Helianz.UI.CheckBox();
			this.labelClaimsReceivedDays = new System.Windows.Forms.Label();
			this.checkClaimPaymentBatchOnly = new Helianz.UI.CheckBox();
			this.groupBoxERA = new Helianz.UI.GroupBox();
			this.comboEraWriteoff = new Helianz.UI.ComboBox();
			this.textEraNoAutoProcessCarcCodes = new System.Windows.Forms.TextBox();
			this.comboEraDefaultPaymentType = new Helianz.UI.ComboBox();
			this.comboFwtPaymentType = new Helianz.UI.ComboBox();
			this.comboAchPaymentType = new Helianz.UI.ComboBox();
			this.comboEraCheckPaymentType = new Helianz.UI.ComboBox();
			this.comboEraAutomation = new Helianz.UI.ComboBox();
			...
			this.checkEraOneClaimPerPage = new Helianz.UI.CheckBox();
			this.checkIncludeEraWOPercCoPay = new Helianz.UI.CheckBox();
			this.labelEraAutomation = new System.Windows.Forms.Label();
			this.checkEraAllowTotalPayment = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkScheduleProvEmpSelectAll;
		private Helianz.UI.CheckBox checkClaimsSendWindowValidateOnLoad;
		private Helianz.UI.CheckBox checkTimeCardADP;
		private UI.ComboBox comboTimeCardOvertimeFirstDayOfWeek;
		private System.Windows.Forms.Label label16;
		private Helianz.UI.CheckBox checkRxHideProvsWithoutDEA;
		...
		private Helianz.UI.CheckBox checkEraAllowTotalPayment;
		private Helianz.UI.CheckBox checkIncludeEraWOPercCoPay;
		private Helianz.UI.CheckBox checkClockEventAllowBreak;
		private ValidNum textClaimsReceivedDays;
		private Helianz.UI.CheckBox checkShowAutoDeposit;
		private Helianz.UI.CheckBox checkEraOneClaimPerPage;
		private Helianz.UI.CheckBox checkClaimPaymentBatchOnly;
		...
		private Helianz.UI.CheckBox checkAccountingInvoiceAttachmentsSaveInDatabase;
