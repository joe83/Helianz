...
namespace Helianz {
	public partial class UserControlManageGeneral:UserControl {
		...
		private void linkLabelClaimPaymentBatchOnly_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://helianz.com/manual/claimedit.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://helianz.com/manual/claimedit.html"+"\r\n"
		...
		private void linkLabelClaimsReceivedDaysDetails_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://www.helianz.com/manual/claimpaymentbatch.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://www.helianz.com/manual/claimpaymentbatch.html"+"\r\n"
					+Lan.g(this,"Please set up a default web browser."));
			}
		}
		...
		private void linkLabelShowAutoDepositDetails_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://helianz.com/manual/claimpayfinalize.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://helianz.com/manual/claimpayfinalize.html"+"\r\n"
					+Lan.g(this,"Please set up a default web browser."));
			}
		}
