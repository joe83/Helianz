...
namespace Helianz {
	partial class UserControlTreatPlanFreqLimit {
		/// <summary> 
		...
		private void InitializeComponent() {
			this.groupBoxDiscountPlanFreqLimit = new Helianz.UI.GroupBox();
			...
			this.checkFrequency = new Helianz.UI.CheckBox();
			this.groupBoxDiscountPlanFreqLimit.SuspendLayout();
			this.SuspendLayout();
			// 
			// groupBoxDiscountPlanFreqLimit
			// 
			this.groupBoxDiscountPlanFreqLimit.BackColor = System.Drawing.Color.White;
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountPACodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountXrayCodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountPerioCodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountLimitedCodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountFluorideCodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountExamCodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.textDiscountProphyCodes);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.label63);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountPAFreq);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountXrayFreq);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountPerioFreq);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountLimitedFreq);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountProphyFreq);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountFluorideFreq);
			this.groupBoxDiscountPlanFreqLimit.Controls.Add(this.labelDiscountExamFreq);
			this.groupBoxDiscountPlanFreqLimit.Location = new System.Drawing.Point(20, 386);
			this.groupBoxDiscountPlanFreqLimit.Name = "groupBoxDiscountPlanFreqLimit";
			this.groupBoxDiscountPlanFreqLimit.Size = new System.Drawing.Size(450, 207);
			this.groupBoxDiscountPlanFreqLimit.TabIndex = 246;
			this.groupBoxDiscountPlanFreqLimit.Text = "Discount Plan Frequency Limitations";
			// 
			// label63
			// 
			...
			this.label63.Location = new System.Drawing.Point(194, 15);
			...
			this.textDiscountPACodes.Location = new System.Drawing.Point(267, 177);
			...
			this.labelDiscountPAFreq.Location = new System.Drawing.Point(131, 180);
			...
			this.textDiscountXrayCodes.Location = new System.Drawing.Point(267, 153);
			...
			this.labelDiscountXrayFreq.Location = new System.Drawing.Point(131, 156);
			...
			this.textDiscountPerioCodes.Location = new System.Drawing.Point(267, 105);
			...
			this.labelDiscountPerioFreq.Location = new System.Drawing.Point(131, 108);
			...
			this.textDiscountLimitedCodes.Location = new System.Drawing.Point(267, 129);
			...
			this.labelDiscountLimitedFreq.Location = new System.Drawing.Point(131, 132);
			...
			this.textDiscountFluorideCodes.Location = new System.Drawing.Point(267, 81);
			...
			this.labelDiscountProphyFreq.Location = new System.Drawing.Point(131, 60);
			...
			this.textDiscountExamCodes.Location = new System.Drawing.Point(267, 33);
			...
			this.labelDiscountFluorideFreq.Location = new System.Drawing.Point(131, 84);
			...
			this.textDiscountProphyCodes.Location = new System.Drawing.Point(267, 57);
			...
			this.labelDiscountExamFreq.Location = new System.Drawing.Point(131, 36);
			...
			this.checkFrequency.Location = new System.Drawing.Point(60, 10);
			this.checkFrequency.Name = "checkFrequency";
			this.checkFrequency.Size = new System.Drawing.Size(400, 17);
			this.checkFrequency.TabIndex = 244;
		...
		private System.Windows.Forms.TextBox textDiscountXrayCodes;
		private System.Windows.Forms.Label labelDiscountXrayFreq;
		private System.Windows.Forms.TextBox textDiscountPerioCodes;
		private System.Windows.Forms.Label labelDiscountPerioFreq;
		private System.Windows.Forms.TextBox textDiscountLimitedCodes;
		private System.Windows.Forms.Label labelDiscountLimitedFreq;
		private System.Windows.Forms.TextBox textDiscountFluorideCodes;
		private System.Windows.Forms.Label labelDiscountProphyFreq;
		private System.Windows.Forms.TextBox textDiscountExamCodes;
		...
		private Helianz.UI.CheckBox checkFrequency;
	}
}
