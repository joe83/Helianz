...
namespace Helianz {
	partial class UserControlAccountGeneral {
		...
		private void InitializeComponent() {
			...
			this.butClearAgingBeginDateT = new Helianz.UI.Button();
			this.groupBoxFunctionality = new Helianz.UI.GroupBox();
			this.textAgingBeginDateT = new System.Windows.Forms.TextBox();
			this.textAgingServiceTimeDue = new System.Windows.Forms.TextBox();
			this.labelAgingBeginDateT = new System.Windows.Forms.Label();
			this.labelAutoAgingRunTime = new System.Windows.Forms.Label();
			this.checkBalancesDontSubtractIns = new Helianz.UI.CheckBox();
			this.checkAccountShowPaymentNums = new Helianz.UI.CheckBox();
			this.checkStatementInvoiceGridShowWriteoffs = new Helianz.UI.CheckBox();
			this.checkAllowFutureTrans = new Helianz.UI.CheckBox();
			this.groupCommLogs = new Helianz.UI.GroupBox();
			this.checkCommLogAutoSave = new Helianz.UI.CheckBox();
			this.checkShowFamilyCommByDefault = new Helianz.UI.CheckBox();
			this.groupBoxFutureDatedTransactions = new Helianz.UI.GroupBox();
			this.labelFutureDatedOptions = new System.Windows.Forms.Label();
			this.checkAllowFutureDebits = new Helianz.UI.CheckBox();
			this.checkAllowFuturePayments = new Helianz.UI.CheckBox();
    ...
    ".\r\nSee Main Menu, Setup, Account, Allocations.";
			...
			this.groupBoxFunctionality.Controls.Add(this.textAgingServiceTimeDue);
			...
			// 
			this.textAgingServiceTimeDue.Location = new System.Drawing.Point(366, 103);
			this.textAgingServiceTimeDue.Name = "textAgingServiceTimeDue";
			this.textAgingServiceTimeDue.Size = new System.Drawing.Size(74, 20);
			this.textAgingServiceTimeDue.TabIndex = 21;
			this.textAgingServiceTimeDue.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.textAgingServiceTimeDue.Validating += new System.ComponentModel.CancelEventHandler(this.TextAgingServiceTimeDue_Validating);
			// 
			// labelAgingBeginDateT
			// 
			this.labelAgingBeginDateT.Location = new System.Drawing.Point(10, 135);
			...
			// 
			this.labelAutoAgingRunTime.Location = new System.Drawing.Point(15, 106);
			...
			this.checkBalancesDontSubtractIns.Text = "Balances don\'t subtract insurance estimates";
			// 
		...
		private Helianz.UI.CheckBox checkCommLogAutoSave;
		private Helianz.UI.CheckBox checkShowFamilyCommByDefault;
		private Helianz.UI.CheckBox checkBalancesDontSubtractIns;
		private Helianz.UI.CheckBox checkAllowFutureTrans;
		private Helianz.UI.CheckBox checkAccountShowPaymentNums;
		private Helianz.UI.CheckBox checkStatementInvoiceGridShowWriteoffs;
		...
		private System.Windows.Forms.TextBox textAgingServiceTimeDue;
		private UI.Button butClearAgingBeginDateT;
		private UI.GroupBox groupBoxFutureDatedTransactions;
		private Helianz.UI.CheckBox checkAllowFuturePayments;
		private Helianz.UI.CheckBox checkAllowFutureDebits;
