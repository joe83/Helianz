...
namespace Helianz {
	public partial class UserControlChartProcedures:UserControl {
		...
		private void linkLabelProcLockingIsAllowedDetails_LinkClicked(object sender,LinkLabelLinkClickedEventArgs e) {
			try {
				Process.Start("https://www.helianz.com/manual/procedurelocking.html");
			}
			catch(Exception ex) {
				MessageBox.Show(Lan.g(this,"Could not find")+" "+"https://www.helianz.com/manual/procedurelocking.html"+"\r\n"
