...
namespace Helianz {
	partial class UserControlEnterpriseManage {
		...
		private void InitializeComponent() {
			this.checkEnterpriseManualRefreshMainTaskLists = new Helianz.UI.CheckBox();
			this.checkEraStrictClaimMatching = new Helianz.UI.CheckBox();
			this.checkEraRefreshOnLoad = new Helianz.UI.CheckBox();
			this.checkEraShowStatusAndClinic = new Helianz.UI.CheckBox();
			this.SuspendLayout();
			// 
			// checkRefresh
			// 
