...
namespace Helianz {
	partial class UserControlMainWindow {
		...
		private void InitializeComponent() {
			this.groupBoxPopups = new Helianz.UI.GroupBox();
			...
			this.groupSelectPatient = new Helianz.UI.GroupBox();
			this.checkEnterpriseAllowRefreshWhileTyping = new Helianz.UI.CheckBox();
			this.checkShowInactivePatientsDefault = new Helianz.UI.CheckBox();
			this.checkPatientSelectFilterRestrictedClinics = new Helianz.UI.CheckBox();
			this.checkRefresh = new Helianz.UI.CheckBox();
			this.checkPrefFName = new Helianz.UI.CheckBox();
			this.groupBox6 = new Helianz.UI.GroupBox();
			this.checkTitleBarShowSpecialty = new Helianz.UI.CheckBox();
			this.checkUseClinicAbbr = new Helianz.UI.CheckBox();
			this.textMainWindowTitle = new System.Windows.Forms.TextBox();
			this.checkTitleBarShowSite = new Helianz.UI.CheckBox();
			this.label15 = new System.Windows.Forms.Label();
			this.comboShowID = new Helianz.UI.ComboBox();
			this.label17 = new System.Windows.Forms.Label();
			this.checkPatientSelectWindowShowGetAll = new Helianz.UI.CheckBox();
			...
			this.groupBoxPopups.Location = new System.Drawing.Point(20, 308);
			...
			this.groupSelectPatient.Controls.Add(this.checkPatientSelectWindowShowGetAll);
			...
			this.groupSelectPatient.Size = new System.Drawing.Size(450, 130);
			...
			// 
			// checkPatientSelectWindowShowGetAll
			// 
			this.checkPatientSelectWindowShowGetAll.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkPatientSelectWindowShowGetAll.Location = new System.Drawing.Point(55, 104);
			this.checkPatientSelectWindowShowGetAll.Name = "checkPatientSelectWindowShowGetAll";
			this.checkPatientSelectWindowShowGetAll.Size = new System.Drawing.Size(382, 18);
			this.checkPatientSelectWindowShowGetAll.TabIndex = 294;
			this.checkPatientSelectWindowShowGetAll.Text = "Show Get All button in Select Patient window";
			// 
		...
		private UI.CheckBox checkPatientSelectWindowShowGetAll;
	}
}
