...
namespace Helianz {
	partial class UserControlTreatPlanGeneral {
		...
		private void InitializeComponent() {
			...
			this.groupTreatPlan = new Helianz.UI.GroupBox();
			this.checkTreatPlanShowCompleted = new Helianz.UI.CheckBox();
			this.checkTreatPlanItemized = new Helianz.UI.CheckBox();
			this.checkTPSaveSigned = new Helianz.UI.CheckBox();
			this.checkPromptSaveTP = new Helianz.UI.CheckBox();
			this.groupBoxDiscounts = new Helianz.UI.GroupBox();
			this.comboProcDiscountType = new Helianz.UI.ComboBox();
			...
			this.groupBoxInsuranceHistory = new Helianz.UI.GroupBox();
			...
			this.groupTreatPlanSort = new Helianz.UI.GroupBox();
			...
			this.textTreatNote = new Helianz.ODtextBox();
			...
			this.labelDiscountPercentage.Location = new System.Drawing.Point(140, 38);
			...
			this.textTreatNote.QuickPasteType = HelianzBusiness.EnumQuickPasteType.TreatPlan;
		...
		private Helianz.UI.CheckBox checkPromptSaveTP;
		...
		private Helianz.UI.CheckBox checkTPSaveSigned;
		private UI.ComboBox comboProcDiscountType;
		private Helianz.UI.CheckBox checkTreatPlanShowCompleted;
		private System.Windows.Forms.TextBox textDiscountPercentage;
		private Helianz.UI.CheckBox checkTreatPlanItemized;
