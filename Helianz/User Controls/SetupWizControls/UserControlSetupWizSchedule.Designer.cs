namespace Helianz.User_Controls.SetupWizard {
	partial class UserControlSetupWizSchedule {
		...
		private void InitializeComponent() {
			...
			this.butPrevProv = new Helianz.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.butNextProv = new Helianz.UI.Button();
			this.checkSaturday = new Helianz.UI.CheckBox();
			this.labelProv = new System.Windows.Forms.Label();
			this.checkWednesday = new Helianz.UI.CheckBox();
			this.checkThursday = new Helianz.UI.CheckBox();
			this.checkFriday = new Helianz.UI.CheckBox();
			this.checkTuesday = new Helianz.UI.CheckBox();
			this.checkSunday = new Helianz.UI.CheckBox();
			this.groupMon = new Helianz.UI.GroupBox();
			this.gridMonday = new Helianz.UI.GridOD();
			this.butAddMonday = new Helianz.UI.Button();
			this.checkMonday = new Helianz.UI.CheckBox();
			this.groupSun = new Helianz.UI.GroupBox();
			this.gridSunday = new Helianz.UI.GridOD();
			this.butAddSunday = new Helianz.UI.Button();
			this.groupSat = new Helianz.UI.GroupBox();
			this.gridSaturday = new Helianz.UI.GridOD();
			this.butAddSaturday = new Helianz.UI.Button();
			this.groupFri = new Helianz.UI.GroupBox();
			this.gridFriday = new Helianz.UI.GridOD();
			this.butAddFriday = new Helianz.UI.Button();
			this.groupThu = new Helianz.UI.GroupBox();
			this.gridThursday = new Helianz.UI.GridOD();
			this.butAddThursday = new Helianz.UI.Button();
			this.groupWed = new Helianz.UI.GroupBox();
			this.gridWednesday = new Helianz.UI.GridOD();
			this.butAddWednesday = new Helianz.UI.Button();
			this.groupTue = new Helianz.UI.GroupBox();
			this.gridTuesday = new Helianz.UI.GridOD();
			this.butAddTuesday = new Helianz.UI.Button();
		...
		#endregion
		private Helianz.UI.CheckBox checkSunday;
		private Helianz.UI.CheckBox checkMonday;
		private Helianz.UI.CheckBox checkTuesday;
		private Helianz.UI.CheckBox checkFriday;
		private Helianz.UI.CheckBox checkThursday;
		private Helianz.UI.CheckBox checkWednesday;
		...
		private Helianz.UI.CheckBox checkSaturday;
		private System.Windows.Forms.Label labelProv;
		private UI.Button butNextProv;
		private System.Windows.Forms.Label label2;
		private UI.Button butPrevProv;
		private Helianz.UI.GroupBox groupMon;
		private Helianz.UI.GroupBox groupTue;
		private Helianz.UI.GroupBox groupWed;
		private Helianz.UI.GroupBox groupThu;
		private Helianz.UI.GroupBox groupFri;
		private Helianz.UI.GroupBox groupSat;
		private Helianz.UI.GroupBox groupSun;
	}
}
