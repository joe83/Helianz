namespace Helianz.User_Controls {
	partial class UserControlReportSetup {
		...
		private void InitializeComponent() {
			...
			this.gridProdInc = new Helianz.UI.GridOD();
			this.gridDaily = new Helianz.UI.GridOD();
			this.gridMonthly = new Helianz.UI.GridOD();
			this.gridLists = new Helianz.UI.GridOD();
			this.butDown = new Helianz.UI.Button();
			this.gridPublicHealth = new Helianz.UI.GridOD();
    ...
    ":";
			...
			this.gridProdInc.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridProdInc.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellClick);
			this.gridProdInc.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.grid_CellLeave);
			// 
			// gridDaily
			// 
			...
			this.gridDaily.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridDaily.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellClick);
			this.gridDaily.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.grid_CellLeave);
			// 
			// gridMonthly
			// 
			...
			this.gridMonthly.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridMonthly.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellClick);
			this.gridMonthly.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.grid_CellLeave);
			// 
			// gridLists
			// 
			...
			this.gridLists.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridLists.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellClick);
			this.gridLists.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.grid_CellLeave);
			// 
			// butDown
			// 
			...
			this.gridPublicHealth.SelectionMode = Helianz.UI.GridSelectionMode.OneCell;
			...
			this.gridPublicHealth.CellClick += new Helianz.UI.ODGridClickEventHandler(this.grid_CellClick);
			this.gridPublicHealth.CellLeave += new Helianz.UI.ODGridClickEventHandler(this.grid_CellLeave);
			// 
			// butUp
			// 
