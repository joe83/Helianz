namespace Helianz {
	partial class SmsThreadView {
		...
		private void InitializeComponent() {
			...
			this.butForwardPage = new Helianz.UI.Button();
			this.butBackPage = new Helianz.UI.Button();
			this.butBeginning = new Helianz.UI.Button();
			this.butEnd = new Helianz.UI.Button();
			this.panelNavigation = new Helianz.UI.PanelOD();
