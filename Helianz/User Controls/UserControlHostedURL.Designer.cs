namespace Helianz.User_Controls {
	partial class UserControlHostedURL {
		...
		private void InitializeComponent() {
			...
			this.checkAllowChildren = new Helianz.UI.CheckBox();
			this.butClearExistingPat = new Helianz.UI.Button();
			this.butEditExistingPat = new Helianz.UI.Button();
			this.butClearNewPat = new Helianz.UI.Button();
			this.butCopy = new Helianz.UI.Button();
			this.butEditNewPat = new Helianz.UI.Button();
			this.groupExistingPat = new Helianz.UI.GroupBox();
			this.checkExistingPatEmail = new Helianz.UI.CheckBox();
			this.checkExistingPatText = new Helianz.UI.CheckBox();
			this.groupNewPat = new Helianz.UI.GroupBox();
			this.checkNewPatEmail = new Helianz.UI.CheckBox();
			this.checkNewPatText = new Helianz.UI.CheckBox();
			...
			this.butClearExistingPat.Image = global::Helianz.Properties.Resources.deleteX18;
			...
			this.butClearNewPat.Image = global::Helianz.Properties.Resources.deleteX18;
		...
		private Helianz.UI.CheckBox checkAllowChildren;
		private UI.GroupBox groupExistingPat;
		private Helianz.UI.CheckBox checkExistingPatEmail;
		private Helianz.UI.CheckBox checkExistingPatText;
		private UI.GroupBox groupNewPat;
		private Helianz.UI.CheckBox checkNewPatEmail;
		private Helianz.UI.CheckBox checkNewPatText;
	}
}
