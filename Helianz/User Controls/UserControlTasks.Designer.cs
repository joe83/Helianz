namespace Helianz {
	partial class UserControlTasks {
		...
		private void InitializeComponent() {
			...
			this.butClearFilter = new Helianz.UI.Button();
			...
			this.tabNew = new Helianz.UI.TabPage();
			this.tabOpenTickets = new Helianz.UI.TabPage();
			this.tabPatientTickets = new Helianz.UI.TabPage();
			this.tabMain = new Helianz.UI.TabPage();
			this.tabReminders = new Helianz.UI.TabPage();
			this.tabRepeating = new Helianz.UI.TabPage();
			this.tabDate = new Helianz.UI.TabPage();
			this.tabWeek = new Helianz.UI.TabPage();
			this.tabMonth = new Helianz.UI.TabPage();
		...
		private Helianz.UI.TabPage tabRepeating;
		private Helianz.UI.TabPage tabDate;
		private Helianz.UI.TabPage tabWeek;
		private Helianz.UI.TabPage tabMonth;
		...
		private Helianz.UI.TabPage tabNew;
		private Helianz.UI.TabPage tabOpenTickets;
		...
		private Helianz.UI.TabPage tabPatientTickets;
		...
		private Helianz.UI.Button butClearFilter;
