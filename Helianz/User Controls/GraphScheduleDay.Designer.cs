namespace Helianz {
	partial class GraphScheduleDay {
		...
		private void InitializeComponent() {
			...
			this.panel2 = new Helianz.UI.PanelOD();
			...
			this.panel1 = new Helianz.UI.PanelOD();
			this.groupBox2 = new Helianz.UI.GroupBox();
			this.checkBoxNotes = new Helianz.UI.CheckBox();
			this.checkBoxProviders = new Helianz.UI.CheckBox();
			this.checkBoxEmployees = new Helianz.UI.CheckBox();
		...
		private Helianz.UI.CheckBox checkBoxEmployees;
		private Helianz.UI.CheckBox checkBoxProviders;
		private Helianz.UI.CheckBox checkBoxNotes;
