...
namespace UnitTestsCore {
	public class CdcrecT {
		...
		public static void FillCdcrecTableIfNeeded() {
			...
			listcdcrec.Add(new Cdcrec(){ CdcrecCode="2028-9",HeirarchicalCode="R2",Description="ASIAN" });
			...
			listcdcrec.Add(new Cdcrec(){ CdcrecCode="2054-5",HeirarchicalCode="R3",Description="BLACK OR AFRICAN AMERICAN" });
			...
			listcdcrec.Add(new Cdcrec(){ CdcrecCode="2106-3",HeirarchicalCode="R5",Description="WHITE" });
