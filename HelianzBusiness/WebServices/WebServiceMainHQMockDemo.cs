...
namespace HelianzBusiness {
	public class WebServiceMainHQMockDemo : HelianzBusiness.WebServiceMainHQ.WebServiceMainHQ, IWebServiceMainHQ {
		...
		private string GetHostedUrlForCode(eServiceCode code) {
			switch(code) {
				...
				case (eServiceCode.EmailMassUsage):
					return "https://helianz.com/site/massemailembedded.html";
				case (eServiceCode.EmailSecureAccess):
					return "https://helianz.com/site/secureemailembedded.html";
				default:
					return "";
			}
		}
