...
namespace HelianzBusiness.WebServices {
	public class HelianzServerMockIIS : IHelianzServer {
		...
		public HelianzServerMockIIS(string server="",string db="",string user="",string password="",string userLow="",string passLow=""
