...
using HelianzWebCore.Extensions;

namespace HelianzWebCore.Serializing {
	///<summary>This file is generated automatically by the crud, do not make any changes to this file because they will get overwritten.</summary>
	public class CareCreditWebResponse {

		///<summary></summary>
		public static string Serialize(HelianzBusiness.CareCreditWebResponse carecreditwebresponse) {
		...
		///<summary></summary>
		public static HelianzBusiness.CareCreditWebResponse Deserialize(string xml) {
			HelianzBusiness.CareCreditWebResponse carecreditwebresponse=new HelianzBusiness.CareCreditWebResponse();
				...
				while(reader.Read()) {
					...
					switch(fieldName) {
						...
						case "ProcessingStatus":
							carecreditwebresponse.ProcessingStatus=(HelianzBusiness.CareCreditWebStatus)Enum.Parse(typeof(HelianzBusiness.CareCreditWebStatus),SerializeStringEscapes.ReplaceEscapes(reader.ReadContentAsString()));
							break;
						case "DateTimeEntry":
						...
						case "ClinicNum":
							...
							break;
						case "ServiceType":
							carecreditwebresponse.ServiceType=(HelianzBusiness.CareCreditServiceType)Enum.Parse(typeof(HelianzBusiness.CareCreditServiceType),SerializeStringEscapes.ReplaceEscapes(reader.ReadContentAsString()));
							break;
						case "TransType":
							carecreditwebresponse.TransType=(HelianzBusiness.CareCreditTransType)Enum.Parse(typeof(HelianzBusiness.CareCreditTransType),SerializeStringEscapes.ReplaceEscapes(reader.ReadContentAsString()));
							break;
						case "MerchantNumber":
		...
		///<summary></summary>
		public static List<HelianzBusiness.CareCreditWebResponse> FromDataTable(DataTable dataTable) {
			List<HelianzBusiness.CareCreditWebResponse> carecreditwebresponses=new List<HelianzBusiness.CareCreditWebResponse>();
			for(int i=0;i<dataTable.Rows.Count;i++) {
				try{
					...
					carecreditwebresponse.ProcessingStatus=(HelianzBusiness.CareCreditWebStatus)Enum.Parse(typeof(HelianzBusiness.CareCreditWebStatus),SerializeStringEscapes.ReplaceEscapes(System.Convert.ToString(dataTable.Rows[i]["ProcessingStatus"])));
					carecreditwebresponse.DateTimeEntry=HelianzBusiness.PIn.DateT(System.Convert.ToString(dataTable.Rows[i]["DateTimeEntry"]));
					carecreditwebresponse.DateTimePending=HelianzBusiness.PIn.DateT(System.Convert.ToString(dataTable.Rows[i]["DateTimePending"]));
					carecreditwebresponse.DateTimeCompleted=HelianzBusiness.PIn.DateT(System.Convert.ToString(dataTable.Rows[i]["DateTimeCompleted"]));
					carecreditwebresponse.DateTimeExpired=HelianzBusiness.PIn.DateT(System.Convert.ToString(dataTable.Rows[i]["DateTimeExpired"]));
					carecreditwebresponse.DateTimeLastError=HelianzBusiness.PIn.DateT(System.Convert.ToString(dataTable.Rows[i]["DateTimeLastError"]));
					...
					carecreditwebresponse.ServiceType=(HelianzBusiness.CareCreditServiceType)Enum.Parse(typeof(HelianzBusiness.CareCreditServiceType),SerializeStringEscapes.ReplaceEscapes(System.Convert.ToString(dataTable.Rows[i]["ServiceType"])));
					carecreditwebresponse.TransType=(HelianzBusiness.CareCreditTransType)Enum.Parse(typeof(HelianzBusiness.CareCreditTransType),SerializeStringEscapes.ReplaceEscapes(System.Convert.ToString(dataTable.Rows[i]["TransType"])));
		...
		///<summary>Converts a list of HelianzBusiness.CareCreditWebResponse into a DataTable.</summary>
		public static DataTable ListToTable(List<HelianzBusiness.CareCreditWebResponse> listCareCreditWebResponses,string tableName="") {
			...
			foreach(HelianzBusiness.CareCreditWebResponse careCreditWebResponse in listCareCreditWebResponses) {
				table.Rows.Add(new object[] {
					HelianzBusiness.POut.Long  (careCreditWebResponse.CareCreditWebResponseNum),
					HelianzBusiness.POut.Long  (careCreditWebResponse.PatNum),
					HelianzBusiness.POut.Long  (careCreditWebResponse.PayNum),
					                             careCreditWebResponse.RefNumber,
					HelianzBusiness.POut.Double(careCreditWebResponse.Amount),
					                             careCreditWebResponse.WebToken,
					                             careCreditWebResponse.ProcessingStatus.ToString(),
					HelianzBusiness.POut.DateT (careCreditWebResponse.DateTimeEntry,false),
					HelianzBusiness.POut.DateT (careCreditWebResponse.DateTimePending,false),
					HelianzBusiness.POut.DateT (careCreditWebResponse.DateTimeCompleted,false),
					HelianzBusiness.POut.DateT (careCreditWebResponse.DateTimeExpired,false),
					HelianzBusiness.POut.DateT (careCreditWebResponse.DateTimeLastError,false),
					                             careCreditWebResponse.LastResponseStr,
					HelianzBusiness.POut.Long  (careCreditWebResponse.ClinicNum),
					                             careCreditWebResponse.ServiceType.ToString(),
					                             careCreditWebResponse.TransType.ToString(),
					                             careCreditWebResponse.MerchantNumber,
					HelianzBusiness.POut.Bool  (careCreditWebResponse.HasLogged),
				});
			}
			return table;
		}
