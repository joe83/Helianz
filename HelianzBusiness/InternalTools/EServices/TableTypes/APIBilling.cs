...
namespace HelianzBusiness {
	///<summary>Only used internally by Helianz, Inc.  Not used by anyone else. Aggregates customer charges for usage of FHIR API.</summary>
	[Serializable()]
	[CrudTable(IsMissingInGeneral=true,CrudLocationOverride = @"..\..\..\HelianzBusiness\InternalTools\EServices\Crud")]
