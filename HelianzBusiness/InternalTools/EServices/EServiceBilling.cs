...
namespace HelianzBusiness {
	///<summary>Only used internally by Helianz, Inc.  Not used by anyone else. Aggregates customer charges for EServices.</summary>
	[Serializable()]
...
namespace HelianzBusiness {
	public class EServiceBillings {		
		...
		public static List<Procedure> AddEServiceRepeatingChargesHelper(DateTime dateRun,List<RepeatCharge> listRepeatCharges) {
			...
			List<ProcedureCode> listProcCodes=HelianzBusiness.Crud.ProcedureCodeCrud.TableToList(DataCore.GetTable(command));
