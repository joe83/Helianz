...
namespace HelianzBusiness{
	...
	///Only used internally by Helianz, Inc.  Not used by anyone else. Aggregates customer charges for integrated texting.</summary>
	[Serializable()]
	...
	public class SmsBilling:TableBase {
		...
		///<summary>The aggregate cost of all message parts charged by Helianz to the customer. Will need to be summed as the sum of all parts of multi-part messages.
		///Is a function of MsgCost and is calculated from SMSResponse as a result of SendSMS. Maps to HelianzBusiness.SmsToMobile.MsgCostUSD.</summary>
