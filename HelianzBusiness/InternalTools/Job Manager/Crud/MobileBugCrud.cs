	...
	public class MobileBugCrud {
		...
		public static List<MobileBug> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(bugStatus=="") {
					mobileBug.BugStatus    =(HelianzBusiness.MobileBugStatus)0;
				}
				else try{
					mobileBug.BugStatus    =(HelianzBusiness.MobileBugStatus)Enum.Parse(typeof(HelianzBusiness.MobileBugStatus),bugStatus);
				}
				catch{
					mobileBug.BugStatus    =(HelianzBusiness.MobileBugStatus)0;
				}
				...
				mobileBug.Platforms      = (HelianzBusiness.Platforms)PIn.Int(row["Platforms"].ToString());
