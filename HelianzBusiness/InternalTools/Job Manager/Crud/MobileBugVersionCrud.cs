	...
	public class MobileBugVersionCrud {
		...
		public static List<MobileBugVersion> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(bugStatus=="") {
					mobileBugVersion.BugStatus        =(HelianzBusiness.MobileBugStatus)0;
				}
				else try{
					mobileBugVersion.BugStatus        =(HelianzBusiness.MobileBugStatus)Enum.Parse(typeof(HelianzBusiness.MobileBugStatus),bugStatus);
				}
				catch{
					mobileBugVersion.BugStatus        =(HelianzBusiness.MobileBugStatus)0;
				}
				...
				if(appType=="") {
					mobileBugVersion.AppType          =(HelianzBusiness.AppType)0;
				}
				else try{
					mobileBugVersion.AppType          =(HelianzBusiness.AppType)Enum.Parse(typeof(HelianzBusiness.AppType),appType);
				}
				catch{
					mobileBugVersion.AppType          =(HelianzBusiness.AppType)0;
				}
