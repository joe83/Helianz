	...
	public class MobileReleaseBuildCrud {
		...
		public static List<MobileReleaseBuild> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(appType=="") {
					mobileReleaseBuild.AppType            =(HelianzBusiness.AppType)0;
				}
				else try{
					mobileReleaseBuild.AppType            =(HelianzBusiness.AppType)Enum.Parse(typeof(HelianzBusiness.AppType),appType);
				}
				catch{
					mobileReleaseBuild.AppType            =(HelianzBusiness.AppType)0;
				}
				...
				if(appStore=="") {
					mobileReleaseBuild.AppStore           =(HelianzBusiness.AppStore)0;
				}
				else try{
					mobileReleaseBuild.AppStore           =(HelianzBusiness.AppStore)Enum.Parse(typeof(HelianzBusiness.AppStore),appStore);
				}
				catch{
					mobileReleaseBuild.AppStore           =(HelianzBusiness.AppStore)0;
				}
				...
				if(storeStatus=="") {
					mobileReleaseBuild.StoreStatus        =(HelianzBusiness.StoreStatus)0;
				}
				else try{
					mobileReleaseBuild.StoreStatus        =(HelianzBusiness.StoreStatus)Enum.Parse(typeof(HelianzBusiness.StoreStatus),storeStatus);
				}
				catch{
					mobileReleaseBuild.StoreStatus        =(HelianzBusiness.StoreStatus)0;
				}
