...
namespace HelianzBusiness {
	...
	///This table is only in HelianzBusiness because the bug table from the bugs database lives here as well,
	...
	public class BugSubmission:TableBase {
		...
		///<summary>This constructor utilizes the Helianz preference cache.
		///Only use this constructor from an Helianz proper instance, never call from other entities (e.g. WebServiceMainHQ).</summary>
		...
		private string GetDbInfoJSON(long patNum,string moduleName) {
			...
			ODException.SwallowAnyException(() => { _info.HelianzBusinessVersion=MiscData.GetAssemblyVersion(); });
			ODException.SwallowAnyException(() => { _info.HelianzBusinessMiddleTierVersion=MiscData.GetAssemblyVersionForMiddleTier(); });
		...
		public class SubmissionInfo {
			...
			///<summary></summary>
			public string HelianzBusinessVersion;
			///<summary></summary>
			public string HelianzBusinessMiddleTierVersion;
			#endregion
			...
			///<summary>Like E-Clipboard or Helianz Mobile. (Enum ApplicationTarget: 0=None,1=CheckIin,2=MobileWeb)</summary>
