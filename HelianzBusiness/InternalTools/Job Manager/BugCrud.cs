	...
	public class BugCrud {
		...
		public static List<Bug> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				bug.Status_      = (BugStatus)Enum.Parse(typeof(HelianzBusiness.BugStatus),row["Status_"].ToString());
				bug.Type_        = (BugType)Enum.Parse(typeof(HelianzBusiness.BugType),row["Type_"].ToString());
