...
namespace HelianzBusiness {
	///<summary>Only used internally by Helianz, Inc.  Not used by anyone else. Aggregates customer charges for usage of OD Cloud.</summary>
	[Serializable()]
	[CrudTable(IsMissingInGeneral=true,CrudLocationOverride=@"..\..\..\HelianzBusiness\InternalTools\Cloud\Crud")]
