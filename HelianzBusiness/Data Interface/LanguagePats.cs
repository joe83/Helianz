...
namespace HelianzBusiness{
	...
	public class LanguagePats{
		...
		///<summary>Gets a list of all languages corresponding to a list of PrefNames from the db. Does not include default language. Used in HelianzWebApps to generate ApptReminderRules for WebSchedRecall.</summary>
		...
		///<summary>Gets a list of translations corresponding to a list of PrefNames and languages. Used in HelianzWebApps to check for WebSchedRecall URL tags.</summary>
