...
namespace HelianzBusiness{
	...
	public class Sheets{
		...
		///<summary>Used to get sheets that were automatically downloaded by the Helianz Service. These are the sheets that have many or no matching patients that still need to be manually attached to an existing or new pat.</summary>
		...
		///<summary>Used to get the count of sheets that are going to be downloaded by the Helianz Service. Used for creating AlertItems.</summary>
		...
		///<summary>This is supposed to be used explicity with Sheets and not the old Helianz way of creating sheets.</summary>
