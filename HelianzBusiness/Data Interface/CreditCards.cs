...
namespace HelianzBusiness{
	...
	public class CreditCards{
		...
		///<summary>If patNum==0 then does not filter on PatNum; otherwise filters on PatNum. Only includes credit cards whose source is Helianz
		///proper.</summary>
		...
		public static List<RecurringChargeData> GetRecurringChargeList(List<long> listClinicNums,DateTime date) {
			...
			command+=") due "
				...
				//We want to exclude any cards that are currently being processed by Helianz Service or a different human.
