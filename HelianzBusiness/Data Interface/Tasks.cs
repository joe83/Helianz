...
namespace HelianzBusiness{
	...
	public class Tasks {
		...
		///<summary>Sent in from FormHelianz. Allows static method for business layer to cause task navigation in FormHelianz.</summary>
		...
		public static Task CopyReminderToNextDueDate(Task taskReminder) {
			...
			//Here we do our best to follow the signal logic in Helianz namespace.  This may be unneccessary because the copied task isn't due 
