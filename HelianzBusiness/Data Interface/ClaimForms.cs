...
namespace HelianzBusiness{
	...
	public class ClaimForms {
		...
		///<summary>Returns a list of all internal claims within the HelianzBusiness resources.  Throws exceptions.</summary>
		public static List<ClaimForm> GetInternalClaims() {
			Meth.NoCheckMiddleTierRole();
			List<ClaimForm> listClaimFormsInternal = new List<ClaimForm>();
			ResourceSet resourceSet=HelianzBusiness.Properties.Resources.ResourceManager.GetResourceSet(CultureInfo.CurrentUICulture,true,true);
