...
namespace HelianzBusiness{
	...
	public class ActiveInstances{
		...
		///<summary>Gets the Active Instance for the current Helianz session. This is not
		...
		///<summary>Sets the Active Instance for the current Helianz session. This is not
		///honored on the middle tier server, and should not be called from there.</summary>
