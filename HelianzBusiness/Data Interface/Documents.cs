...
namespace HelianzBusiness {
	...
	public class Documents {
		...
		///<summary>Will create a payment plan PDF without any references to Helianz. This method is only used in areas that don't have access to 
		///Helianz and should only be used in such a case. Returns true if it successfully saved a document.</summary>
		...
		///<summary>Will create a treatment plan PDF without any references to Helianz. This method is only used in areas that don't have access to 
		///Helianz and should only be used in such a case. Returns empty string if it successfully saved a document.</summary>
		...
		///<summary>Will create a treatment plan PDF without any references to Helianz. This method is only used for the API. 
