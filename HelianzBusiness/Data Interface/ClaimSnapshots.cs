...
namespace HelianzBusiness{
	...
	public class ClaimSnapshots{
		...
		///If called from Helianz Service, ignore passed in claimprocs and make snapshots for the entire day of completed procedures in a different method.
		...
		///<summary>Users using the HelianzService to create claim snapshots only get primary claim snap shots created.</summary>
