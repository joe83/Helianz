...
namespace HelianzBusiness {
	public class ComputerPrefs {
		...
		///<summary>Returns the computer preferences for the computer which this instance of Helianz is running on.</summary>
		...
		///<summary>Sets the GraphicsSimple column to 1.  Added to fix machines (lately tablets) that are having graphics problems and cannot start Helianz.</summary>
