...
namespace HelianzBusiness{
	...
	public class EmailAttaches{
		...
		///<summary>Throws exceptions.  Creates a new file inside of the email attachment path (inside HelianzImages) and returns an EmailAttach object 
		...
		public static string GetAttachPath() {
			...
			attachPath=ODFileUtils.CombinePaths(Path.GetTempPath(),"helianz");//Have to use Path.GetTempPath() here instead of PrefL.GetTempPathFolder() because we can't access PrefL.
			return attachPath;
		}
