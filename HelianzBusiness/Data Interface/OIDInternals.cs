...
namespace HelianzBusiness{
	...
	public class OIDInternals{
		public static string HelianzOID="2.16.840.1.113883.3.4337";
		private static long _customerPatNum=0;

		///<summary>The PatNum at Helianz HQ associated to this database's registration key.
...
#if DEBUG
					HelianzBusiness.localhost.Service1 OIDService=new HelianzBusiness.localhost.Service1();
#else
					HelianzBusiness.customerUpdates.Service1 OIDService=new HelianzBusiness.customerUpdates.Service1();
