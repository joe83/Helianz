...
namespace HelianzBusiness{
  ///<summary></summary>
	public class Screens {
		...
		///<summary></summary>
		public static long Insert(HelianzBusiness.Screen screen) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
		...
		///<summary></summary>
		public static void Update(HelianzBusiness.Screen screen){
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
		...
		///<summary></summary>
		public static void Delete(HelianzBusiness.Screen screen){
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				Meth.GetVoid(MethodBase.GetCurrentMethod(),screen);
				return;
			}
