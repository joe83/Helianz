...
using EdgeExpressProps=HelianzBusiness.ProgramProperties.PropertyDescs.EdgeExpress;
...
namespace HelianzBusiness {
	...
	public class ProgramProperties{
		...
		public static void GetXWebCreds(long clinicNum,out HelianzBusiness.WebTypes.Shared.XWeb.WebPaymentProperties xwebProperties) {
			string xWebID;
			string authKey;
			string terminalID;
		...
		public static void GetPayConnectPatPortalCreds(long clinicNum,out PayConnect.WebPaymentProperties payConnectProps) {
			...
			HelianzBusiness.Program programPayConnect=HelianzBusiness.Programs.GetCur(HelianzBusiness.ProgramName.PayConnect);
			...
			List<HelianzBusiness.ProgramProperty> listPayConnectProperties=HelianzBusiness.ProgramProperties.GetListForProgramAndClinic(programPayConnect.ProgramNum,clinicNum);
			payConnectProps.Token=HelianzBusiness.ProgramProperties.GetPropValFromList(listPayConnectProperties,PayConnect.ProgramProperties.PatientPortalPaymentsToken,clinicNum);
			payConnectProps.ProgramVersion=PIn.Int(HelianzBusiness.ProgramProperties.GetPropValFromList(listPayConnectProperties,PayConnect.ProgramProperties.ProgramVersion,clinicNum));
			...
			string paymentsAllowedVal=HelianzBusiness.ProgramProperties.GetPropValFromList(listPayConnectProperties,PayConnect.ProgramProperties.PatientPortalPaymentsEnabled,clinicNum);
			payConnectProps.IsPaymentsAllowed=HelianzBusiness.PIn.Bool(paymentsAllowedVal);
		}
		...
		public static void GetPaySimpleOnlinePaymentCreds(long clinicNum,out PaySimple.WebPaymentProperties paySimpleProps) {
			...
			HelianzBusiness.Program programPaySimple=HelianzBusiness.Programs.GetCur(HelianzBusiness.ProgramName.PaySimple);
			...
			List<HelianzBusiness.ProgramProperty> listPaySimpleProperties=HelianzBusiness.ProgramProperties.GetListForProgramAndClinic(programPaySimple.ProgramNum,clinicNum);
			paySimpleProps.Token=HelianzBusiness.ProgramProperties.GetPropValFromList(listPaySimpleProperties,PaySimple.PropertyDescs.PaySimpleApiKey,clinicNum);
			...
			string paymentsAllowedVal=HelianzBusiness.ProgramProperties.GetPropValFromList(listPaySimpleProperties,PaySimple.PropertyDescs.PaySimpleIsOnlinePaymentsEnabled,clinicNum);
			paySimpleProps.IsOnlinePaymentAllowed=HelianzBusiness.PIn.Bool(paymentsAllowedVal);
		}
