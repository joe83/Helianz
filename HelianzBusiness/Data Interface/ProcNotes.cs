...
namespace HelianzBusiness {
	public class ProcNotes{
		...
		public static ProcNote ProcNoteSignatureForApi(ProcNote odbProcNote,string apiSignatureString) {
			...
			//HelianzBusiness.Procedures.GetSignatureKeyData()
			...
			//HelianzBusiness.UI.SignatureBox.SetKeyString()
			UTF8Encoding utf8Encoding=new UTF8Encoding();
			//Helianz.UI.SignatureBoxWrapper.GetSignature()
			...
			//Helianz.UI.SignatureBox.SetAutoKeyData()
			hashNew=ODCrypt.MD5.Hash(Encoding.UTF8.GetBytes(keyData));
			//Helianz.UI.SignatureBox.GetSigString()
