	...
	public class EClipboardImageCaptureDefs{
		...
		*/
		...
		public static bool Sync(List<EClipboardImageCaptureDef> listEClipboardImageCaptureDefsNew,List<EClipboardImageCaptureDef> listEClipboardImageCaptureDefsOld) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),listEClipboardImageCaptureDefsNew,listEClipboardImageCaptureDefsOld);
			}
			return Crud.EClipboardImageCaptureDefCrud.Sync(listEClipboardImageCaptureDefsNew,listEClipboardImageCaptureDefsOld);
		}
