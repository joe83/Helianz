...
namespace HelianzBusiness{
	...
	public class Payments {
		...
		public static List<PaymentForApi> GetPaymentsForApi(int limit,int offset,long patNum,long defNumPayType,DateTime dateEntry) {
			...
			DateTime dateTimeServer=PIn.DateT(HelianzBusiness.Db.GetScalar(commandDatetime)); //run before payments for rigorous inclusion of payments
		...
		///<summary>Gets all payments that have a ProcessStatus of OnlinePending. Pass in an empty list to get payments for all clinics. Referenced by HelianzService.</summary>
		...
		///<summary>Used in HelianzWebApps to get the payment based off of paysimple's payment ID.</summary>
