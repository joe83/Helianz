...
namespace HelianzBusiness{
	...
	public class DocumentMiscs{
		...
		public static string LaunchShareScreen() {
			...
			string shareScreenUriBase="https://helianz.com/resources/HelianzShareScreen";
			...
			if(isDownloadNeeded) {//local exe is missing, corrupt, or an old version.
				...
				if(documentMiscExisting==null) {
					//A complete HelianzShareScreen.exe of this version does not exist in the database yet. Download from website.
