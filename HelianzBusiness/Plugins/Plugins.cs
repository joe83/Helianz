...
namespace HelianzBusiness {
	public class Plugins {
		...
		///<summary>This is only for middle tier. See the similar method Helianz.PluginLoader.LoadAllPlugins for the normal loading. Not sure why anyone would load a plugin in MT, but left this in place until we figure it out.  This MT version does not check any sort of plugin whitelist.</summary>
		public static void LoadAllPlugins(Form host=null) {
			...
			//		+"\r\n\r\nPlease see https://www.helianz.com/site/pluginwhitelisting.html for more details.";
		...
		///So HelianzBusiness can be passed through here quickly to return null.</summary>
