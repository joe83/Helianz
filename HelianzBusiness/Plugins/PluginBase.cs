...
namespace HelianzBusiness {
	public abstract class PluginBase {
		...
		///<summary>This will be a refrence to the main FormHelianz so that it can be used by    the plugin if needed.  It is set once on startup, so it's a good place to put startup code.   If this is the middle tier, then this will be null.</summary>
