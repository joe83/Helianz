...
namespace HelianzBusiness.HL7 {
	///<summary>A VXU message is an Unsolicited Vaccination Record Update.  It is a message sent out from Helianz detailing vaccinations that were given.
	...
	public class EhrVXU {
		...
		private void MSH() {
			_seg=new SegmentHL7("MSH"
				...
				+"|Helianz"//MSH-3 Sending Application.  Required if known (length unspecified).  Value set HL70361  (guide page 229, "no suggested values defined").  Type HD (guide page 65).
		...
		private void PID() {
			...
			_seg.SetField(3,
				...
				"Helianz",//PID-3.4 Assigning Authority.  Required.  Value set HL70363.
		...
		//example 1:
		/*
MSH|^~\&|Helianz||||20110316102457||VXU^V04^VXU_V04|OD-110316102457117|P|2.5.1
