	...
	public class EhrADT_A01 {
		...
		private void MSH() {
			_seg=new SegmentHL7("MSH"
				...
				+"|Helianz"//MSH-3 Sending Application.  Optional (length 1..227).
		...
		private void PID() {
			...
			_seg.SetField(3,
				...
				"Helianz",//PID-3.4 Assigning Authority.  Required (1..227).  Value set HL70363.
			...
			if(_pat.SSN.Trim()!="") {
				_seg.RepeatField(3,
					...
					"",//PID-3.2 Check Digit.  Optional (length 1..1).
					"",//PID-3.3 Check Digit Scheme.  No longer used.
					"Helianz",//PID-3.4 Assigning Authority.  Required (length 1..227).  Value set HL70363.
