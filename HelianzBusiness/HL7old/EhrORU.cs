...
namespace HelianzBusiness.HL7 {
	///<summary>An ORU message is an Unsolicited Observation Message.  It is a message sent out from Helianz containing immunization status in order to satisfy ehr public health requirements.</summary>
	public class EhrORU {
		...
		private void MSH(){
			seg=new SegmentHL7(@"MSH|^~\&|Helianz|"//MSH-3: Sending application
