...
namespace HelianzBusiness {
	public class PrefC {
		...
		///<summary>Static variable used to always reflect FormHelianz.IsTreatPlanSortByTooth.  
		///This setter should only be called in FormHelianz.IsTreatPlanSortByTooth.  
		...
		///<summary>Returns the path to the temporary helianz directory, temp/helianz.  Also performs one-time cleanup, if necessary.  In FormHelianz_FormClosing, the contents of temp/helianz get cleaned up.</summary>
		public static string GetTempFolderPath() {
			//Will clean up entire temp folder for a month after the enhancement of temp file cleanups as long as the temp\helianz folder doesn't already exist.
