//These notes describe when to use this Logic folder in HelianzBusiness.

//There is another Logic folder in Helianz that is slightly different.
//Use that one when there are MsgBoxes or you don't need to access from HelianzBusiness.
