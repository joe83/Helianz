...
namespace HelianzBusiness.Eclaims {
		...
		private static string MessageFr4(int errorCode){
			switch(errorCode){
				default:
					break;
				case 1:
					return "Pr�fixe de la transaction absent ou invalide";
				case 2:
					return "Num�ro de demande de prestations ou de transaction du cabinet absent ou invalide";
				case 3:
					return "Num�ro de version absent ou invalide";
				case 4:
					return "Code de la transaction absent ou invalide";
				case 5:
					return "Num�ro de l'assureur absent ou invalide";
				case 6:
					return "Num�ro du logiciel dentaire absent ou invalide";
				case 7:
					return "Num�ro du dentiste attribu� par l'ADC absent ou invalide";
				case 8:
					return "Num�ro du cabinet attribu� par l'ADC absent ou invalide";
				case 9:
					return "Num�ro de police ou r�gime (premier assureur) absent ou invalide";
				case 10:
					return "Num�ro de section ou de division absent ou invalide";
				case 11:
					return "Num�ro du titulaire de l'assurance absent ou invalide";
				case 12:
					return "Code indiquant lien de parent� patient-titulaire absent ou invalide";
				case 13:
				...
				case 16:
					return "Pr�nom du patient absent ou invalide";
				case 17:
					return "Code indiquant exception quant � l'admissibilit� absent ou invalide";
				case 18:
					return "Nom de l'�tablissement scolaire absent";
				case 19:
					return "Nom de famille du titulaire de l'assurance absent ou non conforme au dossier";
				case 20:
					return "Pr�nom du titulaire de l'assurance absent ou non conforme au dossier";
				case 21:
				...
				case 24:
					return "Langue premi�re du titulaire de l'assurance invalide";
				case 25:
					return "Date de naissance du titulaire de l'assurance absente ou invalide";
				case 26:
					return "Num�ro du second assureur invalide";
				case 27:
					return "Num�ro de police ou r�gime (second assureur) absent ou invalide";
				case 28:
					return "Num�ro de division ou section (second assureur) absent ou invalide";
				case 29:
					return "Num�ro du titulaire (second assureur) absent ou invalide";
				case 30:
					return "Date de naissance du titulaire (second assureur) absente ou invalide";
				case 31:
					return "Demande doit d'abord �tre soumise au second assureur (second assureur = premier assureur)";
				case 32:
					return "Destinataire du paiement absent ou invalide";
				case 33:
					return "Date de l'accident invalide";
				case 34:
					return "Nombre d'actes ex�cut�s absent ou invalide";
				case 35:
					return "Code de l'acte absent ou invalide";
				case 36:
					return "Date � laquelle l'acte a �t� ex�cut� absente ou invalide";
				case 37:
					return "Num�ro de dent international, sextant, quadrant ou site absent ou invalide";
				case 38:
					return "Surface de la dent absente ou invalide";
				case 39:
					return "Date de la mise en bouche initiale au maxillaire invalide";
				case 40:
					return "R�ponse absente ou invalide : Le traitement est-il requis en vue de soins d'orthodontie ?";
				case 41:
					return "Honoraires demand�s par le dentiste absents ou invalides";
				case 42:
					return "Frais de laboratoire absents ou invalides";
				case 43:
					return "Unit� de temps absente ou invalide";
				case 44:
					return "Longueur du message indiqu�e non identique � longueur du message re�u";
				case 45:
					return "Indicateur de courrier �lectronique ou d'informations suppl�mentaires absent ou invalide";
				case 46:
					return "Num�ro de r�f�rence de la demande de prestations absent ou invalide";
				case 47:
					return "Dentiste n'a pas acc�s au r�seau CDAnet";
				case 48:
					return "Veuillez soumettre demande manuellement";
				case 49:
					return "Pas de r�ponse en suspens provenant du r�seau demand�e";
				case 50:
					return "Num�ro de ligne de l'acte absent ou invalide";
				case 51:
					return "Num�ro du plan de traitement introuvable";
				case 52:
				...
				case 54:
					return "Num�ro du titulaire sur Refus non conforme � demande originale";
				case 55:
					return "Annulation ne concerne pas transaction du jour";
				case 56:
					return "Code de sp�cialit� du dentiste non conforme au dossier";
				case 57:
					return "R�ponse absente ou invalide : S'agit-il de la mise en bouche initiale au maxillaire ?";
				case 58:
					return "Nombre d'actes non conforme au nombre indiqu�";
				case 59:
					return "Logiciel dentaire du cabinet non autoris� � transmettre transactions au CDAnet";
				case 60:
					return "Annulation ne peut �tre accept�e maintenant - R�essayer plus tard aujourd'hui";
				case 61:
					return "Erreur du r�seau - Veuillez recommencer";
				case 62:
					return "Num�ro du dentiste destinataire du paiement absent ou invalide";
				case 63:
					return "Num�ro du cabinet destinataire du paiement absent ou invalide";
				case 64:
					return "Dentiste ayant adress� (r�f�r�) patient absent ou invalide";
				case 65:
					return "Code indiquant motif de la recommandation absent ou invalide";
				case 66:
					return "Indicateur d'un r�gime de soins absent ou invalide";
				case 67:
					return "Champs se rapportant au r�gime NNSA absents";
				case 68:
					return "Num�ro de la bande absent ou invalide";
				case 69:
					return "Num�ro de la famille absent ou invalide";
				case 70:
					return "Odontogramme des dents manquantes absent ou invalide";
				case 71:
					return "Code indiquant parent� patient-titulaire (second assureur) absent ou invalide";
				case 72:
					return "Code indiquant type d'acte absent ou invalide";
				case 73:
					return "S�rie de dents absente ou invalide";
				case 74:
					return "Date � laquelle l'acte a �t� ex�cut� est une date ult�rieure";
				case 75:
					return "Date � laquelle l'acte a �t� ex�cut� est au-del� d'un an";
				case 76:
					return "Groupe non accept� par l'EDI";
				case 77:
				...
				case 81:
					return "Date d'admissibilit� invalide";
				case 82:
					return "Num�ro de s�quence ou version de la carte invalide";
				case 83:
					return "Nom de famille du titulaire (second assureur) absent ou invalide";
				case 84:
					return "Pr�nom du titulaire (second assureur) absent ou invalide";
				case 85:
					return "Lettre initiale du second pr�nom du titulaire (second assureur) invalide";
				case 86:
					return "Premi�re ligne de l'adresse du titulaire (second assureur) absente";
				case 87:
					return "Ville du titulaire (second assureur) absente";
				case 88:
					return "Province ou �tat du titulaire (second assureur) absent";
				case 89:
					return "Code postal ou zip du titulaire (second assureur) invalide";
				case 90:
					return "R�ponse absente ou invalide : S'agit-il de la mise en bouche initiale � la mandibule ?";
				case 91:
					return "Date de la mise en bouche initiale � la mandibule absente ou invalide";
				case 92:
					return "Mat�riau de la proth�se au maxillaire absent ou invalide";
				case 93:
					return "Mat�riau de la proth�se � la mandibule absent ou invalide";
				case 94:
					return "Nombre de dents extraites absent ou invalide";
				case 95:
					return "Num�ro de la dent extraite absent ou invalide";
				case 96:
					return "Date de l'extraction absente ou invalide";
				case 97:
					return "D�calage du rapprochement invalide";
				case 98:
				...
				case 101:
					return "Initiale du second pr�nom du titulaire invalide";
				case 102:
					return "Initiale du second pr�nom du patient invalide";
				case 103:
					return "Code de la personne � charge (premi�re assurance) absent ou invalide";
				case 104:
					return "Code de la personne � charge (seconde assurance) absent ou invalide";
				case 105:
					return "Num�ro de s�quence/version de la carte (seconde assurance) absent ou invalide";
				case 106:
					return "Langue de titulaire (seconde assurance) absente ou invalide";
				case 107:
					return "Indicateur de r�gime (seconde assurance) absente ou invalide";
				case 108:
					return "Champs portant sur la seconde assurance absents";
				case 109:
					return "Num�ro de s�quence (seconde assurance) absent ou invalide";
				case 110:
				...
				case 115:
					return "Dur�e du traitement absente ou invalide";
				case 116:
					return "Nombre pr�vu de paiements absent ou invalide";
				case 117:
					return "Montant pr�vue du paiement absent ou invalide";
				case 118:
					return "Code des frais de laboratoire #2 absent ou invalide";
				case 119:
					return "Frais de laboratoire #2 absents ou invalide";
				case 120:
					return "D�but pr�vue de traitement";
				case 121:
					return "D�tail des prestations (premi�re assurance) modifi�, diff�rent de l�original";
				case 122:
					return "Date plus disponible";
				case 123:
					return "Num�ro de page du rapprochement absent ou invalide";
				case 124:
					return "Transaction non accept�e par l�assureur";
				case 125:
					return "Version de transaction non accept�e";
				case 126:
					return "Code diagnostique absent ou invalide";
				case 127:
					return "Code institutionnelle absent ou invalide";
				case 128:
					return "Num�ro de page du plan de traitement courant absent ou invalide";
				case 129:
					return "Num�ro de page du dernier plan de traitement absent ou invalide";
				case 130:
				...
				case 134:
					return "";
				case 997:
					return "Derni�re transaction illisible";
				case 998:
					return "Pour usage futur par l'ADC";
				case 999:
					return "Erreur du syst�me central - Veuillez recommencer manuellement";
			}
