...
namespace HelianzBusiness.SheetFramework{
	public class ToothChartHelper{
		...
		public static Image GetToothChartImageProcess(List<Def> ListDefs,List<Procedure> ListProceduresFiltered,List<ToothInitial> ToothInitialList,HelianzBusiness.ToothNumberingNomenclature ToothNumberingNomenclature,
			List<HelianzBusiness.PerioMeasure> ListPerioMeasures, Dictionary<PrefName,Color> DictPrefToColor,List<Def> ListDefsPerio,List<Procedure> ListProcsForPerio,List<ProcedureCode> ListProcedureCodesForPerio,
			...
			if(IsForPerio) {
				...
				for (int i=0;i<ListPerioMeasures.Count;i++) {
					if(ListPerioMeasures[i].SequenceType==HelianzBusiness.PerioSequenceType.SkipTooth) {
						toothChart.SetMissing(ListPerioMeasures[i].IntTooth.ToString());
					} 
					else if(ListPerioMeasures[i].SequenceType==HelianzBusiness.PerioSequenceType.Mobility) {
	...
	public class ToothChartHelperData {
		...
		public HelianzBusiness.ToothNumberingNomenclature ToothNumberingNomenclature;
		public List<HelianzBusiness.PerioMeasure> ListPerioMeasures=new List<HelianzBusiness.PerioMeasure>();
