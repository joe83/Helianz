	...
	public class TaskHistCrud {
		...
		public static List<TaskHist> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				taskHist.TaskStatus       = (HelianzBusiness.TaskStatusEnum)PIn.Int(row["TaskStatus"].ToString());
				taskHist.IsRepeating      = PIn.Bool  (row["IsRepeating"].ToString());
				taskHist.DateType         = (HelianzBusiness.TaskDateType)PIn.Int(row["DateType"].ToString());
				taskHist.FromNum          = PIn.Long  (row["FromNum"].ToString());
				taskHist.ObjectType       = (HelianzBusiness.TaskObjectType)PIn.Int(row["ObjectType"].ToString());
				...
				taskHist.ReminderType     = (HelianzBusiness.TaskReminderType)PIn.Int(row["ReminderType"].ToString());
