	...
	public class TsiTransLogCrud {
		...
		public static List<TsiTransLog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				tsiTransLog.TransType     = (HelianzBusiness.TsiTransType)PIn.Int(row["TransType"].ToString());
				tsiTransLog.TransDateTime = PIn.DateT (row["TransDateTime"].ToString());
				tsiTransLog.ServiceType   = (HelianzBusiness.TsiServiceType)PIn.Int(row["ServiceType"].ToString());
				tsiTransLog.ServiceCode   = (HelianzBusiness.TsiServiceCode)PIn.Int(row["ServiceCode"].ToString());
				...
				tsiTransLog.FKeyType      = (HelianzBusiness.TsiFKeyType)PIn.Int(row["FKeyType"].ToString());
