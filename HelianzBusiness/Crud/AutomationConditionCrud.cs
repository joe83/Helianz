	...
	public class AutomationConditionCrud {
		...
		public static List<AutomationCondition> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				automationCondition.CompareField          = (HelianzBusiness.AutoCondField)PIn.Int(row["CompareField"].ToString());
				automationCondition.Comparison            = (HelianzBusiness.AutoCondComparison)PIn.Int(row["Comparison"].ToString());
