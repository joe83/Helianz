	...
	public class PayPlanCrud {
		...
		public static List<PayPlan> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				payPlan.PaySchedule           = (HelianzBusiness.PaymentSchedule)PIn.Int(row["PaySchedule"].ToString());
				...
				payPlan.ChargeFrequency       = (HelianzBusiness.PayPlanFrequency)PIn.Int(row["ChargeFrequency"].ToString());
				...
				payPlan.DynamicPayPlanTPOption= (HelianzBusiness.DynamicPayPlanTPOptions)PIn.Int(row["DynamicPayPlanTPOption"].ToString());
