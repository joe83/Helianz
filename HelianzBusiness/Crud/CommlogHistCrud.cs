	...
	public class CommlogHistCrud {
		...
		public static List<CommlogHist> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				commlogHist.HistSource          = (HelianzBusiness.CommlogHistSource)PIn.Int(row["HistSource"].ToString());
				...
				commlogHist.Mode_               = (HelianzBusiness.CommItemMode)PIn.Int(row["Mode_"].ToString());
				commlogHist.SentOrReceived      = (HelianzBusiness.CommSentOrReceived)PIn.Int(row["SentOrReceived"].ToString());
				...
				commlogHist.CommSource          = (HelianzBusiness.CommItemSource)PIn.Int(row["CommSource"].ToString());
				commlogHist.ProgramNum          = PIn.Long  (row["ProgramNum"].ToString());
				commlogHist.ReferralNum         = PIn.Long  (row["ReferralNum"].ToString());
				commlogHist.CommReferralBehavior= (HelianzBusiness.EnumCommReferralBehavior)PIn.Int(row["CommReferralBehavior"].ToString());
