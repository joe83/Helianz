	...
	public class TreatPlanCrud {
		...
		public static List<TreatPlan> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				treatPlan.TPStatus             = (HelianzBusiness.TreatPlanStatus)PIn.Int(row["TPStatus"].ToString());
				...
				treatPlan.TPType               = (HelianzBusiness.TreatPlanType)PIn.Int(row["TPType"].ToString());
