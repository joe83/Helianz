	...
	public class AlertItemCrud {
		...
		public static List<AlertItem> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				alertItem.Type         = (HelianzBusiness.AlertType)PIn.Int(row["Type"].ToString());
				alertItem.Severity     = (HelianzBusiness.SeverityType)PIn.Int(row["Severity"].ToString());
				alertItem.Actions      = (HelianzBusiness.ActionType)PIn.Int(row["Actions"].ToString());
				alertItem.FormToOpen   = (HelianzBusiness.FormType)PIn.Int(row["FormToOpen"].ToString());
