	...
	public class BenefitCrud {
		...
		public static List<Benefit> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				benefit.BenefitType      = (HelianzBusiness.InsBenefitType)PIn.Int(row["BenefitType"].ToString());
				benefit.Percent          = PIn.Int   (row["Percent"].ToString());
				benefit.MonetaryAmt      = PIn.Double(row["MonetaryAmt"].ToString());
				benefit.TimePeriod       = (HelianzBusiness.BenefitTimePeriod)PIn.Int(row["TimePeriod"].ToString());
				benefit.QuantityQualifier= (HelianzBusiness.BenefitQuantity)PIn.Int(row["QuantityQualifier"].ToString());
				benefit.Quantity         = PIn.Byte  (row["Quantity"].ToString());
				benefit.CodeNum          = PIn.Long  (row["CodeNum"].ToString());
				benefit.CoverageLevel    = (HelianzBusiness.BenefitCoverageLevel)PIn.Int(row["CoverageLevel"].ToString());
				...
				benefit.TreatArea        = (HelianzBusiness.TreatmentArea)PIn.Int(row["TreatArea"].ToString());
				retVal.Add(benefit);
			}
			return retVal;
		}
