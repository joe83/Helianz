	...
	public class RefAttachCrud {
		...
		public static List<RefAttach> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				refAttach.RefType           = (HelianzBusiness.ReferralType)PIn.Int(row["RefType"].ToString());
				refAttach.RefToStatus       = (HelianzBusiness.ReferralToStatus)PIn.Int(row["RefToStatus"].ToString());
