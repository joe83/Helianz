	...
	public class PayPlanTemplateCrud {
		...
		public static List<PayPlanTemplate> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				payPlanTemplate.ChargeFrequency       = (HelianzBusiness.PayPlanFrequency)PIn.Int(row["ChargeFrequency"].ToString());
				payPlanTemplate.DownPayment           = PIn.Double(row["DownPayment"].ToString());
				payPlanTemplate.DynamicPayPlanTPOption= (HelianzBusiness.DynamicPayPlanTPOptions)PIn.Int(row["DynamicPayPlanTPOption"].ToString());
