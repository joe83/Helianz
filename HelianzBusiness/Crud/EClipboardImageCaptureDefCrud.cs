	...
	public class EClipboardImageCaptureDefCrud {
		...
		public static List<EClipboardImageCaptureDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eClipboardImageCaptureDef.OcrCaptureType              = (HelianzBusiness.EnumOcrCaptureType)PIn.Int(row["OcrCaptureType"].ToString());
				eClipboardImageCaptureDef.Frequency                   = (HelianzBusiness.EnumEClipFreq)PIn.Int(row["Frequency"].ToString());
