	...
	public class SheetFieldDefCrud {
		...
		public static List<SheetFieldDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				sheetFieldDef.FieldType               = (HelianzBusiness.SheetFieldType)PIn.Int(row["FieldType"].ToString());
				...
				sheetFieldDef.GrowthBehavior          = (HelianzBusiness.GrowthBehaviorEnum)PIn.Int(row["GrowthBehavior"].ToString());
				...
				sheetFieldDef.LayoutMode              = (HelianzBusiness.SheetFieldLayoutMode)PIn.Int(row["LayoutMode"].ToString());
