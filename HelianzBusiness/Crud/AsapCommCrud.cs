	...
	public class AsapCommCrud {
		...
		public static List<AsapComm> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				asapComm.FKeyType            = (HelianzBusiness.AsapCommFKeyType)PIn.Int(row["FKeyType"].ToString());
				...
				asapComm.SmsSendStatus       = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SmsSendStatus"].ToString());
				asapComm.EmailSendStatus     = (HelianzBusiness.AutoCommStatus)PIn.Int(row["EmailSendStatus"].ToString());
				...
				asapComm.ResponseStatus      = (HelianzBusiness.AsapRSVPStatus)PIn.Int(row["ResponseStatus"].ToString());
				...
				if(emailTemplateType=="") {
					asapComm.EmailTemplateType =(HelianzBusiness.EmailType)0;
				}
				else try{
					asapComm.EmailTemplateType =(HelianzBusiness.EmailType)Enum.Parse(typeof(HelianzBusiness.EmailType),emailTemplateType);
				}
				catch{
					asapComm.EmailTemplateType =(HelianzBusiness.EmailType)0;
				}
