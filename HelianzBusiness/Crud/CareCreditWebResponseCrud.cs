	...
	public class CareCreditWebResponseCrud {
		...
		public static List<CareCreditWebResponse> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(processingStatus=="") {
					careCreditWebResponse.ProcessingStatus      =(HelianzBusiness.CareCreditWebStatus)0;
				}
				else try{
					careCreditWebResponse.ProcessingStatus      =(HelianzBusiness.CareCreditWebStatus)Enum.Parse(typeof(HelianzBusiness.CareCreditWebStatus),processingStatus);
				}
				catch{
					careCreditWebResponse.ProcessingStatus      =(HelianzBusiness.CareCreditWebStatus)0;
				}
				...
				if(serviceType=="") {
					careCreditWebResponse.ServiceType           =(HelianzBusiness.CareCreditServiceType)0;
				}
				else try{
					careCreditWebResponse.ServiceType           =(HelianzBusiness.CareCreditServiceType)Enum.Parse(typeof(HelianzBusiness.CareCreditServiceType),serviceType);
				}
				catch{
					careCreditWebResponse.ServiceType           =(HelianzBusiness.CareCreditServiceType)0;
				}
				...
				if(transType=="") {
					careCreditWebResponse.TransType             =(HelianzBusiness.CareCreditTransType)0;
				}
				else try{
					careCreditWebResponse.TransType             =(HelianzBusiness.CareCreditTransType)Enum.Parse(typeof(HelianzBusiness.CareCreditTransType),transType);
				}
				catch{
					careCreditWebResponse.TransType             =(HelianzBusiness.CareCreditTransType)0;
				}
