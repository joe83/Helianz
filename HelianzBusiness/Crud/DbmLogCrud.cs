	...
	public class DbmLogCrud {
		...
		public static List<DbmLog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				dbmLog.FKeyType     = (HelianzBusiness.DbmLogFKeyType)PIn.Int(row["FKeyType"].ToString());
				dbmLog.ActionType   = (HelianzBusiness.DbmLogActionType)PIn.Int(row["ActionType"].ToString());
