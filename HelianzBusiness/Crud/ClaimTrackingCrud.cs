	...
	public class ClaimTrackingCrud {
		...
		public static List<ClaimTracking> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(trackingType=="") {
					claimTracking.TrackingType     =(HelianzBusiness.ClaimTrackingType)0;
				}
				else try{
					claimTracking.TrackingType     =(HelianzBusiness.ClaimTrackingType)Enum.Parse(typeof(HelianzBusiness.ClaimTrackingType),trackingType);
				}
				catch{
					claimTracking.TrackingType     =(HelianzBusiness.ClaimTrackingType)0;
				}
