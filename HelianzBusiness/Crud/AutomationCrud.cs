	...
	public class AutomationCrud {
		...
		public static List<Automation> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				automation.Autotrigger       = (HelianzBusiness.EnumAutomationTrigger)PIn.Int(row["Autotrigger"].ToString());
				automation.ProcCodes         = PIn.String(row["ProcCodes"].ToString());
				automation.AutoAction        = (HelianzBusiness.AutomationAction)PIn.Int(row["AutoAction"].ToString());
				...
				automation.AptStatus         = (HelianzBusiness.ApptStatus)PIn.Int(row["AptStatus"].ToString());
				automation.AppointmentTypeNum= PIn.Long  (row["AppointmentTypeNum"].ToString());
				automation.PatStatus         = (HelianzBusiness.PatientStatus)PIn.Int(row["PatStatus"].ToString());
