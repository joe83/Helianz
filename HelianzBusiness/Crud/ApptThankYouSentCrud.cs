	...
	public class ApptThankYouSentCrud {
		...
		public static List<ApptThankYouSent> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				apptThankYouSent.SendStatus              = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				apptThankYouSent.MessageType             = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
