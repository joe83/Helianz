	...
	public class ToothGridDefCrud {
		...
		public static List<ToothGridDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				toothGridDef.CellType        = (HelianzBusiness.ToothGridCellType)PIn.Int(row["CellType"].ToString());
				...
				toothGridDef.ProcStatus      = (HelianzBusiness.ProcStat)PIn.Int(row["ProcStatus"].ToString());
