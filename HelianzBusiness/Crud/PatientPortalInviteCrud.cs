	...
	public class PatientPortalInviteCrud {
		...
		public static List<PatientPortalInvite> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				patientPortalInvite.SendStatus            = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				patientPortalInvite.MessageType           = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
