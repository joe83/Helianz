	...
	public class ChartViewCrud {
		...
		public static List<ChartView> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				chartView.ProcStatuses     = (HelianzBusiness.ChartViewProcStat)PIn.Int(row["ProcStatuses"].ToString());
				chartView.ObjectTypes      = (HelianzBusiness.ChartViewObjs)PIn.Int(row["ObjectTypes"].ToString());
				...
				chartView.OrionStatusFlags = (HelianzBusiness.OrionStatus)PIn.Int(row["OrionStatusFlags"].ToString());
				chartView.DatesShowing     = (HelianzBusiness.ChartViewDates)PIn.Int(row["DatesShowing"].ToString());
