	...
	public class PayConnectResponseWebCrud {
		...
		public static List<PayConnectResponseWeb> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				payConnectResponseWeb.CCSource                = (HelianzBusiness.CreditCardSource)PIn.Int(row["CCSource"].ToString());
				...
				if(processingStatus=="") {
					payConnectResponseWeb.ProcessingStatus      =(HelianzBusiness.PayConnectWebStatus)0;
				}
				else try{
					payConnectResponseWeb.ProcessingStatus      =(HelianzBusiness.PayConnectWebStatus)Enum.Parse(typeof(HelianzBusiness.PayConnectWebStatus),processingStatus);
				}
				catch{
					payConnectResponseWeb.ProcessingStatus      =(HelianzBusiness.PayConnectWebStatus)0;
				}
				...
				if(transType=="") {
					payConnectResponseWeb.TransType             =(HelianzBusiness.PayConnectService.transType)0;
				}
				else try{
					payConnectResponseWeb.TransType             =(HelianzBusiness.PayConnectService.transType)Enum.Parse(typeof(HelianzBusiness.PayConnectService.transType),transType);
				}
				catch{
					payConnectResponseWeb.TransType             =(HelianzBusiness.PayConnectService.transType)0;
				}
