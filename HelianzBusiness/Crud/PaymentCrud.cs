	...
	public class PaymentCrud {
		...
		public static List<Payment> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				payment.PaymentSource      = (HelianzBusiness.CreditCardSource)PIn.Int(row["PaymentSource"].ToString());
				payment.ProcessStatus      = (HelianzBusiness.ProcessStat)PIn.Int(row["ProcessStatus"].ToString());
				...
				payment.PaymentStatus      = (HelianzBusiness.PaymentStatus)PIn.Int(row["PaymentStatus"].ToString());
