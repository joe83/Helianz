	...
	public class JobCrud {
		...
		public static List<Job> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				job.Category               = (HelianzBusiness.JobCategory)PIn.Int(row["Category"].ToString());
				...
				job.PhaseCur               = (HelianzBusiness.JobPhase)PIn.Int(row["PhaseCur"].ToString());
				...
				job.PatternReviewProject   = (HelianzBusiness.JobPatternReviewProject)PIn.Int(row["PatternReviewProject"].ToString());
				job.PatternReviewStatus    = (HelianzBusiness.JobPatternReviewStatus)PIn.Int(row["PatternReviewStatus"].ToString());
				job.ProposedVersion        = (HelianzBusiness.JobProposedVersion)PIn.Int(row["ProposedVersion"].ToString());
