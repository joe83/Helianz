	...
	public class ClockEventCrud {
		...
		public static List<ClockEvent> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				clockEvent.ClockStatus       = (HelianzBusiness.TimeClockStatus)PIn.Int(row["ClockStatus"].ToString());
		...
		public static bool Update(ClockEvent clockEvent,ClockEvent oldClockEvent) {
			...
			if(clockEvent.Rate3Hours != oldClockEvent.Rate3Hours) {
				if(command!="") { command+=",";}
				command+="Rate3Hours = '"+POut.TSpan (clockEvent.Rate3Hours)+"'";
			}
