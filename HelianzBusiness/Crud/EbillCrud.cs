	...
	public class EbillCrud {
		...
		public static List<Ebill> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				ebill.PracticeAddress = (HelianzBusiness.EbillAddress)PIn.Int(row["PracticeAddress"].ToString());
				ebill.RemitAddress    = (HelianzBusiness.EbillAddress)PIn.Int(row["RemitAddress"].ToString());
				retVal.Add(ebill);
			}
			return retVal;
		}
