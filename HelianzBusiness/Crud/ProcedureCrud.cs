	...
	public class ProcedureCrud {
		...
		public static List<Procedure> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				procedure.ProcStatus         = (HelianzBusiness.ProcStat)PIn.Int(row["ProcStatus"].ToString());
				...
				procedure.PlaceService       = (HelianzBusiness.PlaceOfService)PIn.Int(row["PlaceService"].ToString());
				...
				procedure.DrugUnit           = (HelianzBusiness.EnumProcDrugUnit)PIn.Int(row["DrugUnit"].ToString());
				procedure.DrugQty            = PIn.Float (row["DrugQty"].ToString());
				procedure.UnitQtyType        = (HelianzBusiness.ProcUnitQtyType)PIn.Int(row["UnitQtyType"].ToString());
		...
		public static Procedure RowToObj(IDataRecord row) {
			return new Procedure {
				...
				ProcStatus         = (HelianzBusiness.ProcStat)PIn.Int(row["ProcStatus"].ToString()),
				ProvNum            = PIn.Long  (row["ProvNum"].ToString()),
				Dx                 = PIn.Long  (row["Dx"].ToString()),
				PlannedAptNum      = PIn.Long  (row["PlannedAptNum"].ToString()),
				PlaceService       = (HelianzBusiness.PlaceOfService)PIn.Int(row["PlaceService"].ToString()),
				...
				DrugUnit           = (HelianzBusiness.EnumProcDrugUnit)PIn.Int(row["DrugUnit"].ToString()),
				DrugQty            = PIn.Float (row["DrugQty"].ToString()),
				UnitQtyType        = (HelianzBusiness.ProcUnitQtyType)PIn.Int(row["UnitQtyType"].ToString()),
