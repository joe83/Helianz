	...
	public class ImageDrawCrud {
		...
		public static List<ImageDraw> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				imageDraw.DrawType        = (HelianzBusiness.ImageDrawType)PIn.Int(row["DrawType"].ToString());
				imageDraw.ImageAnnotVendor= (HelianzBusiness.EnumImageAnnotVendor)PIn.Int(row["ImageAnnotVendor"].ToString());
				imageDraw.Details         = PIn.String(row["Details"].ToString());
				imageDraw.PearlLayer      = (HelianzBusiness.Pearl.EnumCategoryOD)PIn.Int(row["PearlLayer"].ToString());
