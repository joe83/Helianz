	...
	public class CarrierCrud {
		...
		public static List<Carrier> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				carrier.NoSendElect               = (HelianzBusiness.NoSendElectType)PIn.Int(row["NoSendElect"].ToString());
				...
				carrier.CanadianSupportedTypes    = (HelianzBusiness.CanSupTransTypes)PIn.Int(row["CanadianSupportedTypes"].ToString());
				...
				carrier.TrustedEtransFlags        = (HelianzBusiness.TrustedEtransTypes)PIn.Int(row["TrustedEtransFlags"].ToString());
				carrier.CobInsPaidBehaviorOverride= (HelianzBusiness.EclaimCobInsPaidBehavior)PIn.Int(row["CobInsPaidBehaviorOverride"].ToString());
				carrier.EraAutomationOverride     = (HelianzBusiness.EraAutomationMode)PIn.Int(row["EraAutomationOverride"].ToString());
				carrier.OrthoInsPayConsolidate    = (HelianzBusiness.EnumOrthoInsPayConsolidate)PIn.Int(row["OrthoInsPayConsolidate"].ToString());
				retVal.Add(carrier);
			}
			return retVal;
		}
