	...
	public class TaskCrud {
		...
		public static List<Task> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				task.TaskStatus       = (HelianzBusiness.TaskStatusEnum)PIn.Int(row["TaskStatus"].ToString());
				task.IsRepeating      = PIn.Bool  (row["IsRepeating"].ToString());
				task.DateType         = (HelianzBusiness.TaskDateType)PIn.Int(row["DateType"].ToString());
				task.FromNum          = PIn.Long  (row["FromNum"].ToString());
				task.ObjectType       = (HelianzBusiness.TaskObjectType)PIn.Int(row["ObjectType"].ToString());
				...
				task.ReminderType     = (HelianzBusiness.TaskReminderType)PIn.Int(row["ReminderType"].ToString());
