	...
	public class EntryLogCrud {
		...
		public static List<EntryLog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				entryLog.FKeyType     = (HelianzBusiness.EntryLogFKeyType)PIn.Int(row["FKeyType"].ToString());
				entryLog.FKey         = PIn.Long  (row["FKey"].ToString());
				entryLog.LogSource    = (HelianzBusiness.LogSources)PIn.Int(row["LogSource"].ToString());
