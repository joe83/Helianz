	...
	public class StatementCrud {
		...
		public static List<Statement> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				statement.Mode_              = (HelianzBusiness.StatementMode)PIn.Int(row["Mode_"].ToString());
				...
				if(statementType=="") {
					statement.StatementType    =(HelianzBusiness.StmtType)0;
				}
				else try{
					statement.StatementType    =(HelianzBusiness.StmtType)Enum.Parse(typeof(HelianzBusiness.StmtType),statementType);
				}
				catch{
					statement.StatementType    =(HelianzBusiness.StmtType)0;
				}
				...
				statement.SmsSendStatus      = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SmsSendStatus"].ToString());
				statement.LimitedCustomFamily= (HelianzBusiness.EnumLimitedCustomFamily)PIn.Int(row["LimitedCustomFamily"].ToString());
