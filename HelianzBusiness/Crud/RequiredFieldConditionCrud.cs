	...
	public class RequiredFieldConditionCrud {
		...
		public static List<RequiredFieldCondition> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(conditionType=="") {
					requiredFieldCondition.ConditionType          =(HelianzBusiness.RequiredFieldName)0;
				}
				else try{
					requiredFieldCondition.ConditionType          =(HelianzBusiness.RequiredFieldName)Enum.Parse(typeof(HelianzBusiness.RequiredFieldName),conditionType);
				}
				catch{
					requiredFieldCondition.ConditionType          =(HelianzBusiness.RequiredFieldName)0;
				}
				requiredFieldCondition.Operator                 = (HelianzBusiness.ConditionOperator)PIn.Int(row["Operator"].ToString());
				requiredFieldCondition.ConditionValue           = PIn.String(row["ConditionValue"].ToString());
				requiredFieldCondition.ConditionRelationship    = (HelianzBusiness.LogicalOperator)PIn.Int(row["ConditionRelationship"].ToString());
