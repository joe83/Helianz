	...
	public class MedLabResultCrud {
		...
		public static List<MedLabResult> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(obsSubType=="") {
					medLabResult.ObsSubType   =(HelianzBusiness.DataSubtype)0;
				}
				else try{
					medLabResult.ObsSubType   =(HelianzBusiness.DataSubtype)Enum.Parse(typeof(HelianzBusiness.DataSubtype),obsSubType);
				}
				catch{
					medLabResult.ObsSubType   =(HelianzBusiness.DataSubtype)0;
				}
				...
				if(abnormalFlag=="") {
					medLabResult.AbnormalFlag =(HelianzBusiness.AbnormalFlag)0;
				}
				else try{
					medLabResult.AbnormalFlag =(HelianzBusiness.AbnormalFlag)Enum.Parse(typeof(HelianzBusiness.AbnormalFlag),abnormalFlag);
				}
				catch{
					medLabResult.AbnormalFlag =(HelianzBusiness.AbnormalFlag)0;
				}
				...
				if(resultStatus=="") {
					medLabResult.ResultStatus =(HelianzBusiness.ResultStatus)0;
				}
				else try{
					medLabResult.ResultStatus =(HelianzBusiness.ResultStatus)Enum.Parse(typeof(HelianzBusiness.ResultStatus),resultStatus);
				}
				catch{
					medLabResult.ResultStatus =(HelianzBusiness.ResultStatus)0;
				}
