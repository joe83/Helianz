	...
	public class ClaimCrud {
		...
		public static List<Claim> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				claim.PlaceService                  = (HelianzBusiness.PlaceOfService)PIn.Int(row["PlaceService"].ToString());
				...
				claim.EmployRelated                 = (HelianzBusiness.YN)PIn.Int(row["EmployRelated"].ToString());
				...
				claim.PatRelat                      = (HelianzBusiness.Relat)PIn.Int(row["PatRelat"].ToString());
				claim.PlanNum2                      = PIn.Long  (row["PlanNum2"].ToString());
				claim.PatRelat2                     = (HelianzBusiness.Relat)PIn.Int(row["PatRelat2"].ToString());
				...
				claim.SpecialProgramCode            = (HelianzBusiness.EnumClaimSpecialProgram)PIn.Int(row["SpecialProgramCode"].ToString());
				claim.UniformBillType               = PIn.String(row["UniformBillType"].ToString());
				claim.MedType                       = (HelianzBusiness.EnumClaimMedType)PIn.Int(row["MedType"].ToString());
				...
				claim.CorrectionType                = (HelianzBusiness.ClaimCorrectionType)PIn.Int(row["CorrectionType"].ToString());
				...
				claim.DateIllnessInjuryPregQualifier= (HelianzBusiness.DateIllnessInjuryPregQualifier)PIn.Int(row["DateIllnessInjuryPregQualifier"].ToString());
				claim.DateOther                     = PIn.Date  (row["DateOther"].ToString());
				claim.DateOtherQualifier            = (HelianzBusiness.DateOtherQualifier)PIn.Int(row["DateOtherQualifier"].ToString());
