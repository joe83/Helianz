	...
	public class ApptViewCrud {
		...
		public static List<ApptView> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				apptView.StackBehavUR         = (HelianzBusiness.ApptViewStackBehavior)PIn.Int(row["StackBehavUR"].ToString());
				apptView.StackBehavLR         = (HelianzBusiness.ApptViewStackBehavior)PIn.Int(row["StackBehavLR"].ToString());
				...
				apptView.WaitingRmName        = (HelianzBusiness.EnumWaitingRmName)PIn.Int(row["WaitingRmName"].ToString());
