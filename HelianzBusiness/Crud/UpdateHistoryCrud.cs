	...
	public class UpdateHistoryCrud {
		...
		public static List<UpdateHistory> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				updateHistory.Signature       = PIn.String(row["Signature"].ToString());
		...
		public static long Insert(UpdateHistory updateHistory,bool useExistingPK) {
			...
			if(updateHistory.Signature==null) {
				updateHistory.Signature="";
			}
			OdSqlParameter paramSignature=new OdSqlParameter("paramSignature",OdDbType.Text,POut.StringParam(updateHistory.Signature));
			if(useExistingPK || PrefC.RandomKeys) {
