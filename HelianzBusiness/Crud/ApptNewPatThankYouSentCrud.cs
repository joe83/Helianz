	...
	public class ApptNewPatThankYouSentCrud {
		...
		public static List<ApptNewPatThankYouSent> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				apptNewPatThankYouSent.SendStatus                    = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				apptNewPatThankYouSent.MessageType                   = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
