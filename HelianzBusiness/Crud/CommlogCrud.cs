	...
	public class CommlogCrud {
		...
		public static List<Commlog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				commlog.Mode_               = (HelianzBusiness.CommItemMode)PIn.Int(row["Mode_"].ToString());
				commlog.SentOrReceived      = (HelianzBusiness.CommSentOrReceived)PIn.Int(row["SentOrReceived"].ToString());
				...
				commlog.CommSource          = (HelianzBusiness.CommItemSource)PIn.Int(row["CommSource"].ToString());
				...
				commlog.CommReferralBehavior= (HelianzBusiness.EnumCommReferralBehavior)PIn.Int(row["CommReferralBehavior"].ToString());
				retVal.Add(commlog);
			}
			return retVal;
		}
