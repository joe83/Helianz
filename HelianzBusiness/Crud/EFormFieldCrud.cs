	...
	public class EFormFieldCrud {
		...
		public static List<EFormField> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eFormField.FieldType        = (HelianzBusiness.EnumEFormFieldType)PIn.Int(row["FieldType"].ToString());
				...
				eFormField.LabelAlign       = (HelianzBusiness.EnumEFormLabelAlign)PIn.Int(row["LabelAlign"].ToString());
				...
				eFormField.Border           = (HelianzBusiness.EnumEFormBorder)PIn.Int(row["Border"].ToString());
