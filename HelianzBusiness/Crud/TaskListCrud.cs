	...
	public class TaskListCrud {
		...
		public static List<TaskList> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				taskList.DateType            = (HelianzBusiness.TaskDateType)PIn.Int(row["DateType"].ToString());
				taskList.FromNum             = PIn.Long  (row["FromNum"].ToString());
				taskList.ObjectType          = (HelianzBusiness.TaskObjectType)PIn.Int(row["ObjectType"].ToString());
				taskList.DateTimeEntry       = PIn.DateT (row["DateTimeEntry"].ToString());
				taskList.GlobalTaskFilterType= (HelianzBusiness.EnumTaskFilterType)PIn.Int(row["GlobalTaskFilterType"].ToString());
				taskList.TaskListStatus      = (HelianzBusiness.TaskListStatusEnum)PIn.Int(row["TaskListStatus"].ToString());
				retVal.Add(taskList);
			}
			return retVal;
		}
