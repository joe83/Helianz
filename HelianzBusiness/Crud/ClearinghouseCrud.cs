	...
	public class ClearinghouseCrud {
		...
		public static List<Clearinghouse> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				clearinghouse.Eformat                = (HelianzBusiness.ElectronicClaimFormat)PIn.Int(row["Eformat"].ToString());
				...
				clearinghouse.CommBridge             = (HelianzBusiness.EclaimsCommBridge)PIn.Int(row["CommBridge"].ToString());
				...
				clearinghouse.IsEraDownloadAllowed   = (HelianzBusiness.EraBehaviors)PIn.Int(row["IsEraDownloadAllowed"].ToString());
