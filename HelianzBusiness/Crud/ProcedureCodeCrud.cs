	...
	public class ProcedureCodeCrud {
		...
		public static List<ProcedureCode> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				procedureCode.TreatArea         = (HelianzBusiness.TreatmentArea)PIn.Int(row["TreatArea"].ToString());
				...
				procedureCode.PaintType         = (HelianzBusiness.ToothPaintingType)PIn.Int(row["PaintType"].ToString());
				...
				procedureCode.SubstOnlyIf       = (HelianzBusiness.SubstitutionCondition)PIn.Int(row["SubstOnlyIf"].ToString());
				...
				procedureCode.BypassGlobalLock  = (HelianzBusiness.BypassLockStatus)PIn.Int(row["BypassGlobalLock"].ToString());
