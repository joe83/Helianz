	...
	public class DiseaseCrud {
		...
		public static List<Disease> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				disease.ProbStatus       = (HelianzBusiness.ProblemStatus)PIn.Int(row["ProbStatus"].ToString());
				...
				disease.FunctionStatus   = (HelianzBusiness.FunctionalStatus)PIn.Int(row["FunctionStatus"].ToString());
				retVal.Add(disease);
			}
			return retVal;
		}
