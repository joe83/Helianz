	...
	public class ERoutingActionDefCrud {
		...
		public static List<ERoutingActionDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eRoutingActionDef.ERoutingActionType  = (HelianzBusiness.EnumERoutingActionType)PIn.Int(row["ERoutingActionType"].ToString());
				...
				eRoutingActionDef.ForeignKeyType      = (HelianzBusiness.EnumERoutingDefFKType)PIn.Int(row["ForeignKeyType"].ToString());
