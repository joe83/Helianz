		...
		public static List<EmailHostingTemplate> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(emailTemplateType=="") {
					emailHostingTemplate.EmailTemplateType    =(HelianzBusiness.EmailType)0;
				}
				else try{
					emailHostingTemplate.EmailTemplateType    =(HelianzBusiness.EmailType)Enum.Parse(typeof(HelianzBusiness.EmailType),emailTemplateType);
				}
				catch{
					emailHostingTemplate.EmailTemplateType    =(HelianzBusiness.EmailType)0;
				}
				...
				if(templateType=="") {
					emailHostingTemplate.TemplateType         =(HelianzBusiness.PromotionType)0;
				}
				else try{
					emailHostingTemplate.TemplateType         =(HelianzBusiness.PromotionType)Enum.Parse(typeof(HelianzBusiness.PromotionType),templateType);
				}
				catch{
					emailHostingTemplate.TemplateType         =(HelianzBusiness.PromotionType)0;
				}
