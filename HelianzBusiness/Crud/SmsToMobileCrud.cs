	...
	public class SmsToMobileCrud {
		...
		public static List<SmsToMobile> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				smsToMobile.MsgType           = (HelianzBusiness.SmsMessageSource)PIn.Int(row["MsgType"].ToString());
				smsToMobile.MsgText           = PIn.String(row["MsgText"].ToString());
				smsToMobile.SmsStatus         = (HelianzBusiness.SmsDeliveryStatus)PIn.Int(row["SmsStatus"].ToString());
