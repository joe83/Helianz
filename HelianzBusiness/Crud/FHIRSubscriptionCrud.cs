	...
	public class FHIRSubscriptionCrud {
		...
		public static List<FHIRSubscription> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				fHIRSubscription.SubStatus          = (HelianzBusiness.SubscriptionStatus)PIn.Int(row["SubStatus"].ToString());
				fHIRSubscription.ErrorNote          = PIn.String(row["ErrorNote"].ToString());
				fHIRSubscription.ChannelType        = (HelianzBusiness.SubscriptionChannelType)PIn.Int(row["ChannelType"].ToString());
