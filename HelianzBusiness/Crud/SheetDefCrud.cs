	...
	public class SheetDefCrud {
		...
		public static List<SheetDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				sheetDef.SheetType                    = (HelianzBusiness.SheetTypeEnum)PIn.Int(row["SheetType"].ToString());
				...
				sheetDef.BypassGlobalLock             = (HelianzBusiness.BypassLockStatus)PIn.Int(row["BypassGlobalLock"].ToString());
