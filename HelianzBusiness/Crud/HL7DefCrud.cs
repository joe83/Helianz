	...
	public class HL7DefCrud {
		...
		public static List<HL7Def> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				hL7Def.ModeTx               = (HelianzBusiness.ModeTxHL7)PIn.Int(row["ModeTx"].ToString());
				...
				if(internalType=="") {
					hL7Def.InternalType       =(HelianzBusiness.HL7InternalType)0;
				}
				else try{
					hL7Def.InternalType       =(HelianzBusiness.HL7InternalType)Enum.Parse(typeof(HelianzBusiness.HL7InternalType),internalType);
				}
				catch{
					hL7Def.InternalType       =(HelianzBusiness.HL7InternalType)0;
				}
				...
				hL7Def.ShowDemographics     = (HelianzBusiness.HL7ShowDemographics)PIn.Int(row["ShowDemographics"].ToString());
