	...
	public class HL7DefMessageCrud {
		...
		public static List<HL7DefMessage> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(messageType=="") {
					hL7DefMessage.MessageType   =(HelianzBusiness.MessageTypeHL7)0;
				}
				else try{
					hL7DefMessage.MessageType   =(HelianzBusiness.MessageTypeHL7)Enum.Parse(typeof(HelianzBusiness.MessageTypeHL7),messageType);
				}
				catch{
					hL7DefMessage.MessageType   =(HelianzBusiness.MessageTypeHL7)0;
				}
				...
				if(eventType=="") {
					hL7DefMessage.EventType     =(HelianzBusiness.EventTypeHL7)0;
				}
				else try{
					hL7DefMessage.EventType     =(HelianzBusiness.EventTypeHL7)Enum.Parse(typeof(HelianzBusiness.EventTypeHL7),eventType);
				}
				catch{
					hL7DefMessage.EventType     =(HelianzBusiness.EventTypeHL7)0;
				}
				hL7DefMessage.InOrOut         = (HelianzBusiness.InOutHL7)PIn.Int(row["InOrOut"].ToString());
				...
				if(messageStructure=="") {
					hL7DefMessage.MessageStructure=(HelianzBusiness.MessageStructureHL7)0;
				}
				else try{
					hL7DefMessage.MessageStructure=(HelianzBusiness.MessageStructureHL7)Enum.Parse(typeof(HelianzBusiness.MessageStructureHL7),messageStructure);
				}
				catch{
					hL7DefMessage.MessageStructure=(HelianzBusiness.MessageStructureHL7)0;
				}
