	...
	public class EmailMessageCrud {
		...
		public static List<EmailMessage> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				emailMessage.SentOrReceived  = (HelianzBusiness.EmailSentOrReceived)PIn.Int(row["SentOrReceived"].ToString());
				...
				emailMessage.HideIn          = (HelianzBusiness.HideInFlags)PIn.Int(row["HideIn"].ToString());
				emailMessage.AptNum          = PIn.Long  (row["AptNum"].ToString());
				emailMessage.UserNum         = PIn.Long  (row["UserNum"].ToString());
				emailMessage.HtmlType        = (HelianzBusiness.EmailType)PIn.Int(row["HtmlType"].ToString());
				...
				if(msgType=="") {
					emailMessage.MsgType       =(HelianzBusiness.EmailMessageSource)0;
				}
				else try{
					emailMessage.MsgType       =(HelianzBusiness.EmailMessageSource)Enum.Parse(typeof(HelianzBusiness.EmailMessageSource),msgType);
				}
				catch{
					emailMessage.MsgType       =(HelianzBusiness.EmailMessageSource)0;
				}
