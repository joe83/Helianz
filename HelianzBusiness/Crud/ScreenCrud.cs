	...
	public class ScreenCrud {
		...
		public static List<Screen> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				screen.Gender          = (HelianzBusiness.PatientGender)PIn.Int(row["Gender"].ToString());
				screen.RaceOld         = (HelianzBusiness.PatientRaceOld)PIn.Int(row["RaceOld"].ToString());
				screen.GradeLevel      = (HelianzBusiness.PatientGrade)PIn.Int(row["GradeLevel"].ToString());
				screen.Age             = PIn.Byte  (row["Age"].ToString());
				screen.Urgency         = (HelianzBusiness.TreatmentUrgency)PIn.Int(row["Urgency"].ToString());
				screen.HasCaries       = (HelianzBusiness.YN)PIn.Int(row["HasCaries"].ToString());
				screen.NeedsSealants   = (HelianzBusiness.YN)PIn.Int(row["NeedsSealants"].ToString());
				screen.CariesExperience= (HelianzBusiness.YN)PIn.Int(row["CariesExperience"].ToString());
				screen.EarlyChildCaries= (HelianzBusiness.YN)PIn.Int(row["EarlyChildCaries"].ToString());
				screen.ExistingSealants= (HelianzBusiness.YN)PIn.Int(row["ExistingSealants"].ToString());
				screen.MissingAllTeeth = (HelianzBusiness.YN)PIn.Int(row["MissingAllTeeth"].ToString());
