	...
	public class MobileNotificationCrud {
		...
		public static List<MobileNotification> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				mobileNotification.NotificationType     = (HelianzBusiness.MobileNotificationType)PIn.Int(row["NotificationType"].ToString());
				...
				mobileNotification.AppTarget            = (HelianzBusiness.EnumAppTarget)PIn.Int(row["AppTarget"].ToString());
