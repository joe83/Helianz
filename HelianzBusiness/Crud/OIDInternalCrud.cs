	...
	public class OIDInternalCrud {
		...
		public static List<OIDInternal> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(iDType=="") {
					oIDInternal.IDType      =(HelianzBusiness.IdentifierType)0;
				}
				else try{
					oIDInternal.IDType      =(HelianzBusiness.IdentifierType)Enum.Parse(typeof(HelianzBusiness.IdentifierType),iDType);
				}
				catch{
					oIDInternal.IDType      =(HelianzBusiness.IdentifierType)0;
				}
