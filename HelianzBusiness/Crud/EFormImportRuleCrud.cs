	...
	public class EFormImportRuleCrud {
		...
		public static List<EFormImportRule> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eFormImportRule.Situation         = (HelianzBusiness.EnumEFormImportSituation)PIn.Int(row["Situation"].ToString());
				eFormImportRule.Action            = (HelianzBusiness.EnumEFormImportAction)PIn.Int(row["Action"].ToString());
