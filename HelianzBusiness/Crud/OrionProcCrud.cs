	...
	public class OrionProcCrud {
		...
		public static List<OrionProc> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				orionProc.DPC            = (HelianzBusiness.OrionDPC)PIn.Int(row["DPC"].ToString());
				orionProc.DPCpost        = (HelianzBusiness.OrionDPC)PIn.Int(row["DPCpost"].ToString());
				orionProc.DateScheduleBy = PIn.Date  (row["DateScheduleBy"].ToString());
				orionProc.DateStopClock  = PIn.Date  (row["DateStopClock"].ToString());
				orionProc.Status2        = (HelianzBusiness.OrionStatus)PIn.Int(row["Status2"].ToString());
