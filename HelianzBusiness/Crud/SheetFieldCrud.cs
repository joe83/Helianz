	...
	public class SheetFieldCrud {
		...
		public static List<SheetField> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				sheetField.FieldType               = (HelianzBusiness.SheetFieldType)PIn.Int(row["FieldType"].ToString());
				...
				sheetField.GrowthBehavior          = (HelianzBusiness.GrowthBehaviorEnum)PIn.Int(row["GrowthBehavior"].ToString());
