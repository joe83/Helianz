	...
	public class JobReviewCrud {
		...
		public static List<JobReview> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(reviewStatus=="") {
					jobReview.ReviewStatus=(HelianzBusiness.JobReviewStatus)0;
				}
				else try{
					jobReview.ReviewStatus=(HelianzBusiness.JobReviewStatus)Enum.Parse(typeof(HelianzBusiness.JobReviewStatus),reviewStatus);
				}
				catch{
					jobReview.ReviewStatus=(HelianzBusiness.JobReviewStatus)0;
				}
