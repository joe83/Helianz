	...
	public class EFormFieldDefCrud {
		...
		public static List<EFormFieldDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eFormFieldDef.FieldType        = (HelianzBusiness.EnumEFormFieldType)PIn.Int(row["FieldType"].ToString());
				...
				eFormFieldDef.LabelAlign       = (HelianzBusiness.EnumEFormLabelAlign)PIn.Int(row["LabelAlign"].ToString());
				...
				eFormFieldDef.Border           = (HelianzBusiness.EnumEFormBorder)PIn.Int(row["Border"].ToString());
