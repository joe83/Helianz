	...
	public class MedLabCrud {
		...
		public static List<MedLab> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				medLab.PatFasting         = (HelianzBusiness.YN)PIn.Int(row["PatFasting"].ToString());
				...
				if(actionCode=="") {
					medLab.ActionCode       =(HelianzBusiness.ResultAction)0;
				}
				else try{
					medLab.ActionCode       =(HelianzBusiness.ResultAction)Enum.Parse(typeof(HelianzBusiness.ResultAction),actionCode);
				}
				catch{
					medLab.ActionCode       =(HelianzBusiness.ResultAction)0;
				}
				...
				if(resultStatus=="") {
					medLab.ResultStatus     =(HelianzBusiness.ResultStatus)0;
				}
				else try{
					medLab.ResultStatus     =(HelianzBusiness.ResultStatus)Enum.Parse(typeof(HelianzBusiness.ResultStatus),resultStatus);
				}
				catch{
					medLab.ResultStatus     =(HelianzBusiness.ResultStatus)0;
				}
