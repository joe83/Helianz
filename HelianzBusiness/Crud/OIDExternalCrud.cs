	...
	public class OIDExternalCrud {
		...
		public static List<OIDExternal> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(iDType=="") {
					oIDExternal.IDType      =(HelianzBusiness.IdentifierType)0;
				}
				else try{
					oIDExternal.IDType      =(HelianzBusiness.IdentifierType)Enum.Parse(typeof(HelianzBusiness.IdentifierType),iDType);
				}
				catch{
					oIDExternal.IDType      =(HelianzBusiness.IdentifierType)0;
				}
