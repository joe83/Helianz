	...
	public class ScheduledProcessCrud {
		...
		public static List<ScheduledProcess> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(scheduledAction=="") {
					scheduledProcess.ScheduledAction  =(HelianzBusiness.ScheduledActionEnum)0;
				}
				else try{
					scheduledProcess.ScheduledAction  =(HelianzBusiness.ScheduledActionEnum)Enum.Parse(typeof(HelianzBusiness.ScheduledActionEnum),scheduledAction);
				}
				catch{
					scheduledProcess.ScheduledAction  =(HelianzBusiness.ScheduledActionEnum)0;
				}
				...
				if(frequencyToRun=="") {
					scheduledProcess.FrequencyToRun   =(HelianzBusiness.FrequencyToRunEnum)0;
				}
				else try{
					scheduledProcess.FrequencyToRun   =(HelianzBusiness.FrequencyToRunEnum)Enum.Parse(typeof(HelianzBusiness.FrequencyToRunEnum),frequencyToRun);
				}
				catch{
					scheduledProcess.FrequencyToRun   =(HelianzBusiness.FrequencyToRunEnum)0;
				}
