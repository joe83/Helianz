	...
	public class InsPlanCrud {
		...
		public static List<InsPlan> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				insPlan.CobRule                                   = (HelianzBusiness.EnumCobRule)PIn.Int(row["CobRule"].ToString());
				...
				insPlan.OrthoType                                 = (HelianzBusiness.OrthoClaimType)PIn.Int(row["OrthoType"].ToString());
				insPlan.OrthoAutoProcFreq                         = (HelianzBusiness.OrthoAutoProcFrequency)PIn.Int(row["OrthoAutoProcFreq"].ToString());
				...
				insPlan.ExclusionFeeRule                          = (HelianzBusiness.ExclusionRule)PIn.Int(row["ExclusionFeeRule"].ToString());
				...
				insPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride  = (HelianzBusiness.YN)PIn.Int(row["InsPlansZeroWriteOffsOnAnnualMaxOverride"].ToString());
				insPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride= (HelianzBusiness.YN)PIn.Int(row["InsPlansZeroWriteOffsOnFreqOrAgingOverride"].ToString());
