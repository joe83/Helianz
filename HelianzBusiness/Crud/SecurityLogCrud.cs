	...
	public class SecurityLogCrud {
		...
		public static List<SecurityLog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				securityLog.PermType      = (HelianzBusiness.EnumPermType)PIn.Int(row["PermType"].ToString());
				...
				securityLog.LogSource     = (HelianzBusiness.LogSources)PIn.Int(row["LogSource"].ToString());
