	...
	public class Etrans835Crud {
		...
		public static List<Etrans835> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				etrans835.Status           = (HelianzBusiness.X835Status)PIn.Int(row["Status"].ToString());
				etrans835.AutoProcessed    = (HelianzBusiness.X835AutoProcessed)PIn.Int(row["AutoProcessed"].ToString());
