	...
	public class AppointmentCrud {
		...
		public static List<Appointment> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				appointment.AptStatus            = (HelianzBusiness.ApptStatus)PIn.Int(row["AptStatus"].ToString());
				...
				appointment.Priority             = (HelianzBusiness.ApptPriority)PIn.Int(row["Priority"].ToString());
