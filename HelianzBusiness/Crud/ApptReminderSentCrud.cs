	...
	public class ApptReminderSentCrud {
		...
		public static List<ApptReminderSent> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				apptReminderSent.SendStatus         = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				apptReminderSent.MessageType        = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
