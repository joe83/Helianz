	...
	public class ProviderCrud {
		...
		public static List<Provider> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				provider.ProvStatus            = (HelianzBusiness.ProviderStatus)PIn.Int(row["ProvStatus"].ToString());
				provider.IsHiddenReport        = PIn.Bool  (row["IsHiddenReport"].ToString());
				provider.IsErxEnabled          = (HelianzBusiness.ErxEnabledStatus)PIn.Int(row["IsErxEnabled"].ToString());
