	...
	public class MsgToPaySentCrud {
		...
		public static List<MsgToPaySent> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				msgToPaySent.SendStatus         = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				msgToPaySent.Source             = (HelianzBusiness.MsgToPaySource)PIn.Int(row["Source"].ToString());
				msgToPaySent.MessageType        = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
				...
				msgToPaySent.EmailType          = (HelianzBusiness.EmailType)PIn.Int(row["EmailType"].ToString());
