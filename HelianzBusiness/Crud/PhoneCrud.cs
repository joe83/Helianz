	...
	public class PhoneCrud {
		...
		public static List<Phone> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(clockStatus=="") {
					phone.ClockStatus         =(HelianzBusiness.ClockStatusEnum)0;
				}
				else try{
					phone.ClockStatus         =(HelianzBusiness.ClockStatusEnum)Enum.Parse(typeof(HelianzBusiness.ClockStatusEnum),clockStatus);
				}
				catch{
					phone.ClockStatus         =(HelianzBusiness.ClockStatusEnum)0;
				}
				...
				phone.RingGroups            = (HelianzBusiness.AsteriskQueues)PIn.Int(row["RingGroups"].ToString());
