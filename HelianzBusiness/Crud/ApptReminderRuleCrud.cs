	...
	public class ApptReminderRuleCrud {
		...
		public static List<ApptReminderRule> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				apptReminderRule.TypeCur                   = (HelianzBusiness.ApptReminderType)PIn.Int(row["TypeCur"].ToString());
				...
				if(emailTemplateType=="") {
					apptReminderRule.EmailTemplateType       =(HelianzBusiness.EmailType)0;
				}
				else try{
					apptReminderRule.EmailTemplateType       =(HelianzBusiness.EmailType)Enum.Parse(typeof(HelianzBusiness.EmailType),emailTemplateType);
				}
				catch{
					apptReminderRule.EmailTemplateType       =(HelianzBusiness.EmailType)0;
				}
				...
				if(aggEmailTemplateType=="") {
					apptReminderRule.AggEmailTemplateType    =(HelianzBusiness.EmailType)0;
				}
				else try{
					apptReminderRule.AggEmailTemplateType    =(HelianzBusiness.EmailType)Enum.Parse(typeof(HelianzBusiness.EmailType),aggEmailTemplateType);
				}
				catch{
					apptReminderRule.AggEmailTemplateType    =(HelianzBusiness.EmailType)0;
				}
				...
				apptReminderRule.SendMultipleInvites       = (HelianzBusiness.SendMultipleInvites)PIn.Int(row["SendMultipleInvites"].ToString());
