	...
	public class DocumentCrud {
		...
		public static List<Document> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				document.ImgType         = (HelianzBusiness.ImageType)PIn.Int(row["ImgType"].ToString());
				...
				if(externalSource=="") {
					document.ExternalSource=(HelianzBusiness.ExternalSourceType)0;
				}
				else try{
					document.ExternalSource=(HelianzBusiness.ExternalSourceType)Enum.Parse(typeof(HelianzBusiness.ExternalSourceType),externalSource);
				}
				catch{
					document.ExternalSource=(HelianzBusiness.ExternalSourceType)0;
				}
				...
				document.ImageCaptureType= (HelianzBusiness.EnumOcrCaptureType)PIn.Int(row["ImageCaptureType"].ToString());
