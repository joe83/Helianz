	...
	public class ToothGridColCrud {
		...
		public static List<ToothGridCol> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				toothGridCol.CellType       = (HelianzBusiness.ToothGridCellType)PIn.Int(row["CellType"].ToString());
				...
				toothGridCol.ProcStatus     = (HelianzBusiness.ProcStat)PIn.Int(row["ProcStatus"].ToString());
