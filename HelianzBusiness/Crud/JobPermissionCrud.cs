	...
	public class JobPermissionCrud {
		...
		public static List<JobPermission> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(jobPermType=="") {
					jobPermission.JobPermType   =(HelianzBusiness.JobPerm)0;
				}
				else try{
					jobPermission.JobPermType   =(HelianzBusiness.JobPerm)Enum.Parse(typeof(HelianzBusiness.JobPerm),jobPermType);
				}
				catch{
					jobPermission.JobPermType   =(HelianzBusiness.JobPerm)0;
				}
