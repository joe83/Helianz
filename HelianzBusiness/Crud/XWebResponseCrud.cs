	...
	public class XWebResponseCrud {
		...
		public static List<XWebResponse> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				xWebResponse.TransactionStatus    = (HelianzBusiness.XWebTransactionStatus)PIn.Int(row["TransactionStatus"].ToString());
				xWebResponse.ResponseCode         = PIn.Int   (row["ResponseCode"].ToString());
				string xWebResponseCode=row["XWebResponseCode"].ToString();
				if(xWebResponseCode=="") {
					xWebResponse.XWebResponseCode   =(HelianzBusiness.XWebResponseCodes)0;
				}
				else try{
					xWebResponse.XWebResponseCode   =(HelianzBusiness.XWebResponseCodes)Enum.Parse(typeof(HelianzBusiness.XWebResponseCodes),xWebResponseCode);
				}
				catch{
					xWebResponse.XWebResponseCode   =(HelianzBusiness.XWebResponseCodes)0;
				}
				...
				xWebResponse.CCSource             = (HelianzBusiness.CreditCardSource)PIn.Int(row["CCSource"].ToString());
