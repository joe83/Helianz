	...
	public class EServiceShortGuidCrud {
		...
		public static List<EServiceShortGuid> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(eServiceCode=="") {
					eServiceShortGuid.EServiceCode      =(HelianzBusiness.eServiceCode)0;
				}
				else try{
					eServiceShortGuid.EServiceCode      =(HelianzBusiness.eServiceCode)Enum.Parse(typeof(HelianzBusiness.eServiceCode),eServiceCode);
				}
				catch{
					eServiceShortGuid.EServiceCode      =(HelianzBusiness.eServiceCode)0;
				}
				...
				if(fKeyType=="") {
					eServiceShortGuid.FKeyType          =(HelianzBusiness.EServiceShortGuidKeyType)0;
				}
				else try{
					eServiceShortGuid.FKeyType          =(HelianzBusiness.EServiceShortGuidKeyType)Enum.Parse(typeof(HelianzBusiness.EServiceShortGuidKeyType),fKeyType);
				}
				catch{
					eServiceShortGuid.FKeyType          =(HelianzBusiness.EServiceShortGuidKeyType)0;
				}
