	...
	public class FieldDefLinkCrud {
		...
		public static List<FieldDefLink> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				fieldDefLink.FieldDefType   = (HelianzBusiness.FieldDefTypes)PIn.Int(row["FieldDefType"].ToString());
				fieldDefLink.FieldLocation  = (HelianzBusiness.FieldLocations)PIn.Int(row["FieldLocation"].ToString());
