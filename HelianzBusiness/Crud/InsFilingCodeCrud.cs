	...
	public class InsFilingCodeCrud {
		...
		public static List<InsFilingCode> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				insFilingCode.ExcludeOtherCoverageOnPriClaims= PIn.Bool  (row["ExcludeOtherCoverageOnPriClaims"].ToString());
		...
		public static DataTable ListToTable(List<InsFilingCode> listInsFilingCodes,string tableName="") {
			...
			foreach(InsFilingCode insFilingCode in listInsFilingCodes) {
				table.Rows.Add(new object[] {
					...
					POut.Bool  (insFilingCode.ExcludeOtherCoverageOnPriClaims),
				});
			}
			return table;
		}
		...
		public static void Update(InsFilingCode insFilingCode) {
			string command="UPDATE insfilingcode SET "
				...
				+"ExcludeOtherCoverageOnPriClaims=  "+POut.Bool  (insFilingCode.ExcludeOtherCoverageOnPriClaims)+" "
		...
		public static bool Update(InsFilingCode insFilingCode,InsFilingCode oldInsFilingCode) {
			...
			if(insFilingCode.ExcludeOtherCoverageOnPriClaims != oldInsFilingCode.ExcludeOtherCoverageOnPriClaims) {
				if(command!="") { command+=",";}
				command+="ExcludeOtherCoverageOnPriClaims = "+POut.Bool(insFilingCode.ExcludeOtherCoverageOnPriClaims)+"";
			}
			if(command=="") {
				return false;
			}
