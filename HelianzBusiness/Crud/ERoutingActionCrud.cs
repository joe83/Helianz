	...
	public class ERoutingActionCrud {
		...
		public static List<ERoutingAction> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eRoutingAction.ERoutingActionType= (HelianzBusiness.EnumERoutingActionType)PIn.Int(row["ERoutingActionType"].ToString());
				...
				eRoutingAction.ForeignKeyType    = (HelianzBusiness.EnumERoutingFKType)PIn.Int(row["ForeignKeyType"].ToString());
