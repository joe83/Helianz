	...
	public class VaccinePatCrud {
		...
		public static List<VaccinePat> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				vaccinePat.CompletionStatus      = (HelianzBusiness.VaccineCompletionStatus)PIn.Int(row["CompletionStatus"].ToString());
				vaccinePat.AdministrationNoteCode= (HelianzBusiness.VaccineAdministrationNote)PIn.Int(row["AdministrationNoteCode"].ToString());
				...
				vaccinePat.RefusalReason         = (HelianzBusiness.VaccineRefusalReason)PIn.Int(row["RefusalReason"].ToString());
				vaccinePat.ActionCode            = (HelianzBusiness.VaccineAction)PIn.Int(row["ActionCode"].ToString());
				vaccinePat.AdministrationRoute   = (HelianzBusiness.VaccineAdministrationRoute)PIn.Int(row["AdministrationRoute"].ToString());
				vaccinePat.AdministrationSite    = (HelianzBusiness.VaccineAdministrationSite)PIn.Int(row["AdministrationSite"].ToString());
