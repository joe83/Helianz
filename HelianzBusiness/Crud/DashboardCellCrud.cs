	...
	public class DashboardCellCrud {
		...
		public static List<DashboardCell> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(cellType=="") {
					dashboardCell.CellType        =(HelianzBusiness.DashboardCellType)0;
				}
				else try{
					dashboardCell.CellType        =(HelianzBusiness.DashboardCellType)Enum.Parse(typeof(HelianzBusiness.DashboardCellType),cellType);
				}
				catch{
					dashboardCell.CellType        =(HelianzBusiness.DashboardCellType)0;
				}
