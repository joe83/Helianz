	...
	public class EhrAptObsCrud {
		...
		public static List<EhrAptObs> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				ehrAptObs.IdentifyingCode= (HelianzBusiness.EhrAptObsIdentifier)PIn.Int(row["IdentifyingCode"].ToString());
				ehrAptObs.ValType        = (HelianzBusiness.EhrAptObsType)PIn.Int(row["ValType"].ToString());
