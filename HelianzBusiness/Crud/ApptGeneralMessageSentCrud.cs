	...
	public class ApptGeneralMessageSentCrud {
		...
		public static List<ApptGeneralMessageSent> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				apptGeneralMessageSent.SendStatus               = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				apptGeneralMessageSent.MessageType              = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
