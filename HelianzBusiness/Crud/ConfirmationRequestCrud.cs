	...
	public class ConfirmationRequestCrud {
		...
		public static List<ConfirmationRequest> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				confirmationRequest.RSVPStatus             = (HelianzBusiness.RSVPStatusCodes)PIn.Int(row["RSVPStatus"].ToString());
				...
				confirmationRequest.SendStatus             = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				confirmationRequest.MessageType            = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
