	...
	public class PayPlanChargeCrud {
		...
		public static List<PayPlanCharge> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				payPlanCharge.ChargeType      = (HelianzBusiness.PayPlanChargeType)PIn.Int(row["ChargeType"].ToString());
				...
				payPlanCharge.LinkType        = (HelianzBusiness.PayPlanLinkType)PIn.Int(row["LinkType"].ToString());
