	...
	public class CommOptOutCrud {
		...
		public static List<CommOptOut> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				commOptOut.OptOutSms    = (HelianzBusiness.CommOptOutType)PIn.Int(row["OptOutSms"].ToString());
				commOptOut.OptOutEmail  = (HelianzBusiness.CommOptOutType)PIn.Int(row["OptOutEmail"].ToString());
