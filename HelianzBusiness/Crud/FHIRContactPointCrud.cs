	...
	public class FHIRContactPointCrud {
		...
		public static List<FHIRContactPoint> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				fHIRContactPoint.ContactSystem      = (HelianzBusiness.ContactPointSystem)PIn.Int(row["ContactSystem"].ToString());
				fHIRContactPoint.ContactValue       = PIn.String(row["ContactValue"].ToString());
				fHIRContactPoint.ContactUse         = (HelianzBusiness.ContactPointUse)PIn.Int(row["ContactUse"].ToString());
