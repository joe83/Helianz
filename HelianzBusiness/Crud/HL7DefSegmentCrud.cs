	...
	public class HL7DefSegmentCrud {
		...
		public static List<HL7DefSegment> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(segmentName=="") {
					hL7DefSegment.SegmentName   =(HelianzBusiness.SegmentNameHL7)0;
				}
				else try{
					hL7DefSegment.SegmentName   =(HelianzBusiness.SegmentNameHL7)Enum.Parse(typeof(HelianzBusiness.SegmentNameHL7),segmentName);
				}
				catch{
					hL7DefSegment.SegmentName   =(HelianzBusiness.SegmentNameHL7)0;
				}
