	...
	public class HL7DefFieldCrud {
		...
		public static List<HL7DefField> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				if(dataType=="") {
					hL7DefField.DataType      =(HelianzBusiness.DataTypeHL7)0;
				}
				else try{
					hL7DefField.DataType      =(HelianzBusiness.DataTypeHL7)Enum.Parse(typeof(HelianzBusiness.DataTypeHL7),dataType);
				}
				catch{
					hL7DefField.DataType      =(HelianzBusiness.DataTypeHL7)0;
				}
