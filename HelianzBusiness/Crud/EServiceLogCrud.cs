	...
	public class EServiceLogCrud {
		...
		public static List<EServiceLog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				eServiceLog.KeyType         = (HelianzBusiness.FKeyType)PIn.Int(row["KeyType"].ToString());
				eServiceLog.EServiceType    = (HelianzBusiness.eServiceType)PIn.Int(row["EServiceType"].ToString());
				eServiceLog.EServiceAction  = (HelianzBusiness.eServiceAction)PIn.Int(row["EServiceAction"].ToString());
