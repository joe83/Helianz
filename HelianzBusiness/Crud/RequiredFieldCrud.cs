	...
	public class RequiredFieldCrud {
		...
		public static List<RequiredField> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				requiredField.FieldType       = (HelianzBusiness.RequiredFieldType)PIn.Int(row["FieldType"].ToString());
				string fieldName=row["FieldName"].ToString();
				if(fieldName=="") {
					requiredField.FieldName     =(HelianzBusiness.RequiredFieldName)0;
				}
				else try{
					requiredField.FieldName     =(HelianzBusiness.RequiredFieldName)Enum.Parse(typeof(HelianzBusiness.RequiredFieldName),fieldName);
				}
				catch{
					requiredField.FieldName     =(HelianzBusiness.RequiredFieldName)0;
				}
