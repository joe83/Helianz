	...
	public class InsBlueBookRuleCrud {
		...
		public static List<InsBlueBookRule> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				insBlueBookRule.RuleType          = (HelianzBusiness.InsBlueBookRuleType)PIn.Int(row["RuleType"].ToString());
				insBlueBookRule.LimitValue        = PIn.Int   (row["LimitValue"].ToString());
				insBlueBookRule.LimitType         = (HelianzBusiness.InsBlueBookRuleLimitType)PIn.Int(row["LimitType"].ToString());
