	...
	public class ProviderErxCrud {
		...
		public static List<ProviderErx> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				providerErx.IsEnabled         = (HelianzBusiness.ErxStatus)PIn.Int(row["IsEnabled"].ToString());
				...
				providerErx.ErxType           = (HelianzBusiness.ErxOption)PIn.Int(row["ErxType"].ToString());
