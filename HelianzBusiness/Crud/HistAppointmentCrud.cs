	...
	public class HistAppointmentCrud {
		...
		public static List<HistAppointment> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				histAppointment.HistApptAction       = (HelianzBusiness.HistAppointmentAction)PIn.Int(row["HistApptAction"].ToString());
				histAppointment.ApptSource           = (HelianzBusiness.EServiceTypes)PIn.Int(row["ApptSource"].ToString());
				histAppointment.AptNum               = PIn.Long  (row["AptNum"].ToString());
				histAppointment.PatNum               = PIn.Long  (row["PatNum"].ToString());
				histAppointment.AptStatus            = (HelianzBusiness.ApptStatus)PIn.Int(row["AptStatus"].ToString());
				...
				histAppointment.Priority             = (HelianzBusiness.ApptPriority)PIn.Int(row["Priority"].ToString());
