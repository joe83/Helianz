	...
	public class WebSchedRecallCrud {
		...
		public static List<WebSchedRecall> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				webSchedRecall.Source             = (HelianzBusiness.WebSchedRecallSource)PIn.Int(row["Source"].ToString());
				...
				webSchedRecall.SendStatus         = (HelianzBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				webSchedRecall.MessageType        = (HelianzBusiness.CommType)PIn.Int(row["MessageType"].ToString());
