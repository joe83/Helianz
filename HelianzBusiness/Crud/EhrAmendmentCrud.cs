	...
	public class EhrAmendmentCrud {
		...
		public static List<EhrAmendment> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				ehrAmendment.IsAccepted     = (HelianzBusiness.YN)PIn.Int(row["IsAccepted"].ToString());
				ehrAmendment.Description    = PIn.String(row["Description"].ToString());
				ehrAmendment.Source         = (HelianzBusiness.AmendmentSource)PIn.Int(row["Source"].ToString());
