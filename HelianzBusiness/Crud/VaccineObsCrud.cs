	...
	public class VaccineObsCrud {
		...
		public static List<VaccineObs> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				vaccineObs.ValType           = (HelianzBusiness.VaccineObsType)PIn.Int(row["ValType"].ToString());
				vaccineObs.IdentifyingCode   = (HelianzBusiness.VaccineObsIdentifier)PIn.Int(row["IdentifyingCode"].ToString());
				vaccineObs.ValReported       = PIn.String(row["ValReported"].ToString());
				vaccineObs.ValCodeSystem     = (HelianzBusiness.VaccineObsValCodeSystem)PIn.Int(row["ValCodeSystem"].ToString());
