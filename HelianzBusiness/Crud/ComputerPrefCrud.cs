	...
	public class ComputerPrefCrud {
		...
		public static List<ComputerPref> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				computerPref.GraphicsSimple         = (HelianzBusiness.DrawingMode)PIn.Int(row["GraphicsSimple"].ToString());
				...
				computerPref.PatSelectSearchMode    = (HelianzBusiness.SearchMode)PIn.Int(row["PatSelectSearchMode"].ToString());
				...
				if(computerOS=="") {
					computerPref.ComputerOS           =(HelianzBusiness.PlatformOD)0;
				}
				else try{
					computerPref.ComputerOS           =(HelianzBusiness.PlatformOD)Enum.Parse(typeof(HelianzBusiness.PlatformOD),computerOS);
				}
				catch{
					computerPref.ComputerOS           =(HelianzBusiness.PlatformOD)0;
				}
				computerPref.HelpButtonXAdjustment  = PIn.Double(row["HelpButtonXAdjustment"].ToString());
				computerPref.GraphicsUseDirectX11   = (HelianzBusiness.YN)PIn.Int(row["GraphicsUseDirectX11"].ToString());
