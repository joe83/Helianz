...
DROP TABLE IF EXISTS etAck";
		...
		private static void To6_7_22() {
			if(FromVersion<new Version("6.7.22.0")) {
				...
				string command;
				command="UPDATE preference SET ValueString ='http://helianzsoft.com:1942/WebServiceCustomerUpdates/Service1.asmx' WHERE PrefName='UpdateServerAddress' AND ValueString LIKE '%70.90.133.65%'";
				Db.NonQ(command);
				try {
...
'204203105')";
		...
		private static void To7_3_1() {
			if(FromVersion<new Version("7.3.1.0")) {
				...
				Db.NonQ(command);
				command="INSERT INTO preference(PrefName,ValueString) VALUES('WebHostSynchServerURL','https://helianzsoft.com/WebHostSynch/WebHostSynch.asmx')";
				Db.NonQ(command);
		...
		private static void To7_6_1() {
			if(FromVersion<new Version("7.6.1.0")) {
				...
				Db.NonQ(command);
				command="UPDATE preference SET ValueString = 'https://helianzsoft.com/WebHostSynch/Sheets.asmx' WHERE PrefName = 'WebHostSynchServerURL'";
				Db.NonQ(command);
				...
				Db.NonQ(command);
				command="INSERT INTO preference(PrefName,ValueString) VALUES('MobileSyncServerURL','https://helianzsoft.com/WebHostSynch/Mobile.asmx')";
				Db.NonQ(command);
