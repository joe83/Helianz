...
namespace HelianzBusiness.Misc {
	public class SecurityHash {
		///<summary>The date Helianz started hashing fields into various SecurityHash columns. Used to determine if hashing is required. </summary>
		...
		///Runs a hashing algorithm over all tables for which Helianz is enforcing database integrity. Overwrites any existing SecurityHashes with new ones for recent entries, except Patient table.</summary>
