	...
	public partial class ConvertDatabases {
		...
		private static void To23_2_1() {
			...
			command="INSERT INTO programproperty (ProgramNum,PropertyDesc,PropertyValue" 
				 ...
				 +"'C:\\\\ProgramData\\\\Jazz Imaging LLC\\\\Classic\\\\HelianzPatientInfo.xml')"; 
			Db.NonQ(command); 
			command="INSERT INTO toolbutitem (ProgramNum,ToolBar,ButtonText) " 
				 +"VALUES (" 
				 +"'"+POut.Long(programNum)+"', " 
			...
			command="INSERT INTO program (ProgName,ProgDesc,Enabled,Path,CommandLine,Note" 
				 ...
				 +"'"+POut.String(@"--source ""Helianz"" --pName ""[NameFL]"" --pAge ""[BirthDate_yyyyMMdd]"" --pGender ""[Gender]""")+"', "
				 +"'')"; 
			programNum=Db.NonQ(command,true); 
			command="INSERT INTO toolbutitem (ProgramNum,ToolBar,ButtonText) " 
				 +"VALUES (" 
		...
		private static void To23_2_24() {
			string command=@"UPDATE programproperty SET PropertyValue='C:\\ProgramData\\Jazz Imaging LLC\\Classic\\HelianzPatientInfo.xml' WHERE ProgramNum IN(SELECT programnum FROM program WHERE ProgName LIKE 'JazzClassic%')";
			Db.NonQ(command);
