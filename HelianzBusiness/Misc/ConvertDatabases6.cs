...
namespace HelianzBusiness {
	public partial class ConvertDatabases {
		...
		private static void DetachTransferClaimProcsFromClaimPayments() {
			...
			//Also, using a subselect was slow for MySQL 5.5 which is the officially supported version for Helianz (v5.6 was fast).
			string command=@"
            ...
            <table cellspacing=""0"" cellpadding=""0"" width=""500"" class=""w320"">
              <tr>
                <td valign=""top"" style=""padding:10px 0; text-align:center;"" class=""mobile-center"">
                  <img width=""160"" src=""https://www.helianz.com/images/logos/templateLogoSign.png"">
                </td>
              </tr>
            </table>
          </center>
      ...
      <tr>
        <td valign=""top"">
          ...
          <v:rect xmlns:v=""urn:schemas-microsoft-com:vml"" fill=""true"" stroke=""false"" style=""mso-width-percent:1000;height:303px;"">
            <v:fill type=""tile"" src=""https://www.helianz.com/images/logos/templateopensign.png"" color=""#64594b"" />
          ...
          <div>
            <center>
                ...
                <tr>
                  <td>
										<img style=""width: 100%;"" src=""https://www.helianz.com/images/logos/templateopensign.png"">
									</td>
                </tr>
              </table>
            </center>
                  ...
                  <table cellspacing=""0"" cellpadding=""0"" width=""100%"">
                    <tr>
                      <td class=""mobile-padding"" style=""text-align:left;"">
						...
						We will be taking many precautions as we re-open, following local and state guidelines. This includes social distancing measures and increased sanitizing of the office. Please check our <a href=""https://www.helianz.com"">website</a> for updates.<br><br>
...
Please call our office at your earliest convenience to schedule an appointment.";
		...
		private static void To18_3_1() {
			...
			Db.NonQ(command);
			command="INSERT INTO preference(PrefName,ValueString) VALUES('HelianzServiceHeartbeat','0001-01-01 00:00:00')";
			Db.NonQ(command);
			...
			command="INSERT INTO alertcategorylink(AlertCategoryNum,AlertType) VALUES('"+alertCategoryNum+"','20')";//20 for alerttype HelianzServiceDown
			Db.NonQ(command);
		...
		private static void To18_3_30() {
			string command;
			command=@"UPDATE preference SET ValueString='https://www.patientviewer.com:49997/HelianzWebServiceHQ/WebServiceMainHQ.asmx' 
				WHERE PrefName='WebServiceHQServerURL' AND ValueString='http://www.patientviewer.com:49999/HelianzWebServiceHQ/WebServiceMainHQ.asmx'";
			Db.NonQ(command);
		}

		private static void To18_3_49() {
			string command;
			command="UPDATE preference SET ValueString='https://helianzsoft.com:1943/WebServiceCustomerUpdates/Service1.asmx' "
				+"WHERE PrefName='UpdateServerAddress' AND ValueString='http://helianzsoft.com:1942/WebServiceCustomerUpdates/Service1.asmx'";
			Db.NonQ(command);
		}
		...
		private static void To19_2_1() {
			...
			//Previously www.helianz.com/updates/ redirected to www.helianz.com/updates/. Since we want to use HTTPS now, we will simply go directly
			//to www.helianz.com.
			command="UPDATE preference SET ValueString='https://www.helianz.com/updates/' WHERE PrefName='UpdateWebsitePath' "
				+"AND ValueString='http://www.helianz.com/updates/'";
			Db.NonQ(command);
		...
		private static void To19_2_8() {
			string command="INSERT INTO preference(PrefName,ValueString) VALUES('HelianzServiceComputerName','')";
			Db.NonQ(command);
