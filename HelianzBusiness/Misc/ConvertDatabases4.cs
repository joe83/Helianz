	...
	public partial class ConvertDatabases {
		...
		private static void To16_3_1() {
			if(FromVersion<new Version("16.3.1.0")) {
				...
				//Since we've kicked everyone out of Helianz for this upgrade, we can ignore converting invalid types over to the new system.
		...
		private static void To16_4_13() {
			if(FromVersion<new Version("16.4.13.0")) {
				...
				command="UPDATE programproperty SET PropertyDesc = 'Enter 0 to use Helianz for sending review invitations, or 1 to use the Service' "
					+"WHERE ProgramNum="+podiumProgNum+" "
					+"AND PropertyDesc = 'Enter 0 to use Helianz for sending review invitations, or 1 to use eConnector'";
				Db.NonQ(command);
