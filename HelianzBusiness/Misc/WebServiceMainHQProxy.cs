...
namespace HelianzBusiness {
	public static class WebServiceMainHQProxy {
		...
		public static WebServiceMainHQ.WebServiceMainHQ GetWebServiceMainHQInstance(string webServiceHqUrl="") {
			...
			service.Url="http://10.10.1.184:49999/alpha/helianzwebservicehq/webservicemainhq.asmx";
			return service;
#endif
			...
			service.Url="http://chris/HelianzWebServiceHQ/WebServiceMainHQ.asmx"; //Chris has most graciously volunteered to host the test serviceshq web service and db.
			//service.Url="http://10.10.2.18:55018/HelianzWebServiceHQ/WebServiceMainHQ.asmx";//Sam's Computer
			//service.Url="http://server184:49999/HelianzWebServiceHQ/WebServiceMainHQ.asmx";//The actual server hosting WebServiceMainHQ.
			//service.Url="http://sam/HelianzWebServiceHQ/WebServiceMainHQ.asmx"; //Sams computer
			service.Timeout=(int)TimeSpan.FromMinutes(60).TotalMilliseconds;
#endif
			return service;
		}
		
		///<summary>Any calls to WebServiceMainHQ must go through this method. The payload created here will be digested and extracted to HelianzWebServiceHQ.PayloadArgs.
		///If any args are null or not provided then they will be retrieved from Prefs.</summary>
		///<param name="registrationKey">An Helianz distributed registration key that HQ has on file.  Do not include hyphens.</param>
