...
namespace HelianzBusiness{
	...
	///<summary>Transworld Systems Inc (TSI) transaction log.  Logs communication between the Helianz program and TSI.  Entries contain information
	...
	public class TsiTransLog:TableBase {
		...
		///<summary>Not a database column.  Only used temporarily by the HelianzService.TransworldThread in order to aggregate claimproc amounts
		...
		public long ProcNum;
		///<summary>Not a database column.  Only used temporarily by the HelianzService.TransworldThread in order to aggregate paysplit amounts into
		...
		[CrudColumn(IsNotDbColumn=true)]
		public long PayNum;
		///<summary>Not a database column.  Only used temporarily by the HelianzService.TransworldThread in order to process transactions in the order
