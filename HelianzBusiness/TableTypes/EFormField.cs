...
namespace HelianzBusiness {
	...
	public class EFormField:TableBase {
		...
		///<para>SigBox: First char is 0 for our sigbox and 1 for Topaz. The remainder is the signature string. See HelianzBusiness\UI\SignatureBoxWrapper.cs for details. Same format as used for all signatures in OD. Does not get imported.</para>
