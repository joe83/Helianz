...
namespace HelianzBusiness {
	...
	///<summary>Various statuses from XWeb. These states are returned directly from the XWeb gateway. A more complete list can be found at \\helianz.od\serverfiles\Storage\OPEN DENTAL\Programmers Documents\Bridge Info\X-Charge\EdgeExpress\EdgeExpress Card Not Present API 1.0.0.pdf.</summary>
