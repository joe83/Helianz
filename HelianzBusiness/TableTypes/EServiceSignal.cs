...
namespace HelianzBusiness {
	...
	public class EServiceSignal:TableBase {
		...
		///<summary>The enum is at HQ as HelianzWebCore.BroadcasterThreadDefs. Can be zero if no grouping is necessary per a given service.</summary>
		public int ReasonCategory;
		///<summary>The enum is at HQ as HelianzWebCore.BroadcasterErrorCodes. This code is used to determine what actions to take and how to process this message. 
