...
namespace HelianzBusiness {
	///<summary>Any row in this table will show up in the main menu of Helianz to get the attention of the user.
	...
	public enum AlertType {
		...
		///<summary>2 - Only used by Helianz HQ. The server monitoring incoming voicemails is not working.</summary>
		...
		///<summary>10 - Only used by Helianz HQ. The Asterisk Server is not processing messages or is getting all blank payloads.</summary>
		...
		///<summary>19 - Multiple computers are running HelianzServices. There should only ever be one.</summary>
		[Description("Multiple HelianzServices")]
		MultipleHelianzServices,
		///<summary>20 - HelianzService is down.</summary>
		[Description("HelianzService Down")]
		HelianzServiceDown,
