...
namespace HelianzBusiness{
	...
	public enum LogSources {
		///<summary>0 - Helianz and unknown entities.</summary>
		None,
		...
		AutoConfirmations,
		///<summary>9 - Helianz messages created for debugging and diagnostic purposes. 
		...
		MobileWeb,
		///<summary>11 - When retrieving reports in the background of FormHelianz</summary>
		CanadaEobAutoImport,
		///<summary>12 - Web Sched application for moving ASAP appointments.</summary>
		WebSchedASAP,
		///<summary>13 - HelianzService.</summary>
		HelianzService,
		...
		ODMobile,
		///<summary>17 - Helianz text messaging.</summary>
		TextMessaging,
