...
namespace HelianzBusiness {
	...
	///are intended to allow end patients to respond to Helianz via text or email and automatically confirm, or set to a desired status, the appointments
	...
	public class ShortCodeAttribute:Attribute {
		private SmsMessageSource[] _smsMessageSource=new SmsMessageSource[] { HelianzBusiness.SmsMessageSource.Undefined };
