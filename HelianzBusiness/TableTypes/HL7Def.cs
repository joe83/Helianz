...
//TODO: This column may need to be changed to the TextIsClobNote attribute to remove more than 50 consecutive new line characters.
		...
		public string Note;
		///<summary>The machine name of the computer where the HelianzHL7 service for this def is running.</summary>
		public string HL7Server;
		///<summary>The name of the HL7 service for this def.  Must begin with Helianz...</summary>
