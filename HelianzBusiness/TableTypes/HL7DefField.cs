...
namespace HelianzBusiness{
	...
	public class FieldNameAndType{
		...
		public static List<FieldNameAndType> GetFullList() {
			...
			retVal.Add(new FieldNameAndType("sendingApp",DataTypeHL7.HD,"0361"));//the Helianz HL7 root assigned to the office and stored in the oidinternal table with the IDType of Root
	...
	public enum DataTypeHL7 {
		...
		FT,
		///<summary>Hierarchic designator.  Application identifier.  Example: "OD" for Helianz.</summary>
		HD,
