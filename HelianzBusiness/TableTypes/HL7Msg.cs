...
namespace HelianzBusiness{
	...
	public class HL7Msg:TableBase {
		...
		///<summary>Enum:HL7MessageStatus Out/In are relative to Helianz.  This is in contrast to the names of the old ecw folders, which were relative to the other program.  OutPending, OutSent, InReceived, InProcessed.</summary>
