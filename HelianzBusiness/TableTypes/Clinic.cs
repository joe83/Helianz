...
namespace HelianzBusiness{
	...
	public class Clinic:TableBase {
		...
		///<summary>True if this clinic is a medical clinic.  Used to hide/change certain areas of Helianz, like hiding the tooth chart and changing
		...
		///<summary>Not currently used by Helianz but is used by other software's.</summary>
