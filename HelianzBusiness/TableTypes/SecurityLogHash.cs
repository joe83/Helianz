...
namespace HelianzBusiness {
	...
	public class SecurityLogHash:TableBase {
		...
		///<summary>The SHA-256 hash of PermType, UserNum, LogDateTime, LogText, and PatNum, all concatenated together.  This hash has length of 32 bytes encoded as base64.  Used to detect if the entry has been altered outside of Helianz.</summary>
