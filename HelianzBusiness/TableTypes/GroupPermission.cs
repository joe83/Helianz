...
namespace HelianzBusiness{
	...
	public enum EnumPermType {
		...
		[Description("Helianz Help, FAQ edit and creation.")]
		FAQEdit,
		...
		WebFormAccess,
		///<summary>195 - Close other sessions of Helianz Cloud</summary>
		...
		DefEdit,
		///<summary>221 - Allows user to install Helianz updates.</summary>
