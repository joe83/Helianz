...
namespace HelianzBusiness{
	...
	public class Clearinghouse:TableBase {
		...
		public string ISA05;
		///<summary>Used in ISA06, GS02, 1000A NM1, and 1000A PER.  If blank, then 810624427 is used to indicate Helianz.
		...
		///<summary>Currently only used for DentalXChange's attachment service. This indicates that the user has set up the attachment service and would like to use it in Helianz.</summary>
