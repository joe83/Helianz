...
namespace HelianzBusiness{
	...
	public enum EServiceTypes {
		...
		///<summary></summary>
		ServiceMainHQ,
		///<summary>Used by the HelianzService. Not a eService but we need the "phantom" user to behave like eService users.</summary>
		HelianzService,
		///<summary>Used by the Helianz API Service.</summary>
		HelianzAPIService,
	}
