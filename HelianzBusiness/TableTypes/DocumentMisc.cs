...
namespace HelianzBusiness{
	...
	public enum DocumentMiscType {
		...
		UpdateFilesSegment,
		///<summary>2- Entires of this doc type are segments of HelianzShareScreen.exe from our website.
		///File names are formatted like version{guid}segment# (ex 12.11.2022.501{45e744a7-f6dd-4e55-9f9f-11d1f746eefe}13).
		///An HelianzShareScreen.exe is complete when a record is present without a segment# (ex 12.11.2022.501{45e744a7-f6dd-4e55-9f9f-11d1f746eefe}).</summary>
