...
namespace HelianzBusiness {
	...
	public class ConnectionStore {
		...
		static ConnectionStore() {
			//Because ConnectionStoreBase does not have access to classes in HelianzBusiness, we need to "override" a few methods to inject logic from 
			//HelianzBusiness.
			...
			ConnectionStoreBase.GetDentalOfficeReportServerFromPrefC=() => {
				...
				ODException.SwallowAnyException(() => {
					...
					//If ServerName is null or empty, then the current instance of Helianz is utilizing a connection string.
		...
		public static HelianzBusiness.CentralConnection GetConnection(ConnectionNames name) {
		...
		public static HelianzBusiness.CentralConnection SetDb(ConnectionNames dbName,bool skipValidation=false) {
			return (CentralConnection)ConnectionStoreBase.SetDb(dbName,skipValidation);
		}

		///<summary>Sets the connection of the current thread to the ConnectionName indicated. Connection details will be retrieved from ConnectionStore.xml.</summary>
		public static HelianzBusiness.CentralConnection SetDbT(ConnectionNames dbName,DataConnection dataConn=null) {
