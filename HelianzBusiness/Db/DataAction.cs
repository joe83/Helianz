...
namespace HelianzBusiness {
	...
	public class DataAction {
		...
		///<summary>Perform the given action as a Middle Tier client using HelianzServerMockIIS.</summary>
		public static void RunMiddleTierMock(Action a) {
			MiddleTierRole remotingRolePrevious=RemotingClient.MiddleTierRole;
			HelianzBusiness.WebServices.HelianzServerMockIIS mockPrevious=HelianzBusiness.WebServices.HelianzServerProxy.MockHelianzServerCur;
			if(mockPrevious==null) {
				HelianzBusiness.WebServices.HelianzServerProxy.MockHelianzServerCur=new HelianzBusiness.WebServices.HelianzServerMockIIS();
			}
			...
			try {
				...
				HelianzBusiness.WebServices.HelianzServerProxy.MockHelianzServerCur=mockPrevious;
