...
namespace HelianzBusiness{
	...
	public enum InvalidType{
		...
		AlertSubs,
		///<summary>72. THIS IS NOT CACHED. But is used to make server run the alert logic in HelianzService.</summary>
		AlertItems,
    ...
    EmailMessages,
		...
		///<summary>88.</summary>
		SmsPhones,
		///<summary>89.  Chat support through our website at http://helianz.com/contact.html.
  ...
  public enum AutoCondition{
	...
	///<summary>For every type of electronic claim format that Helianz can create, there will be an item in this enumeration.  All e-claim formats are hard coded due to complexity.</summary>
	...
	public enum FHIRKeyStatus {
		...
		DisabledByDeveloper,
		///<summary>Helianz HQ has disabled this key.</summary>
		[Description("Disabled by Helianz")]
		DisabledByHQ,
	...
	public enum OAuthApplicationNames {
		...
		///<summary>4 - Used for getting the Helianz PayConnect2 API key.</summary>
		PayConnect2,
		///<summary>5 - Used for getting the Helianz PayConnect2 DLL key.</summary>
		PayConnect2Dll,
		///<summary>6 - Used for getting the Helianz DoseSpot Subscription key</summary>
		DoseSpotSubscriptionKey,
		///<summary>7 - Used for getting the Helianz DoseSpot ClientID</summary>
		DoseSpotClientID,
		///<summary>8 - Gets a token generated by our client admin credentials to move offices from V1 to V2.</summary>
		DoseSpotAdminID,
		///<summary>7 - Used for getting the Helianz DoseSpot V2 ClientID</summary>
		MedispanClientID,
	}
	...
	///<summary>Used by the HelianzService to determine how often a thread should perform a task.  Example:  For Transworld, account activity is sent
	...
	///<summary>Contains exit codes used for FormHelianz. Not all codes used are listed here. If using a new exit code, you should add it to this
	///enum.</summary>
	public enum FormHelianzExitCodes {
