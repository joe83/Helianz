...
namespace Helianz.UI {
	partial class SignatureBoxWrapper {
		...
		private void InitializeComponent() {
			...
			this.signatureBox = new Helianz.UI.SignatureBox();
			this.SuspendLayout();
			// 
			// butTopazSign
			// 
			...
			this.butTopazSign.Image = global::HelianzBusiness.Properties.Resources.topazPen10;
			...
			this.butClearSig.Image = global::HelianzBusiness.Properties.Resources.deleteX10;
			...
			// butESign
			// 
			this.butESign.Image = global::HelianzBusiness.Properties.Resources.eSig;
