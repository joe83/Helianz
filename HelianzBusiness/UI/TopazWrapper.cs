...
namespace Helianz.UI {
	public class TopazWrapper {
		...
		public static void FillSignatureANSI(Control topaz,string keyData,string signature,Helianz.UI.SignatureBoxWrapper.SigMode sigMode) {
			ClearTopaz(topaz);
			...
			switch(sigMode) {
				case Helianz.UI.SignatureBoxWrapper.SigMode.TreatPlan:
					...
					break;
				case Helianz.UI.SignatureBoxWrapper.SigMode.OrthoChart:
					hashedKeyData=OrthoCharts.GetHashStringForSignature(keyData);//Passed in key data has not been hashed yet.
					SetTopazAutoKeyANSIData(topaz,hashedKeyData);
					break;
				case Helianz.UI.SignatureBoxWrapper.SigMode.Document:
				case Helianz.UI.SignatureBoxWrapper.SigMode.Default:
				default:
		...
		public static void FillSignatureEncodings(Control topaz,string keyData,string signature,Helianz.UI.SignatureBoxWrapper.SigMode sigMode) {
