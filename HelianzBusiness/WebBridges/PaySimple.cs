	...
	public class PaySimple:WebBase {
			...
			,string billingZipCode="",string cvv="",long clinicNum=-1,string lname="") 
		{
			...
			if(string.IsNullOrWhiteSpace(cc.PaySimpleToken)) {
				...
				//If the user doesn't want Helianz to store their account id, we will let them continue entering their CC info.
		...
		public class ApiResponse {
			...
			///<summary>Not given from the API.  This is filled after returning back to Helianz 
			///and uses Helianz specific things to generate this (ie. clinic info)</summary>
