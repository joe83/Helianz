...
namespace HelianzBusiness {
	public class Erx {
		...
		///<summary>If this value is found in a MedicationPat or RxPat's ErxGuid column, it is a med/rx created in Helianz, NOT imported from an eRx solution.</summary>
		public static string HelianzErxPrefix="OD_SelfReported";
		...
		///<summary>If this value is found in a MedicationPat or RxPat's ErxGuid column, it was created in Helianz and has not yet been sent to DoseSpot. 
		...
		///<summary>Returns true if the passed in erxGuid is in a format that is consistent with Helianz</summary>
		...
		public static bool IsTwoWayIntegrated(string erxGuid) {
			return erxGuid.StartsWith(HelianzErxPrefix);
		}
