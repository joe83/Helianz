...
namespace HelianzBusiness {
	public class Google {
		...
		public class AuthorizationRequest {
			...
			///Shows a message in the browser indicating to user that they can close it and return to Helianz.
			...
			///This HTML will display in the browser, letting the user know they can close it and return to Helianz.
			...
			private string GetAuthCodeFromContextOrThrow(HttpListenerContext context) {
				...
				if(error.IsNullOrEmpty()) {
					...
					//Helianz made the request which resulted in authorization.
