...
namespace HelianzBusiness.WebTypes.WebForms {
	[Serializable]
	[CrudTable(IsMissingInGeneral=true,CrudLocationOverride=@"..\..\..\HelianzBusiness\WebTypes\WebForms\Crud",NamespaceOverride="HelianzBusiness.WebTypes.WebForms.Crud",CrudExcludePrefC=true)]
