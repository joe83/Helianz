...
using HelianzBusiness.WebTypes.WebForms.Data_Interface;
using System;
...
namespace HelianzBusiness.WebTypes.WebForms {
	public class WebForms_Sheets {
		...
		///<summary>Gets dictionary for the Helianz Service of ClinicNums with their count of available webforms to download.</summary>
