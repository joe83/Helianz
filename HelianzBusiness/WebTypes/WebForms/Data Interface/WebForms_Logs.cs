...
using HelianzBusiness.WebTypes.WebForms.Crud;
using System;
...
namespace HelianzBusiness.WebTypes.WebForms {
	public class WebForms_Logs {
		...
		///Older versions of Helianz used PatNum (DentalOfficeID) instead of RegistrationKeyNum.</summary>
		...
		///<summary>Returns true if logging is turned on for the dental office or globally via the LogLevelOfApplication set within the HelianzWebConfig.xml file.</summary>
