	...
	public class WebForms_SheetFieldCrud {
		...
		public static List<WebForms_SheetField> TableToList(DataTable table) {
			...
			for(int i=0;i<table.Rows.Count;i++) {
				...
				webForms_SheetField.FieldType               = (HelianzBusiness.SheetFieldType)PIn.Int(table.Rows[i]["FieldType"].ToString());
				...
				webForms_SheetField.GrowthBehavior          = (HelianzBusiness.GrowthBehaviorEnum)PIn.Int(table.Rows[i]["GrowthBehavior"].ToString());
