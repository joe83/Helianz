...
namespace HelianzBusiness.WebTypes.WebForms.Crud{
	public class WebForms_SheetFieldDefCrud {
		...
		public static List<WebForms_SheetFieldDef> TableToList(DataTable table) {
			...
			for(int i=0;i<table.Rows.Count;i++) {
				...
				webForms_SheetFieldDef.FieldType               = (HelianzBusiness.SheetFieldType)PIn.Int(table.Rows[i]["FieldType"].ToString());
				...
				webForms_SheetFieldDef.GrowthBehavior          = (HelianzBusiness.GrowthBehaviorEnum)PIn.Int(table.Rows[i]["GrowthBehavior"].ToString());
