...
BMI 18.5-25.";
		...
		private static void GenerateQRDACatThree(List<QualityMeasure> listQMs,DateTime dateStart,DateTime dateEnd,string folderRoot) {
			...
			using(_w=XmlWriter.Create(folderRoot+"\\QRDA_Category_III.xml",xmlSettings)) {
				...
				_w.WriteElementString("softwareName","Helianz version "+PrefC.GetString(PrefName.ProgramVersion));
				...
				_w.WriteComment("This is the practice OID provider root and Helianz assigned ProvNum extension");
		...
		private static void GenerateQRDACatOne(List<QualityMeasure> listQMs,DateTime dateStart,DateTime dateEnd,string folderRoot) {
			...
			for(int i=0;i<listAllEhrPats.Count;i++) {
				...
				using(_w=XmlWriter.Create(strBuilder,xmlSettings)) {
					...
					//}
					//_w.WriteComment("The extension is the patient's Helianz number, the root is the assigning authority");
					...
					Start("assignedAuthoringDevice");
					_w.WriteElementString("manufacturerModelName","Helianz version "+PrefC.GetString(PrefName.ProgramVersion));
					_w.WriteElementString("softwareName","Helianz Software Inc.");
					End("assignedAuthoringDevice");
					End("assignedAuthor");
					End("author");
					#endregion author
