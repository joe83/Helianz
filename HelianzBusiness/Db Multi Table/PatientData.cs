...
namespace HelianzBusiness {//Jordan is the only one allowed to edit this file.
	...
	public partial class PatientData {
		//There is one instance of this object at the level of FormHelianz. References are passed to each module. This object is never reinitialized.
		...
		//In that case, we would instead process lists into datatables at the client level using methods in HelianzBusiness.
