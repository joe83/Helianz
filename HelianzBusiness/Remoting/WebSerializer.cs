...
namespace WebServiceSerializer {
	...
	///Marked internal so it doesn't get mistaken or misused in place of HelianzBusiness.POut.</summary>
	internal class POut {
...
=================================== class PIn ===========================================*/
	...
	///Marked internal so it doesn't get mistaken or misused in place of HelianzBusiness.PIn.</summary>
	internal class PIn {
		///<summary></summary>
