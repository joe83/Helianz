...
namespace HelianzBusiness {
	...
	public class DtoObject:IXmlSerializable {
		///<summary>Fully qualified name, including the namespace but not the assembly.  Examples: System.Int32, HelianzBusiness.Patient, HelianzBusiness.Patient[], List&lt;HelianzBusiness.Patient&gt;, PluginOC.OcContainer.  When the xml element is created for the Obj, the namespace is not included.  So this field properly stores it.</summary>
		...
		///<summary>Examples of strTypeName passed in: System.Int32, System.Drawing.Color, HelianzBusiness.Patient, HelianzBusiness.Patient[], List&lt;HelianzBusiness.Patient&gt;, PluginOC.OcContainer</summary>
		private static Type ConvertNameToType(string strTypeName){//,string strAssembDeprecating) {
			...
			if(strTypeName.StartsWith("List<")) {
				...
				if(assemb==null) {
					...
					if(typeGen==null) {//For assemblies other than HelianzBusiness, i.e. CodeBase
			...
			else {//system types, HelianzBusiness, and plugins
				...
				if(assemb==null) {
					...
					if(typeObj==null) {//For assemblies other than HelianzBusiness, i.e. CodeBase
