...
namespace HelianzBusiness {
	///<summary>Provides a base class for DTO classes.  A DTO class is a simple data storage object.  A DTO is the only format accepted by HelianzBusiness.dll.</summary>
	...
	public class DtoGetObject:DataTransferObject{
		///<summary>This is the "FullName" string representation of the type of object that we expect back as a result.  Examples: System.Int32, HelianzBusiness.Patient, HelianzBusiness.Patient[], List&lt;HelianzBusiness.Patient&gt;.  DataTable and DataSet not allowed.</summary>
	...
	///<summary>HelianzBusiness and all the DA classes are designed to throw an exception if something goes wrong.  If using HelianzBusiness through the remote server, then the server catches the exception and passes it back to the main program using this DTO.  The client then turns it back into an exception so that it behaves just as if HelianzBusiness was getting called locally.</summary>
