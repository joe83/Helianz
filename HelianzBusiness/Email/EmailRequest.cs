namespace HelianzBusiness.Email {

	///<summary>Represents what will be sent to the HelianzEmail process. May be an email or a command for the process to carry out. Serialized
	///in XML.</summary>
