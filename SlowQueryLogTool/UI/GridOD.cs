...
namespace SlowQueryLogTool.UI {
	...
	public class GridOD:System.Windows.Forms.UserControl {
		...
		private static SolidBrush _brushHeaderBackground=new SolidBrush(Color.FromArgb(223,234,245));//#DFE0F5
	...
	public static class ODExtensions {
