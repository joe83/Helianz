...
using HelianzGraph.Enumerations;
...
namespace HelianzGraph {
	public partial class GraphQuantityOverTime:UserControl,IODGraphPrinter {
		...
		public delegate Color OnGetColorFromSeriesGraphTypeArgs(object sender,HelianzBusiness.DashboardCellType cellType,string seriesName);
		...
		private void FilterData(object sender,EventArgs e) {
			...
			if(topGrossingCount<0) {
				//MessageBox.Show(HelianzBusiness.Lans.g("HelianzGraph","Not allowed to disable the last series."));
