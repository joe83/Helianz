namespace HelianzGraph {
	partial class GraphQuantityOverTime {
		...
		private void InitializeComponent() {
			...
			this.chartLegend1 = new HelianzGraph.Legend();
			...
			this.chartLegend1.LegendDock = HelianzGraph.Enumerations.LegendDockType.Left;
			...
			this.pictureBoxLoading.Image = global::HelianzGraph.Properties.Resources.loadingAnim;
