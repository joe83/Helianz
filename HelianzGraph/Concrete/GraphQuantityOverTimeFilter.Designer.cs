namespace HelianzGraph {
	partial class GraphQuantityOverTimeFilter {
		...
		private void InitializeComponent() {
			...
			this.groupingOptionsCtrl1 = new HelianzGraph.GroupingOptionsCtrl();
			this.graph = new HelianzGraph.GraphQuantityOverTime();
			...
			// 
			this.groupingOptionsCtrl1.CurGrouping = HelianzGraph.GroupingOptionsCtrl.Grouping.provider;
			...
			this.graph.BreakdownPref = HelianzGraph.Enumerations.BreakdownType.items;
			...
			this.graph.LegendDock = HelianzGraph.Enumerations.LegendDockType.Bottom;
			this.graph.LegendTitle = "Provider";
			this.graph.Location = new System.Drawing.Point(0, 0);
			this.graph.MoneyItemDescription = "Income";
			this.graph.Name = "graph";
			this.graph.QtyType = HelianzGraph.Enumerations.QuantityType.money;
			this.graph.QuickRangePref = HelianzGraph.Enumerations.QuickRange.allTime;
			...
			this.graph.OnGetGetColor = new HelianzGraph.GraphQuantityOverTime.OnGetColorArgs(this.graph_OnGetGetColor);
			// 
