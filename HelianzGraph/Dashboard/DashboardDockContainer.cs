...
namespace HelianzGraph {
	...
	public interface IDashboardDockContainer {
		DashboardDockContainer CreateDashboardDockContainer(HelianzBusiness.TableBase dbItem);
	...
	public class DashboardDockContainer {
		...
		private HelianzBusiness.TableBase _dbItem;
		...
		public HelianzBusiness.TableBase DbItem {
			get { return _dbItem; }
		}
