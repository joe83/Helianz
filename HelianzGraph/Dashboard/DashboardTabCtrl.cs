						...
						case 0:
							...
							cell.CellSettings=ODGraphJson.Serialize(new ODGraphJson() {
								...
								GraphJson=ODGraphSettingsBase.Serialize(new GraphQuantityOverTime.QuantityOverTimeGraphSettings() {
									...
									QtyType=HelianzGraph.Enumerations.QuantityType.money,
									...
									LegendDock=HelianzGraph.Enumerations.LegendDockType.None,
									QuickRangePref=HelianzGraph.Enumerations.QuickRange.last12Months,
									BreakdownPref=HelianzGraph.Enumerations.BreakdownType.none,
								})
							});
							break;
						case 1:
						...
						case 2:
							...
							cell.CellSettings=ODGraphJson.Serialize(new ODGraphJson() {
								...
								GraphJson=ODGraphSettingsBase.Serialize(new GraphQuantityOverTime.QuantityOverTimeGraphSettings() {
									...
									QtyType=HelianzGraph.Enumerations.QuantityType.count,
									SeriesType=System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Line,
						...
						default:
							...
							cell.CellSettings=ODGraphJson.Serialize(new ODGraphJson() {
								...
								GraphJson=ODGraphSettingsBase.Serialize(new GraphQuantityOverTime.QuantityOverTimeGraphSettings() {
									...
									LegendDock=HelianzGraph.Enumerations.LegendDockType.None,
									QuickRangePref=HelianzGraph.Enumerations.QuickRange.last30Days,
									BreakdownPref=HelianzGraph.Enumerations.BreakdownType.none,
								})
							});
							break;
						...
						case 0:
							...
							cell.CellSettings=ODGraphJson.Serialize(new ODGraphJson() {
								...
								GraphJson=ODGraphSettingsBase.Serialize(new GraphQuantityOverTime.QuantityOverTimeGraphSettings() {
									...
									GroupByType=System.Windows.Forms.DataVisualization.Charting.IntervalType.Months,
									LegendDock=HelianzGraph.Enumerations.LegendDockType.Bottom,
									QuickRangePref=HelianzGraph.Enumerations.QuickRange.last12Months,
									BreakdownPref=HelianzGraph.Enumerations.BreakdownType.items,
									BreakdownVal=10,
								})
							});
							break;
