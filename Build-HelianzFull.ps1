...
$installerCsproj = Join-Path $PSScriptRoot "Helianz-Installer\HelianzInstaller\Heliantrix-Installer.csproj"
...
# ---------------------------------------------------------------------------
# Step 6b: (REMOVED) Pangolin client is no longer mandatory.
# Clients connect directly to the middle-tier server via the VPS public domain
# (http://dsmile.smkkampungjawa.sch.id). No local VPN/tunnel client needed.
# ---------------------------------------------------------------------------
# The HelianzInstaller.exe gracefully skips Pangolin when the folder is absent,
# showing: "Pangolin.exe not found in the installer directory. Pangolin will not be installed."
