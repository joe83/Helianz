  ...
  <nav style="position: fixed; top:0; bottom:0; Left:0; width:300px; Overflow-x:hidden; overflow-y:scroll; min-height:100%;">
	<div style="text-align:center; display: block; margin-bottom:.809em;">
		...
		<select id="versionSelect" onchange="optionChanged(this.value);" style="margin-bottom:8px;">
			<option value="/HelianzDiffDocumentation18-2.xml">Version 18.2</option>
			<option value="/HelianzDiffDocumentation18-1.xml">Version 18.1</option>
			<option value="/HelianzDiffDocumentation17-4.xml">Version 17.4</option>
			<option value="/HelianzDiffDocumentation17-3.xml">Version 17.3</option>
			<option value="/HelianzDiffDocumentation17-2.xml">Version 17.2</option>
			<option value="/HelianzDiffDocumentation17-1.xml">Version 17.1</option>
		</select>
		<br/>
	...
	<div style="margin-left:20; margin-right:20; overflow-y=auto;">
		<p>
      <a href="/HelianzDocumentation18-2.xml" id="linkDocumentation" onclick="setDatabaseDocLink();">Show All Database Schema</a>
