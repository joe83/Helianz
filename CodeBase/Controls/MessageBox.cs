...
namespace CodeBase {
	...
	///E.g. see Helianz.MessageBox for more details.
	...
	///or go remove the suggestion entirely in the Visual Studio settings.  To remove this suggestion from the Helianz project...
